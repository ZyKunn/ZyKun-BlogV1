<template><div><h1 id="reggie-开发笔记【优化七】" tabindex="-1"><a class="header-anchor" href="#reggie-开发笔记【优化七】" aria-hidden="true">#</a> Reggie 开发笔记【优化七】</h1>
<nav class="table-of-contents"><ul><li><router-link to="#缓存优化">缓存优化</router-link><ul><li><router-link to="#环境搭建">环境搭建</router-link></li><li><router-link to="#缓存短信验证码">缓存短信验证码</router-link></li><li><router-link to="#缓存菜品数据">缓存菜品数据</router-link></li><li><router-link to="#spring-cache">Spring Cache</router-link></li><li><router-link to="#缓存套餐数据">缓存套餐数据</router-link></li></ul></li></ul></nav>
<h2 id="缓存优化" tabindex="-1"><a class="header-anchor" href="#缓存优化" aria-hidden="true">#</a> 缓存优化</h2>
<p><strong>问题说明</strong></p>
<p><img src="@source/notes/project/01/Reggie开发笔记07/assets/1683975506654.png" alt="1683975506654"></p>
<p><strong>用户数量多，系统访问量大频繁访问数据库，系统性能下降，用户体验差</strong></p>
<h3 id="环境搭建" tabindex="-1"><a class="header-anchor" href="#环境搭建" aria-hidden="true">#</a> 环境搭建</h3>
<h4 id="maven-坐标" tabindex="-1"><a class="header-anchor" href="#maven-坐标" aria-hidden="true">#</a> maven 坐标</h4>
<p>在项目的 pom.xm1 文件中导入 spring data redis 的 maven 坐标:</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="配置文件" tabindex="-1"><a class="header-anchor" href="#配置文件" aria-hidden="true">#</a> 配置文件</h4>
<p>在项目的 application.yml 中加入 redis 相关配置:</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="配置类" tabindex="-1"><a class="header-anchor" href="#配置类" aria-hidden="true">#</a> 配置类</h4>
<p>在项目中加入配置类 RedisConfig:</p>
...
<h3 id="缓存短信验证码" tabindex="-1"><a class="header-anchor" href="#缓存短信验证码" aria-hidden="true">#</a> 缓存短信验证码</h3>
<h4 id="实现思路" tabindex="-1"><a class="header-anchor" href="#实现思路" aria-hidden="true">#</a> 实现思路</h4>
<p>前面我们已经实现了移动端手机验证码登录，随机生成的验证码我们是保存在 HttpSession 中的。现在需要改造为将验证码缓存在 Redis 中，具体的实现思路如下:</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>2、在服务端 UserController 的 sendMsg 方法中，将随机生成的验证码缓存到 Redis 中，并设置有效期为 5 分钟</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>3、在服务端 UserController 的 login 方法中，从 Redis 中获取缓存的验证码，如果登录成功则删除 Redis 中的验证码</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//从redis中获取保存的验证码</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="缓存菜品数据" tabindex="-1"><a class="header-anchor" href="#缓存菜品数据" aria-hidden="true">#</a> 缓存菜品数据</h3>
<h4 id="实现思路-1" tabindex="-1"><a class="header-anchor" href="#实现思路-1" aria-hidden="true">#</a> 实现思路</h4>
<p>前面我们已经实现了移动端菜品查看功能，对应的服务端方法为 DishController 的 list 方法，此方法会根据前端提交的查询条件进行数据库查询操作。在高并发的情况下，频繁查询数据库会导致系统性能下降，服务端响应时间增长。现在需要对此方法进行缓存优化，提高系统的性能。</p>
<p>具体的实现思路如下:</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2、改造 DishController 的 save 和 update 方法，加入清理缓存的逻辑</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//清理所有菜品缓存数据</span>
...
<h3 id="spring-cache" tabindex="-1"><a class="header-anchor" href="#spring-cache" aria-hidden="true">#</a> Spring Cache</h3>
<h4 id="spring-cache-介绍" tabindex="-1"><a class="header-anchor" href="#spring-cache-介绍" aria-hidden="true">#</a> Spring Cache 介绍</h4>
<p>Spring cache 是一个框架，实现了基于注解的缓存功能，只需要简单地加一个注解，就能实现缓存功能。</p>
<p>Spring Cache 提供了一层抽象，底层可以切换不同的 cache 实现。具体就是通过 CacheManager 接口来统一不同的缓存技术。</p>
<p>CacheManager 是 Spring 提供的各种缓存技术抽象接口。</p>
<p>针对不同的缓存技术需要实现不同的 CacheManager:
<img src="@source/notes/project/01/Reggie开发笔记07/assets/1683975570094.png" alt="1683975570094"></p>
<h4 id="spring-cache-常用注解" tabindex="-1"><a class="header-anchor" href="#spring-cache-常用注解" aria-hidden="true">#</a> Spring Cache 常用注解</h4>
<p><img src="@source/notes/project/01/Reggie开发笔记07/assets/1683975586087.png" alt="1683975586087"></p>
...
<h4 id="spring-cache-使用方式" tabindex="-1"><a class="header-anchor" href="#spring-cache-使用方式" aria-hidden="true">#</a> Spring Cache 使用方式</h4>
<p>在 Spring Boot 项目中使用 Spring Cache 的操作步骤(使用 redis 缓存技术);</p>
<p>1、导入 maven 坐标</p>
<ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>3、在启动类上加入@EnableCaching 注解，开启缓存注解功能</p>
<p>4、在 Controller 的方法上加入@Cacheable、@CacheEvict 等注解，进行缓存操作</p>
<h3 id="缓存套餐数据" tabindex="-1"><a class="header-anchor" href="#缓存套餐数据" aria-hidden="true">#</a> 缓存套餐数据</h3>
<h4 id="实现思路-2" tabindex="-1"><a class="header-anchor" href="#实现思路-2" aria-hidden="true">#</a> 实现思路</h4>
<p>前面我们已经实现了移动端套餐查看功能，对应的服务端方法为 SetmealController 的 list 方法，此方法会根据前端提交的查询条件进行数据库查询操作。在高并发的情况下，频繁查询数据库会导致系统性能下降，服务端响应时间增长。现在需要对此方法进行缓存优化，提高系统的性能。</p>
<p>具体的实现思路如下:</p>
<p>1、导入 Spring Cache 和 Redis 相关 maven 坐标</p>
<p>2、在 application.yml 中配置缓存数据的过期时间</p>
<p>3、在启动类上加入@EnableCaching 注解，开启缓存注解功能</p>
<p>4、在 SetmealController 的 list 方法上加入@Cacheable 注解</p>
<p>5、在 SetmealController 的 save 和 delete 方法上加入 CacheEvict 注解</p>
<h4 id="代码改造" tabindex="-1"><a class="header-anchor" href="#代码改造" aria-hidden="true">#</a> 代码改造</h4>
<p>在 pom.xml 文件中导入 maven 坐标:</p>
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>dependency</span><span class="token punctuation">></span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>groupId</span><span class="token punctuation">></span></span>org.springframework.boot<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>groupId</span><span class="token punctuation">></span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>artifactId</span><span class="token punctuation">></span></span>spring-boot-starter-cache<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>artifactId</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>dependency</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在 application.yml 中配置缓存数据过期时间:</p>
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code><span class="token key atrule">cache</span><span class="token punctuation">:</span>
  <span class="token key atrule">redis</span><span class="token punctuation">:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在启动类@EnableCaching 注解</p>
<p>在 list 方法上添加注解，实现在 redis 里添加缓存：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>在 update，add，delete 方法上添加注解，清除缓存：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><strong>注意</strong>：要让 R 实现 Serializable 接口（序列化），注解才能生效</p>
</div></template>
