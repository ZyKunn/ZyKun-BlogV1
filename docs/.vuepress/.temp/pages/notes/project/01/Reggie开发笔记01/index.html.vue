<template><div><h1 id="reggie-开发笔记-一" tabindex="-1"><a class="header-anchor" href="#reggie-开发笔记-一" aria-hidden="true">#</a> Reggie 开发笔记 一</h1>
<nav class="table-of-contents"><ul><li><router-link to="#_1、软件开发整体介绍">1、软件开发整体介绍</router-link><ul><li><router-link to="#软件开发流程">软件开发流程</router-link></li><li><router-link to="#角色分工">角色分工</router-link></li><li><router-link to="#软件环境">软件环境</router-link></li></ul></li><li><router-link to="#_2、reggie-外卖项目介绍">2、Reggie 外卖项目介绍</router-link><ul><li><router-link to="#项目介绍">项目介绍</router-link></li><li><router-link to="#产品原型展示">产品原型展示</router-link></li><li><router-link to="#技术选型">技术选型</router-link></li><li><router-link to="#功能架构">功能架构</router-link></li><li><router-link to="#角色">角色</router-link></li></ul></li><li><router-link to="#_3、环境搭建">3、环境搭建</router-link><ul><li><router-link to="#数据库环境搭建">数据库环境搭建</router-link></li><li><router-link to="#maven-项目搭建">maven 项目搭建</router-link></li></ul></li><li><router-link to="#_4、后台登录功能开发">4、后台登录功能开发</router-link><ul><li><router-link to="#需求分析">需求分析</router-link></li><li><router-link to="#代码开发">代码开发</router-link></li></ul></li><li><router-link to="#_5、后台退出功能开发">5、后台退出功能开发</router-link></li></ul></nav>
<h2 id="_1、软件开发整体介绍" tabindex="-1"><a class="header-anchor" href="#_1、软件开发整体介绍" aria-hidden="true">#</a> 1、软件开发整体介绍</h2>
<h3 id="软件开发流程" tabindex="-1"><a class="header-anchor" href="#软件开发流程" aria-hidden="true">#</a> 软件开发流程</h3>
<p><img src="@source/notes/project/01/Reggie开发笔记01/assets/1682589688874.png" alt="1682589688874"></p>
<h3 id="角色分工" tabindex="-1"><a class="header-anchor" href="#角色分工" aria-hidden="true">#</a> 角色分工</h3>
<p><img src="@source/notes/project/01/Reggie开发笔记01/assets/1682589715204.png" alt="1682589715204"></p>
<h3 id="软件环境" tabindex="-1"><a class="header-anchor" href="#软件环境" aria-hidden="true">#</a> 软件环境</h3>
<p><img src="@source/notes/project/01/Reggie开发笔记01/assets/1682589731919.png" alt="1682589731919"></p>
<h2 id="_2、reggie-外卖项目介绍" tabindex="-1"><a class="header-anchor" href="#_2、reggie-外卖项目介绍" aria-hidden="true">#</a> 2、Reggie 外卖项目介绍</h2>
<h3 id="项目介绍" tabindex="-1"><a class="header-anchor" href="#项目介绍" aria-hidden="true">#</a> 项目介绍</h3>
<p><img src="@source/notes/project/01/Reggie开发笔记01/assets/1682589747879.png" alt="1682589747879"></p>
<h3 id="产品原型展示" tabindex="-1"><a class="header-anchor" href="#产品原型展示" aria-hidden="true">#</a> 产品原型展示</h3>
<p><img src="@source/notes/project/01/Reggie开发笔记01/assets/1682589771943.png" alt="1682589771943"></p>
<h3 id="技术选型" tabindex="-1"><a class="header-anchor" href="#技术选型" aria-hidden="true">#</a> 技术选型</h3>
<p><img src="@source/notes/project/01/Reggie开发笔记01/assets/1682589790553.png" alt="1682589790553"></p>
<h3 id="功能架构" tabindex="-1"><a class="header-anchor" href="#功能架构" aria-hidden="true">#</a> 功能架构</h3>
<p><img src="@source/notes/project/01/Reggie开发笔记01/assets/1682589804560.png" alt="1682589804560"></p>
<h3 id="角色" tabindex="-1"><a class="header-anchor" href="#角色" aria-hidden="true">#</a> 角色</h3>
<p><img src="@source/notes/project/01/Reggie开发笔记01/assets/1682589817060.png" alt="1682589817060"></p>
<h2 id="_3、环境搭建" tabindex="-1"><a class="header-anchor" href="#_3、环境搭建" aria-hidden="true">#</a> 3、环境搭建</h2>
<h3 id="数据库环境搭建" tabindex="-1"><a class="header-anchor" href="#数据库环境搭建" aria-hidden="true">#</a> 数据库环境搭建</h3>
<ul>
<li><strong>创建数据库</strong>
<img src="@source/notes/project/01/Reggie开发笔记01/assets/1682589834235.png" alt="1682589834235"></li>
<li><strong>执行 SQL 脚本</strong>
<img src="@source/notes/project/01/Reggie开发笔记01/assets/1682589850486.png" alt="1682589850486"></li>
<li><strong>数据表</strong>
<img src="@source/notes/project/01/Reggie开发笔记01/assets/1682589865368.png" alt="1682589865368"></li>
</ul>
<h3 id="maven-项目搭建" tabindex="-1"><a class="header-anchor" href="#maven-项目搭建" aria-hidden="true">#</a> maven 项目搭建</h3>
<p><img src="@source/notes/project/01/Reggie开发笔记01/assets/1682589883929.png" alt="1682589883929"></p>
<p><strong>解决 IDEA 加载 maven 工程缓慢</strong>
VM Options:-DarchetypeCatalog=local</p>
...
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code>    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>parent</span><span class="token punctuation">></span></span>
    ...
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>groupId</span><span class="token punctuation">></span></span>com.ka<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>groupId</span><span class="token punctuation">></span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>artifactId</span><span class="token punctuation">></span></span>reggie<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>artifactId</span><span class="token punctuation">></span></span>
...
<span class="token key atrule">mybatis-plus</span><span class="token punctuation">:</span>
  <span class="token key atrule">configuration</span><span class="token punctuation">:</span>
    <span class="token comment">#address_book->AddressBook</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>配置 application 启动类</strong></p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>把前端的静态资源放在 resource 目录
<img src="@source/notes/project/01/Reggie开发笔记01/assets/1682589943519.png" alt="1682589943519"></p>
<p>设置静态资源映射</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Slf4j</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">WebMvcConfig</span> <span class="token keyword">extends</span> <span class="token class-name">WebMvcConfigurationSupport</span> <span class="token punctuation">{</span>
    ...
    <span class="token keyword">protected</span> <span class="token keyword">void</span> <span class="token function">addResourceHandlers</span><span class="token punctuation">(</span><span class="token class-name">ResourceHandlerRegistry</span> registry<span class="token punctuation">)</span> <span class="token punctuation">{</span>
        log<span class="token punctuation">.</span><span class="token function">info</span><span class="token punctuation">(</span><span class="token string">"开始静态资源映射"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>启动项目，访问 http://localhost:8080/backend/index.html
<img src="@source/notes/project/01/Reggie开发笔记01/assets/1682590084569.png" alt="1682590084569"></p>
<h2 id="_4、后台登录功能开发" tabindex="-1"><a class="header-anchor" href="#_4、后台登录功能开发" aria-hidden="true">#</a> 4、后台登录功能开发</h2>
<h3 id="需求分析" tabindex="-1"><a class="header-anchor" href="#需求分析" aria-hidden="true">#</a> 需求分析</h3>
<ul>
<li>登录页面展示(<a href="http://localhost:8080/backend/page/login/login.html" target="_blank" rel="noopener noreferrer">http://localhost:8080/backend/page/login/login.html<ExternalLinkIcon/></a>)
<img src="@source/notes/project/01/Reggie开发笔记01/assets/1682590111293.png" alt="1682590111293"></li>
<li>查看登录请求信息
<img src="@source/notes/project/01/Reggie开发笔记01/assets/1682590125600.png" alt="1682590125600"></li>
<li>数据模型（employee 表）
<img src="@source/notes/project/01/Reggie开发笔记01/assets/1682590141391.png" alt="1682590141391"></li>
</ul>
<h3 id="代码开发" tabindex="-1"><a class="header-anchor" href="#代码开发" aria-hidden="true">#</a> 代码开发</h3>
<ul>
<li>创建实体类 Employee，和 employee 表进行映射</li>
</ul>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Employee</span> <span class="token keyword">implements</span> <span class="token class-name">Serializable</span> <span class="token punctuation">{</span>
    ...
    <span class="token keyword">private</span> <span class="token class-name">String</span> idNumber<span class="token punctuation">;</span><span class="token comment">//身份证号码</span>
...
<li>创建 Controller，Service，Mapper</li>
</ul>
<p>EmployeeMapper</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>EmployeeService</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>EmployeeServiceImpl</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>EmployeeController</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Slf4j</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">EmployeeController</span> <span class="token punctuation">{</span>
    ...
    <span class="token keyword">private</span> <span class="token class-name">EmployeeServiceImpl</span> employeeService<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
...
<li>在 Controller 中创建登录方法
<img src="@source/notes/project/01/Reggie开发笔记01/assets/1682590259774.png" alt="1682590259774">
<img src="@source/notes/project/01/Reggie开发笔记01/assets/1682590280155.png" alt="1682590280155"></li>
</ul>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Slf4j</span>
<span class="token annotation punctuation">@RestController</span>
<span class="token annotation punctuation">@RequestMapping</span><span class="token punctuation">(</span><span class="token string">"/employee"</span><span class="token punctuation">)</span>
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">EmployeeController</span> <span class="token punctuation">{</span>
    ...
    <span class="token keyword">public</span> <span class="token class-name">R</span><span class="token generics"><span class="token punctuation">&lt;</span><span class="token class-name">Employee</span><span class="token punctuation">></span></span> <span class="token function">logib</span><span class="token punctuation">(</span><span class="token class-name">HttpServletRequest</span> request<span class="token punctuation">,</span> <span class="token annotation punctuation">@RequestBody</span> <span class="token class-name">Employee</span> employee<span class="token punctuation">)</span> <span class="token punctuation">{</span>
        ...
        <span class="token keyword">if</span> <span class="token punctuation">(</span><span class="token operator">!</span>emp<span class="token punctuation">.</span><span class="token function">getPassword</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">.</span><span class="token function">equals</span><span class="token punctuation">(</span>password<span class="token punctuation">)</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
            <span class="token keyword">return</span> <span class="token class-name">R</span><span class="token punctuation">.</span><span class="token function">error</span><span class="token punctuation">(</span><span class="token string">"密码错误"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
        <span class="token punctuation">}</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_5、后台退出功能开发" tabindex="-1"><a class="header-anchor" href="#_5、后台退出功能开发" aria-hidden="true">#</a> 5、后台退出功能开发</h2>
<p><strong>需求分析</strong>
<img src="@source/notes/project/01/Reggie开发笔记01/assets/1682590314987.png" alt="1682590314987"></p>
<p><strong>代码实现</strong></p>
<p>在 Controller 中创建退出方法</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>    <span class="token comment">//员工退出</span>
