<template><div><h1 id="_03-javascript-三" tabindex="-1"><a class="header-anchor" href="#_03-javascript-三" aria-hidden="true">#</a> 03 - JavaScript（三） 🏵️</h1>
<nav class="table-of-contents"><ul><li><router-link to="#全局函数">全局函数</router-link></li><li><router-link to="#常见内置对象">常见内置对象</router-link><ul><li><router-link to="#array">Array</router-link></li></ul></li><li><router-link to="#dom-文档对象模型">DOM（文档对象模型）</router-link><ul><li><router-link to="#概述">概述</router-link></li><li><router-link to="#获取-dom-几种方式">获取 DOM 几种方式</router-link></li></ul></li><li><router-link to="#练习">练习</router-link></li></ul></nav>
<h2 id="全局函数" tabindex="-1"><a class="header-anchor" href="#全局函数" aria-hidden="true">#</a> 全局函数</h2>
<p>javascript 提供了一些常见的全局函数，大多数用实现数据转换的功能：</p>
<ul>
<li>parseInt():将 string 类型转换为 number 类型（只会取整数）</li>
<li>parseFloat():将 string 类型转换为 number 类型（会保留小数点）</li>
<li>eval():可以将字符串作为 js 代码进行执行 <kbd>永远不要使用 <code v-pre>eval</code>！</kbd></li>
<li>encodeURI():将 string 类型数据转码为 url 编码</li>
<li>decodeURI():将 url 编码的字符串解码为原始字符串值</li>
<li>Number():将任意类型转换为 number</li>
<li>String():将任意类型转换为 string</li>
</ul>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> s <span class="token operator">=</span> <span class="token string">'123456'</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="常见内置对象" tabindex="-1"><a class="header-anchor" href="#常见内置对象" aria-hidden="true">#</a> 常见内置对象</h2>
<h4 id="number" tabindex="-1"><a class="header-anchor" href="#number" aria-hidden="true">#</a> Number</h4>
<p>JavaScript 的 <strong>Number</strong> 对象是经过封装的能让你处理数字值的对象。<code v-pre>Number</code> 对象的创建方式分为两种：</p>
<ol>
<li>
<p>使用 Number 构造器创建</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> num <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">Number</span><span class="token punctuation">(</span><span class="token string">'100'</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li>
<li>
<p>使用 Number 的工厂方法创建</p>
...
<p>关于工厂方法原理如下：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">User</span><span class="token punctuation">(</span><span class="token parameter">id<span class="token punctuation">,</span> name<span class="token punctuation">,</span> pwd</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<p>使用示例:</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">//工厂模式</span>
...
<p>类似 java 中 String，javascript 的 String 类型也用于表示字符串，区别在于 js 中的 String 既可以表示字符串还可以表示字符，内部包含的一些方法与 java 中 String 类的方法基本一致，String 对象的创建同 number 一样也包含两种创建方式：</p>
<ol>
<li>构造器创建</li>
<li>工厂方法创建</li>
</ol>
...
<p>Array 是 js 中的数组对象，创建方式包含以下：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">//构造空数组对象</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="math" tabindex="-1"><a class="header-anchor" href="#math" aria-hidden="true">#</a> Math</h4>
<p>Math 对象类似 java 中 Math 类，js 中的 Math 不能通过传统的方式(构造器，工厂)创建对象，内部的所有方法可以直接通过 Math 调用，不需要实例对象调用（类似 java 中静态方法）</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">//从传入的参数中返回最大的一个元素</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="regexp-正则表达式" tabindex="-1"><a class="header-anchor" href="#regexp-正则表达式" aria-hidden="true">#</a> RegExp（正则表达式）</h4>
<p>​ 正则表达式在 javascript 用途主要在表单验证，正则表达式即通过一些特殊的符号标记按照一定的规则进行组织，形成字符串可以用于对指定的文本内容（string）进行匹配，查找，替换等操作。</p>
<p>js 中正则表达式对象的创建方式主要包含以下三种:</p>
<ol>
<li>
<p>使用构造器创建</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> regex <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">RegExp</span><span class="token punctuation">(</span><span class="token string">'\\d{3,5}'</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li>
<li>
<p>使用正则表达式常量表示形式</p>
...
<li>
<p>使用静态工厂创建</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> regex <span class="token operator">=</span> <span class="token string">'\\d{3,5}'</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li>
</ol>
<p>基本使用：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> num <span class="token operator">=</span> <span class="token string">'56432123123'</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>正则表达式使用实例：</p>
<p><strong>验证手机号格式是否正确</strong></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="dom-文档对象模型" tabindex="-1"><a class="header-anchor" href="#dom-文档对象模型" aria-hidden="true">#</a> DOM（文档对象模型）</h2>
<h3 id="概述" tabindex="-1"><a class="header-anchor" href="#概述" aria-hidden="true">#</a> 概述</h3>
<p>​ Javascript 支持 DOM 编程，DOM 即：Document Object Model；对于任何一个 html 网页都可以将页面中所有内容当做一颗倒置的文档树理解，可以通过 js 的 dom 操作对树中任意节点进行访问（添加，删除，修改，检索），倒置的文档树看上去，就像如下结构:</p>
<p><img src="@source/notes/front-end/02/03-JavaScript(三）/assets/1608793100663.png" alt="1608793100663"></p>
<p>名词解释:</p>
<ol>
<li>元素（Element）：html 中任意一个标签开始到标签结束，之间的内容（包括标签本身）都称之为元素，一个元素也称之为一个节点</li>
<li>属性（Attribute）：属性是开始标签中有属性名和属性值构成的一个键值对结构</li>
</ol>
<h3 id="获取-dom-几种方式" tabindex="-1"><a class="header-anchor" href="#获取-dom-几种方式" aria-hidden="true">#</a> 获取 DOM 几种方式</h3>
<ol>
<li>
<p>获取文档中的所有元素</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> all <span class="token operator">=</span> document<span class="token punctuation">.</span>all <span class="token comment">// 返回一个包含了文档中所有节点的数组对象</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li>
<li>
<p>根据标签获取元素</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">//获取页面中的所有h1元素 (返回数组对象)</span>
...
<li>
<p>根据元素的 class 名称获取元素（存在兼容性问题，慎用）</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">//返回所有class名称为row的元素(返回数组对象)</span>
...
<li>
<p>根据元素的 name 属性获取元素集合（一般只有表单元素才有 name 属性）</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">let</span> langs <span class="token operator">=</span> document<span class="token punctuation">.</span><span class="token function">getElementsByName</span><span class="token punctuation">(</span><span class="token string">'lang'</span><span class="token punctuation">)</span> <span class="token comment">//返回数组</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li>
<li>
<p><strong>根据元素的 id 获取元素(因为 id 在页面中具备唯一性，因此以下代码只能获取一个元素)</strong></p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">let</span> selectAll <span class="token operator">=</span> document<span class="token punctuation">.</span><span class="token function">getElementById</span><span class="token punctuation">(</span><span class="token string">'selectAll'</span><span class="token punctuation">)</span> <span class="token comment">//返回单个元素对象</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li>
</ol>
<p>以上都是一些比较常规的获取 dom 的方式，另外 javascript 还提供了两种更为全面的获取 dom 对象的方式：</p>
<ol>
<li>
<p><strong>document.querySelector()：根据 css 的选择器获取匹配的单个元素</strong></p>
</li>
<li>
<p><strong>document.querySelectAll()：根据提供的 css 选择器获取匹配的多个元素</strong></p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">//根据css的选择器获取指定选择器选中的单个元素</span>
...
<h4 id="综合练习" tabindex="-1"><a class="header-anchor" href="#综合练习" aria-hidden="true">#</a> 综合练习</h4>
<p>省市联动效果：</p>
<ol>
<li>
<p>数据文件</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>var data = <span class="token punctuation">{</span>
...
<ol>
<li>
<p>结合 Array 和 Math 对象实现一个抽奖系统？页面效果自己实现</p>
</li>
<li>
<p>给定 json 数据，要求将数据在页面中进行绑定</p>
<p>参考：</p>
<ul>
<li>json 数据：</li>
</ul>
...
<p><img src="@source/notes/front-end/02/03-JavaScript(三）/assets/1608801775202.png" alt="1608801775202"></p>
</li>
</ol>
<p>提示：innerHTML</p>
</div></template>
