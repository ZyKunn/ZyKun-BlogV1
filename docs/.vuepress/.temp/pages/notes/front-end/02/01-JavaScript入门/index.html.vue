<template><div><h1 id="_01-javascript-入门" tabindex="-1"><a class="header-anchor" href="#_01-javascript-入门" aria-hidden="true">#</a> 01 - JavaScript 入门 🌸</h1>
<nav class="table-of-contents"><ul><li><router-link to="#js-概述">JS 概述</router-link><ul><li><router-link to="#js-使用场景">JS 使用场景</router-link></li></ul></li><li><router-link to="#基础语法">基础语法</router-link><ul><li><router-link to="#hellojs">HelloJS</router-link></li><li><router-link to="#常见引入方式">常见引入方式</router-link></li><li><router-link to="#数据类型">数据类型</router-link></li><li><router-link to="#运算符">运算符</router-link></li><li><router-link to="#流程控制">流程控制</router-link></li></ul></li><li><router-link to="#练习">练习</router-link></li></ul></nav>
<h2 id="js-概述" tabindex="-1"><a class="header-anchor" href="#js-概述" aria-hidden="true">#</a> JS 概述</h2>
<p>​ javaScript 简称 JS，是一门运行在客户端浏览器的脚本语言（无法独立运行的程序设计语言）；是一门直译型语言（不需要编译），是一门客户端语言；</p>
<p>​ Javascript 同时也是一门弱类型的程序语句，以及基于事件驱动的语言。</p>
<blockquote>
<p>关于强类型和弱类型：</p>
<p><strong>java：</strong></p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">int</span> i <span class="token operator">=</span> <span class="token number">10</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>注意:java 中任何变量再使用前需要声明其数据类型，任何的变量一旦确定其类型，则只能赋予对应类型的值，运行期间不能修改为其他类型的数据，因此 Java 是一门强类型语言，即不是一门动态语言</p>
<p>javascript：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>i <span class="token operator">=</span> <span class="token number">10</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>javascript 由于没有编译的过程，因此任何变量的数据类型确定是在运行期间动态绑定，并且还能在运行时修改其数据类型，因此，javascript 是一门弱类型语言，即动态语言。与 Python 相同没有都没有编译过程</p>
<p>通过以上案例不难看出：</p>
<p>java 是一门服务端语言（经过编译后，直接执行）</p>
<p>javascript 是一门客户端语言（不要编译，运行期间动态绑定，效率相对较低，不适合进行服务器开发）</p>
</blockquote>
<h3 id="js-使用场景" tabindex="-1"><a class="header-anchor" href="#js-使用场景" aria-hidden="true">#</a> JS 使用场景</h3>
<p>javascript 一般用于对网页特效以及表单验证等涉及到网页动态效果的功能,例如:</p>
<ul>
<li>下拉菜单</li>
<li>回到顶部</li>
<li>楼层导航</li>
...
<h3 id="hellojs" tabindex="-1"><a class="header-anchor" href="#hellojs" aria-hidden="true">#</a> HelloJS</h3>
<p>javascript 一般在 html 页面中进行编写，通常位于一对<code v-pre>&lt;script&gt;</code>之间</p>
...
<p>注意:</p>
<p><code v-pre>&lt;script&gt;</code>标签可以在 html 的任意位置进行编写，常见的区域主要出现在以下两个位置</p>
<ul>
<li>head 标签对之间</li>
<li><strong>body 标签结尾处（推荐）</strong></li>
</ul>
</blockquote>
<h3 id="常见引入方式" tabindex="-1"><a class="header-anchor" href="#常见引入方式" aria-hidden="true">#</a> 常见引入方式</h3>
<p>在 html 中使用 javascript 包含以下三种方式：</p>
<ol>
<li>
<p>直接在 html 页面中使用内联<code v-pre>&lt;script&gt;</code>标签编写</p>
...
<li>
<p>引入外部的脚本文件(js 文件)</p>
<div class="language-html line-numbers-mode" data-ext="html"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>script</span> <span class="token attr-name">src</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>js/js01.js<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token script"></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>script</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>js 文件(js01.js)</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// System.out.println()</span>
console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span><span class="token string">'hello js!'</span><span class="token punctuation">)</span>
...
<li>
<p>直接在 html 元素中使用内嵌的方式使用</p>
<div class="language-html line-numbers-mode" data-ext="html"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>a</span> <span class="token attr-name">href</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>javascript:alert('想啥呢，老铁！！')<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>点我看pian<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>a</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li>
</ol>
<blockquote>
<h4 id="关于-href-和-src-区别" tabindex="-1"><a class="header-anchor" href="#关于-href-和-src-区别" aria-hidden="true">#</a> 关于 href 和 src 区别？</h4>
<div class="language-html line-numbers-mode" data-ext="html"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>link</span> <span class="token attr-name">rel</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>stylesheet<span class="token punctuation">"</span></span> <span class="token attr-name">href</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>css/index.css<span class="token punctuation">"</span></span> <span class="token punctuation">/></span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>href 和 src 都用于关联外部的资源文件，区别在于 href 所关联的资源一旦执行到此处，则<strong>同步加载</strong></p>
<p>src 所关联的资源，一旦执行到此处，则<strong>浏览器停止对页面进行渲染</strong>，先读取 src 关联的资源，并将资源<strong>替换</strong>到当前位置</p>
</blockquote>
<h3 id="数据类型" tabindex="-1"><a class="header-anchor" href="#数据类型" aria-hidden="true">#</a> 数据类型</h3>
<p>虽然说 js 是一门弱类型语言，但是不代表不区分数据类型，js 中也支持很多不同类型的数据，js 的主要数据类型包含以下几类:</p>
<ul>
<li>数值型（包含浮点型）</li>
<li>字符串型</li>
<li>布尔型</li>
...
<h4 id="数值类型-number" tabindex="-1"><a class="header-anchor" href="#数值类型-number" aria-hidden="true">#</a> 数值类型（number）</h4>
<p>javascript 中对于任何的数值都是使用的 number 的数据类型表示，没有所谓浮点型和整型之分：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> i <span class="token operator">=</span> <span class="token number">10</span>
...
<p>typeof 是一个 js 中的一个运算符，判断指定变量是什么类型</p>
</blockquote>
<h4 id="字符串类型-string" tabindex="-1"><a class="header-anchor" href="#字符串类型-string" aria-hidden="true">#</a> 字符串类型（string）</h4>
<p>javascript 中对于所有的字符字符串统一使用 string 来表示，即没有字符和字符串之分，在 js 中可以使用单引号或者双引号表示字符串类型：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> s <span class="token operator">=</span> <span class="token string">'中'</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="布尔类型-boolean" tabindex="-1"><a class="header-anchor" href="#布尔类型-boolean" aria-hidden="true">#</a> 布尔类型（boolean）</h4>
<p>javascript 中也存在 boolean 类型，取值也只能是 true 和 false,但是 js 中可以将任何的变量转换为 boolean 类型</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> b <span class="token operator">=</span> <span class="token boolean">false</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="对象类型-object" tabindex="-1"><a class="header-anchor" href="#对象类型-object" aria-hidden="true">#</a> 对象类型（object）</h4>
<p>javascript 中的对象有多种存在形式，其中一种比较常见的显示方式为类 Java 中 map 结构（键值对），在 js 中称之为<strong>json 对象</strong></p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">//对象(JSON对象)</span>
...
<p>以上 javascript 对象可以使用如下的 Java 类描述:</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">class</span> <span class="token class-name">People</span><span class="token punctuation">{</span>
...
<h4 id="数组类型-object-引用类型" tabindex="-1"><a class="header-anchor" href="#数组类型-object-引用类型" aria-hidden="true">#</a> 数组类型（object-引用类型）</h4>
<p>javascript 中的数组是以对象的形式存在，是一种引用类型</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="null-类型-object" tabindex="-1"><a class="header-anchor" href="#null-类型-object" aria-hidden="true">#</a> null 类型（object）</h4>
<p>表示一个空对象，在内存申请了空间，但是没有为该申请的空间赋值，通常这种对象使用 null 表示</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> n <span class="token operator">=</span> <span class="token keyword">null</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="undefined" tabindex="-1"><a class="header-anchor" href="#undefined" aria-hidden="true">#</a> undefined</h4>
<p>表示未申明的类型，与 null 类似，但是 undefined 并未申请任何空间。</p>
<h3 id="运算符" tabindex="-1"><a class="header-anchor" href="#运算符" aria-hidden="true">#</a> 运算符</h3>
<p>不同的数据类型之间必然会存在运算的操作，javascript 中支持大量的运算符，javascript 中的运算符主要包含以下几类：</p>
<ul>
<li>算术运算符</li>
<li>关系运算</li>
<li>布尔逻辑运算</li>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">/*算术运算*/</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="流程控制" tabindex="-1"><a class="header-anchor" href="#流程控制" aria-hidden="true">#</a> 流程控制</h3>
<h4 id="分支语句" tabindex="-1"><a class="header-anchor" href="#分支语句" aria-hidden="true">#</a> 分支语句</h4>
<h5 id="if" tabindex="-1"><a class="header-anchor" href="#if" aria-hidden="true">#</a> if</h5>
<p>if 语句的语法与 Java 基本类似，唯一不同的是 Java 中的 if 条件必须是一个布尔类型的表达式，但是 js 中 if 中可以编写任意类型的表达式，甚至是一个任何类型的变量，因为 js 中可以将任何的变量转换为 boolean 类型，例如:</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> i <span class="token operator">=</span> <span class="token number">0</span>
...
<p>i 虽然是一个 number 类型，但是 js 引擎会自动将该变量转换为 Boolean;js 中具体会将哪些数值转为 false,哪些数值转换为 true?</p>
<ol>
<li><strong>对于数值类型（number）,任何的非 0 的值都是 true</strong></li>
<li><strong>null 和 undefined 转换为 false</strong></li>
<li><strong>只要是存在的对象都是 true</strong></li>
<li><strong>空字符串转换为 false</strong></li>
</ol>
</blockquote>
<h5 id="swich" tabindex="-1"><a class="header-anchor" href="#swich" aria-hidden="true">#</a> swich</h5>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> y <span class="token operator">=</span> <span class="token number">2020</span>
...
<span class="token keyword">switch</span> <span class="token punctuation">(</span>m<span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token keyword">default</span><span class="token operator">:</span>
    ...
    <span class="token keyword">break</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="循环语句" tabindex="-1"><a class="header-anchor" href="#循环语句" aria-hidden="true">#</a> 循环语句</h4>
<p>javascript 中支持的循环语句主要包含两种</p>
<ul>
<li>for</li>
<li>while</li>
</ul>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//普通for循环</span>
...
<ol>
<li>完成一个动态日历的显示，在 html 页面中展示</li>
</ol>
</div></template>
