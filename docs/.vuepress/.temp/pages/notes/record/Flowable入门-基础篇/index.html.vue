<template><div><h1 id="🎐flowable-入门-基础篇" tabindex="-1"><a class="header-anchor" href="#🎐flowable-入门-基础篇" aria-hidden="true">#</a> 🎐Flowable 入门-基础篇</h1>
<hr/>
<nav class="table-of-contents"><ul><li><router-link to="#_1-创建-processengine">1.创建 ProcessEngine</router-link></li><li><router-link to="#_2-部署流程定义">2.部署流程定义</router-link></li><li><router-link to="#_3-启动流程实例">3.启动流程实例</router-link></li><li><router-link to="#_4-查看任务">4.查看任务</router-link></li><li><router-link to="#_5-完成任务">5.完成任务</router-link></li><li><router-link to="#_6-流程的删除">6.流程的删除</router-link></li><li><router-link to="#_7-查看历史信息">7.查看历史信息</router-link></li><li><router-link to="#_1-eclipse-designer">1.Eclipse Designer</router-link><ul><li><router-link to="#_1-1-下载安装-eclipse">1.1 下载安装 Eclipse</router-link></li><li><router-link to="#_1-2-安装-flowable-插件">1.2 安装 Flowable 插件</router-link></li><li><router-link to="#_1-3-创建项目">1.3 创建项目</router-link></li><li><router-link to="#_1-4-创建流程图">1.4 创建流程图</router-link></li><li><router-link to="#_1-5-部署流程">1.5 部署流程</router-link></li></ul></li><li><router-link to="#_2-flowable-ui-应用">2.Flowable UI 应用</router-link><ul><li><router-link to="#_2-1-安装部署">2.1 安装部署</router-link></li><li><router-link to="#_2-2-启动服务">2.2 启动服务</router-link></li><li><router-link to="#_2-3-用户管理">2.3 用户管理</router-link></li><li><router-link to="#_2-4-绘制流程">2.4 绘制流程</router-link></li><li><router-link to="#_2-5-部署流程">2.5 部署流程</router-link></li><li><router-link to="#_2-6-flowableui-演示">2.6 FlowableUI 演示</router-link></li></ul></li><li><router-link to="#_1-表结构讲解">1.表结构讲解</router-link></li><li><router-link to="#_2-processengine-讲解-processenginetest">2.ProcessEngine 讲解（ProcessEngineTest）</router-link><ul><li><router-link to="#_2-1-硬编码的方式">2.1 硬编码的方式</router-link></li><li><router-link to="#_2-2-配置文件">2.2 配置文件</router-link></li><li><router-link to="#_2-3-自定义配置文件">2.3 自定义配置文件</router-link></li></ul></li><li><router-link to="#_3-servcie-服务接口">3. Servcie 服务接口</router-link><ul><li><router-link to="#_3-1-service-创建方式">3.1 Service 创建方式</router-link></li><li><router-link to="#_3-2-service-总览">3.2 Service 总览</router-link></li></ul></li><li><router-link to="#_4-图标介绍">4.图标介绍</router-link><ul><li><router-link to="#_4-1-事件图标">4.1 事件图标</router-link></li><li><router-link to="#_4-2-活动-任务-图标">4.2 活动(任务)图标</router-link></li><li><router-link to="#_4-3-结构图标">4.3 结构图标</router-link></li><li><router-link to="#_4-4-网关图标">4.4 网关图标</router-link></li></ul></li><li><router-link to="#_5-流程部署详解">5.流程部署详解</router-link><ul><li><router-link to="#_5-1-部署实现">5.1 部署实现</router-link></li><li><router-link to="#_5-2-部署涉及表结构">5.2 部署涉及表结构</router-link></li><li><router-link to="#_5-3-挂起和激活">5.3 挂起和激活</router-link></li></ul></li><li><router-link to="#_6-启动流程实例">6.启动流程实例</router-link></li><li><router-link to="#_7-处理流程">7.处理流程</router-link></li><li><router-link to="#_8-完成一个流程">8.完成一个流程</router-link></li></ul></nav>
<h1 id="最新-flowable-工作流教程" tabindex="-1"><a class="header-anchor" href="#最新-flowable-工作流教程" aria-hidden="true">#</a> 最新 Flowable 工作流教程</h1>
<h1 id="一、flowable-介绍" tabindex="-1"><a class="header-anchor" href="#一、flowable-介绍" aria-hidden="true">#</a> 一、Flowable 介绍</h1>
<p>  Flowable 是 BPMN 的一个基于 java 的软件实现，不过 Flowable 不仅仅包括 BPMN，还有 DMN 决策表和 CMMN Case 管理引擎，并且有自己的用户管理、微服务 API 等一系列功能，是一个服务平台。</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220317101115398.png" alt="image-20220317101115398"></p>
<h1 id="二、flowable-基础" tabindex="-1"><a class="header-anchor" href="#二、flowable-基础" aria-hidden="true">#</a> 二、Flowable 基础</h1>
<p>官方手册：https://tkjohn.github.io/flowable-userguide/#_introduction</p>
<h2 id="_1-创建-processengine" tabindex="-1"><a class="header-anchor" href="#_1-创建-processengine" aria-hidden="true">#</a> 1.创建 ProcessEngine</h2>
<p>  创建一个基本的 maven 工程，可以是 Eclipse 也可以是其他 IDEA。然后添加两个依赖</p>
<ul>
<li>Flowable 流程引擎。使我们可以创建一个 ProcessEngine 流程引擎对象，并访问 Flowable API。</li>
<li>一个是 MySQL 的数据库驱动</li>
</ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>  注意在 mysql8.0 中执行可能出现如下的错误</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220316093416477.png" alt="image-20220316093416477"></p>
<p>  出现这种情况只需要在 mysql 的连接字符串中添加上 nullCatalogMeansCurrent=true，设置为只查当前连接的 schema 库即可。</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>  然后应用运行没有问题，但也没有在控制台提供有用的信息，只有一条消息提示日志没有正确配置。Flowable 使用<a href="http://www.slf4j.org/" target="_blank" rel="noopener noreferrer">SLF4J<ExternalLinkIcon/></a>作为内部日志框架。在这个例子中，我们使用 log4j 作为 SLF4J 的实现。因此在 pom.xml 文件中添加下列依赖：</p>
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>dependency</span><span class="token punctuation">></span></span>
...
<div class="language-properties line-numbers-mode" data-ext="properties"><pre v-pre class="language-properties"><code><span class="token key attr-name">log4j.rootLogger</span><span class="token punctuation">=</span><span class="token value attr-value">DEBUG, CA</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>  重新运行应用。应该可以看到关于引擎启动与创建数据库表结构的提示日志：</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220316093922199.png" alt="image-20220316093922199"></p>
<p>  同时可以看到创建了相关的表结构在数据库中(34 张表)</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220316093957662.png" alt="image-20220316093957662"></p>
<p>  这样就得到了一个启动可用的流程引擎。接下来为它提供一个流程！</p>
<h2 id="_2-部署流程定义" tabindex="-1"><a class="header-anchor" href="#_2-部署流程定义" aria-hidden="true">#</a> 2.部署流程定义</h2>
<p>  接下来我们构建一个非常简单的请假流程，Flowable 引擎需要流程定义为 BPMN 2.0 格式，这是一个业界广泛接受的 XML 标准。 在 Flowable 术语中，我们将其称为一个<strong>流程定义(process definition)</strong>。一个<em>流程定义</em>可以启动多个<strong>流程实例(process instance)</strong>。<em>流程定义</em>可以看做是重复执行流程的蓝图。 在这个例子中，<em>流程定义</em>定义了请假的各个步骤，而一个<em>流程实例</em>对应某个雇员提出的一个请假申请。</p>
<p>  BPMN 2.0 存储为 XML，并包含可视化的部分：使用标准方式定义了每个步骤类型（人工任务，自动服务调用，等等）如何呈现，以及如何互相连接。这样 BPMN 2.0 标准使技术人员与业务人员能用双方都能理解的方式交流业务流程。</p>
<p>  我们要使用的流程定义为：</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/getting.started.bpmn.process.png" alt="getting.started.bpmn.process"></p>
<p>  流程定义说明：</p>
<ul>
...
<li>左侧的圆圈叫做<strong>启动事件(start event)</strong>。这是一个流程实例的起点。</li>
<li>第一个矩形是一个<strong>用户任务(user task)</strong>。这是流程中用户操作的步骤。在这个例子中，经理需要批准或驳回申请</li>
...
<p>  一般来说，这样的<em>流程定义</em>使用可视化建模工具建立，如 Flowable Designer(Eclipse)或 Flowable Web Modeler(Web 应用)。但在这里我们直接撰写 XML，以熟悉 BPMN 2.0 及其概念。</p>
<p>  与上面展示的流程图对应的 BPMN 2.0 XML 在下面显示。请注意这只包含了“流程部分”。如果使用图形化建模工具，实际的 XML 文件还将包含“可视化部分”，用于描述图形信息，如流程定义中各个元素的坐标（所有的图形化信息包含在 XML 的<em>BPMNDiagram</em>标签中，作为<em>definitions</em>标签的子元素）。</p>
<p>  将下面的 XML 保存在<em>src/main/resources</em>文件夹下名为<em>holiday-request.bpmn20.xml</em>的文件中。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>  现在我们已经有了流程 BPMN 2.0 XML 文件，下来需要将它***部署(deploy)***到引擎中。<em>部署</em>一个流程定义意味着：</p>
<ul>
<li>流程引擎会将 XML 文件存储在数据库中，这样可以在需要的时候获取它</li>
<li>流程定义转换为内部的、可执行的对象模型，这样使用它就可以启动<em>流程实例</em>。</li>
</ul>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220317110902636.png" alt="image-20220317110902636"></p>
<p>  将流程定义<em>部署</em>至 Flowable 引擎，需要使用<em>RepositoryService</em>，其可以从<em>ProcessEngine</em>对象获取。使用<em>RepositoryService</em>，可以通过 XML 文件的路径创建一个新的<em>部署(Deployment)</em>，并调用*deploy()*方法实际执行：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>    <span class="token doc-comment comment">/**
     * 部署流程
...
<div class="language-txt line-numbers-mode" data-ext="txt"><pre v-pre class="language-txt"><code>deploy.getId() = 2501
deploy.getName() = 请求流程
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>  然后执行该方法日志操作成功：</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220316100439048.png" alt="image-20220316100439048"></p>
<p>  在后台表结构也可以看到相关的信息</p>
<p>act_re_deployment: 流程定义部署表，每部署一次就增加一条记录</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220316100532725.png" alt="image-20220316100532725"></p>
<p>act_re_procdef ：流程定义表，部署每个新的流程定义都会在这张表中增加一条记录</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220316100611004.png" alt="image-20220316100611004"></p>
<p>act_ge_bytearray ：流程资源表，流程部署的 bpmn 文件和 png 图片会保存在该表中</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220316100648362.png" alt="image-20220316100648362"></p>
<p>  我们现在可以通过 API 查询验证流程定义已经部署在引擎中（并学习一些 API）。通过<em>RepositoryService</em>创建的<em>ProcessDefinitionQuery</em>对象实现。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token doc-comment comment">/**
 * 查看流程定义
 */</span>
<span class="token annotation punctuation">@Test</span>
...
<div class="language-txt line-numbers-mode" data-ext="txt"><pre v-pre class="language-txt"><code>processDefinition.getId() = holidayRequest:2:2503
processDefinition.getName() = Holiday Request
processDefinition.getDeploymentId() = 2501
processDefinition.getDescription() = null
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>    <span class="token doc-comment comment">/**
     * 查询流程定义的信息
     */</span>
    <span class="token annotation punctuation">@Test</span>
    <span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">testDeployQuery</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<div class="language-txt line-numbers-mode" data-ext="txt"><pre v-pre class="language-txt"><code>processDefinition.getDeploymentId() = 1
processDefinition.getName() = 请假流程
processDefinition.getDescription() = null
processDefinition.getId() = holidayRequest:1:3
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3-启动流程实例" tabindex="-1"><a class="header-anchor" href="#_3-启动流程实例" aria-hidden="true">#</a> 3.启动流程实例</h2>
<p>  现在已经在流程引擎中<em>部署</em>了流程定义，因此可以使用这个<em>流程定义</em>作为“模板”启动<em>流程实例</em>。</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220316102638015.png" alt="image-20220316102638015"></p>
<p>  要启动流程实例，需要提供一些初始化<em>流程变量</em>。一般来说，可以通过呈现给用户的表单，或者在流程由其他系统自动触发时通过 REST API，来获取这些变量。在这个例子里，我们简化直接在代码中定义了，我们使用<em>RuntimeService</em>启动一个<em>流程实例</em>。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token doc-comment comment">/**
 * 启动流程实例
 */</span>
<span class="token annotation punctuation">@Test</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>启动成功，输出结果如下：</p>
<div class="language-txt line-numbers-mode" data-ext="txt"><pre v-pre class="language-txt"><code>流程定义的ID：holidayRequest:2:2503
流程实例的ID：5001
当前活动的ID：null
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>对应的流程实例 ID 为：5001</p>
<p>启动流程实例涉及到的表结构：</p>
<ul>
...
<h2 id="_4-查看任务" tabindex="-1"><a class="header-anchor" href="#_4-查看任务" aria-hidden="true">#</a> 4.查看任务</h2>
<p>  上面员工发起了一个请假流程，接下来就会流转到总经理这儿来处理，之前我们没有指定经理这的处理人，我们可以加一个</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220316110406801.png" alt="image-20220316110406801"></p>
<p>  然后我们来查看下 lisi 的任务</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token doc-comment comment">/**
* 查看任务
*/</span>
<span class="token annotation punctuation">@Test</span>
...
<div class="language-txt line-numbers-mode" data-ext="txt"><pre v-pre class="language-txt"><code>task.getProcessDefinitionId() = holidayRequestNew:1:10003
task.getId() = 12508
task.getAssignee() = lisi
task.getName() = Approve or reject request
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_5-完成任务" tabindex="-1"><a class="header-anchor" href="#_5-完成任务" aria-hidden="true">#</a> 5.完成任务</h2>
<p>  现在李四这个角色可以来完成当前的任务了</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220316111124019.png" alt="image-20220316111124019"></p>
<p>  在此处我们直接解决掉这个请假，然后会走发送拒绝邮件的流程，这块我们需要用到 JavaDelegate 来触发。</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220316111253702.png" alt="image-20220316111253702"></p>
<p>我们定义这样一个 Java 类</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>然后可以看到 JavaDelegate 触发了</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220316111913933.png" alt="image-20220316111913933"></p>
<h2 id="_6-流程的删除" tabindex="-1"><a class="header-anchor" href="#_6-流程的删除" aria-hidden="true">#</a> 6.流程的删除</h2>
<p>  有些流程已经没有用了，我们需要删除掉，其实也非常简单</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>    <span class="token doc-comment comment">/**
     * 删除流程
     */</span>
    <span class="token annotation punctuation">@Test</span>
    ...
    <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_7-查看历史信息" tabindex="-1"><a class="header-anchor" href="#_7-查看历史信息" aria-hidden="true">#</a> 7.查看历史信息</h2>
<p>  选择使用 Flowable 这样的流程引擎的原因之一，是它可以自动存储所有流程实例的<strong>审计数据</strong>或<strong>历史数据</strong>。这些数据可以用于创建报告，深入展现组织运行的情况，瓶颈在哪里，等等。</p>
...
<div class="language-txt line-numbers-mode" data-ext="txt"><pre v-pre class="language-txt"><code>startEvent took 1 milliseconds
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>好了~flowable 的基本应用我们就先介绍到这里了。</p>
<h1 id="三、flowable-流程设计器" tabindex="-1"><a class="header-anchor" href="#三、flowable-流程设计器" aria-hidden="true">#</a> 三、Flowable 流程设计器</h1>
<h2 id="_1-eclipse-designer" tabindex="-1"><a class="header-anchor" href="#_1-eclipse-designer" aria-hidden="true">#</a> 1.Eclipse Designer</h2>
<p>  Flowable 提供了名为 Flowable Eclipse Designer 的 Eclipse 插件，可以用于图形化地建模、测试与部署 BPMN 2.0 流程。</p>
<h3 id="_1-1-下载安装-eclipse" tabindex="-1"><a class="header-anchor" href="#_1-1-下载安装-eclipse" aria-hidden="true">#</a> 1.1 下载安装 Eclipse</h3>
<p>  去 Eclipse 官网下载即可：https://www.eclipse.org/downloads/packages/release 注意 2020-09 后的版本不再支持 jdk8</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220316202904261.png" alt="image-20220316202904261"></p>
<p> 解压缩就可以了，然后进入解压缩的目录</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220316203036602.png" alt="image-20220316203036602"></p>
<p>  直接启动即可</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220316203111301.png" alt="image-20220316203111301"></p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220316203237316.png" alt="image-20220316203237316"></p>
<h3 id="_1-2-安装-flowable-插件" tabindex="-1"><a class="header-anchor" href="#_1-2-安装-flowable-插件" aria-hidden="true">#</a> 1.2 安装 Flowable 插件</h3>
<p>  然后我们再安装下 Flowable 的插件，选择<strong>Help → Install New Software</strong>。在下图面板中，点击<em>Add</em>按钮，并填写下列字段</p>
<ul>
<li><strong>Name:</strong> Flowable BPMN 2.0 designer</li>
<li><strong>Location:</strong> http://www.flowable.org/designer/update/</li>
</ul>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220316203454281.png" alt="image-20220316203454281"></p>
<p>  这种在线更新的方式已经被官网移除了，操作不了</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220316211319931.png" alt="image-20220316211319931"></p>
<p>  这时我们就只能通过离线安装的方式来实现了，下载对应的离线文件</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220316211405001.png" alt="image-20220316211405001"></p>
<p>  安装步骤来操作，</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220316211518520.png" alt="image-20220316211518520"></p>
<p>然后继续：选择<strong>Help → Install New Software</strong></p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220316211622115.png" alt="image-20220316211622115"></p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220316211651195.png" alt="image-20220316211651195"></p>
<p>下一步</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220316211729581.png" alt="image-20220316211729581"></p>
<p>再下一步</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220316211802548.png" alt="image-20220316211802548"></p>
<p>然后 finish。弹出如下窗口</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220316212008477.png" alt="image-20220316212008477"></p>
<p>重启即可</p>
<h3 id="_1-3-创建项目" tabindex="-1"><a class="header-anchor" href="#_1-3-创建项目" aria-hidden="true">#</a> 1.3 创建项目</h3>
<p>  然后我们就可以创建一个 Flowable Project 了</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220316212418899.png" alt="image-20220316212418899"></p>
<p>  然后我们可以在 src/mian/resources/ 的目录下创建对应的流程图了</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220316212605146.png" alt="image-20220316212605146"></p>
<p>  看到如下的界面说明插件安装成功了</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220316212720767.png" alt="image-20220316212720767"></p>
<h3 id="_1-4-创建流程图" tabindex="-1"><a class="header-anchor" href="#_1-4-创建流程图" aria-hidden="true">#</a> 1.4 创建流程图</h3>
<p>使用滑板来绘制流程，通过从右侧把图标拖拽到左侧的面板，最终的效果</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220316214339678.png" alt="image-20220316214339678"></p>
<p>指 定流程的主键</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220316214430644.png" alt="image-20220316214430644"></p>
<p>指定任务的负责人</p>
<p>在 Properties 视图中指定每个任务节点的负责人</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220316214700887.png" alt="image-20220316214700887"></p>
<p>创建请假单：zhangsan</p>
<p>审批请假单：lisi</p>
<p>当我们设置完成后保存文件，会同时生成 png 图片</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220316214808400.png" alt="image-20220316214808400"></p>
<p>注意：生成图片需要如下配置</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220316214256235.png" alt="image-20220316214256235"></p>
<h3 id="_1-5-部署流程" tabindex="-1"><a class="header-anchor" href="#_1-5-部署流程" aria-hidden="true">#</a> 1.5 部署流程</h3>
<p>  首先在 Eclipse 中生成 bar 文件，选中项目然后鼠标右击</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220316215805503.png" alt="image-20220316215805503"></p>
<p>然后会发现在项目的根目录下多了一个 deployment 文件夹，里面多了一个 MyProcess.bar 文件</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220316215900052.png" alt="image-20220316215900052"></p>
<p>然后我们就可以把这个 bar 文件拷贝到 IDEA 中，继续部署的流程</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220316215945236.png" alt="image-20220316215945236"></p>
<p>而部署的代码和前面没啥区别</p>
...
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220316220121734.png" alt="image-20220316220121734"></p>
<p>完整的案例代码：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2-flowable-ui-应用" tabindex="-1"><a class="header-anchor" href="#_2-flowable-ui-应用" aria-hidden="true">#</a> 2.Flowable UI 应用</h2>
<p>  Flowable 提供了几个 web 应用，用于演示及介绍 Flowable 项目提供的功能：</p>
<ul>
<li>Flowable IDM: 身份管理应用。为所有 Flowable UI 应用提供单点登录认证功能，并且为拥有 IDM 管理员权限的用户提供了管理用户、组与权限的功能。</li>
<li>Flowable Modeler: 让具有建模权限的用户可以创建流程模型、表单、选择表与应用定义。</li>
<li>Flowable Task: 运行时任务应用。提供了启动流程实例、编辑任务表单、完成任务，以及查询流程实例与任务的功能。</li>
<li>Flowable Admin: 管理应用。让具有管理员权限的用户可以查询 BPMN、DMN、Form 及 Content 引擎，并提供了许多选项用于修改流程实例、任务、作业等。管理应用通过 REST API 连接至引擎，并与 Flowable Task 应用及 Flowable REST 应用一同部署。</li>
</ul>
<p>  所有其他的应用都需要 Flowable IDM 提供认证。每个应用的 WAR 文件可以部署在相同的 servlet 容器（如 Apache Tomcat）中，也可以部署在不同的容器中。由于每个应用使用相同的 cookie 进行认证，因此应用需要运行在相同的域名下。</p>
<h3 id="_2-1-安装部署" tabindex="-1"><a class="header-anchor" href="#_2-1-安装部署" aria-hidden="true">#</a> 2.1 安装部署</h3>
<p>下载 Tomcat：https://tomcat.apache.org/download-80.cgi 官网下载后解压缩到非中文目录即可，然后是下载 FlowableUI 的文件，在 Flowable6.6 之后把 FlowableUI 中提供的四个功能合并到了一起。</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220318102128672.png" alt="image-20220318102128672"></p>
<p>然后把解压缩后的两个 war 包拷贝到 Tomcat 的解压缩的 webapps 目录下</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220318102224330.png" alt="image-20220318102224330"></p>
<p>Tomcat 目录：</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220318102255188.png" alt="image-20220318102255188"></p>
<h3 id="_2-2-启动服务" tabindex="-1"><a class="header-anchor" href="#_2-2-启动服务" aria-hidden="true">#</a> 2.2 启动服务</h3>
<p>  启动 Tomcat 服务，执行 startup.bat 文件</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220318102325924.png" alt="image-20220318102325924"></p>
<p>如果启动中出现乱码修改 Tomcat 的 conf 目录下的 logging.properties 文件中的编码</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220318102446699.png" alt="image-20220318102446699"></p>
<p>如果一闪而过则检查 jdk 的环境变量配置。启动成功后，在浏览器中访问 http://localhost:8080/flowable-ui, 默认的账号密码是 admin/test</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220318102609807.png" alt="image-20220318102609807"></p>
<h3 id="_2-3-用户管理" tabindex="-1"><a class="header-anchor" href="#_2-3-用户管理" aria-hidden="true">#</a> 2.3 用户管理</h3>
<p>  我们先在 <code v-pre>身份管理应用程序</code> 中创建用户并授权</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220318102707368.png" alt="image-20220318102707368"></p>
<p>创建用户</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220318102734238.png" alt="image-20220318102734238"></p>
<p>填写详细信息</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220318102817782.png" alt="image-20220318102817782"></p>
<p>授权管理</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220318102859814.png" alt="image-20220318102859814"></p>
<h3 id="_2-4-绘制流程" tabindex="-1"><a class="header-anchor" href="#_2-4-绘制流程" aria-hidden="true">#</a> 2.4 绘制流程</h3>
<p>创建新的流程</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220318101239742.png" alt="image-20220318101239742"></p>
<p>流程图界面</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220318101346692.png" alt="image-20220318101346692"></p>
<p>创建流程，分配处理人</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220318101639424.png" alt="image-20220318101639424"></p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220318101611564.png" alt="image-20220318101611564"></p>
<p>继续完成流程图的创建</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220318101810272.png" alt="image-20220318101810272"></p>
<h3 id="_2-5-部署流程" tabindex="-1"><a class="header-anchor" href="#_2-5-部署流程" aria-hidden="true">#</a> 2.5 部署流程</h3>
<p>  绘制好的流程图，我们只需要一键导出即可</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220318103413285.png" alt="image-20220318103413285"></p>
<p>下载下来后拷贝到项目的 resource 目录下即可</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220318103518807.png" alt="image-20220318103518807"></p>
<p>然后就是正常的操作流程了</p>
<p><code v-pre>部署流程</code>--<code v-pre>查询流程定义的信息</code>--<code v-pre>删除流程定义</code>--<code v-pre>启动流程实例</code>--<code v-pre>任务查询</code>--<code v-pre>完成当前任务</code>--<code v-pre>获取流程任务的历史数据</code>等等（项目中的 Test03）</p>
<h3 id="_2-6-flowableui-演示" tabindex="-1"><a class="header-anchor" href="#_2-6-flowableui-演示" aria-hidden="true">#</a> 2.6 FlowableUI 演示</h3>
<h4 id="_2-6-1-部署流程" tabindex="-1"><a class="header-anchor" href="#_2-6-1-部署流程" aria-hidden="true">#</a> 2.6.1 部署流程</h4>
<p>  在 FlowableUI 中提供了演示程序 <code v-pre>该功能可以方便的更直观的看到程序的运转流程</code></p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220318104517967.png" alt="image-20220318104517967"></p>
<p>创建一个新的应用程序，并指定相关的信息</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220318104614784.png" alt="image-20220318104614784"></p>
<p>创建应用后需要指定对应的流程图</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220318104703306.png" alt="image-20220318104703306"></p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220318104735714.png" alt="image-20220318104735714"></p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220318104811812.png" alt="image-20220318104811812"></p>
<p>发布应用程序</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220318105045345.png" alt="image-20220318105045345"></p>
<h4 id="_2-6-2-启动流程" tabindex="-1"><a class="header-anchor" href="#_2-6-2-启动流程" aria-hidden="true">#</a> 2.6.2 启动流程</h4>
<p>  发布了应用程序后我们就可以来启动流程了</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220318105258331.png" alt="image-20220318105258331"></p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220318105315908.png" alt="image-20220318105315908"></p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220318105336107.png" alt="image-20220318105336107"></p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220318105420011.png" alt="image-20220318105420011"></p>
<p>点击显示图：</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220318105444672.png" alt="image-20220318105444672"></p>
<p>也就是可以看到当前是 user1 来处理，user1 登录后可以看到要处理的流程，user2 登录是看不到的。</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220318105646273.png" alt="image-20220318105646273"></p>
<p>点击完成后<code v-pre>流程</code>就向下一步流转了</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220318105727192.png" alt="image-20220318105727192"></p>
<p>这时再通过 user2 登录，就可以看到对应的代办的信息</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220318105808830.png" alt="image-20220318105808830"></p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220318105848185.png" alt="image-20220318105848185"></p>
<p>然后点击完成，那么整个流程就结束了</p>
<h1 id="四、flowable-进阶" tabindex="-1"><a class="header-anchor" href="#四、flowable-进阶" aria-hidden="true">#</a> 四、Flowable 进阶</h1>
<h2 id="_1-表结构讲解" tabindex="-1"><a class="header-anchor" href="#_1-表结构讲解" aria-hidden="true">#</a> 1.表结构讲解</h2>
<p>  工作流程的相关操作都是操作存储在对应的表结构中，为了能更好的弄清楚 Flowable 的实现原理和细节，我们有必要先弄清楚 Flowable 的相关表结构及其作用。在 Flowable 中的表结构在初始化的时候会创建五类表结构，具体如下：</p>
<ul>
<li><strong>ACT_RE</strong> ：'RE'表示 repository。 这个前缀的表包含了流程定义和流程静态资源 （图片，规则，等等）。</li>
<li><strong>ACT_RU</strong>：'RU'表示 runtime。 这些运行时的表，包含流程实例，任务，变量，异步任务，等运行中的数据。 Flowable 只在流程实例执行过程中保存这些数据， 在流程结束时就会删除这些记录。 这样运行时表可以一直很小速度很快。</li>
<li><strong>ACT_HI</strong>：'HI'表示 history。 这些表包含历史数据，比如历史流程实例， 变量，任务等等。</li>
<li><strong>ACT_GE</strong>： GE 表示 general。 通用数据， 用于不同场景下</li>
<li><strong>ACT_ID:</strong> ’ID’表示 identity(组织机构)。这些表包含标识的信息，如用户，用户组，等等。</li>
</ul>
<p>具体的表结构的含义:</p>
<table>
<thead>
...
<h2 id="_2-processengine-讲解-processenginetest" tabindex="-1"><a class="header-anchor" href="#_2-processengine-讲解-processenginetest" aria-hidden="true">#</a> 2.ProcessEngine 讲解（ProcessEngineTest）</h2>
<p><strong>初始化方式</strong></p>
<h3 id="_2-1-硬编码的方式" tabindex="-1"><a class="header-anchor" href="#_2-1-硬编码的方式" aria-hidden="true">#</a> 2.1 硬编码的方式</h3>
<p>  我们前面讲解案例的时候是通过 ProcessEngineConfiguration 这个配置类来加载的。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 配置数据库相关信息 获取 ProcessEngineConfiguration</span>
<span class="token class-name">ProcessEngineConfiguration</span> cfg <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">StandaloneProcessEngineConfiguration</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
    <span class="token punctuation">.</span><span class="token function">setJdbcUrl</span><span class="token punctuation">(</span><span class="token string">"jdbc:mysql://localhost:3306/flowable-learn2?serverTimezone=UTC&amp;nullCatalogMeansCurrent=true"</span><span class="token punctuation">)</span>
    <span class="token punctuation">.</span><span class="token function">setJdbcUsername</span><span class="token punctuation">(</span><span class="token string">"root"</span><span class="token punctuation">)</span>
    <span class="token punctuation">.</span><span class="token function">setJdbcPassword</span><span class="token punctuation">(</span><span class="token string">"123456"</span><span class="token punctuation">)</span>
...
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220319113106848.png" alt="image-20220319113106848"></p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220319113139646.png" alt="image-20220319113139646"></p>
<h3 id="_2-2-配置文件" tabindex="-1"><a class="header-anchor" href="#_2-2-配置文件" aria-hidden="true">#</a> 2.2 配置文件</h3>
<p>  除了上面的硬编码的方式外，我们还可以在 resources 目录下创建一个<code v-pre>flowable.cfg.xml</code>文件，注意这个名称是固定的哦。内容如下：</p>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token class-name">ProcessEngine</span> <span class="token function">getProcessEngine</span><span class="token punctuation">(</span><span class="token class-name">String</span> processEngineName<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>  进入 init 方法</p>
...
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220319114011806.png" alt="image-20220319114011806"></p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220319114053252.png" alt="image-20220319114053252"></p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220319114210012.png" alt="image-20220319114210012"></p>
<p>而且我们也可以看到 ProcessEngine 最终的实现是 ProcessEngineImpl 对象。</p>
<h3 id="_2-3-自定义配置文件" tabindex="-1"><a class="header-anchor" href="#_2-3-自定义配置文件" aria-hidden="true">#</a> 2.3 自定义配置文件</h3>
<p>  最后我们如果要加载自定义名称的配置文件可以通过 ProcessEngineConfiguration 中的对应构造方法来实现</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>    <span class="token annotation punctuation">@Test</span>
    <span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">test2</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">Exception</span><span class="token punctuation">{</span>
        ...
        <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"processEngine = "</span> <span class="token operator">+</span> processEngine<span class="token punctuation">)</span><span class="token punctuation">;</span>
    <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3-servcie-服务接口" tabindex="-1"><a class="header-anchor" href="#_3-servcie-服务接口" aria-hidden="true">#</a> 3. Servcie 服务接口</h2>
<p>Service 是工作流引擎提供用于进行工作流部署、执行、管理的服务接口，我们使用这些接口可以就是操作服务对应的数据表</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220319223019186.png" alt="image-20220319223019186"></p>
<h3 id="_3-1-service-创建方式" tabindex="-1"><a class="header-anchor" href="#_3-1-service-创建方式" aria-hidden="true">#</a> 3.1 Service 创建方式</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-2-service-总览" tabindex="-1"><a class="header-anchor" href="#_3-2-service-总览" aria-hidden="true">#</a> 3.2 Service 总览</h3>
<table>
<thead>
<tr>
<th>service 名称</th>
...
<td>Flowable 的资源管理类</td>
</tr>
<tr>
<td>RuntimeService</td>
<td>Flowable 的流程运行管理类</td>
</tr>
<tr>
<td>TaskService</td>
<td>Flowable 的任务管理类</td>
</tr>
<tr>
<td>HistoryService</td>
<td>Flowable 的历史管理类</td>
</tr>
<tr>
<td>ManagerService</td>
<td>Flowable 的引擎管理类</td>
</tr>
</tbody>
</table>
<p>简单介绍：</p>
...
<p>Flowable 的历史管理类，可以查询历史信息，执行流程时，引擎会保存很多数据（根据配置），比如流程实例启动时间，任务的参与者， 完成任务的时间，每个流程实例的执行路径，等等。 这个服务主要通过查询功能来获得这些数据。</p>
<p><strong>ManagementService</strong></p>
<p>Activiti 的引擎管理类，提供了对 Flowable 流程引擎的管理和维护功能，这些功能不在工作流驱动的应用程序中使用，主要用于 Flowable 系统的日常维护。</p>
<h2 id="_4-图标介绍" tabindex="-1"><a class="header-anchor" href="#_4-图标介绍" aria-hidden="true">#</a> 4.图标介绍</h2>
<p>  BPMN 2.0 是业务流程建模符号 2.0 的缩写。它由 Business Process Management Initiative 这个非营利协会创建并不断发展。作为一种标识，BPMN 2.0 是使用一些<strong>符号</strong>来明确业务流程设计流程图的一整套符号规范，它能增进业务建模时的沟通效率。目前 BPMN2.0 是最新的版本，它用于在 BPM 上下文中进行布局和可视化的沟通。接下来我们先来了解在流程设计中常见的 符号。</p>
<p>BPMN2.0 的<strong>基本符合</strong>主要包含：</p>
<h3 id="_4-1-事件图标" tabindex="-1"><a class="header-anchor" href="#_4-1-事件图标" aria-hidden="true">#</a> 4.1 事件图标</h3>
<p>  在 Flowable 中的事件图标启动事件，边界事件,中间事件和结束事件.</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220320103803308.png" alt="image-20220320103803308"></p>
<h3 id="_4-2-活动-任务-图标" tabindex="-1"><a class="header-anchor" href="#_4-2-活动-任务-图标" aria-hidden="true">#</a> 4.2 活动(任务)图标</h3>
<p>  活动是工作或任务的一个通用术语。一个活动可以是一个任务，还可以是一个当前流程的子处理流程； 其次，你还可以为活动指定不同的类型。常见活动如下:</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220320103929543.png" alt="image-20220320103929543"></p>
<h3 id="_4-3-结构图标" tabindex="-1"><a class="header-anchor" href="#_4-3-结构图标" aria-hidden="true">#</a> 4.3 结构图标</h3>
<p>  结构图标可以看做是整个流程活动的结构，一个流程中可以包括子流程。常见的结构有：</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20230705184623096.png" alt="image-20230705184623096"></p>
<h3 id="_4-4-网关图标" tabindex="-1"><a class="header-anchor" href="#_4-4-网关图标" aria-hidden="true">#</a> 4.4 网关图标</h3>
<p>  网关用来处理决策，有几种常用网关需要了解：</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220320104157816.png" alt="image-20220320104157816"></p>
<h2 id="_5-流程部署详解" tabindex="-1"><a class="header-anchor" href="#_5-流程部署详解" aria-hidden="true">#</a> 5.流程部署详解</h2>
<h3 id="_5-1-部署实现" tabindex="-1"><a class="header-anchor" href="#_5-1-部署实现" aria-hidden="true">#</a> 5.1 部署实现</h3>
<p>  我们先来看下流程部署的具体过程。代码实现</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token doc-comment comment">/**
 * 部署流程
 */</span>
<span class="token annotation punctuation">@Test</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_5-2-部署涉及表结构" tabindex="-1"><a class="header-anchor" href="#_5-2-部署涉及表结构" aria-hidden="true">#</a> 5.2 部署涉及表结构</h3>
<p>涉及到的三张表：</p>
...
<td>GENERATED_</td>
<td>是否系统生成</td>
<td>0 为用户上传，<br/>1 为系统自动生成， 比如系统会 自动根据 xml 生 成 png</td>
</tr>
</tbody>
</table>
<p>部署 ID 表：act_re_deployment</p>
<table>
<thead>
<tr>
<th>字段</th>
...
<tr>
<td>TENANT<em>ID</em></td>
<td>租户 ID</td>
<td></td>
</tr>
<tr>
<td>DEPLOY<em>TIME</em></td>
<td>部署时间</td>
<td></td>
</tr>
<tr>
<td>DERIVED<em>FROM</em></td>
<td>来源于</td>
<td></td>
</tr>
<tr>
<td>DERIVED<em>FROM_ROOT</em></td>
<td>来源于</td>
<td></td>
</tr>
<tr>
<td>ENGINE<em>VERSION</em></td>
<td>流程引擎的版本</td>
<td></td>
</tr>
</tbody>
...
<tr>
<td>RESOURCE<em>NAME</em></td>
<td>资源名称</td>
<td>流程 bpmn 文件名称</td>
</tr>
<tr>
<td>DGRM<em>RESOURCE_NAME</em></td>
<td>图片资源名称</td>
<td></td>
</tr>
<tr>
...
<tr>
<td>HAS<em>START_FORM_KEY</em></td>
<td>拥有开始表单标识</td>
<td>start 节点是否存在 formKey 0 否 1 是</td>
</tr>
<tr>
<td>HAS<em>GRAPHICAL_NOTATION</em></td>
<td>拥有图形信息</td>
<td></td>
</tr>
<tr>
<td>SUSPENSION<em>STATE</em></td>
<td>挂起状态</td>
<td>暂停状态 1 激活 2 暂停</td>
</tr>
<tr>
<td>TENANT<em>ID</em></td>
<td>租户 ID</td>
...
<blockquote>
<p>详细说明：</p>
<p>业务流程定义数据表。此表和 ACT_RE_DEPLOYMENT 是多对一的关系，即，一个部署的 bar 包里可能包含多个流程定义文件，每个流程定义文件都会有一条记录在 ACT_REPROCDEF 表内，每个流程定义的数据，都会对于 ACT_GE_BYTEARRAY 表内的一个资源文件和 PNG 图片文件。</p>
<p>和 ACT<em>GE_BYTEARRAY 的关联是通过程序用 ACT_GE_BYTEARRAY.NAME 与 ACT_RE_PROCDEF.NAME</em>完成的</p>
</blockquote>
<h3 id="_5-3-挂起和激活" tabindex="-1"><a class="header-anchor" href="#_5-3-挂起和激活" aria-hidden="true">#</a> 5.3 挂起和激活</h3>
<p>  部署的流程默认的状态为激活，如果我们暂时不想使用该定义的流程，那么可以挂起该流程。当然该流程定义下边所有的流程实例全部暂停。</p>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token doc-comment comment">/**
    ...
    <span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">test05</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
        ...
        <span class="token punctuation">}</span>
    <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>具体的实现其实就是更新了流程定义表中的字段</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220321210010518.png" alt="image-20220321210010518"></p>
<p>而且通过 REV_字段来控制数据安全，也是一种乐观锁的体现了，如果要启动一个已经挂起的流程就会出现如下的错误</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220321211858122.png" alt="image-20220321211858122"></p>
<h2 id="_6-启动流程实例" tabindex="-1"><a class="header-anchor" href="#_6-启动流程实例" aria-hidden="true">#</a> 6.启动流程实例</h2>
<p>  然后我们来看看启动流程实例的过程。实现代码如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token doc-comment comment">/**
     * 启动流程实例
     */</span>
    <span class="token annotation punctuation">@Test</span>
    <span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">testRunProcess</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
        ...
        <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"当前活动的ID："</span> <span class="token operator">+</span> processInstance<span class="token punctuation">.</span><span class="token function">getActivityId</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
    <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>  当我们启动了一个流程实例后，会在 ACT<em>RU</em>*对应的表结构中操作,运行时实例涉及的表结构共 10 张：</p>
<ul>
...
<tr>
<td>PROC<em>INST_ID</em></td>
<td>流程实例 ID</td>
<td></td>
</tr>
<tr>
<td>BUSINESS<em>KEY</em></td>
<td>业务主键 ID</td>
<td></td>
</tr>
<tr>
<td>PARENT<em>ID</em></td>
<td>父执行流的 ID</td>
<td></td>
</tr>
<tr>
<td>PROC<em>DEF_ID</em></td>
<td>流程定义的数据 ID</td>
<td></td>
</tr>
<tr>
<td>SUPER<em>EXEC</em></td>
<td></td>
<td></td>
</tr>
<tr>
<td>ROOT<em>PROC_INST_ID</em></td>
<td>流程实例的 root 流程 id</td>
<td></td>
</tr>
<tr>
<td>ACT<em>ID</em></td>
...
<tr>
<td>IS<em>ACTIVE</em></td>
<td>是否存活</td>
<td></td>
</tr>
<tr>
<td>IS<em>CONCURRENT</em></td>
<td>执行流是否正在并行</td>
<td></td>
</tr>
<tr>
<td>IS<em>SCOPE</em></td>
<td></td>
<td></td>
</tr>
<tr>
<td>IS<em>EVENT_SCOPE</em></td>
<td></td>
<td></td>
</tr>
<tr>
<td>IS<em>MI_ROOT</em></td>
<td></td>
<td></td>
</tr>
<tr>
...
<tr>
<td>START<em>TIME</em></td>
<td>开始时间</td>
<td></td>
</tr>
<tr>
<td>START<em>USER_ID</em></td>
<td>开始的用户编号</td>
<td></td>
</tr>
<tr>
<td>LOCK<em>TIME</em></td>
<td>锁定时间</td>
<td></td>
</tr>
<tr>
<td>IS<em>COUNT_ENABLED</em></td>
<td></td>
<td></td>
</tr>
<tr>
<td>EVT<em>SUBSCR_COUNT</em></td>
<td></td>
<td></td>
</tr>
<tr>
<td>TASK<em>COUNT</em></td>
<td></td>
<td></td>
</tr>
<tr>
<td>JOB<em>COUNT</em></td>
<td></td>
<td></td>
</tr>
<tr>
<td>TIMER<em>JOB_COUNT</em></td>
<td></td>
<td></td>
</tr>
<tr>
<td>SUSP<em>JOB_COUNT</em></td>
<td></td>
<td></td>
</tr>
<tr>
<td>DEADLETTER<em>JOB_COUNT</em></td>
<td></td>
<td></td>
</tr>
<tr>
<td>VAR<em>COUNT</em></td>
<td></td>
<td></td>
</tr>
<tr>
<td>ID<em>LINK_COUNT</em></td>
<td></td>
<td></td>
</tr>
</tbody>
...
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220322133108405.png" alt="image-20220322133108405"></p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220322133219534.png" alt="image-20220322133219534"></p>
...
<tr>
<td>CREATE<em>TIME</em></td>
<td>创建时间</td>
<td></td>
</tr>
<tr>
<td>DUE<em>DATE</em></td>
<td>耗时</td>
<td></td>
</tr>
<tr>
...
<tr>
<td>FORM<em>KEY</em></td>
<td></td>
<td></td>
</tr>
<tr>
<td>CLAIM<em>TIME</em></td>
<td>拾取时间</td>
<td></td>
</tr>
</tbody>
...
<p>创建流程实例后对应的表结构的数据</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220322133307195.png" alt="image-20220322133307195"></p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220322133335326.png" alt="image-20220322133335326"></p>
...
<tr>
<td>BYTEARRAY<em>ID</em></td>
<td>资源 ID</td>
<td></td>
</tr>
<tr>
<td>DOUBLE_</td>
<td>参数为 double，则保存在该字段中</td>
<td></td>
</tr>
<tr>
<td>LONG_</td>
<td>参数为 long，则保存在该字段中</td>
<td></td>
</tr>
<tr>
<td>TEXT_</td>
...
<p>创建流程实例后对应的表结构的数据</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220322133406398.png" alt="image-20220322133406398"></p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220322133439827.png" alt="image-20220322133439827"></p>
...
<td>TYPE_</td>
<td>关系数据类型</td>
<td>assignee 支配人(组)、candidate 候选人(组)、owner 拥有人,participant 参与者</td>
</tr>
<tr>
<td>USER<em>ID</em></td>
<td>用户 ID</td>
...
<p>创建流程实例后对应的表结构的数据:</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220322133501720.png" alt="image-20220322133501720"></p>
<h2 id="_7-处理流程" tabindex="-1"><a class="header-anchor" href="#_7-处理流程" aria-hidden="true">#</a> 7.处理流程</h2>
<p>  上面的流程已经流转到了 zhangsan 这个用户这里，然后可以开始审批了</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 获取流程引擎对象</span>
    <span class="token class-name">ProcessEngine</span> processEngine <span class="token operator">=</span> <span class="token class-name">ProcessEngines</span><span class="token punctuation">.</span><span class="token function">getDefaultProcessEngine</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
    <span class="token class-name">TaskService</span> taskService <span class="token operator">=</span> processEngine<span class="token punctuation">.</span><span class="token function">getTaskService</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
    <span class="token class-name">Task</span> task <span class="token operator">=</span> taskService<span class="token punctuation">.</span><span class="token function">createTaskQuery</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
            <span class="token punctuation">.</span><span class="token function">processDefinitionId</span><span class="token punctuation">(</span><span class="token string">"holiday:1:4"</span><span class="token punctuation">)</span>
...
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220322135040119.png" alt="image-20220322135040119"></p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220322135125703.png" alt="image-20220322135125703"></p>
<p>ACT_RU_VARIABLE 运行时变量表:会记录新的流程变量</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220322135204021.png" alt="image-20220322135204021"></p>
<p>当然流程实例也可以挂起</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 1.获取ProcessEngine对象</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>启动第二个流程实例后再查看相关的表结构时，对他们的关系理解会更加的清楚一些</p>
<p>启动一个新的流程实例对应的就会产生两条记录</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220322135605252.png" alt="image-20220322135605252"></p>
<p>IDENTITYLINK 中会记录每次流程操作的信息</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220322135636841.png" alt="image-20220322135636841"></p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220322135659671.png" alt="image-20220322135659671"></p>
<p>流程变量数据，及时 key 相同，但是属于不同的流程实例相互间也是隔离的</p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220322135719104.png" alt="image-20220322135719104"></p>
<h2 id="_8-完成一个流程" tabindex="-1"><a class="header-anchor" href="#_8-完成一个流程" aria-hidden="true">#</a> 8.完成一个流程</h2>
<p>  然后我们把第一个流程处理完成</p>
...
<span class="token comment">// 完成任务</span>
taskService<span class="token punctuation">.</span><span class="token function">complete</span><span class="token punctuation">(</span>task<span class="token punctuation">.</span><span class="token function">getId</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">,</span>variables<span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>处理完了一个工作流程后，我们来看看相关的表结构信息</p>
<p>首先我们会发现</p>
<ul>
<li>ACT_RU_EXECUTION 运行时流程执行实例</li>
<li>ACT_RU_IDENTITYLINK 运行时用户关系信息</li>
...
<li>
<p>ACT_HI_ATTACHMENT 历史的流程附件</p>
</li>
<li>
<p>ACT_HI_COMMENT 历史的说明性信息</p>
</li>
<li>
<p>ACT_HI_DETAIL 历史的流程运行中的细节信息</p>
</li>
<li>
...
<li>
<p>ACT_HI_VARINST 历史的流程运行中的变量信息</p>
</li>
</ul>
...
<tr>
<td>CALL<em>PROC_INST_ID</em></td>
<td>调用外部的流程实例 ID</td>
<td></td>
</tr>
<tr>
<td>ACT<em>NAME</em></td>
<td>节点名称</td>
<td></td>
</tr>
<tr>
<td>ACT<em>TYPE</em></td>
<td>节点类型</td>
<td></td>
</tr>
<tr>
...
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220322141800554.png" alt="image-20220322141800554"></p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220322141825065.png" alt="image-20220322141825065"></p>
<p>ACT_HI_IDENTITYLINK 历史的流程运行过程中用户关系</p>
<table>
<thead>
<tr>
...
<tr>
<td>SCOPE<em>ID</em></td>
<td></td>
<td></td>
</tr>
<tr>
<td>SCOPE<em>TYPE</em></td>
<td></td>
<td></td>
</tr>
<tr>
<td>SCOPE<em>DEFINITION_ID</em></td>
<td></td>
<td></td>
</tr>
<tr>
...
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220322141717826.png" alt="image-20220322141717826"></p>
<p>ACT_HI_PROCINST 历史的流程实例</p>
<table>
<thead>
<tr>
...
<tr>
<td>START<em>ACT_ID</em></td>
<td>起始节点</td>
<td></td>
</tr>
<tr>
<td>END<em>ACT_ID</em></td>
<td>结束节点</td>
<td></td>
</tr>
<tr>
<td>SUPER<em>PROCESS_INSTANCE_ID</em></td>
<td>父流程实例 ID</td>
<td></td>
</tr>
<tr>
...
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220322141855401.png" alt="image-20220322141855401"></p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220322141912602.png" alt="image-20220322141912602"></p>
<p>ACT_HI_TASKINST 历史的任务实例</p>
<table>
<thead>
<tr>
...
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220322142609163.png" alt="image-20220322142609163"></p>
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220322142650699.png" alt="image-20220322142650699"></p>
...
<p><img src="@source/notes/record/Flowable入门-基础篇/assets/image-20220322142756867.png" alt="image-20220322142756867"></p>
