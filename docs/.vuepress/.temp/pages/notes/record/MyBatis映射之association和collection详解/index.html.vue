<template><div><h1 id="🐦‍mybatis-映射之-association-和-collection-详解" tabindex="-1"><a class="header-anchor" href="#🐦‍mybatis-映射之-association-和-collection-详解" aria-hidden="true">#</a> 🐦‍MyBatis 映射之 association 和 collection 详解</h1>
<hr/>
<nav class="table-of-contents"><ul><li><router-link to="#一、引言">一、引言</router-link></li><li><router-link to="#二、association">二、association</router-link></li><li><router-link to="#三、collection">三、collection</router-link></li></ul></nav>
<h2 id="一、引言" tabindex="-1"><a class="header-anchor" href="#一、引言" aria-hidden="true">#</a> 一、引言</h2>
<p>一直对 association 和 collection 有点混淆，现整理一篇文章，用于加强记忆。</p>
<h2 id="二、association" tabindex="-1"><a class="header-anchor" href="#二、association" aria-hidden="true">#</a> 二、association</h2>
<p>association 用于一对一、多对一场景使用。</p>
<p>现在有 2 个表 book 表、bookshelf 书架表。</p>
<table>
<thead>
<tr>
<th>BOOK</th>
...
<p>现有需求：查询根据书籍 id 查询书籍信息和所在书架编号。</p>
<p>PoJo</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>mapper</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="三、collection" tabindex="-1"><a class="header-anchor" href="#三、collection" aria-hidden="true">#</a> 三、collection</h2>
<p>应用场景为一对多关系，即实体里放集合。</p>
<p>表不变</p>
<p>现有需求：根据书架 ID 查询书架信息及书架存放的书籍信息。</p>
<p>POJO</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Book</span><span class="token punctuation">{</span>
