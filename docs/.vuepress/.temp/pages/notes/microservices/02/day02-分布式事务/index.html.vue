<template><div><h1 id="day02-分布式事务" tabindex="-1"><a class="header-anchor" href="#day02-分布式事务" aria-hidden="true">#</a> day02-分布式事务</h1>
<nav class="table-of-contents"><ul><li><router-link to="#_1-1-本地事务">1.1.本地事务</router-link></li><li><router-link to="#_1-2-分布式事务">1.2.分布式事务</router-link></li><li><router-link to="#_1-3-演示分布式事务问题">1.3.演示分布式事务问题</router-link></li><li><router-link to="#_2-1-cap-定理">2.1.CAP 定理</router-link><ul><li><router-link to="#_2-1-1-一致性">2.1.1.一致性</router-link></li><li><router-link to="#_2-1-2-可用性">2.1.2.可用性</router-link></li><li><router-link to="#_2-1-3-分区容错">2.1.3.分区容错</router-link></li><li><router-link to="#_2-1-4-矛盾">2.1.4.矛盾</router-link></li></ul></li><li><router-link to="#_2-2-base-理论">2.2.BASE 理论</router-link></li><li><router-link to="#_2-3-解决分布式事务的思路">2.3.解决分布式事务的思路</router-link></li><li><router-link to="#_3-1-seata-的架构">3.1.Seata 的架构</router-link></li><li><router-link to="#_3-2-部署-tc-服务">3.2.部署 TC 服务</router-link></li><li><router-link to="#_3-3-微服务集成-seata">3.3.微服务集成 Seata</router-link><ul><li><router-link to="#_3-3-1-引入依赖">3.3.1.引入依赖</router-link></li><li><router-link to="#_3-3-2-配置-tc-地址">3.3.2.配置 TC 地址</router-link></li><li><router-link to="#_3-3-3-其它服务">3.3.3.其它服务</router-link></li></ul></li><li><router-link to="#_4-1-xa-模式">4.1.XA 模式</router-link><ul><li><router-link to="#_4-1-1-两阶段提交">4.1.1.两阶段提交</router-link></li><li><router-link to="#_4-1-2-seata-的-xa-模型">4.1.2.Seata 的 XA 模型</router-link></li><li><router-link to="#_4-1-3-优缺点">4.1.3.优缺点</router-link></li><li><router-link to="#_4-1-4-实现-xa-模式">4.1.4.实现 XA 模式</router-link></li></ul></li><li><router-link to="#_4-2-at-模式">4.2.AT 模式</router-link><ul><li><router-link to="#_4-2-1-seata-的-at-模型">4.2.1.Seata 的 AT 模型</router-link></li><li><router-link to="#_4-2-2-流程梳理">4.2.2.流程梳理</router-link></li><li><router-link to="#_4-2-3-at-与-xa-的区别">4.2.3.AT 与 XA 的区别</router-link></li><li><router-link to="#_4-2-4-脏写问题">4.2.4.脏写问题</router-link></li><li><router-link to="#_4-2-5-优缺点">4.2.5.优缺点</router-link></li><li><router-link to="#_4-2-6-实现-at-模式">4.2.6.实现 AT 模式</router-link></li></ul></li><li><router-link to="#_4-3-tcc-模式">4.3.TCC 模式</router-link><ul><li><router-link to="#_4-3-1-流程分析">4.3.1.流程分析</router-link></li><li><router-link to="#_4-3-2-seata-的-tcc-模型">4.3.2.Seata 的 TCC 模型</router-link></li><li><router-link to="#_4-3-3-优缺点">4.3.3.优缺点</router-link></li><li><router-link to="#_4-3-4-事务悬挂和空回滚">4.3.4.事务悬挂和空回滚</router-link></li><li><router-link to="#_4-3-5-实现-tcc-模式">4.3.5.实现 TCC 模式</router-link></li></ul></li><li><router-link to="#_4-4-saga-模式">4.4.SAGA 模式</router-link><ul><li><router-link to="#_4-4-1-原理">4.4.1.原理</router-link></li><li><router-link to="#_4-4-2-优缺点">4.4.2.优缺点</router-link></li></ul></li><li><router-link to="#_4-5-四种模式对比">4.5.四种模式对比</router-link></li><li><router-link to="#_5-1-高可用架构模型">5.1.高可用架构模型</router-link></li><li><router-link to="#_5-2-实现高可用">5.2.实现高可用</router-link></li></ul></nav>
...
<p><img src="@source/notes/microservices/02/day02-分布式事务/assets/image-20210724165045186.png" alt="image-20210724165045186"></p>
...
<p><img src="@source/notes/microservices/02/day02-分布式事务/assets/image-20210724165338958.png" alt="image-20210724165338958"></p>
...
<p>1）<strong>创建数据库，名为 seata_demo，然后导入课前资料提供的 SQL 文件：</strong></p>
<p><img src="@source/notes/microservices/02/day02-分布式事务/assets/image-20210724165634571.png" alt="image-20210724165634571"></p>
<p>2）<strong>导入课前资料提供的微服务：</strong></p>
<p><img src="@source/notes/microservices/02/day02-分布式事务/assets/image-20210724165709994.png" alt="image-20210724165709994"></p>
<p>微服务结构如下：</p>
<p><img src="@source/notes/microservices/02/day02-分布式事务/assets/image-20210724165729273.png" alt="image-20210724165729273"></p>
<p>其中：</p>
...
<p><strong>3）启动 nacos、所有微服务</strong></p>
<p><strong>4）测试下单功能，发出 Post 请求：</strong></p>
<p>请求如下：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">curl</span> <span class="token parameter variable">--location</span> <span class="token parameter variable">--request</span> POST <span class="token string">'http://localhost:8082/order?userId=user202103032042012&amp;commodityCode=100202003032041&amp;count=20&amp;money=200'</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>如图：</p>
<p><img src="@source/notes/microservices/02/day02-分布式事务/assets/image-20210724170113404.png" alt="image-20210724170113404"></p>
...
<h2 id="_2-1-cap-定理" tabindex="-1"><a class="header-anchor" href="#_2-1-cap-定理" aria-hidden="true">#</a> 2.1.CAP 定理</h2>
...
<p><img src="@source/notes/microservices/02/day02-分布式事务/assets/image-20210724170517944.png" alt="image-20210724170517944"></p>
...
<p><img src="@source/notes/microservices/02/day02-分布式事务/assets/image-20210724170704694.png" alt="image-20210724170704694"></p>
<p>当我们修改其中一个节点的数据时，两者的数据产生了差异：</p>
<p><img src="@source/notes/microservices/02/day02-分布式事务/assets/image-20210724170735847.png" alt="image-20210724170735847"></p>
<p>要想保住一致性，就必须实现 node01 到 node02 的数据 同步：</p>
<p><img src="@source/notes/microservices/02/day02-分布式事务/assets/image-20210724170834855.png" alt="image-20210724170834855"></p>
...
<p><img src="@source/notes/microservices/02/day02-分布式事务/assets/image-20210724170932072.png" alt="image-20210724170932072"></p>
<p>当有部分节点因为网络故障或其它原因无法访问时，代表节点不可用：</p>
<p><img src="@source/notes/microservices/02/day02-分布式事务/assets/image-20210724171007516.png" alt="image-20210724171007516"></p>
...
<p><img src="@source/notes/microservices/02/day02-分布式事务/assets/image-20210724171041210.png" alt="image-20210724171041210"></p>
...
<p>在分布式系统中，系统间的网络不能 100%保证健康，一定会有故障的时候，而服务有必须对外保证服务。因此 Partition Tolerance 不可避免。</p>
<p>当节点接收到新的数据变更时，就会出现问题了：</p>
<p><img src="@source/notes/microservices/02/day02-分布式事务/assets/image-20210724171546472.png" alt="image-20210724171546472"></p>
...
<h2 id="_2-2-base-理论" tabindex="-1"><a class="header-anchor" href="#_2-2-base-理论" aria-hidden="true">#</a> 2.2.BASE 理论</h2>
...
<p>分布式事务最大的问题是各个子事务的一致性问题，因此可以借鉴 CAP 定理和 BASE 理论，有两种解决思路：</p>
<ul>
<li>
<p>AP 模式：各子事务分别执行和提交，允许出现结果不一致，然后采用弥补措施恢复数据即可，实现最终一致。</p>
</li>
<li>
<p>CP 模式：各个子事务执行后互相等待，同时提交，同时回滚，达成强一致。但事务等待过程中，处于弱可用状态。</p>
</li>
</ul>
<p>但不管是哪一种模式，都需要在子系统事务之间互相通讯，协调事务状态，也就是需要一个<strong>事务协调者(TC)</strong>：</p>
<p><img src="@source/notes/microservices/02/day02-分布式事务/assets/image-20210724172123567.png" alt="image-20210724172123567"></p>
<p>这里的子系统事务，称为<strong>分支事务</strong>；有关联的各个分支事务在一起称为<strong>全局事务</strong>。</p>
<h1 id="_3-初识-seata" tabindex="-1"><a class="header-anchor" href="#_3-初识-seata" aria-hidden="true">#</a> 3.初识 Seata</h1>
...
<p><img src="@source/notes/microservices/02/day02-分布式事务/assets/image-20210724172225817.png" alt="image-20210724172225817"></p>
<h2 id="_3-1-seata-的架构" tabindex="-1"><a class="header-anchor" href="#_3-1-seata-的架构" aria-hidden="true">#</a> 3.1.Seata 的架构</h2>
<p>Seata 事务管理中有三个重要的角色：</p>
<ul>
<li>
...
<li>
<p><strong>RM (Resource Manager) -</strong> **资源管理器：**管理分支事务处理的资源，与 TC 交谈以注册分支事务和报告分支事务的状态，并驱动分支事务提交或回滚。</p>
</li>
</ul>
<p>整体的架构如图：</p>
<p><img src="@source/notes/microservices/02/day02-分布式事务/assets/image-20210724172326452.png" alt="image-20210724172326452"></p>
...
<h2 id="_3-2-部署-tc-服务" tabindex="-1"><a class="header-anchor" href="#_3-2-部署-tc-服务" aria-hidden="true">#</a> 3.2.部署 TC 服务</h2>
<p>参考课前资料提供的文档《 seata 的部署和集成.md 》：</p>
<p><img src="@source/notes/microservices/02/day02-分布式事务/assets/image-20210724172549013.png" alt="image-20210724172549013"></p>
<h2 id="_3-3-微服务集成-seata" tabindex="-1"><a class="header-anchor" href="#_3-3-微服务集成-seata" aria-hidden="true">#</a> 3.3.微服务集成 Seata</h2>
<p>我们以 order-service 为例来演示。</p>
<h3 id="_3-3-1-引入依赖" tabindex="-1"><a class="header-anchor" href="#_3-3-1-引入依赖" aria-hidden="true">#</a> 3.3.1.引入依赖</h3>
<p>首先，在 order-service 中引入依赖：</p>
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code><span class="token comment">&lt;!--seata--></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>dependency</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-3-2-配置-tc-地址" tabindex="-1"><a class="header-anchor" href="#_3-3-2-配置-tc-地址" aria-hidden="true">#</a> 3.3.2.配置 TC 地址</h3>
<p>在 order-service 中的 application.yml 中，配置 TC 服务信息，通过注册中心 nacos，结合服务名称获取 TC 地址：</p>
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code><span class="token key atrule">seata</span><span class="token punctuation">:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>微服务如何根据这些配置寻找 TC 的地址呢？</p>
<p>我们知道注册到 Nacos 中的微服务，确定一个具体实例需要四个信息：</p>
<ul>
...
<p>以上四个信息，在刚才的 yaml 文件中都能找到：</p>
<p><img src="@source/notes/microservices/02/day02-分布式事务/assets/image-20210724173654258.png" alt="image-20210724173654258"></p>
<p>namespace 为空，就是默认的 public</p>
<p>结合起来，TC 服务的信息就是：public@DEFAULT_GROUP@seata-tc-server@SH，这样就能确定 TC 服务集群了。然后就可以去 Nacos 拉取对应的实例信息了。</p>
<h3 id="_3-3-3-其它服务" tabindex="-1"><a class="header-anchor" href="#_3-3-3-其它服务" aria-hidden="true">#</a> 3.3.3.其它服务</h3>
<p>其它两个微服务也都参考 order-service 的步骤来做，完全一样。</p>
<h1 id="_4-动手实践" tabindex="-1"><a class="header-anchor" href="#_4-动手实践" aria-hidden="true">#</a> 4.动手实践</h1>
<p>下面我们就一起学习下 Seata 中的四种不同的事务模式。</p>
<h2 id="_4-1-xa-模式" tabindex="-1"><a class="header-anchor" href="#_4-1-xa-模式" aria-hidden="true">#</a> 4.1.XA 模式</h2>
<p>XA 规范 是 X/Open 组织定义的分布式事务处理（DTP，Distributed Transaction Processing）标准，XA 规范 描述了全局的 TM 与局部的 RM 之间的接口，几乎所有主流的数据库都对 XA 规范 提供了支持。</p>
<h3 id="_4-1-1-两阶段提交" tabindex="-1"><a class="header-anchor" href="#_4-1-1-两阶段提交" aria-hidden="true">#</a> 4.1.1.两阶段提交</h3>
<p>XA 是规范，目前主流数据库都实现了这种规范，实现的原理都是基于两阶段提交。</p>
<p>正常情况：</p>
<p><img src="@source/notes/microservices/02/day02-分布式事务/assets/image-20210724174102768.png" alt="image-20210724174102768"></p>
<p>异常情况：</p>
<p><img src="@source/notes/microservices/02/day02-分布式事务/assets/image-20210724174234987.png" alt="image-20210724174234987"></p>
<p>一阶段：</p>
<ul>
...
<h3 id="_4-1-2-seata-的-xa-模型" tabindex="-1"><a class="header-anchor" href="#_4-1-2-seata-的-xa-模型" aria-hidden="true">#</a> 4.1.2.Seata 的 XA 模型</h3>
<p>Seata 对原始的 XA 模式做了简单的封装和改造，以适应自己的事务模型，基本架构如图：</p>
<p><img src="@source/notes/microservices/02/day02-分布式事务/assets/image-20210724174424070.png" alt="image-20210724174424070"></p>
<p>RM 一阶段的工作：</p>
<p>​ ① 注册分支事务到 TC</p>
<p>​ ② 执行分支业务 sql 但不提交</p>
<p>​ ③ 报告执行状态到 TC</p>
...
<h3 id="_4-1-4-实现-xa-模式" tabindex="-1"><a class="header-anchor" href="#_4-1-4-实现-xa-模式" aria-hidden="true">#</a> 4.1.4.实现 XA 模式</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>2）给发起全局事务的入口方法添加@GlobalTransactional 注解:</p>
<p>本例中是 OrderServiceImpl 中的 create 方法.</p>
<p><img src="@source/notes/microservices/02/day02-分布式事务/assets/image-20210724174859556.png" alt="image-20210724174859556"></p>
<p>3）重启服务并测试</p>
<p>重启 order-service，再次测试，发现无论怎样，三个微服务都能成功回滚。</p>
<h2 id="_4-2-at-模式" tabindex="-1"><a class="header-anchor" href="#_4-2-at-模式" aria-hidden="true">#</a> 4.2.AT 模式</h2>
<p>AT 模式同样是分阶段提交的事务模型，不过缺弥补了 XA 模型中资源锁定周期过长的缺陷。</p>
<h3 id="_4-2-1-seata-的-at-模型" tabindex="-1"><a class="header-anchor" href="#_4-2-1-seata-的-at-模型" aria-hidden="true">#</a> 4.2.1.Seata 的 AT 模型</h3>
<p>基本流程图：</p>
<p><img src="@source/notes/microservices/02/day02-分布式事务/assets/image-20210724175327511.png" alt="image-20210724175327511"></p>
<p>阶段一 RM 的工作：</p>
<ul>
<li>注册分支事务</li>
...
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token keyword">update</span> tb_account <span class="token keyword">set</span> money <span class="token operator">=</span> money <span class="token operator">-</span> <span class="token number">10</span> <span class="token keyword">where</span> id <span class="token operator">=</span> <span class="token number">1</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>AT 模式下，当前分支事务执行流程如下：</p>
<p>一阶段：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>5）RM 执行业务 SQL，提交本地事务，释放数据库锁。此时 <code v-pre>money = 90</code></p>
<p>6）RM 报告本地事务状态给 TC</p>
<p>二阶段：</p>
<p>1）TM 通知 TC 事务结束</p>
<p>2）TC 检查分支事务状态</p>
<p>​ a）如果都成功，则立即删除快照</p>
<p>​ b）如果有分支事务失败，需要回滚。读取快照数据（<code v-pre>{&quot;id&quot;: 1, &quot;money&quot;: 100}</code>），将快照恢复到数据库。此时数据库再次恢复为 100</p>
<p>流程图：</p>
<p><img src="@source/notes/microservices/02/day02-分布式事务/assets/image-20210724180722921.png" alt="image-20210724180722921"></p>
<h3 id="_4-2-3-at-与-xa-的区别" tabindex="-1"><a class="header-anchor" href="#_4-2-3-at-与-xa-的区别" aria-hidden="true">#</a> 4.2.3.AT 与 XA 的区别</h3>
...
<p>在多线程并发访问 AT 模式的分布式事务时，有可能出现脏写问题，如图：</p>
<p><img src="@source/notes/microservices/02/day02-分布式事务/assets/image-20210724181541234.png" alt="image-20210724181541234"></p>
<p>解决思路就是引入了全局锁的概念。在释放 DB 锁之前，先拿到全局锁。避免同一时刻有另外一个事务来操作当前数据。</p>
<p><img src="@source/notes/microservices/02/day02-分布式事务/assets/image-20210724181843029.png" alt="image-20210724181843029"></p>
...
<li>框架的快照功能会影响性能，但比 XA 模式要好很多</li>
</ul>
<h3 id="_4-2-6-实现-at-模式" tabindex="-1"><a class="header-anchor" href="#_4-2-6-实现-at-模式" aria-hidden="true">#</a> 4.2.6.实现 AT 模式</h3>
<p>AT 模式中的快照生成、回滚等动作都是由框架自动完成，没有任何代码侵入，因此实现非常简单。</p>
<p>只不过，AT 模式需要一个表来记录全局锁、另一张表来记录数据快照 undo_log。</p>
<p>1）导入数据库表，记录全局锁</p>
<p>导入课前资料提供的 Sql 文件：seata-at.sql，其中 lock_table 导入到 TC 服务关联的数据库，undo_log 表导入到微服务关联的数据库：</p>
<p><img src="@source/notes/microservices/02/day02-分布式事务/assets/image-20210724182217272.png" alt="image-20210724182217272"></p>
...
<h2 id="_4-3-tcc-模式" tabindex="-1"><a class="header-anchor" href="#_4-3-tcc-模式" aria-hidden="true">#</a> 4.3.TCC 模式</h2>
...
<li>
<p>Cancel：预留资源释放，可以理解为 try 的反向操作。</p>
</li>
</ul>
...
<ul>
<li><strong>阶段一（ Try ）</strong>：检查余额是否充足，如果充足则冻结金额增加 30 元，可用余额扣除 30</li>
</ul>
<p>初识余额：</p>
<p><img src="@source/notes/microservices/02/day02-分布式事务/assets/image-20210724182424907.png" alt="image-20210724182424907"></p>
<p>余额充足，可以冻结：</p>
<p><img src="@source/notes/microservices/02/day02-分布式事务/assets/image-20210724182457951.png" alt="image-20210724182457951"></p>
<p>此时，总金额 = 冻结金额 + 可用金额，数量依然是 100 不变。事务直接提交无需等待其它事务。</p>
<ul>
<li><strong>阶段二（Confirm)</strong>：假如要提交（Confirm），则冻结金额扣减 30</li>
</ul>
<p>确认可以提交，不过之前可用金额已经扣减过了，这里只要清除冻结金额就好了：</p>
<p><img src="@source/notes/microservices/02/day02-分布式事务/assets/image-20210724182706011.png" alt="image-20210724182706011"></p>
<p>此时，总金额 = 冻结金额 + 可用金额 = 0 + 70 = 70 元</p>
<ul>
<li><strong>阶段二(Canncel)</strong>：如果要回滚（Cancel），则冻结金额扣减 30，可用余额增加 30</li>
</ul>
<p>需要回滚，那么就要释放冻结金额，恢复可用金额：</p>
<p><img src="@source/notes/microservices/02/day02-分布式事务/assets/image-20210724182810734.png" alt="image-20210724182810734"></p>
<h3 id="_4-3-2-seata-的-tcc-模型" tabindex="-1"><a class="header-anchor" href="#_4-3-2-seata-的-tcc-模型" aria-hidden="true">#</a> 4.3.2.Seata 的 TCC 模型</h3>
<p>Seata 中的 TCC 模型依然延续之前的事务架构，如图：</p>
<p><img src="@source/notes/microservices/02/day02-分布式事务/assets/image-20210724182937713.png" alt="image-20210724182937713"></p>
...
<p>当某分支事务的 try 阶段<strong>阻塞</strong>时，可能导致全局事务超时而触发二阶段的 cancel 操作。在未执行 try 操作时先执行了 cancel 操作，这时 cancel 不能做回滚，就是<strong>空回滚</strong>。</p>
<p>如图：</p>
<p><img src="@source/notes/microservices/02/day02-分布式事务/assets/image-20210724183426891.png" alt="image-20210724183426891"></p>
<p>执行 cancel 操作时，应当判断 try 是否已经执行，如果尚未执行，则应该空回滚。</p>
<h4 id="_2-业务悬挂" tabindex="-1"><a class="header-anchor" href="#_2-业务悬挂" aria-hidden="true">#</a> 2）业务悬挂</h4>
<p>对于已经空回滚的业务，之前被阻塞的 try 操作恢复，继续执行 try，就永远不可能 confirm 或 cancel ，事务一直处于中间状态，这就是<strong>业务悬挂</strong>。</p>
<p>执行 try 操作时，应当判断 cancel 是否已经执行过了，如果已经执行，应当阻止空回滚后的 try 操作，避免悬挂</p>
<h3 id="_4-3-5-实现-tcc-模式" tabindex="-1"><a class="header-anchor" href="#_4-3-5-实现-tcc-模式" aria-hidden="true">#</a> 4.3.5.实现 TCC 模式</h3>
<p>解决空回滚和业务悬挂问题，必须要记录当前事务状态，是在 try、还是 cancel？</p>
<h4 id="_1-思路分析" tabindex="-1"><a class="header-anchor" href="#_1-思路分析" aria-hidden="true">#</a> 1）思路分析</h4>
<p>这里我们定义一张表：</p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token keyword">CREATE</span> <span class="token keyword">TABLE</span> <span class="token identifier"><span class="token punctuation">`</span>account_freeze_tbl<span class="token punctuation">`</span></span> <span class="token punctuation">(</span>
...
<p>接下来，我们改造 account-service，利用 TCC 实现余额扣减功能。</p>
<h4 id="_2-声明-tcc-接口" tabindex="-1"><a class="header-anchor" href="#_2-声明-tcc-接口" aria-hidden="true">#</a> 2）声明 TCC 接口</h4>
<p>TCC 的 Try、Confirm、Cancel 方法都需要在接口中基于注解来声明，</p>
<p>我们在 account-service 项目中的<code v-pre>cn.itcast.account.service</code>包中新建一个接口，声明 TCC 三个接口：</p>
...
<p>在 account-service 服务中的<code v-pre>cn.itcast.account.service.impl</code>包下新建一个类，实现 TCC 业务：</p>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">AccountTCCServiceImpl</span> <span class="token keyword">implements</span> <span class="token class-name">AccountTCCService</span> <span class="token punctuation">{</span>
    ...
    <span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">deduct</span><span class="token punctuation">(</span><span class="token class-name">String</span> userId<span class="token punctuation">,</span> <span class="token keyword">int</span> money<span class="token punctuation">)</span> <span class="token punctuation">{</span>
        ...
        <span class="token comment">//0.获取全局事务Id</span>
        ...
        <span class="token comment">// 判断freezs中是否有冻结记录，如果有，一定是CANCEL执行过，我要拒绝业务</span>
        ...
        <span class="token keyword">if</span> <span class="token punctuation">(</span>oldFreeze <span class="token operator">!=</span> <span class="token keyword">null</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
            <span class="token comment">// CANCEL执行过 我要拒绝业务</span>
            <span class="token keyword">return</span><span class="token punctuation">;</span>
        <span class="token punctuation">}</span>

        <span class="token comment">// 1. 余额判断</span>

        <span class="token comment">// 2.扣减可用余额</span>
        ...
        <span class="token comment">// 3.记录冻结状态</span>
    ...
    <span class="token keyword">public</span> <span class="token keyword">boolean</span> <span class="token function">confirm</span><span class="token punctuation">(</span><span class="token class-name">BusinessActionContext</span> ctx<span class="token punctuation">)</span> <span class="token punctuation">{</span>
        ...
        <span class="token comment">// 2.根据事务ID删除冻结信息</span>
    ...
    <span class="token keyword">public</span> <span class="token keyword">boolean</span> <span class="token function">cancel</span><span class="token punctuation">(</span><span class="token class-name">BusinessActionContext</span> ctx<span class="token punctuation">)</span> <span class="token punctuation">{</span>
        <span class="token comment">// 1.查询冻结记录</span>
        <span class="token class-name">String</span> xid <span class="token operator">=</span> ctx<span class="token punctuation">.</span><span class="token function">getXid</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
        ...
        <span class="token comment">// 1.空回滚判断，判断freeze 是否为null，为null证明try没执行 需要空回滚</span>
        <span class="token keyword">if</span> <span class="token punctuation">(</span>freeze <span class="token operator">==</span> <span class="token keyword">null</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
            <span class="token comment">// 证明try 没执行 需要空回滚</span>
        ...
        <span class="token keyword">if</span> <span class="token punctuation">(</span>freeze<span class="token punctuation">.</span><span class="token function">getState</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">==</span> <span class="token class-name">AccountFreeze<span class="token punctuation">.</span>State</span><span class="token punctuation">.</span><span class="token constant">CANCEL</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
            <span class="token comment">// 已经处理过一次CANCEL了 无需重复处理</span>
            <span class="token keyword">return</span> <span class="token boolean">true</span><span class="token punctuation">;</span>
        <span class="token punctuation">}</span>

        <span class="token comment">// 1.恢复冻结余额</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_4-4-saga-模式" tabindex="-1"><a class="header-anchor" href="#_4-4-saga-模式" aria-hidden="true">#</a> 4.4.SAGA 模式</h2>
<p>Saga 模式是 Seata 即将开源的长事务解决方案，将由蚂蚁金服主要贡献。</p>
<p>其理论基础是 Hector &amp; Kenneth 在 1987 年发表的论文<a href="https://microservices.io/patterns/data/saga.html" target="_blank" rel="noopener noreferrer">Sagas<ExternalLinkIcon/></a>。</p>
<p>Seata 官网对于 Saga 的指南：https://seata.io/zh-cn/docs/user/saga.html</p>
...
<p><img src="@source/notes/microservices/02/day02-分布式事务/assets/image-20210724184846396.png" alt="image-20210724184846396"></p>
<p>Saga 也分为两个阶段：</p>
<ul>
<li>一阶段：直接提交本地事务</li>
...
<p>如图：</p>
<p><img src="@source/notes/microservices/02/day02-分布式事务/assets/image-20210724185021819.png" alt="image-20210724185021819"></p>
<h1 id="_5-高可用" tabindex="-1"><a class="header-anchor" href="#_5-高可用" aria-hidden="true">#</a> 5.高可用</h1>
<p>Seata 的 TC 服务作为分布式事务核心，一定要保证集群的高可用性。</p>
<h2 id="_5-1-高可用架构模型" tabindex="-1"><a class="header-anchor" href="#_5-1-高可用架构模型" aria-hidden="true">#</a> 5.1.高可用架构模型</h2>
<p>搭建 TC 服务集群非常简单，启动多个 TC 服务，注册到 nacos 即可。</p>
<p>但集群并不能确保 100%安全，万一集群所在机房故障怎么办？所以如果要求较高，一般都会做异地多机房容灾。</p>
<p>比如一个 TC 集群在上海，另一个 TC 集群在杭州：</p>
<p><img src="@source/notes/microservices/02/day02-分布式事务/assets/image-20210724185240957.png" alt="image-20210724185240957"></p>
<p>微服务基于事务组（tx-service-group)与 TC 集群的映射关系，来查找当前应该使用哪个 TC 集群。当 SH 集群故障时，只需要将 vgroup-mapping 中的映射关系改成 HZ。则所有微服务就会切换到 HZ 的 TC 集群了。</p>
<h2 id="_5-2-实现高可用" tabindex="-1"><a class="header-anchor" href="#_5-2-实现高可用" aria-hidden="true">#</a> 5.2.实现高可用</h2>
<p>具体实现请参考课前资料提供的文档《seata 的部署和集成.md》：</p>
<p><img src="@source/notes/microservices/02/day02-分布式事务/assets/image-20210724172549013.png" alt="image-20210724172549013"></p>
<p>第三章节：</p>
<p><img src="@source/notes/microservices/02/day02-分布式事务/assets/image-20210724185638729.png" alt="image-20210724185638729"></p>
</div></template>
