<template><div><h1 id="day05-服务异步通信-高级篇" tabindex="-1"><a class="header-anchor" href="#day05-服务异步通信-高级篇" aria-hidden="true">#</a> day05-服务异步通信-高级篇</h1>
<nav class="table-of-contents"><ul><li><router-link to="#_1-1-生产者消息确认">1.1.生产者消息确认</router-link><ul><li><router-link to="#_1-1-1-修改配置">1.1.1.修改配置</router-link></li><li><router-link to="#_1-1-2-定义-return-回调">1.1.2.定义 Return 回调</router-link></li><li><router-link to="#_1-1-3-定义-confirmcallback">1.1.3.定义 ConfirmCallback</router-link></li></ul></li><li><router-link to="#_1-2-消息持久化">1.2.消息持久化</router-link><ul><li><router-link to="#_1-2-1-交换机持久化">1.2.1.交换机持久化</router-link></li><li><router-link to="#_1-2-2-队列持久化">1.2.2.队列持久化</router-link></li><li><router-link to="#_1-2-3-消息持久化">1.2.3.消息持久化</router-link></li></ul></li><li><router-link to="#_1-3-消费者消息确认">1.3.消费者消息确认</router-link><ul><li><router-link to="#_1-3-1-演示-none-模式">1.3.1.演示 none 模式</router-link></li><li><router-link to="#_1-3-2-演示-auto-模式">1.3.2.演示 auto 模式</router-link></li></ul></li><li><router-link to="#_1-4-消费失败重试机制">1.4.消费失败重试机制</router-link><ul><li><router-link to="#_1-4-1-本地重试">1.4.1.本地重试</router-link></li><li><router-link to="#_1-4-2-失败策略">1.4.2.失败策略</router-link></li></ul></li><li><router-link to="#_1-5-总结">1.5.总结</router-link></li><li><router-link to="#_2-1-初识死信交换机">2.1.初识死信交换机</router-link><ul><li><router-link to="#_2-1-1-什么是死信交换机">2.1.1.什么是死信交换机</router-link></li><li><router-link to="#_2-1-2-利用死信交换机接收死信-拓展">2.1.2.利用死信交换机接收死信（拓展）</router-link></li><li><router-link to="#_2-1-3-总结">2.1.3.总结</router-link></li></ul></li><li><router-link to="#_2-2-ttl">2.2.TTL</router-link><ul><li><router-link to="#_2-2-1-接收超时死信的死信交换机">2.2.1.接收超时死信的死信交换机</router-link></li><li><router-link to="#_2-2-2-声明一个队列-并且指定-ttl">2.2.2.声明一个队列，并且指定 TTL</router-link></li><li><router-link to="#_2-2-3-发送消息时-设定-ttl">2.2.3.发送消息时，设定 TTL</router-link></li><li><router-link to="#_2-2-4-总结">2.2.4.总结</router-link></li></ul></li><li><router-link to="#_2-3-延迟队列">2.3.延迟队列</router-link><ul><li><router-link to="#_2-3-1-安装-delayexchange-插件">2.3.1.安装 DelayExchange 插件</router-link></li><li><router-link to="#_2-3-2-delayexchange-原理">2.3.2.DelayExchange 原理</router-link></li><li><router-link to="#_2-3-3-使用-delayexchange">2.3.3.使用 DelayExchange</router-link></li><li><router-link to="#_2-3-4-总结">2.3.4.总结</router-link></li></ul></li><li><router-link to="#_3-1-消息堆积问题">3.1.消息堆积问题</router-link></li><li><router-link to="#_3-2-惰性队列">3.2.惰性队列</router-link><ul><li><router-link to="#_3-2-1-基于命令行设置-lazy-queue">3.2.1.基于命令行设置 lazy-queue</router-link></li><li><router-link to="#_3-2-2-基于-bean-声明-lazy-queue">3.2.2.基于@Bean 声明 lazy-queue</router-link></li><li><router-link to="#_3-2-3-基于-rabbitlistener-声明-lazyqueue">3.2.3.基于@RabbitListener 声明 LazyQueue</router-link></li><li><router-link to="#_3-3-总结">3.3.总结</router-link></li></ul></li><li><router-link to="#_4-1-集群分类">4.1.集群分类</router-link></li><li><router-link to="#_4-2-普通集群">4.2.普通集群</router-link><ul><li><router-link to="#_4-2-1-集群结构和特征">4.2.1.集群结构和特征</router-link></li><li><router-link to="#_4-2-2-部署">4.2.2.部署</router-link></li></ul></li><li><router-link to="#_4-3-镜像集群">4.3.镜像集群</router-link><ul><li><router-link to="#_4-3-1-集群结构和特征">4.3.1.集群结构和特征</router-link></li><li><router-link to="#_4-3-2-部署">4.3.2.部署</router-link></li></ul></li><li><router-link to="#_4-4-仲裁队列">4.4.仲裁队列</router-link><ul><li><router-link to="#_4-4-1-集群特征">4.4.1.集群特征</router-link></li><li><router-link to="#_4-4-2-部署">4.4.2.部署</router-link></li><li><router-link to="#_4-4-3-java-代码创建仲裁队列">4.4.3.Java 代码创建仲裁队列</router-link></li><li><router-link to="#_4-4-4-springamqp-连接-mq-集群">4.4.4.SpringAMQP 连接 MQ 集群</router-link></li></ul></li></ul></nav>
<p>消息队列在使用过程中，面临着很多实际问题需要思考：</p>
<p><img src="@source/notes/microservices/02/day05-MQ高级/assets/image-20210718155003157.png" alt="image-20210718155003157"></p>
<h1 id="_1-消息可靠性" tabindex="-1"><a class="header-anchor" href="#_1-消息可靠性" aria-hidden="true">#</a> 1.消息可靠性</h1>
<p>消息从发送，到消费者接收，会经理多个过程：</p>
<p><img src="@source/notes/microservices/02/day05-MQ高级/assets/image-20210718155059371.png" alt="image-20210718155059371"></p>
<p>其中的每一步都可能导致消息丢失，常见的丢失原因包括：</p>
<ul>
<li>发送时丢失：
<ul>
<li>生产者发送的消息未送达 exchange</li>
<li>消息到达 exchange 后未到达 queue</li>
</ul>
</li>
<li>MQ 宕机，queue 将消息丢失</li>
<li>consumer 接收到消息后未消费就宕机</li>
</ul>
<p>针对这些问题，RabbitMQ 分别给出了解决方案：</p>
<ul>
<li>生产者确认机制</li>
<li>mq 持久化</li>
<li>消费者确认机制</li>
...
<p>首先，导入课前资料提供的 demo 工程：</p>
<p><img src="@source/notes/microservices/02/day05-MQ高级/assets/image-20210718155328927.png" alt="image-20210718155328927"></p>
<p>项目结构如下：</p>
<p><img src="@source/notes/microservices/02/day05-MQ高级/assets/image-20210718155448734.png" alt="image-20210718155448734"></p>
<h2 id="_1-1-生产者消息确认" tabindex="-1"><a class="header-anchor" href="#_1-1-生产者消息确认" aria-hidden="true">#</a> 1.1.生产者消息确认</h2>
<p>RabbitMQ 提供了 publisher confirm 机制来避免消息发送到 MQ 过程中丢失。这种机制必须给每个消息指定一个唯一 ID。消息发送到 MQ 以后，会返回一个结果给发送者，表示消息是否处理成功。</p>
<p>返回结果有两种方式：</p>
<ul>
...
<p><img src="@source/notes/microservices/02/day05-MQ高级/assets/image-20210718160907166.png" alt="image-20210718160907166"></p>
<p>注意：</p>
<p><img src="@source/notes/microservices/02/day05-MQ高级/assets/image-20210718161707992.png" alt="image-20210718161707992"></p>
<h3 id="_1-1-1-修改配置" tabindex="-1"><a class="header-anchor" href="#_1-1-1-修改配置" aria-hidden="true">#</a> 1.1.1.修改配置</h3>
<p>首先，修改 publisher 服务中的 application.yml 文件，添加下面的内容：</p>
...
<ul>
<li><code v-pre>publish-confirm-type</code>：开启 publisher-confirm，这里支持两种类型：
<ul>
<li><code v-pre>simple</code>：同步等待 confirm 结果，直到超时</li>
<li><code v-pre>correlated</code>：异步回调，定义 ConfirmCallback，MQ 返回结果时会回调这个 ConfirmCallback</li>
</ul>
</li>
<li><code v-pre>publish-returns</code>：开启 publish-return 功能，同样是基于 callback 机制，不过是定义 ReturnCallback</li>
<li><code v-pre>template.mandatory</code>：定义消息路由失败时的策略。true，则调用 ReturnCallback；false：则直接丢弃消息</li>
</ul>
<h3 id="_1-1-2-定义-return-回调" tabindex="-1"><a class="header-anchor" href="#_1-1-2-定义-return-回调" aria-hidden="true">#</a> 1.1.2.定义 Return 回调</h3>
<p>每个 RabbitTemplate 只能配置一个 ReturnCallback，因此需要在项目加载时配置：</p>
<p>修改 publisher 服务，添加一个：</p>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">CommonConfig</span> <span class="token keyword">implements</span> <span class="token class-name">ApplicationContextAware</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-1-3-定义-confirmcallback" tabindex="-1"><a class="header-anchor" href="#_1-1-3-定义-confirmcallback" aria-hidden="true">#</a> 1.1.3.定义 ConfirmCallback</h3>
<p>ConfirmCallback 可以在发送消息时指定，因为每个业务处理 confirm 成功或失败的逻辑不一定相同。</p>
<p>在 publisher 服务的 cn.itcast.mq.spring.SpringAmqpTest 类中，定义一个单元测试方法：</p>
...
<p>生产者确认可以确保消息投递到 RabbitMQ 的队列中，但是消息发送到 RabbitMQ 以后，如果突然宕机，也可能导致消息丢失。</p>
<p>要想确保消息在 RabbitMQ 中安全保存，必须开启消息持久化机制。</p>
<ul>
<li>交换机持久化</li>
<li>队列持久化</li>
<li>消息持久化</li>
...
<p>RabbitMQ 中交换机默认是非持久化的，mq 重启后就丢失。</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>事实上，默认情况下，由 SpringAMQP 声明的交换机都是持久化的。</p>
<p>可以在 RabbitMQ 控制台看到持久化的交换机都会带上<code v-pre>D</code>的标示：</p>
<p><img src="@source/notes/microservices/02/day05-MQ高级/assets/image-20210718164412450.png" alt="image-20210718164412450"></p>
<h3 id="_1-2-2-队列持久化" tabindex="-1"><a class="header-anchor" href="#_1-2-2-队列持久化" aria-hidden="true">#</a> 1.2.2.队列持久化</h3>
<p>RabbitMQ 中队列默认是非持久化的，mq 重启后就丢失。</p>
<p>SpringAMQP 中可以通过代码指定交换机持久化：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Bean</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>事实上，默认情况下，由 SpringAMQP 声明的队列都是持久化的。</p>
<p>可以在 RabbitMQ 控制台看到持久化的队列都会带上<code v-pre>D</code>的标示：</p>
<p><img src="@source/notes/microservices/02/day05-MQ高级/assets/image-20210718164729543.png" alt="image-20210718164729543"></p>
...
<p>用 java 代码指定：</p>
<p><img src="@source/notes/microservices/02/day05-MQ高级/assets/image-20210718165100016.png" alt="image-20210718165100016"></p>
<p>默认情况下，SpringAMQP 发出的任何消息都是持久化的，不用特意指定。</p>
<h2 id="_1-3-消费者消息确认" tabindex="-1"><a class="header-anchor" href="#_1-3-消费者消息确认" aria-hidden="true">#</a> 1.3.消费者消息确认</h2>
<p>RabbitMQ 是<strong>阅后即焚</strong>机制，RabbitMQ 确认消息被消费者消费后会立刻删除。</p>
<p>而 RabbitMQ 是通过消费者回执来确认消费者是否成功处理消息的：消费者获取消息后，应该向 RabbitMQ 发送 ACK 回执，表明自己已经处理消息。</p>
<p>设想这样的场景：</p>
<ul>
<li>1）RabbitMQ 投递消息给消费者</li>
<li>2）消费者获取消息后，返回 ACK 给 RabbitMQ</li>
<li>3）RabbitMQ 删除消息</li>
<li>4）消费者宕机，消息尚未处理</li>
</ul>
<p>这样，消息就丢失了。因此消费者返回 ACK 的时机非常重要。</p>
<p>而 SpringAMQP 则允许配置三种确认模式：</p>
<p>•manual：手动 ack，需要在业务代码结束后，调用 api 发送 ack。</p>
<p>•auto：自动 ack，由 spring 监测 listener 代码是否出现异常，没有异常则返回 ack；抛出异常则返回 nack</p>
<p>•none：关闭 ack，MQ 假定消费者获取消息后会成功处理，因此消息投递后立即被删除</p>
<p>由此可知：</p>
<ul>
<li>none 模式下，消息投递是不可靠的，可能丢失</li>
<li>auto 模式类似事务机制，出现异常时返回 nack，消息回滚到 mq；没有异常，返回 ack</li>
<li>manual：自己根据业务情况，判断什么时候该 ack</li>
</ul>
<p>一般，我们都是使用默认的 auto 即可。</p>
<h3 id="_1-3-1-演示-none-模式" tabindex="-1"><a class="header-anchor" href="#_1-3-1-演示-none-模式" aria-hidden="true">#</a> 1.3.1.演示 none 模式</h3>
<p>修改 consumer 服务的 application.yml 文件，添加下面内容：</p>
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code><span class="token key atrule">spring</span><span class="token punctuation">:</span>
  <span class="token key atrule">rabbitmq</span><span class="token punctuation">:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>修改 consumer 服务的 SpringRabbitListener 类中的方法，模拟一个消息处理异常：</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>测试可以发现，当消息处理抛异常时，消息依然被 RabbitMQ 删除了。</p>
<h3 id="_1-3-2-演示-auto-模式" tabindex="-1"><a class="header-anchor" href="#_1-3-2-演示-auto-模式" aria-hidden="true">#</a> 1.3.2.演示 auto 模式</h3>
<p>再次把确认机制修改为 auto:</p>
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code><span class="token key atrule">spring</span><span class="token punctuation">:</span>
  <span class="token key atrule">rabbitmq</span><span class="token punctuation">:</span>
    <span class="token key atrule">listener</span><span class="token punctuation">:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在异常位置打断点，再次发送消息，程序卡在断点时，可以发现此时消息状态为 unack（未确定状态）：</p>
<p><img src="@source/notes/microservices/02/day05-MQ高级/assets/image-20210718171705383.png" alt="image-20210718171705383"></p>
<p>抛出异常后，因为 Spring 会自动返回 nack，所以消息恢复至 Ready 状态，并且没有被 RabbitMQ 删除：</p>
<p><img src="@source/notes/microservices/02/day05-MQ高级/assets/image-20210718171759179.png" alt="image-20210718171759179"></p>
<h2 id="_1-4-消费失败重试机制" tabindex="-1"><a class="header-anchor" href="#_1-4-消费失败重试机制" aria-hidden="true">#</a> 1.4.消费失败重试机制</h2>
<p>当消费者出现异常后，消息会不断 requeue（重入队）到队列，再重新发送给消费者，然后再次异常，再次 requeue，无限循环，导致 mq 的消息处理飙升，带来不必要的压力：</p>
<p><img src="@source/notes/microservices/02/day05-MQ高级/assets/image-20210718172746378.png" alt="image-20210718172746378"></p>
<p>怎么办呢？</p>
...
<p>修改 consumer 服务的 application.yml 文件，添加内容：</p>
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code><span class="token key atrule">spring</span><span class="token punctuation">:</span>
  <span class="token key atrule">rabbitmq</span><span class="token punctuation">:</span>
    <span class="token key atrule">listener</span><span class="token punctuation">:</span>
      <span class="token key atrule">simple</span><span class="token punctuation">:</span>
...
<ul>
<li>在重试 3 次后，SpringAMQP 会抛出异常 AmqpRejectAndDontRequeueException，说明本地重试触发了</li>
<li>查看 RabbitMQ 控制台，发现消息被删除了，说明最后 SpringAMQP 返回的是 ack，mq 删除消息了</li>
</ul>
<p>结论：</p>
<ul>
<li>开启本地重试时，消息处理过程中抛出异常，不会 requeue 到队列，而是在消费者本地重试</li>
<li>重试达到最大次数后，Spring 会返回 ack，消息会被丢弃</li>
</ul>
<h3 id="_1-4-2-失败策略" tabindex="-1"><a class="header-anchor" href="#_1-4-2-失败策略" aria-hidden="true">#</a> 1.4.2.失败策略</h3>
<p>在之前的测试中，达到最大重试次数后，消息会被丢弃，这是由 Spring 内部机制决定的。</p>
<p>在开启重试模式后，重试次数耗尽，如果消息依然失败，则需要有 MessageRecovery 接口来处理，它包含三种不同的实现：</p>
<ul>
<li>
<p>RejectAndDontRequeueRecoverer：重试耗尽后，直接 reject，丢弃消息。默认就是这种方式</p>
</li>
<li>
...
<p>比较优雅的一种处理方案是 RepublishMessageRecoverer，失败后将消息投递到一个指定的，专门存放异常消息的队列，后续由人工集中处理。</p>
<p>1）在 consumer 服务中定义处理失败消息的交换机和队列</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Bean</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2）定义一个 RepublishMessageRecoverer，关联队列和交换机</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Bean</span>
...
<p>如果这个包含死信的队列配置了<code v-pre>dead-letter-exchange</code>属性，指定了一个交换机，那么队列中的死信就会投递到这个交换机中，而这个交换机称为<strong>死信交换机</strong>（Dead Letter Exchange，检查 DLX）。</p>
<p>如图，一个消息被消费者拒绝了，变成了死信：</p>
<p><img src="@source/notes/microservices/02/day05-MQ高级/assets/image-20210718174328383.png" alt="image-20210718174328383"></p>
<p>因为 simple.queue 绑定了死信交换机 dl.direct，因此死信会投递给这个交换机：</p>
<p><img src="@source/notes/microservices/02/day05-MQ高级/assets/image-20210718174416160.png" alt="image-20210718174416160"></p>
<p>如果这个死信交换机也绑定了一个队列，则消息最终会进入这个存放死信的队列：</p>
<p><img src="@source/notes/microservices/02/day05-MQ高级/assets/image-20210718174506856.png" alt="image-20210718174506856"></p>
<p>另外，队列将死信投递给死信交换机时，必须知道两个信息：</p>
<ul>
<li>死信交换机名称</li>
<li>死信交换机与死信队列绑定的 RoutingKey</li>
</ul>
<p>这样才能确保投递的消息能到达死信交换机，并且正确的路由到死信队列。</p>
<p><img src="@source/notes/microservices/02/day05-MQ高级/assets/image-20210821073801398.png" alt="image-20210821073801398"></p>
...
<p>在失败重试策略中，默认的 RejectAndDontRequeueRecoverer 会在本地重试次数耗尽后，发送 reject 给 RabbitMQ，消息变成死信，被丢弃。</p>
<p>我们可以给 simple.queue 添加一个死信交换机，给死信交换机绑定一个队列。这样消息变成死信后也不会丢弃，而是最终投递到死信交换机，路由到与死信交换机绑定的队列。</p>
<p><img src="@source/notes/microservices/02/day05-MQ高级/assets/image-20210718174506856.png" alt="image-20210718174506856"></p>
<p>我们在 consumer 服务中，定义一组死信交换机、死信队列：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 声明普通的 simple.queue队列，并且为其指定死信交换机：dl.direct</span>
<span class="token annotation punctuation">@Bean</span>
...
<p><img src="@source/notes/microservices/02/day05-MQ高级/assets/image-20210718182643311.png" alt="image-20210718182643311"></p>
...
<p>在 consumer 服务的 SpringRabbitListener 中，定义一个新的消费者，并且声明 死信交换机、死信队列：</p>
...
<p>要给队列设置超时时间，需要在声明队列时配置 x-message-ttl 属性：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Bean</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>发送消息，但是不要指定 TTL：</p>
...
<p><img src="@source/notes/microservices/02/day05-MQ高级/assets/image-20210718191657478.png" alt="image-20210718191657478"></p>
<p>查看下接收消息的日志：</p>
<p><img src="@source/notes/microservices/02/day05-MQ高级/assets/image-20210718191738706.png" alt="image-20210718191738706"></p>
<p>因为队列的 TTL 值是 10000ms，也就是 10 秒。可以看到消息发送与接收之间的时差刚好是 10 秒。</p>
<h3 id="_2-2-3-发送消息时-设定-ttl" tabindex="-1"><a class="header-anchor" href="#_2-2-3-发送消息时-设定-ttl" aria-hidden="true">#</a> 2.2.3.发送消息时，设定 TTL</h3>
<p>在发送消息时，也可以指定 TTL：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
...
<p><img src="@source/notes/microservices/02/day05-MQ高级/assets/image-20210718191939140.png" alt="image-20210718191939140"></p>
<p>接收消息日志：</p>
<p><img src="@source/notes/microservices/02/day05-MQ高级/assets/image-20210718192004662.png" alt="image-20210718192004662"></p>
<p>这次，发送与接收的延迟只有 5 秒。说明当队列、消息都设置了 TTL 时，任意一个到期就会成为死信。</p>
<h3 id="_2-2-4-总结" tabindex="-1"><a class="header-anchor" href="#_2-2-4-总结" aria-hidden="true">#</a> 2.2.4.总结</h3>
<p>消息超时的两种方式是？</p>
<ul>
<li>给队列设置 ttl 属性，进入队列后超过 ttl 时间的消息变为死信</li>
<li>给消息设置 ttl 属性，队列接收到消息超过 ttl 时间后变为死信</li>
</ul>
<p>如何实现发送一个消息 20 秒后消费者才收到消息？</p>
<ul>
<li>给消息的目标队列指定死信交换机</li>
<li>将消费者监听的队列绑定到死信交换机</li>
<li>发送消息时给消息设置超时时间为 20 秒</li>
</ul>
<h2 id="_2-3-延迟队列" tabindex="-1"><a class="header-anchor" href="#_2-3-延迟队列" aria-hidden="true">#</a> 2.3.延迟队列</h2>
<p>利用 TTL 结合死信交换机，我们实现了消息发出后，消费者延迟收到消息的效果。这种消息模式就称为延迟队列（Delay Queue）模式。</p>
<p>延迟队列的使用场景包括：</p>
<ul>
<li>延迟发送短信</li>
<li>用户下单，如果用户在 15 分钟内未支付，则自动取消</li>
<li>预约工作会议，20 分钟后自动通知所有参会人员</li>
</ul>
<p>因为延迟队列的需求非常多，所以 RabbitMQ 的官方也推出了一个插件，原生支持延迟队列效果。</p>
<p>这个插件就是 DelayExchange 插件。参考 RabbitMQ 的插件列表页面：https://www.rabbitmq.com/community-plugins.html</p>
<p><img src="@source/notes/microservices/02/day05-MQ高级/assets/image-20210718192529342.png" alt="image-20210718192529342"></p>
<p>使用方式可以参考官网地址：https://blog.rabbitmq.com/posts/2015/04/scheduling-messages-with-rabbitmq</p>
<h3 id="_2-3-1-安装-delayexchange-插件" tabindex="-1"><a class="header-anchor" href="#_2-3-1-安装-delayexchange-插件" aria-hidden="true">#</a> 2.3.1.安装 DelayExchange 插件</h3>
<p>参考课前资料：</p>
<p><img src="@source/notes/microservices/02/day05-MQ高级/assets/image-20210718193409812.png" alt="image-20210718193409812"></p>
<h3 id="_2-3-2-delayexchange-原理" tabindex="-1"><a class="header-anchor" href="#_2-3-2-delayexchange-原理" aria-hidden="true">#</a> 2.3.2.DelayExchange 原理</h3>
<p>DelayExchange 需要将一个交换机声明为 delayed 类型。当我们发送消息到 delayExchange 时，流程如下：</p>
<ul>
<li>接收消息</li>
<li>判断消息是否具备 x-delay 属性</li>
<li>如果有 x-delay 属性，说明是延迟消息，持久化到硬盘，读取 x-delay 值，作为延迟时间</li>
<li>返回 routing not found 结果给消息发送者</li>
<li>x-delay 时间到期后，重新投递消息到指定队列</li>
</ul>
<h3 id="_2-3-3-使用-delayexchange" tabindex="-1"><a class="header-anchor" href="#_2-3-3-使用-delayexchange" aria-hidden="true">#</a> 2.3.3.使用 DelayExchange</h3>
<p>插件的使用也非常简单：声明一个交换机，交换机的类型可以是任意类型，只需要设定 delayed 属性为 true 即可，然后声明队列与其绑定即可。</p>
<h4 id="_1-声明-delayexchange-交换机" tabindex="-1"><a class="header-anchor" href="#_1-声明-delayexchange-交换机" aria-hidden="true">#</a> 1）声明 DelayExchange 交换机</h4>
<p>基于注解方式（推荐）：</p>
<p><img src="@source/notes/microservices/02/day05-MQ高级/assets/image-20210718193747649.png" alt="image-20210718193747649"></p>
<p>也可以基于@Bean 的方式：</p>
<p><img src="@source/notes/microservices/02/day05-MQ高级/assets/image-20210718193831076.png" alt="image-20210718193831076"></p>
<h4 id="_2-发送消息" tabindex="-1"><a class="header-anchor" href="#_2-发送消息" aria-hidden="true">#</a> 2）发送消息</h4>
<p>发送消息时，一定要携带 x-delay 属性，指定延迟的时间：</p>
<p><img src="@source/notes/microservices/02/day05-MQ高级/assets/image-20210718193917009.png" alt="image-20210718193917009"></p>
<h3 id="_2-3-4-总结" tabindex="-1"><a class="header-anchor" href="#_2-3-4-总结" aria-hidden="true">#</a> 2.3.4.总结</h3>
<p>延迟队列插件的使用步骤包括哪些？</p>
<p>•声明一个交换机，添加 delayed 属性为 true</p>
<p>•发送消息时，添加 x-delay 头，值为超时时间</p>
...
<p><img src="@source/notes/microservices/02/day05-MQ高级/assets/image-20210718194040498.png" alt="image-20210718194040498"></p>
<p>解决消息堆积有两种思路：</p>
<ul>
<li>增加更多消费者，提高消费速度。也就是我们之前说的 work queue 模式</li>
<li>扩大队列容积，提高堆积上限</li>
</ul>
...
<p>从 RabbitMQ 的 3.6.0 版本开始，就增加了 Lazy Queues 的概念，也就是惰性队列。惰性队列的特征如下：</p>
<ul>
<li>接收到消息后直接存入磁盘而非内存</li>
<li>消费者要消费消息时才会从磁盘中读取并加载到内存</li>
<li>支持数百万条的消息存储</li>
</ul>
<h3 id="_3-2-1-基于命令行设置-lazy-queue" tabindex="-1"><a class="header-anchor" href="#_3-2-1-基于命令行设置-lazy-queue" aria-hidden="true">#</a> 3.2.1.基于命令行设置 lazy-queue</h3>
<p>而要设置一个队列为惰性队列，只需要在声明队列时，指定 x-queue-mode 属性为 lazy 即可。可以通过命令行将一个运行中的队列修改为惰性队列：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>rabbitmqctl set_policy Lazy <span class="token string">"^lazy-queue$"</span> <span class="token string">'{"queue-mode":"lazy"}'</span> --apply-to queues
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>命令解读：</p>
<ul>
<li><code v-pre>rabbitmqctl</code> ：RabbitMQ 的命令行工具</li>
...
<li><code v-pre>'{&quot;queue-mode&quot;:&quot;lazy&quot;}'</code> ：设置队列模式为 lazy 模式</li>
<li><code v-pre>--apply-to queues  </code>：策略的作用对象，是所有的队列</li>
</ul>
<h3 id="_3-2-2-基于-bean-声明-lazy-queue" tabindex="-1"><a class="header-anchor" href="#_3-2-2-基于-bean-声明-lazy-queue" aria-hidden="true">#</a> 3.2.2.基于@Bean 声明 lazy-queue</h3>
<p><img src="@source/notes/microservices/02/day05-MQ高级/assets/image-20210718194522223.png" alt="image-20210718194522223"></p>
<h3 id="_3-2-3-基于-rabbitlistener-声明-lazyqueue" tabindex="-1"><a class="header-anchor" href="#_3-2-3-基于-rabbitlistener-声明-lazyqueue" aria-hidden="true">#</a> 3.2.3.基于@RabbitListener 声明 LazyQueue</h3>
<p><img src="@source/notes/microservices/02/day05-MQ高级/assets/image-20210718194539054.png" alt="image-20210718194539054"></p>
<h3 id="_3-3-总结" tabindex="-1"><a class="header-anchor" href="#_3-3-总结" aria-hidden="true">#</a> 3.3.总结</h3>
<p>消息堆积问题的解决方案？</p>
<ul>
<li>队列上绑定多个消费者，提高消费速度</li>
<li>使用惰性队列，可以再 mq 中保存更多消息</li>
</ul>
<p>惰性队列的优点有哪些？</p>
<ul>
<li>基于磁盘存储，消息上限高</li>
<li>没有间歇性的 page-out，性能比较稳定</li>
</ul>
<p>惰性队列的缺点有哪些？</p>
<ul>
...
<h1 id="_4-mq-集群" tabindex="-1"><a class="header-anchor" href="#_4-mq-集群" aria-hidden="true">#</a> 4.MQ 集群</h1>
<h2 id="_4-1-集群分类" tabindex="-1"><a class="header-anchor" href="#_4-1-集群分类" aria-hidden="true">#</a> 4.1.集群分类</h2>
<p>RabbitMQ 的是基于 Erlang 语言编写，而 Erlang 又是一个面向并发的语言，天然支持集群模式。RabbitMQ 的集群有两种模式：</p>
<p>•<strong>普通集群</strong>：是一种分布式集群，将队列分散到集群的各个节点，从而提高整个集群的并发能力。</p>
<p>•<strong>镜像集群</strong>：是一种主从集群，普通集群的基础上，添加了主从备份功能，提高集群的数据可用性。</p>
<p>镜像集群虽然支持主从，但主从同步并不是强一致的，某些情况下可能有数据丢失的风险。因此在 RabbitMQ 的 3.8 版本以后，推出了新的功能：<strong>仲裁队列</strong>来代替镜像集群，底层采用 Raft 协议确保主从的数据一致性。</p>
...
<p>结构如图：</p>
<p><img src="@source/notes/microservices/02/day05-MQ高级/assets/image-20210718220843323.png" alt="image-20210718220843323"></p>
<h3 id="_4-2-2-部署" tabindex="-1"><a class="header-anchor" href="#_4-2-2-部署" aria-hidden="true">#</a> 4.2.2.部署</h3>
<p>参考课前资料：《RabbitMQ 部署指南.md》</p>
...
<p>结构如图：</p>
<p><img src="@source/notes/microservices/02/day05-MQ高级/assets/image-20210718221039542.png" alt="image-20210718221039542"></p>
...
<p>仲裁队列：仲裁队列是 3.8 版本以后才有的新功能，用来替代镜像队列，具备下列特征：</p>
<ul>
...
<p>参考课前资料：《RabbitMQ 部署指南.md》</p>
<h3 id="_4-4-3-java-代码创建仲裁队列" tabindex="-1"><a class="header-anchor" href="#_4-4-3-java-代码创建仲裁队列" aria-hidden="true">#</a> 4.4.3.Java 代码创建仲裁队列</h3>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Bean</span>
<span class="token keyword">public</span> <span class="token class-name">Queue</span> <span class="token function">quorumQueue</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token keyword">return</span> <span class="token class-name">QueueBuilder</span>
        ...
        <span class="token punctuation">.</span><span class="token function">build</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-4-4-springamqp-连接-mq-集群" tabindex="-1"><a class="header-anchor" href="#_4-4-4-springamqp-连接-mq-集群" aria-hidden="true">#</a> 4.4.4.SpringAMQP 连接 MQ 集群</h3>
<p>注意，这里用 address 来代替 host、port 方式</p>
