<template><div><h1 id="seata-的部署和集成-🧙" tabindex="-1"><a class="header-anchor" href="#seata-的部署和集成-🧙" aria-hidden="true">#</a> seata 的部署和集成 🧙</h1>
<nav class="table-of-contents"><ul><li><router-link to="#_1-下载">1.下载</router-link></li><li><router-link to="#_2-解压">2.解压</router-link></li><li><router-link to="#_3-修改配置">3.修改配置</router-link></li><li><router-link to="#_4-在-nacos-添加配置">4.在 nacos 添加配置</router-link></li><li><router-link to="#_5-创建数据库表">5.创建数据库表</router-link></li><li><router-link to="#_6-启动-tc-服务">6.启动 TC 服务</router-link></li><li><router-link to="#_1-引入依赖">1.引入依赖</router-link></li><li><router-link to="#_2-修改配置文件">2.修改配置文件</router-link></li><li><router-link to="#_1-模拟异地容灾的-tc-集群">1.模拟异地容灾的 TC 集群</router-link></li><li><router-link to="#_2-将事务组映射配置到-nacos">2.将事务组映射配置到 nacos</router-link></li><li><router-link to="#_3-微服务读取-nacos-配置">3.微服务读取 nacos 配置</router-link></li></ul></nav>
<h1 id="一、部署-seata-的-tc-server" tabindex="-1"><a class="header-anchor" href="#一、部署-seata-的-tc-server" aria-hidden="true">#</a> 一、部署 Seata 的 tc-server</h1>
<h2 id="_1-下载" tabindex="-1"><a class="header-anchor" href="#_1-下载" aria-hidden="true">#</a> 1.下载</h2>
<p>首先我们要下载 seata-server 包，地址在<a href="http://seata.io/zh-cn/blog/download.html" target="_blank" rel="noopener noreferrer">http<ExternalLinkIcon/></a><a href="http://seata.io/zh-cn/blog/download.html" target="_blank" rel="noopener noreferrer">😕/seata.io/zh-cn/blog/download<ExternalLinkIcon/></a><a href="http://seata.io/zh-cn/blog/download.html" target="_blank" rel="noopener noreferrer">.<ExternalLinkIcon/></a><a href="http://seata.io/zh-cn/blog/download.html" target="_blank" rel="noopener noreferrer">html<ExternalLinkIcon/></a></p>
<p>当然，课前资料也准备好了：</p>
<p><img src="@source/notes/microservices/02/seata的部署和集成/assets/image-20210622202357640.png" alt="image-20210622202357640"></p>
<h2 id="_2-解压" tabindex="-1"><a class="header-anchor" href="#_2-解压" aria-hidden="true">#</a> 2.解压</h2>
<p>在非中文目录解压缩这个 zip 包，其目录结构如下：</p>
<p><img src="@source/notes/microservices/02/seata的部署和集成/assets/image-20210622202515014.png" alt="image-20210622202515014"></p>
<h2 id="_3-修改配置" tabindex="-1"><a class="header-anchor" href="#_3-修改配置" aria-hidden="true">#</a> 3.修改配置</h2>
<p>修改 conf 目录下的 registry.conf 文件：</p>
<p><img src="@source/notes/microservices/02/seata的部署和集成/assets/image-20210622202622874.png" alt="image-20210622202622874"></p>
<p>内容如下：</p>
<div class="language-properties line-numbers-mode" data-ext="properties"><pre v-pre class="language-properties"><code><span class="token key attr-name">registry</span> <span class="token value attr-value">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_4-在-nacos-添加配置" tabindex="-1"><a class="header-anchor" href="#_4-在-nacos-添加配置" aria-hidden="true">#</a> 4.在 nacos 添加配置</h2>
<p>特别注意，为了让 tc 服务的集群可以共享配置，我们选择了 nacos 作为统一配置中心。因此服务端配置文件 seataServer.properties 文件需要在 nacos 中配好。</p>
<p>格式如下：</p>
<p><img src="@source/notes/microservices/02/seata的部署和集成/assets/image-20210622203609227.png" alt="image-20210622203609227"></p>
<p>配置内容如下：</p>
<div class="language-properties line-numbers-mode" data-ext="properties"><pre v-pre class="language-properties"><code><span class="token comment"># 数据存储方式，db代表数据库</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>==其中的数据库地址、用户名、密码都需要修改成你自己的数据库信息。==</p>
<h2 id="_5-创建数据库表" tabindex="-1"><a class="header-anchor" href="#_5-创建数据库表" aria-hidden="true">#</a> 5.创建数据库表</h2>
<p>特别注意：tc 服务在管理分布式事务时，需要记录事务相关数据到数据库中，你需要提前创建好这些表。</p>
<p>新建一个名为 seata 的数据库，运行课前资料提供的 sql 文件：</p>
<p><img src="@source/notes/microservices/02/seata的部署和集成/assets/image-20210622204145159.png" alt="image-20210622204145159"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_6-启动-tc-服务" tabindex="-1"><a class="header-anchor" href="#_6-启动-tc-服务" aria-hidden="true">#</a> 6.启动 TC 服务</h2>
<p>进入 bin 目录，运行其中的 seata-server.bat 即可：</p>
<p><img src="@source/notes/microservices/02/seata的部署和集成/assets/image-20210622205427318.png" alt="image-20210622205427318"></p>
<p>启动成功后，seata-server 应该已经注册到 nacos 注册中心了。</p>
<p>打开浏览器，访问 nacos 地址：http://localhost:8848，然后进入服务列表页面，可以看到 seata-tc-server 的信息：</p>
<p><img src="@source/notes/microservices/02/seata的部署和集成/assets/image-20210622205901450.png" alt="image-20210622205901450"></p>
<h1 id="二、微服务集成-seata" tabindex="-1"><a class="header-anchor" href="#二、微服务集成-seata" aria-hidden="true">#</a> 二、微服务集成 seata</h1>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>dependency</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2-修改配置文件" tabindex="-1"><a class="header-anchor" href="#_2-修改配置文件" aria-hidden="true">#</a> 2.修改配置文件</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="三、tc-服务的高可用和异地容灾" tabindex="-1"><a class="header-anchor" href="#三、tc-服务的高可用和异地容灾" aria-hidden="true">#</a> 三、TC 服务的高可用和异地容灾</h1>
<h2 id="_1-模拟异地容灾的-tc-集群" tabindex="-1"><a class="header-anchor" href="#_1-模拟异地容灾的-tc-集群" aria-hidden="true">#</a> 1.模拟异地容灾的 TC 集群</h2>
...
<div class="language-nginx line-numbers-mode" data-ext="nginx"><pre v-pre class="language-nginx"><code><span class="token directive"><span class="token keyword">registry</span></span> <span class="token punctuation">{</span>
  <span class="token comment"># tc服务的注册中心类，这里选择nacos，也可以是eureka、zookeeper等</span>
...
<div class="language-powershell line-numbers-mode" data-ext="powershell"><pre v-pre class="language-powershell"><code>seata-server<span class="token punctuation">.</span>bat <span class="token operator">-</span>p 8092
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>打开 nacos 控制台，查看服务列表：</p>
<p><img src="@source/notes/microservices/02/seata的部署和集成/assets/image-20210624151150840.png" alt="image-20210624151150840"></p>
<p>点进详情查看：</p>
<p><img src="@source/notes/microservices/02/seata的部署和集成/assets/image-20210624151221747.png" alt="image-20210624151221747"></p>
<h2 id="_2-将事务组映射配置到-nacos" tabindex="-1"><a class="header-anchor" href="#_2-将事务组映射配置到-nacos" aria-hidden="true">#</a> 2.将事务组映射配置到 nacos</h2>
<p>接下来，我们需要将 tx-service-group 与 cluster 的映射关系都配置到 nacos 配置中心。</p>
<p>新建一个配置：</p>
<p><img src="@source/notes/microservices/02/seata的部署和集成/assets/image-20210624151507072.png" alt="image-20210624151507072"></p>
<p>配置的内容如下：</p>
<div class="language-properties line-numbers-mode" data-ext="properties"><pre v-pre class="language-properties"><code><span class="token comment"># 事务组映射关系</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3-微服务读取-nacos-配置" tabindex="-1"><a class="header-anchor" href="#_3-微服务读取-nacos-配置" aria-hidden="true">#</a> 3.微服务读取 nacos 配置</h2>
