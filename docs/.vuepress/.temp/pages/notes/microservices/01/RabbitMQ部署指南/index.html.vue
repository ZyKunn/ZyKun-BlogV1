...
<nav class="table-of-contents"><ul><li><router-link to="#_1-1-下载镜像">1.1.下载镜像</router-link></li><li><router-link to="#_1-2-安装-mq">1.2.安装 MQ</router-link></li><li><router-link to="#_2-1-集群分类">2.1.集群分类</router-link></li><li><router-link to="#_2-2-设置网络">2.2.设置网络</router-link></li></ul></nav>
<h1 id="_1-单机部署" tabindex="-1"><a class="header-anchor" href="#_1-单机部署" aria-hidden="true">#</a> 1.单机部署</h1>
<p>我们在 Centos7 虚拟机中使用 Docker 来安装。</p>
<h2 id="_1-1-下载镜像" tabindex="-1"><a class="header-anchor" href="#_1-1-下载镜像" aria-hidden="true">#</a> 1.1.下载镜像</h2>
<p>方式一：在线拉取</p>
...
<p>在课前资料已经提供了镜像包：</p>
<p><img src="@source/notes/microservices/01/RabbitMQ部署指南/assets/image-20210423191210349.png" alt="image-20210423191210349"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="_1-2-安装-mq" tabindex="-1"><a class="header-anchor" href="#_1-2-安装-mq" aria-hidden="true">#</a> 1.2.安装 MQ</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="_2-集群部署" tabindex="-1"><a class="header-anchor" href="#_2-集群部署" aria-hidden="true">#</a> 2.集群部署</h1>
<p>接下来，我们看看如何安装 RabbitMQ 的集群。</p>
<h2 id="_2-1-集群分类" tabindex="-1"><a class="header-anchor" href="#_2-1-集群分类" aria-hidden="true">#</a> 2.1.集群分类</h2>
...
<p>我们先来看普通模式集群。</p>
<h2 id="_2-2-设置网络" tabindex="-1"><a class="header-anchor" href="#_2-2-设置网络" aria-hidden="true">#</a> 2.2.设置网络</h2>
<p>首先，我们需要让 3 台 MQ 互相知道对方的存在。</p>
<p>分别在 3 台机器中，设置 /etc/hosts 文件，添加如下内容：</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>192.168.150.101 mq1
192.168.150.102 mq2
192.168.150.103 mq3
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>并在每台机器上测试，是否可以 ping 通对方：</p>
</div></template>
