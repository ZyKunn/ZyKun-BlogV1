...
<nav class="table-of-contents"><ul><li><router-link to="#_1-1-同步和异步通讯">1.1.同步和异步通讯</router-link><ul><li><router-link to="#_1-1-1-同步通讯">1.1.1.同步通讯</router-link></li><li><router-link to="#_1-1-2-异步通讯">1.1.2.异步通讯</router-link></li></ul></li><li><router-link to="#_1-2-技术对比">1.2.技术对比：</router-link></li><li><router-link to="#_2-1-安装-rabbitmq">2.1.安装 RabbitMQ</router-link></li><li><router-link to="#_2-2-rabbitmq-消息模型">2.2.RabbitMQ 消息模型</router-link></li><li><router-link to="#_2-3-导入-demo-工程">2.3.导入 Demo 工程</router-link></li><li><router-link to="#_2-4-入门案例">2.4.入门案例</router-link><ul><li><router-link to="#_2-4-1-publisher-实现">2.4.1.publisher 实现</router-link></li><li><router-link to="#_2-4-2-consumer-实现">2.4.2.consumer 实现</router-link></li></ul></li><li><router-link to="#_2-5-总结">2.5.总结</router-link></li><li><router-link to="#_3-1-basic-queue-简单队列模型">3.1.Basic Queue 简单队列模型</router-link><ul><li><router-link to="#_3-1-1-消息发送">3.1.1.消息发送</router-link></li><li><router-link to="#_3-1-2-消息接收">3.1.2.消息接收</router-link></li><li><router-link to="#_3-1-3-测试">3.1.3.测试</router-link></li></ul></li><li><router-link to="#_3-2-workqueue">3.2.WorkQueue</router-link><ul><li><router-link to="#_3-2-1-消息发送">3.2.1.消息发送</router-link></li><li><router-link to="#_3-2-2-消息接收">3.2.2.消息接收</router-link></li><li><router-link to="#_3-2-3-测试">3.2.3.测试</router-link></li><li><router-link to="#_3-2-4-能者多劳">3.2.4.能者多劳</router-link></li><li><router-link to="#_3-2-5-总结">3.2.5.总结</router-link></li></ul></li><li><router-link to="#_3-3-发布-订阅">3.3.发布/订阅</router-link></li><li><router-link to="#_3-4-fanout">3.4.Fanout</router-link><ul><li><router-link to="#_3-4-1-声明队列和交换机">3.4.1.声明队列和交换机</router-link></li><li><router-link to="#_3-4-2-消息发送">3.4.2.消息发送</router-link></li><li><router-link to="#_3-4-3-消息接收">3.4.3.消息接收</router-link></li><li><router-link to="#_3-4-4-总结">3.4.4.总结</router-link></li></ul></li><li><router-link to="#_3-5-direct">3.5.Direct</router-link><ul><li><router-link to="#_3-5-1-基于注解声明队列和交换机">3.5.1.基于注解声明队列和交换机</router-link></li><li><router-link to="#_3-5-2-消息发送">3.5.2.消息发送</router-link></li><li><router-link to="#_3-5-3-总结">3.5.3.总结</router-link></li></ul></li><li><router-link to="#_3-6-topic">3.6.Topic</router-link><ul><li><router-link to="#_3-6-1-说明">3.6.1.说明</router-link></li><li><router-link to="#_3-6-2-消息发送">3.6.2.消息发送</router-link></li><li><router-link to="#_3-6-3-消息接收">3.6.3.消息接收</router-link></li><li><router-link to="#_3-6-4-总结">3.6.4.总结</router-link></li></ul></li><li><router-link to="#_3-7-消息转换器">3.7.消息转换器</router-link><ul><li><router-link to="#_3-7-1-测试默认转换器">3.7.1.测试默认转换器</router-link></li><li><router-link to="#_3-7-2-配置-json-转换器">3.7.2.配置 JSON 转换器</router-link></li></ul></li></ul></nav>
<h1 id="_1-初识-mq" tabindex="-1"><a class="header-anchor" href="#_1-初识-mq" aria-hidden="true">#</a> 1.初识 MQ</h1>
...
<p><img src="@source/notes/microservices/01/day04-MQ/assets/image-20210717161939695.png" alt="image-20210717161939695"></p>
...
<p><img src="@source/notes/microservices/01/day04-MQ/assets/image-20210717162004285.png" alt="image-20210717162004285"></p>
<p>总结：</p>
<p>同步调用的优点：</p>
<ul>
...
<p><img src="@source/notes/microservices/01/day04-MQ/assets/image-20210422095356088.png" alt="image-20210422095356088"></p>
...
<li>
<p>流量削峰：不管发布事件的流量波动多大，都由 Broker 接收，订阅者可以按照自己的速度去处理事件</p>
</li>
</ul>
<p>缺点：</p>
<ul>
...
<h2 id="_2-1-安装-rabbitmq" tabindex="-1"><a class="header-anchor" href="#_2-1-安装-rabbitmq" aria-hidden="true">#</a> 2.1.安装 RabbitMQ</h2>
<p>安装 RabbitMQ，参考课前资料：</p>
<p><img src="@source/notes/microservices/01/day04-MQ/assets/image-20210717162628635.png" alt="image-20210717162628635"></p>
<p>MQ 的基本结构：</p>
<p><img src="@source/notes/microservices/01/day04-MQ/assets/image-20210717162752376.png" alt="image-20210717162752376"></p>
<p>RabbitMQ 中的一些角色：</p>
<ul>
<li>publisher：生产者</li>
<li>consumer：消费者</li>
...
<p><img src="@source/notes/microservices/01/day04-MQ/assets/image-20210717163332646.png" alt="image-20210717163332646"></p>
<h2 id="_2-3-导入-demo-工程" tabindex="-1"><a class="header-anchor" href="#_2-3-导入-demo-工程" aria-hidden="true">#</a> 2.3.导入 Demo 工程</h2>
<p>课前资料提供了一个 Demo 工程，mq-demo:</p>
<p><img src="@source/notes/microservices/01/day04-MQ/assets/image-20210717163253264.png" alt="image-20210717163253264"></p>
<p>导入后可以看到结构如下：</p>
<p><img src="@source/notes/microservices/01/day04-MQ/assets/image-20210717163604330.png" alt="image-20210717163604330"></p>
<p>包括三部分：</p>
<ul>
...
<p>简单队列模式的模型图：</p>
<p><img src="@source/notes/microservices/01/day04-MQ/assets/image-20210717163434647.png" alt="image-20210717163434647"></p>
...
<li>
<p>定义 consumer 的消费行为 handleDelivery()</p>
</li>
<li>
<p>利用 channel 将消费者与队列绑定</p>
</li>
</ol>
...
<p>SpringAmqp 的官方地址：https://spring.io/projects/spring-amqp</p>
<p><img src="@source/notes/microservices/01/day04-MQ/assets/image-20210717164024967.png" alt="image-20210717164024967"></p>
<p><img src="@source/notes/microservices/01/day04-MQ/assets/image-20210717164038678.png" alt="image-20210717164038678"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>然后在 publisher 服务中编写测试类 SpringAmqpTest，并利用 RabbitTemplate 实现消息发送：</p>
...
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code><span class="token key atrule">spring</span><span class="token punctuation">:</span>
  <span class="token key atrule">rabbitmq</span><span class="token punctuation">:</span>
    ...
    <span class="token key atrule">username</span><span class="token punctuation">:</span> itcast <span class="token comment"># 用户名</span>
    <span class="token key atrule">password</span><span class="token punctuation">:</span> <span class="token number">123321</span> <span class="token comment"># 密码</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>然后在 consumer 服务的<code v-pre>cn.itcast.mq.listener</code>包中新建一个类 SpringRabbitListener，代码如下：</p>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">SpringRabbitListener</span> <span class="token punctuation">{</span>
    ...
    <span class="token annotation punctuation">@RabbitListener</span><span class="token punctuation">(</span>queues <span class="token operator">=</span> <span class="token string">"simple.queue"</span><span class="token punctuation">)</span> <span class="token comment">// 监听队列消息</span>
...
<p>启动 consumer 服务 服务 服务!!!(SpringBoot 主启动类)，然后在 publisher 服务中运行测试代码，发送 MQ 消息</p>
...
<p><img src="@source/notes/microservices/01/day04-MQ/assets/image-20210717164238910.png" alt="image-20210717164238910"></p>
...
<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">testWorkQueue</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">InterruptedException</span> <span class="token punctuation">{</span>
    ...
    <span class="token comment">//循环消息的发送 模拟并发</span>
    <span class="token keyword">for</span> <span class="token punctuation">(</span><span class="token keyword">int</span> i <span class="token operator">=</span> <span class="token number">0</span><span class="token punctuation">;</span> i <span class="token operator">&lt;</span> <span class="token number">50</span><span class="token punctuation">;</span> i<span class="token operator">++</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
        ...
        <span class="token comment">// 每次 休息20毫秒</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>注意到这个消费者 sleep 了 200sm，模拟任务耗时。</p>
...
<p><img src="@source/notes/microservices/01/day04-MQ/assets/1681614466139.png" alt="1681614466139"></p>
<p>也就是说消息是平均分配给每个消费者，并没有考虑到消费者的处理能力。这样显然是有问题的。(消费预取问题)</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>重启 consumer 服务 在执行 publisher 服务中刚刚编写的发送测试方法 testWorkQueue。 结果如下</p>
<p><img src="@source/notes/microservices/01/day04-MQ/assets/1681614733316.png" alt="1681614733316"></p>
<h3 id="_3-2-5-总结" tabindex="-1"><a class="header-anchor" href="#_3-2-5-总结" aria-hidden="true">#</a> 3.2.5.总结</h3>
<p>Work 模型的使用：</p>
<ul>
...
<p>发布订阅的模型如图：</p>
<p><img src="@source/notes/microservices/01/day04-MQ/assets/image-20210717165309625.png" alt="image-20210717165309625"></p>
<p>可以看到，在订阅模型中，多了一个 exchange 角色，而且过程略有变化：</p>
<ul>
<li>Publisher：生产者，也就是要发送消息的程序，但是不再发送到队列中，而是发给 X（交换机）</li>
<li>Exchange：交换机，图中的 X。一方面，接收生产者发送的消息。另一方面，知道如何处理消息，例如递交给某个特别队列、递交给所有队列、或是将消息丢弃。到底如何操作，取决于 Exchange 的类型。Exchange 有以下 3 种类型：
<ul>
...
<p><img src="@source/notes/microservices/01/day04-MQ/assets/image-20210717165438225.png" alt="image-20210717165438225"></p>
...
<p>我们的计划是这样的：</p>
<ul>
<li>创建一个交换机 itcast.fanout，类型是 Fanout</li>
<li>创建两个队列 fanout.queue1 和 fanout.queue2，绑定到交换机 itcast.fanout</li>
</ul>
<p><img src="@source/notes/microservices/01/day04-MQ/assets/image-20210717165509466.png" alt="image-20210717165509466"></p>
...
<p><img src="@source/notes/microservices/01/day04-MQ/assets/image-20210717165552676.png" alt="image-20210717165552676"></p>
...
<p><img src="@source/notes/microservices/01/day04-MQ/assets/image-20210717170041447.png" alt="image-20210717170041447"></p>
<p>在 Direct 模型下：</p>
<ul>
<li>队列与交换机的绑定，不能是任意绑定了，而是要指定一个<code v-pre>RoutingKey</code>（路由 key）</li>
<li>消息的发送方在 向 Exchange 发送消息时，也必须指定消息的 <code v-pre>RoutingKey</code>。</li>
<li>Exchange 不再把消息交给每一个绑定的队列，而是根据消息的<code v-pre>Routing Key</code>进行判断，只有队列的<code v-pre>Routingkey</code>与消息的 <code v-pre>Routing key</code>完全一致，才会接收到消息</li>
</ul>
<p><strong>案例需求如下</strong>：</p>
<ol>
<li>
<p>利用<code v-pre>@RabbitListener</code>声明 Exchange、Queue、RoutingKey</p>
</li>
<li>
<p>在 consumer 服务中，编写两个消费者方法，分别监听 direct.queue1 和 direct.queue2</p>
</li>
<li>
<p>在 publisher 中编写测试方法，向 itcast. direct 发送消息</p>
</li>
</ol>
<p><img src="@source/notes/microservices/01/day04-MQ/assets/image-20210717170223317.png" alt="image-20210717170223317"></p>
...
<p><code v-pre>*</code>：匹配不多不少恰好 1 个词</p>
<p>举例：</p>
...
<p>​</p>
<p>图示：</p>
<p><img src="@source/notes/microservices/01/day04-MQ/assets/image-20210717170705380.png" alt="image-20210717170705380"></p>
<p>解释：</p>
<ul>
<li>Queue1：绑定的是<code v-pre>china.#</code> ，因此凡是以 <code v-pre>china.</code>开头的<code v-pre>routing key</code> 都会被匹配到。包括 china.news 和 china.weather</li>
<li>Queue2：绑定的是<code v-pre>#.news</code> ，因此凡是以 <code v-pre>.news</code>结尾的 <code v-pre>routing key</code> 都会被匹配。包括 china.news 和 japan.news</li>
</ul>
<p>案例需求：</p>
<p>实现思路如下：</p>
<ol>
<li>
<p>并利用@RabbitListener 声明 Exchange、Queue、RoutingKey</p>
</li>
<li>
<p>在 consumer 服务中，编写两个消费者方法，分别监听 topic.queue1 和 topic.queue2</p>
</li>
<li>
<p>在 publisher 中编写测试方法，向 itcast. topic 发送消息</p>
</li>
</ol>
<p><img src="@source/notes/microservices/01/day04-MQ/assets/image-20210717170829229.png" alt="image-20210717170829229"></p>
...
<li>Topic 交换机与队列绑定时的 bindingKey 可以指定通配符</li>
...
<p><img src="@source/notes/microservices/01/day04-MQ/assets/image-20200525170410401.png" alt="image-20200525170410401"></p>
...
<p>发送消息后查看控制台：</p>
<p><img src="@source/notes/microservices/01/day04-MQ/assets/image-20210422232835363.png" alt="image-20210422232835363"></p>
