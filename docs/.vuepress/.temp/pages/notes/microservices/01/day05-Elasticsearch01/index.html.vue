<template><div><h1 id="分布式搜索引擎-01-🧀" tabindex="-1"><a class="header-anchor" href="#分布式搜索引擎-01-🧀" aria-hidden="true">#</a> 分布式搜索引擎 01 🧀</h1>
<nav class="table-of-contents"><ul><li><router-link to="#_1-1-了解-es">1.1.了解 ES</router-link><ul><li><router-link to="#_1-1-1-elasticsearch-的作用">1.1.1.elasticsearch 的作用</router-link></li><li><router-link to="#_1-1-2-elk-技术栈">1.1.2.ELK 技术栈</router-link></li><li><router-link to="#_1-1-3-elasticsearch-和-lucene">1.1.3.elasticsearch 和 lucene</router-link></li><li><router-link to="#_1-1-4-为什么不是其他搜索技术">1.1.4.为什么不是其他搜索技术？</router-link></li><li><router-link to="#_1-1-5-总结">1.1.5.总结</router-link></li></ul></li><li><router-link to="#_1-2-倒排索引">1.2.倒排索引</router-link><ul><li><router-link to="#_1-2-1-正向索引">1.2.1.正向索引</router-link></li><li><router-link to="#_1-2-2-倒排索引">1.2.2.倒排索引</router-link></li><li><router-link to="#_1-2-3-正向和倒排">1.2.3.正向和倒排</router-link></li></ul></li><li><router-link to="#_1-3-es-的一些概念">1.3.es 的一些概念</router-link><ul><li><router-link to="#_1-3-1-文档和字段">1.3.1.文档和字段</router-link></li><li><router-link to="#_1-3-2-索引和映射">1.3.2.索引和映射</router-link></li><li><router-link to="#_1-3-3-mysql-与-elasticsearch">1.3.3.mysql 与 elasticsearch</router-link></li></ul></li><li><router-link to="#_1-4-安装-es、kibana">1.4.安装 es、kibana</router-link><ul><li><router-link to="#_1-4-1-安装">1.4.1.安装</router-link></li><li><router-link to="#_1-4-2-分词器">1.4.2.分词器</router-link></li><li><router-link to="#_1-4-3-总结">1.4.3.总结</router-link></li></ul></li><li><router-link to="#_2-1-mapping-映射属性">2.1.mapping 映射属性</router-link></li><li><router-link to="#_2-2-索引库的-crud">2.2.索引库的 CRUD</router-link><ul><li><router-link to="#_2-2-1-创建索引库和映射">2.2.1.创建索引库和映射</router-link></li><li><router-link to="#_2-2-2-查询索引库">2.2.2.查询索引库</router-link></li><li><router-link to="#_2-2-3-修改索引库">2.2.3.修改索引库</router-link></li><li><router-link to="#_2-2-4-删除索引库">2.2.4.删除索引库</router-link></li><li><router-link to="#_2-2-5-总结">2.2.5.总结</router-link></li></ul></li><li><router-link to="#_3-1-新增文档">3.1.新增文档</router-link></li><li><router-link to="#_3-2-查询文档">3.2.查询文档</router-link></li><li><router-link to="#_3-3-删除文档">3.3.删除文档</router-link></li><li><router-link to="#_3-4-修改文档">3.4.修改文档</router-link><ul><li><router-link to="#_3-4-1-全量修改">3.4.1.全量修改</router-link></li><li><router-link to="#_3-4-2-增量修改">3.4.2.增量修改</router-link></li></ul></li><li><router-link to="#_3-5-总结">3.5.总结</router-link></li><li><router-link to="#_4-0-导入-demo-工程">4.0.导入 Demo 工程</router-link><ul><li><router-link to="#_4-0-1-导入数据">4.0.1.导入数据</router-link></li><li><router-link to="#_4-0-2-导入项目">4.0.2.导入项目</router-link></li><li><router-link to="#_4-0-3-mapping-映射分析">4.0.3.mapping 映射分析</router-link></li><li><router-link to="#_4-0-4-初始化-restclient">4.0.4.初始化 RestClient</router-link></li></ul></li><li><router-link to="#_4-1-创建索引库">4.1.创建索引库</router-link><ul><li><router-link to="#_4-1-1-代码解读">4.1.1.代码解读</router-link></li><li><router-link to="#_4-1-2-完整示例">4.1.2.完整示例</router-link></li></ul></li><li><router-link to="#_4-2-删除索引库">4.2.删除索引库</router-link></li><li><router-link to="#_4-3-判断索引库是否存在">4.3.判断索引库是否存在</router-link></li><li><router-link to="#_4-4-总结">4.4.总结</router-link></li><li><router-link to="#_5-1-新增文档">5.1.新增文档</router-link><ul><li><router-link to="#_5-1-1-索引库实体类">5.1.1.索引库实体类</router-link></li><li><router-link to="#_5-1-2-语法说明">5.1.2.语法说明</router-link></li><li><router-link to="#_5-1-3-完整代码">5.1.3.完整代码</router-link></li></ul></li><li><router-link to="#_5-2-查询文档">5.2.查询文档</router-link><ul><li><router-link to="#_5-2-1-语法说明">5.2.1.语法说明</router-link></li><li><router-link to="#_5-2-2-完整代码">5.2.2.完整代码</router-link></li></ul></li><li><router-link to="#_5-3-删除文档">5.3.删除文档</router-link></li><li><router-link to="#_5-4-修改文档">5.4.修改文档</router-link><ul><li><router-link to="#_5-4-1-语法说明">5.4.1.语法说明</router-link></li><li><router-link to="#_5-4-2-完整代码">5.4.2.完整代码</router-link></li></ul></li><li><router-link to="#_5-5-批量导入文档">5.5.批量导入文档</router-link><ul><li><router-link to="#_5-5-1-语法说明">5.5.1.语法说明</router-link></li><li><router-link to="#_5-5-2-完整代码">5.5.2.完整代码</router-link></li></ul></li><li><router-link to="#_5-6-小结">5.6.小结</router-link></li></ul></nav>
<div class="custom-container tip"><p class="custom-container-title">Hi</p>
<p>elasticsearch 基础</p>
</div>
<h1 id="_0-学习目标" tabindex="-1"><a class="header-anchor" href="#_0-学习目标" aria-hidden="true">#</a> 0.学习目标</h1>
<h1 id="_1-初识-elasticsearch" tabindex="-1"><a class="header-anchor" href="#_1-初识-elasticsearch" aria-hidden="true">#</a> 1.初识 elasticsearch</h1>
<h2 id="_1-1-了解-es" tabindex="-1"><a class="header-anchor" href="#_1-1-了解-es" aria-hidden="true">#</a> 1.1.了解 ES</h2>
<h3 id="_1-1-1-elasticsearch-的作用" tabindex="-1"><a class="header-anchor" href="#_1-1-1-elasticsearch-的作用" aria-hidden="true">#</a> 1.1.1.elasticsearch 的作用</h3>
<p>elasticsearch 是一款非常强大的开源搜索引擎，具备非常多强大功能，可以帮助我们从海量数据中快速找到需要的内容</p>
<p>例如：</p>
<ul>
<li>
<p>在 GitHub 搜索代码</p>
<p><img src="@source/notes/microservices/01/day05-Elasticsearch01/assets/image-20210720193623245.png" alt="image-20210720193623245"></p>
</li>
<li>
<p>在电商网站搜索商品</p>
<p><img src="@source/notes/microservices/01/day05-Elasticsearch01/assets/image-20210720193633483.png" alt="image-20210720193633483"></p>
</li>
<li>
<p>在百度搜索答案</p>
<p><img src="@source/notes/microservices/01/day05-Elasticsearch01/assets/image-20210720193641907.png" alt="image-20210720193641907"></p>
</li>
<li>
<p>在打车软件搜索附近的车</p>
<p><img src="@source/notes/microservices/01/day05-Elasticsearch01/assets/image-20210720193648044.png" alt="image-20210720193648044"></p>
</li>
</ul>
<h3 id="_1-1-2-elk-技术栈" tabindex="-1"><a class="header-anchor" href="#_1-1-2-elk-技术栈" aria-hidden="true">#</a> 1.1.2.ELK 技术栈</h3>
<p>elasticsearch 结合 kibana、Logstash、Beats，也就是 elastic stack（ELK）。被广泛应用在日志数据分析、实时监控等领域：</p>
<p><img src="@source/notes/microservices/01/day05-Elasticsearch01/assets/image-20210720194008781.png" alt="image-20210720194008781"></p>
<p>而 elasticsearch 是 elastic stack 的核心，负责存储、搜索、分析数据。</p>
<p><img src="@source/notes/microservices/01/day05-Elasticsearch01/assets/image-20210720194230265.png" alt="image-20210720194230265"></p>
<h3 id="_1-1-3-elasticsearch-和-lucene" tabindex="-1"><a class="header-anchor" href="#_1-1-3-elasticsearch-和-lucene" aria-hidden="true">#</a> 1.1.3.elasticsearch 和 lucene</h3>
<p>elasticsearch 底层是基于<strong>lucene</strong>来实现的。</p>
<p><strong>Lucene</strong>是一个 Java 语言的搜索引擎类库，是 Apache 公司的顶级项目，由 DougCutting 于 1999 年研发。官网地址：https://lucene.apache.org/ 。</p>
<p><img src="@source/notes/microservices/01/day05-Elasticsearch01/assets/image-20210720194547780.png" alt="image-20210720194547780"></p>
...
<p><img src="@source/notes/microservices/01/day05-Elasticsearch01/assets/image-20210720195001221.png" alt="image-20210720195001221"></p>
<h3 id="_1-1-4-为什么不是其他搜索技术" tabindex="-1"><a class="header-anchor" href="#_1-1-4-为什么不是其他搜索技术" aria-hidden="true">#</a> 1.1.4.为什么不是其他搜索技术？</h3>
<p>目前比较知名的搜索引擎技术排名：</p>
<p><img src="@source/notes/microservices/01/day05-Elasticsearch01/assets/image-20210720195142535.png" alt="image-20210720195142535"></p>
<p>虽然在早期，Apache Solr 是最主要的搜索引擎技术，但随着发展 elasticsearch 已经渐渐超越了 Solr，独占鳌头：</p>
<p><img src="@source/notes/microservices/01/day05-Elasticsearch01/assets/image-20210720195306484.png" alt="image-20210720195306484"></p>
<h3 id="_1-1-5-总结" tabindex="-1"><a class="header-anchor" href="#_1-1-5-总结" aria-hidden="true">#</a> 1.1.5.总结</h3>
<p>什么是 elasticsearch？</p>
<ul>
<li>一个开源的分布式搜索引擎，可以用来实现搜索、日志统计、分析、系统监控等功能</li>
</ul>
<p>什么是 elastic stack（ELK）？</p>
<ul>
...
<h2 id="_1-2-倒排索引" tabindex="-1"><a class="header-anchor" href="#_1-2-倒排索引" aria-hidden="true">#</a> 1.2.倒排索引</h2>
<p>倒排索引的概念是基于 MySQL 这样的正向索引而言的。</p>
<h3 id="_1-2-1-正向索引" tabindex="-1"><a class="header-anchor" href="#_1-2-1-正向索引" aria-hidden="true">#</a> 1.2.1.正向索引</h3>
<p>那么什么是正向索引呢？例如给下表（tb_goods）中的 id 创建索引：</p>
<p><img src="@source/notes/microservices/01/day05-Elasticsearch01/assets/image-20210720195531539.png" alt="image-20210720195531539"></p>
<p>如果是根据 id 查询，那么直接走索引，查询速度非常快。</p>
<p>但如果是基于 title 做模糊查询，只能是逐行扫描数据，流程如下：</p>
<p>1）用户搜索数据，条件是 title 符合<code v-pre>&quot;%手机%&quot;</code></p>
<p>2）逐行获取数据，比如 id 为 1 的数据</p>
<p>3）判断数据中的 title 是否符合用户搜索条件</p>
<p>4）如果符合则放入结果集，不符合则丢弃。回到步骤 1</p>
<p>逐行扫描，也就是全表扫描，随着数据量增加，其查询效率也会越来越低。当数据量达到数百万时，就是一场灾难。</p>
<h3 id="_1-2-2-倒排索引" tabindex="-1"><a class="header-anchor" href="#_1-2-2-倒排索引" aria-hidden="true">#</a> 1.2.2.倒排索引</h3>
<p>倒排索引中有两个非常重要的概念：</p>
<ul>
<li>文档（<code v-pre>Document</code>）：用来搜索的数据，其中的每一条数据就是一个文档。例如一个网页、一个商品信息</li>
<li>词条（<code v-pre>Term</code>）：对文档数据或用户搜索数据，利用某种算法分词，得到的具备含义的词语就是词条。例如：我是中国人，就可以分为：我、是、中国人、中国、国人这样的几个词条</li>
</ul>
...
<p>如图：</p>
<p><img src="@source/notes/microservices/01/day05-Elasticsearch01/assets/image-20210720200457207.png" alt="image-20210720200457207"></p>
<p>倒排索引的<strong>搜索流程</strong>如下（以搜索&quot;华为手机&quot;为例）：</p>
<p>1）用户输入条件<code v-pre>&quot;华为手机&quot;</code>进行搜索。</p>
<p>2）对用户输入内容<strong>分词</strong>，得到词条：<code v-pre>华为</code>、<code v-pre>手机</code>。</p>
<p>3）拿着词条在倒排索引中查找，可以得到包含词条的文档 id：1、2、3。</p>
<p>4）拿着文档 id 到正向索引中查找具体文档。</p>
<p>如图：</p>
<p><img src="@source/notes/microservices/01/day05-Elasticsearch01/assets/image-20210720201115192.png" alt="image-20210720201115192"></p>
<p>虽然要先查询倒排索引，再查询倒排索引，但是无论是词条、还是文档 id 都建立了索引，查询速度非常快！无需全表扫描。</p>
<h3 id="_1-2-3-正向和倒排" tabindex="-1"><a class="header-anchor" href="#_1-2-3-正向和倒排" aria-hidden="true">#</a> 1.2.3.正向和倒排</h3>
...
<li>
<p>而<strong>倒排索引</strong>则相反，是先找到用户要搜索的词条，根据词条得到保护词条的文档的 id，然后根据 id 获取文档。是<strong>根据词条找文档的过程</strong>。</p>
</li>
</ul>
<p>是不是恰好反过来了？</p>
<p>那么两者方式的优缺点是什么呢？</p>
...
<h2 id="_1-3-es-的一些概念" tabindex="-1"><a class="header-anchor" href="#_1-3-es-的一些概念" aria-hidden="true">#</a> 1.3.es 的一些概念</h2>
<p>elasticsearch 中有很多独有的概念，与 mysql 中略有差别，但也有相似之处。</p>
<h3 id="_1-3-1-文档和字段" tabindex="-1"><a class="header-anchor" href="#_1-3-1-文档和字段" aria-hidden="true">#</a> 1.3.1.文档和字段</h3>
<p>elasticsearch 是面向**文档（Document）**存储的，可以是数据库中的一条商品数据，一个订单信息。文档数据会被序列化为 json 格式后存储在 elasticsearch 中：</p>
<p><img src="@source/notes/microservices/01/day05-Elasticsearch01/assets/image-20210720202707797.png" alt="image-20210720202707797"></p>
<p>而 Json 文档中往往包含很多的<strong>字段（Field）</strong>，类似于数据库中的列。</p>
<h3 id="_1-3-2-索引和映射" tabindex="-1"><a class="header-anchor" href="#_1-3-2-索引和映射" aria-hidden="true">#</a> 1.3.2.索引和映射</h3>
...
<p><img src="@source/notes/microservices/01/day05-Elasticsearch01/assets/image-20210720203022172.png" alt="image-20210720203022172"></p>
<p>因此，我们可以把索引当做是数据库中的表。</p>
<p>数据库的表会有约束信息，用来定义表的结构、字段的名称、类型等信息。因此，索引库中就有<strong>映射（mapping）</strong>，是索引中文档的字段约束信息，类似表的结构约束。</p>
<h3 id="_1-3-3-mysql-与-elasticsearch" tabindex="-1"><a class="header-anchor" href="#_1-3-3-mysql-与-elasticsearch" aria-hidden="true">#</a> 1.3.3.mysql 与 elasticsearch</h3>
...
<p>是不是说，我们学习了 elasticsearch 就不再需要 mysql 了呢？</p>
...
<p><img src="@source/notes/microservices/01/day05-Elasticsearch01/assets/image-20210720203534945.png" alt="image-20210720203534945"></p>
<h2 id="_1-4-安装-es、kibana" tabindex="-1"><a class="header-anchor" href="#_1-4-安装-es、kibana" aria-hidden="true">#</a> 1.4.安装 es、kibana</h2>
<h3 id="_1-4-1-安装" tabindex="-1"><a class="header-anchor" href="#_1-4-1-安装" aria-hidden="true">#</a> 1.4.1.安装</h3>
<p>参考课前资料：</p>
<p><img src="@source/notes/microservices/01/day05-Elasticsearch01/assets/image-20210720203805350.png" alt="image-20210720203805350"></p>
<h3 id="_1-4-2-分词器" tabindex="-1"><a class="header-anchor" href="#_1-4-2-分词器" aria-hidden="true">#</a> 1.4.2.分词器</h3>
<p>参考课前资料：</p>
<p><img src="@source/notes/microservices/01/day05-Elasticsearch01/assets/image-20210720203805350.png" alt="image-20210720203805350"></p>
<h3 id="_1-4-3-总结" tabindex="-1"><a class="header-anchor" href="#_1-4-3-总结" aria-hidden="true">#</a> 1.4.3.总结</h3>
<p>分词器的作用是什么？</p>
<ul>
<li>创建倒排索引时对文档分词</li>
...
<p>IK 分词器如何拓展词条？如何停用词条？</p>
<ul>
<li>利用 config 目录的 IkAnalyzer.cfg.xml 文件添加拓展词典和停用词典</li>
<li>在词典中添加拓展词条或者停用词条</li>
</ul>
<h1 id="_2-索引库操作" tabindex="-1"><a class="header-anchor" href="#_2-索引库操作" aria-hidden="true">#</a> 2.索引库操作</h1>
<p>索引库就类似数据库表，mapping 映射就类似表的结构。</p>
<p>我们要向 es 中存储数据，必须先创建“库”和“表”。</p>
<h2 id="_2-1-mapping-映射属性" tabindex="-1"><a class="header-anchor" href="#_2-1-mapping-映射属性" aria-hidden="true">#</a> 2.1.mapping 映射属性</h2>
...
<h2 id="_2-2-索引库的-crud" tabindex="-1"><a class="header-anchor" href="#_2-2-索引库的-crud" aria-hidden="true">#</a> 2.2.索引库的 CRUD</h2>
<p>这里我们统一使用 Kibana 编写 DSL 的方式来演示。</p>
<h3 id="_2-2-1-创建索引库和映射" tabindex="-1"><a class="header-anchor" href="#_2-2-1-创建索引库和映射" aria-hidden="true">#</a> 2.2.1.创建索引库和映射</h3>
<h4 id="基本语法" tabindex="-1"><a class="header-anchor" href="#基本语法" aria-hidden="true">#</a> 基本语法：</h4>
<ul>
<li>请求方式：PUT</li>
...
<p>格式：</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>PUT /索引库名称
<span class="token punctuation">{</span>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>PUT /heima
<span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-2-2-查询索引库" tabindex="-1"><a class="header-anchor" href="#_2-2-2-查询索引库" aria-hidden="true">#</a> 2.2.2.查询索引库</h3>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>GET /索引库名
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><strong>示例</strong>：</p>
<p><img src="@source/notes/microservices/01/day05-Elasticsearch01/assets/image-20210720211019329.png" alt="image-20210720211019329"></p>
<h3 id="_2-2-3-修改索引库" tabindex="-1"><a class="header-anchor" href="#_2-2-3-修改索引库" aria-hidden="true">#</a> 2.2.3.修改索引库</h3>
...
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>PUT /索引库名/_mapping
<span class="token punctuation">{</span>
  <span class="token property">"properties"</span><span class="token operator">:</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>示例</strong>：</p>
<p><img src="@source/notes/microservices/01/day05-Elasticsearch01/assets/image-20210720212357390.png" alt="image-20210720212357390"></p>
<h3 id="_2-2-4-删除索引库" tabindex="-1"><a class="header-anchor" href="#_2-2-4-删除索引库" aria-hidden="true">#</a> 2.2.4.删除索引库</h3>
...
<p><strong>格式：</strong></p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>DELETE /索引库名
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>在 kibana 中测试：</p>
<p><img src="@source/notes/microservices/01/day05-Elasticsearch01/assets/image-20210720212123420.png" alt="image-20210720212123420"></p>
<h3 id="_2-2-5-总结" tabindex="-1"><a class="header-anchor" href="#_2-2-5-总结" aria-hidden="true">#</a> 2.2.5.总结</h3>
<p>索引库操作有哪些？</p>
<ul>
...
<h1 id="_3-文档操作" tabindex="-1"><a class="header-anchor" href="#_3-文档操作" aria-hidden="true">#</a> 3.文档操作</h1>
<h2 id="_3-1-新增文档" tabindex="-1"><a class="header-anchor" href="#_3-1-新增文档" aria-hidden="true">#</a> 3.1.新增文档</h2>
<p><strong>语法：</strong></p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>POST /索引库名/_doc/文档id
<span class="token punctuation">{</span>
...
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>POST /heima/_doc/<span class="token number">1</span>
<span class="token punctuation">{</span>
    <span class="token property">"info"</span><span class="token operator">:</span> <span class="token string">"黑马程序员Java讲师"</span><span class="token punctuation">,</span>
    <span class="token property">"email"</span><span class="token operator">:</span> <span class="token string">"zy@itcast.cn"</span><span class="token punctuation">,</span>
    <span class="token property">"name"</span><span class="token operator">:</span> <span class="token punctuation">{</span>
...
<p><img src="@source/notes/microservices/01/day05-Elasticsearch01/assets/image-20210720212933362.png" alt="image-20210720212933362"></p>
<h2 id="_3-2-查询文档" tabindex="-1"><a class="header-anchor" href="#_3-2-查询文档" aria-hidden="true">#</a> 3.2.查询文档</h2>
<p>根据 rest 风格，新增是 post，查询应该是 get，不过查询一般都需要条件，这里我们把文档 id 带上。</p>
<p><strong>语法：</strong></p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>GET /<span class="token punctuation">{</span>索引库名称<span class="token punctuation">}</span>/_doc/<span class="token punctuation">{</span>id<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><strong>通过 kibana 查看数据：</strong></p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token constant">GET</span> <span class="token operator">/</span> heima <span class="token operator">/</span> _doc <span class="token operator">/</span> <span class="token number">1</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><strong>查看结果：</strong></p>
<p><img src="@source/notes/microservices/01/day05-Elasticsearch01/assets/image-20210720213345003.png" alt="image-20210720213345003"></p>
<h2 id="_3-3-删除文档" tabindex="-1"><a class="header-anchor" href="#_3-3-删除文档" aria-hidden="true">#</a> 3.3.删除文档</h2>
<p>删除使用 DELETE 请求，同样，需要根据 id 进行删除：</p>
<p><strong>语法：</strong></p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token constant">DELETE</span> <span class="token operator">/</span> <span class="token punctuation">{</span> 索引库名 <span class="token punctuation">}</span> <span class="token operator">/</span> _doc <span class="token operator">/</span> id值
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><strong>示例：</strong></p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code># 根据id删除数据
...
<p><img src="@source/notes/microservices/01/day05-Elasticsearch01/assets/image-20210720213634918.png" alt="image-20210720213634918"></p>
<h2 id="_3-4-修改文档" tabindex="-1"><a class="header-anchor" href="#_3-4-修改文档" aria-hidden="true">#</a> 3.4.修改文档</h2>
<p>修改有两种方式：</p>
<ul>
<li>全量修改：直接覆盖原来的文档</li>
<li>增量修改：修改文档中的部分字段</li>
</ul>
<h3 id="_3-4-1-全量修改" tabindex="-1"><a class="header-anchor" href="#_3-4-1-全量修改" aria-hidden="true">#</a> 3.4.1.全量修改</h3>
<p>全量修改是覆盖原来的文档，其本质是：</p>
<ul>
<li>根据指定的 id 删除文档</li>
<li>新增一个相同 id 的文档</li>
</ul>
<p><strong>注意</strong>：<code v-pre>如果根据id删除时，id不存在，第二步的新增也会执行，也就从修改变成了新增操作了。</code></p>
<p><strong>语法：</strong></p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>PUT /<span class="token punctuation">{</span>索引库名<span class="token punctuation">}</span>/_doc/文档id
<span class="token punctuation">{</span>
    <span class="token property">"字段1"</span><span class="token operator">:</span> <span class="token string">"值1"</span><span class="token punctuation">,</span>
    <span class="token property">"字段2"</span><span class="token operator">:</span> <span class="token string">"值2"</span><span class="token punctuation">,</span>
    <span class="token comment">// ... 略</span>
...
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>PUT /heima/_doc/<span class="token number">1</span>
<span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-4-2-增量修改" tabindex="-1"><a class="header-anchor" href="#_3-4-2-增量修改" aria-hidden="true">#</a> 3.4.2.增量修改</h3>
<p>增量修改是只修改指定 id 匹配的文档中的部分字段。</p>
<p><strong>语法：</strong></p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>POST /<span class="token punctuation">{</span>索引库名<span class="token punctuation">}</span>/_update/文档id
<span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>示例：</strong></p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>POST /heima/_update/<span class="token number">1</span>
<span class="token punctuation">{</span>
  <span class="token property">"doc"</span><span class="token operator">:</span> <span class="token punctuation">{</span>
    <span class="token property">"email"</span><span class="token operator">:</span> <span class="token string">"ZhaoYun@itcast.cn"</span>
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3-5-总结" tabindex="-1"><a class="header-anchor" href="#_3-5-总结" aria-hidden="true">#</a> 3.5.总结</h2>
<p>文档操作有哪些？</p>
<ul>
<li>创建文档：POST /{索引库名}/_doc/文档 id { json 文档 }</li>
<li>查询文档：GET /{索引库名}/_doc/文档 id</li>
<li>删除文档：DELETE /{索引库名}/_doc/文档 id</li>
<li>修改文档：
<ul>
<li>全量修改：PUT /{索引库名}/_doc/文档 id { json 文档 }</li>
<li>增量修改：POST /{索引库名}/_update/文档 id { &quot;doc&quot;: {字段}}</li>
</ul>
</li>
</ul>
<h1 id="_4-restapi" tabindex="-1"><a class="header-anchor" href="#_4-restapi" aria-hidden="true">#</a> 4.RestAPI</h1>
<p>ES 官方提供了各种不同语言的客户端，用来操作 ES。这些客户端的本质就是组装 DSL 语句，通过 http 请求发送给 ES。官方文档地址：https://www.elastic.co/guide/en/elasticsearch/client/index.html</p>
<p>其中的 Java Rest Client 又包括两种：</p>
<ul>
<li>Java Low Level Rest Client</li>
<li>Java High Level Rest Client</li>
</ul>
<p><img src="@source/notes/microservices/01/day05-Elasticsearch01/assets/image-20210720214555863.png" alt="image-20210720214555863"></p>
<p>我们学习的是 Java HighLevel Rest Client 客户端 API</p>
<h2 id="_4-0-导入-demo-工程" tabindex="-1"><a class="header-anchor" href="#_4-0-导入-demo-工程" aria-hidden="true">#</a> 4.0.导入 Demo 工程</h2>
<h3 id="_4-0-1-导入数据" tabindex="-1"><a class="header-anchor" href="#_4-0-1-导入数据" aria-hidden="true">#</a> 4.0.1.导入数据</h3>
<p>首先导入课前资料提供的数据库数据：</p>
<p><img src="@source/notes/microservices/01/day05-Elasticsearch01/assets/image-20210720220400297.png" alt="image-20210720220400297"></p>
<p>数据结构如下：</p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token keyword">CREATE</span> <span class="token keyword">TABLE</span> <span class="token identifier"><span class="token punctuation">`</span>tb_hotel<span class="token punctuation">`</span></span> <span class="token punctuation">(</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-0-2-导入项目" tabindex="-1"><a class="header-anchor" href="#_4-0-2-导入项目" aria-hidden="true">#</a> 4.0.2.导入项目</h3>
<p>然后导入课前资料提供的项目:</p>
<p><img src="@source/notes/microservices/01/day05-Elasticsearch01/assets/image-20210720220503411.png" alt="image-20210720220503411"></p>
<p>项目结构如图：</p>
<p><img src="@source/notes/microservices/01/day05-Elasticsearch01/assets/image-20210720220647541.png" alt="image-20210720220647541"></p>
<h3 id="_4-0-3-mapping-映射分析" tabindex="-1"><a class="header-anchor" href="#_4-0-3-mapping-映射分析" aria-hidden="true">#</a> 4.0.3.mapping 映射分析</h3>
...
<p>来看下酒店数据的索引库结构:</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>PUT /hotel
<span class="token punctuation">{</span>
  <span class="token property">"mappings"</span><span class="token operator">:</span> <span class="token punctuation">{</span>
    <span class="token property">"properties"</span><span class="token operator">:</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>几个特殊字段说明：</p>
<ul>
<li>location：地理坐标，里面包含精度、纬度</li>
<li>all：一个组合字段，其目的是将多字段的值 利用 copy_to 合并，提供给用户搜索</li>
</ul>
<p>地理坐标说明：</p>
<p><img src="@source/notes/microservices/01/day05-Elasticsearch01/assets/image-20210720222110126.png" alt="image-20210720222110126"></p>
<p>copy_to 说明：</p>
<p><img src="@source/notes/microservices/01/day05-Elasticsearch01/assets/image-20210720222221516.png" alt="image-20210720222221516"></p>
<h3 id="_4-0-4-初始化-restclient" tabindex="-1"><a class="header-anchor" href="#_4-0-4-初始化-restclient" aria-hidden="true">#</a> 4.0.4.初始化 RestClient</h3>
<p>在 elasticsearch 提供的 API 中，与 elasticsearch 一切交互都封装在一个名为 RestHighLevelClient 的类中，必须先完成这个对象的初始化，建立与 elasticsearch 的连接。</p>
<p>分为三步：</p>
<p>1）引入 es 的 RestHighLevelClient 依赖：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2）因为 SpringBoot 默认的 ES 版本是 7.6.2，所以我们需要覆盖默认的 ES 版本：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>3）初始化 RestHighLevelClient：</p>
<p>初始化的代码如下：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这里为了单元测试方便，我们创建一个测试类 HotelIndexTest，然后将初始化的代码编写在@BeforeEach 方法中：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">cn<span class="token punctuation">.</span>itcast<span class="token punctuation">.</span>hotel</span><span class="token punctuation">;</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">HotelIndexTest</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_4-1-创建索引库" tabindex="-1"><a class="header-anchor" href="#_4-1-创建索引库" aria-hidden="true">#</a> 4.1.创建索引库</h2>
<h3 id="_4-1-1-代码解读" tabindex="-1"><a class="header-anchor" href="#_4-1-1-代码解读" aria-hidden="true">#</a> 4.1.1.代码解读</h3>
<p>创建索引库的 API 如下：</p>
<p><img src="@source/notes/microservices/01/day05-Elasticsearch01/assets/image-20210720223049408.png" alt="image-20210720223049408"></p>
<p>代码分为三步：</p>
<ul>
<li>1）创建 Request 对象。因为是创建索引库的操作，因此 Request 是 CreateIndexRequest。</li>
<li>2）添加请求参数，其实就是 DSL 的 JSON 参数部分。因为 json 字符串很长，这里是定义了静态字符串常量 MAPPING_TEMPLATE，让代码看起来更加优雅。</li>
<li>3）发送请求，client.indices()方法的返回值是 IndicesClient 类型，封装了所有与索引库操作有关的方法。</li>
</ul>
<h3 id="_4-1-2-完整示例" tabindex="-1"><a class="header-anchor" href="#_4-1-2-完整示例" aria-hidden="true">#</a> 4.1.2.完整示例</h3>
<p>在 hotel-demo 的 cn.itcast.hotel.constants 包下，创建一个类，定义 mapping 映射的 JSON 字符串常量：</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在 hotel-demo 中的 HotelIndexTest 测试类中，编写单元测试，实现创建索引：</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_4-2-删除索引库" tabindex="-1"><a class="header-anchor" href="#_4-2-删除索引库" aria-hidden="true">#</a> 4.2.删除索引库</h2>
<p>删除索引库的 DSL 语句非常简单：</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>DELETE /hotel
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>与创建索引库相比：</p>
<ul>
...
<ul>
<li>1）创建 Request 对象。这次是 DeleteIndexRequest 对象</li>
<li>2）准备参数。这里是无参</li>
<li>3）发送请求。改用 delete 方法</li>
</ul>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_4-3-判断索引库是否存在" tabindex="-1"><a class="header-anchor" href="#_4-3-判断索引库是否存在" aria-hidden="true">#</a> 4.3.判断索引库是否存在</h2>
<p>判断索引库是否存在，本质就是查询，对应的 DSL 是：</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>GET /hotel
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>因此与删除的 Java 代码流程是类似的。依然是三步走：</p>
<ul>
<li>1）创建 Request 对象。这次是 GetIndexRequest 对象</li>
<li>2）准备参数。这里是无参</li>
<li>3）发送请求。改用 exists 方法</li>
</ul>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_4-4-总结" tabindex="-1"><a class="header-anchor" href="#_4-4-总结" aria-hidden="true">#</a> 4.4.总结</h2>
<p>JavaRestClient 操作 elasticsearch 的流程基本类似。核心是 client.indices()方法来获取索引库的操作对象。</p>
<p>索引库操作的基本步骤：</p>
<ul>
<li>初始化 RestHighLevelClient</li>
<li>创建 XxxIndexRequest。XXX 是 Create、Get、Delete</li>
<li>准备 DSL（ Create 时需要，其它是无参）</li>
<li>发送请求。调用 RestHighLevelClient#indices().xxx()方法，xxx 是 create、exists、delete</li>
</ul>
<h1 id="_5-restclient-操作文档" tabindex="-1"><a class="header-anchor" href="#_5-restclient-操作文档" aria-hidden="true">#</a> 5.RestClient 操作文档</h1>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_5-1-新增文档" tabindex="-1"><a class="header-anchor" href="#_5-1-新增文档" aria-hidden="true">#</a> 5.1.新增文档</h2>
<p>我们要将数据库的酒店数据查询出来，写入 elasticsearch 中。</p>
<h3 id="_5-1-1-索引库实体类" tabindex="-1"><a class="header-anchor" href="#_5-1-1-索引库实体类" aria-hidden="true">#</a> 5.1.1.索引库实体类</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_5-1-2-语法说明" tabindex="-1"><a class="header-anchor" href="#_5-1-2-语法说明" aria-hidden="true">#</a> 5.1.2.语法说明</h3>
<p>新增文档的 DSL 语句如下：</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>POST /<span class="token punctuation">{</span>索引库名<span class="token punctuation">}</span>/_doc/<span class="token number">1</span>
<span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>对应的 java 代码如图：</p>
<p><img src="@source/notes/microservices/01/day05-Elasticsearch01/assets/image-20210720230027240.png" alt="image-20210720230027240"></p>
<p>可以看到与创建索引库类似，同样是三步走：</p>
<ul>
<li>1）创建 Request 对象</li>
<li>2）准备请求参数，也就是 DSL 中的 JSON 文档</li>
<li>3）发送请求</li>
</ul>
<p>变化的地方在于，这里直接使用 client.xxx()的 API，不再需要 client.indices()了。</p>
<h3 id="_5-1-3-完整代码" tabindex="-1"><a class="header-anchor" href="#_5-1-3-完整代码" aria-hidden="true">#</a> 5.1.3.完整代码</h3>
<p>我们导入酒店数据，基本流程一致，但是需要考虑几点变化：</p>
<ul>
<li>酒店数据来自于数据库，我们需要先查询出来，得到 hotel 对象</li>
<li>hotel 对象需要转为 HotelDoc 对象</li>
<li>HotelDoc 需要序列化为 json 格式</li>
</ul>
<p>因此，代码整体步骤如下：</p>
<ul>
<li>1）根据 id 查询酒店数据 Hotel</li>
<li>2）将 Hotel 封装为 HotelDoc</li>
<li>3）将 HotelDoc 序列化为 JSON</li>
<li>4）创建 IndexRequest，指定索引库名和 id</li>
<li>5）准备请求参数，也就是 JSON 文档</li>
<li>6）发送请求</li>
</ul>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_5-2-查询文档" tabindex="-1"><a class="header-anchor" href="#_5-2-查询文档" aria-hidden="true">#</a> 5.2.查询文档</h2>
<h3 id="_5-2-1-语法说明" tabindex="-1"><a class="header-anchor" href="#_5-2-1-语法说明" aria-hidden="true">#</a> 5.2.1.语法说明</h3>
<p>查询的 DSL 语句如下：</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>GET /hotel/_doc/<span class="token punctuation">{</span>id<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>非常简单，因此代码大概分两步：</p>
<ul>
<li>准备 Request 对象</li>
<li>发送请求</li>
</ul>
<p>不过查询的目的是得到结果，解析为 HotelDoc，因此难点是结果的解析。完整代码如下：</p>
<p><img src="@source/notes/microservices/01/day05-Elasticsearch01/assets/image-20210720230811674.png" alt="image-20210720230811674"></p>
<p>可以看到，结果是一个 JSON，其中文档放在一个<code v-pre>_source</code>属性中，因此解析就是拿到<code v-pre>_source</code>，反序列化为 Java 对象即可。</p>
<p>与之前类似，也是三步走：</p>
<ul>
<li>1）准备 Request 对象。这次是查询，所以是 GetRequest</li>
<li>2）发送请求，得到结果。因为是查询，这里调用 client.get()方法</li>
<li>3）解析结果，就是对 JSON 做反序列化</li>
</ul>
<h3 id="_5-2-2-完整代码" tabindex="-1"><a class="header-anchor" href="#_5-2-2-完整代码" aria-hidden="true">#</a> 5.2.2.完整代码</h3>
<p>在 hotel-demo 的 HotelDocumentTest 测试类中，编写单元测试：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_5-3-删除文档" tabindex="-1"><a class="header-anchor" href="#_5-3-删除文档" aria-hidden="true">#</a> 5.3.删除文档</h2>
<p>删除的 DSL 为是这样的：</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>DELETE /hotel/_doc/<span class="token punctuation">{</span>id<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>与查询相比，仅仅是请求方式从 DELETE 变成 GET，可以想象 Java 代码应该依然是三步走：</p>
<ul>
<li>1）准备 Request 对象，因为是删除，这次是 DeleteRequest 对象。要指定索引库名和 id</li>
<li>2）准备参数，无参</li>
<li>3）发送请求。因为是删除，所以是 client.delete()方法</li>
</ul>
<p>在 hotel-demo 的 HotelDocumentTest 测试类中，编写单元测试：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
...
<h3 id="_5-4-1-语法说明" tabindex="-1"><a class="header-anchor" href="#_5-4-1-语法说明" aria-hidden="true">#</a> 5.4.1.语法说明</h3>
<p>修改我们讲过两种方式：</p>
<ul>
<li>全量修改：本质是先根据 id 删除，再新增</li>
...
<p>代码示例如图：</p>
<p><img src="@source/notes/microservices/01/day05-Elasticsearch01/assets/image-20210720231040875.png" alt="image-20210720231040875"></p>
<p>与之前类似，也是三步走：</p>
<ul>
<li>1）准备 Request 对象。这次是修改，所以是 UpdateRequest</li>
<li>2）准备参数。也就是 JSON 文档，里面包含要修改的字段</li>
<li>3）更新文档。这里调用 client.update()方法</li>
</ul>
<h3 id="_5-4-2-完整代码" tabindex="-1"><a class="header-anchor" href="#_5-4-2-完整代码" aria-hidden="true">#</a> 5.4.2.完整代码</h3>
<p>在 hotel-demo 的 HotelDocumentTest 测试类中，编写单元测试：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_5-5-批量导入文档" tabindex="-1"><a class="header-anchor" href="#_5-5-批量导入文档" aria-hidden="true">#</a> 5.5.批量导入文档</h2>
<p>案例需求：利用 BulkRequest 批量将数据库数据导入到索引库中。</p>
<p>步骤如下：</p>
<ul>
<li>
<p>利用 mybatis-plus 查询酒店数据</p>
</li>
<li>
<p>将查询到的酒店数据（Hotel）转换为文档类型数据（HotelDoc）</p>
</li>
<li>
<p>利用 JavaRestClient 中的 BulkRequest 批处理，实现批量新增文档</p>
</li>
</ul>
<h3 id="_5-5-1-语法说明" tabindex="-1"><a class="header-anchor" href="#_5-5-1-语法说明" aria-hidden="true">#</a> 5.5.1.语法说明</h3>
<p>批量处理 BulkRequest，其本质就是将多个普通的 CRUD 请求组合在一起发送。</p>
<p>其中提供了一个 add 方法，用来添加其他请求：</p>
<p><img src="@source/notes/microservices/01/day05-Elasticsearch01/assets/image-20210720232105943.png" alt="image-20210720232105943"></p>
<p>可以看到，能添加的请求包括：</p>
<ul>
...
<p><img src="@source/notes/microservices/01/day05-Elasticsearch01/assets/image-20210720232431383.png" alt="image-20210720232431383"></p>
<p>其实还是三步走：</p>
<ul>
<li>1）创建 Request 对象。这里是 BulkRequest</li>
<li>2）准备参数。批处理的参数，就是其它 Request 对象，这里就是多个 IndexRequest</li>
<li>3）发起请求。这里是批处理，调用的方法为 client.bulk()方法</li>
</ul>
<p>我们在导入酒店数据时，将上述代码改造成 for 循环处理即可。</p>
<h3 id="_5-5-2-完整代码" tabindex="-1"><a class="header-anchor" href="#_5-5-2-完整代码" aria-hidden="true">#</a> 5.5.2.完整代码</h3>
<p>在 hotel-demo 的 HotelDocumentTest 测试类中，编写单元测试：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_5-6-小结" tabindex="-1"><a class="header-anchor" href="#_5-6-小结" aria-hidden="true">#</a> 5.6.小结</h2>
<p>文档操作的基本步骤：</p>
<ul>
<li>初始化 RestHighLevelClient</li>
<li>创建 XxxRequest。XXX 是 Index、Get、Update、Delete、Bulk</li>
<li>准备参数（Index、Update、Bulk 时需要）</li>
<li>发送请求。调用 RestHighLevelClient#.xxx()方法，xxx 是 index、get、update、delete、bulk</li>
<li>解析结果（Get 时需要）</li>
</ul>
</div></template>
