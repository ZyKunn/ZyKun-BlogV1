<template><div><h1 id="分布式搜索引擎-02-🥓" tabindex="-1"><a class="header-anchor" href="#分布式搜索引擎-02-🥓" aria-hidden="true">#</a> 分布式搜索引擎 02 🥓</h1>
<nav class="table-of-contents"><ul><li><router-link to="#_1-1-dsl-查询分类">1.1.DSL 查询分类</router-link></li><li><router-link to="#_1-2-全文检索查询">1.2.全文检索查询</router-link><ul><li><router-link to="#_1-2-1-使用场景">1.2.1.使用场景</router-link></li><li><router-link to="#_1-2-2-基本语法">1.2.2.基本语法</router-link></li><li><router-link to="#_1-2-3-示例">1.2.3.示例</router-link></li><li><router-link to="#_1-2-4-总结">1.2.4.总结</router-link></li></ul></li><li><router-link to="#_1-3-精准查询">1.3.精准查询</router-link><ul><li><router-link to="#_1-3-1-term-查询">1.3.1.term 查询</router-link></li><li><router-link to="#_1-3-2-range-查询">1.3.2.range 查询</router-link></li><li><router-link to="#_1-3-3-总结">1.3.3.总结</router-link></li></ul></li><li><router-link to="#_1-4-地理坐标查询">1.4.地理坐标查询</router-link><ul><li><router-link to="#_1-4-1-矩形范围查询">1.4.1.矩形范围查询</router-link></li><li><router-link to="#_1-4-2-附近查询">1.4.2.附近查询</router-link></li></ul></li><li><router-link to="#_1-5-复合查询">1.5.复合查询</router-link><ul><li><router-link to="#_1-5-1-相关性算分">1.5.1.相关性算分</router-link></li><li><router-link to="#_1-5-2-算分函数查询">1.5.2.算分函数查询</router-link></li><li><router-link to="#_1-5-3-布尔查询">1.5.3.布尔查询</router-link></li></ul></li><li><router-link to="#_2-1-排序">2.1.排序</router-link><ul><li><router-link to="#_2-1-1-普通字段排序">2.1.1.普通字段排序</router-link></li><li><router-link to="#_2-1-2-地理坐标排序">2.1.2.地理坐标排序</router-link></li></ul></li><li><router-link to="#_2-2-分页">2.2.分页</router-link><ul><li><router-link to="#_2-2-1-基本的分页">2.2.1.基本的分页</router-link></li><li><router-link to="#_2-2-2-深度分页问题">2.2.2.深度分页问题</router-link></li><li><router-link to="#_2-2-3-小结">2.2.3.小结</router-link></li></ul></li><li><router-link to="#_2-3-高亮">2.3.高亮</router-link><ul><li><router-link to="#_2-3-1-高亮原理">2.3.1.高亮原理</router-link></li><li><router-link to="#_2-3-2-实现高亮">2.3.2.实现高亮</router-link></li></ul></li><li><router-link to="#_2-4-总结">2.4.总结</router-link></li><li><router-link to="#_3-1-快速入门">3.1.快速入门</router-link><ul><li><router-link to="#_3-1-1-发起查询请求">3.1.1.发起查询请求</router-link></li><li><router-link to="#_3-1-2-解析响应">3.1.2.解析响应</router-link></li><li><router-link to="#_3-1-3-完整代码">3.1.3.完整代码</router-link></li><li><router-link to="#_3-1-4-小结">3.1.4.小结</router-link></li></ul></li><li><router-link to="#_3-2-match-查询">3.2.match 查询</router-link></li><li><router-link to="#_3-3-精确查询">3.3.精确查询</router-link></li><li><router-link to="#_3-4-布尔查询">3.4.布尔查询</router-link></li><li><router-link to="#_3-5-排序、分页">3.5.排序、分页</router-link></li><li><router-link to="#_3-6-高亮">3.6.高亮</router-link><ul><li><router-link to="#_3-6-1-高亮请求构建">3.6.1.高亮请求构建</router-link></li><li><router-link to="#_3-6-2-高亮结果解析">3.6.2.高亮结果解析</router-link></li></ul></li><li><router-link to="#_4-1-酒店搜索和分页">4.1.酒店搜索和分页</router-link><ul><li><router-link to="#_4-1-1-需求分析">4.1.1.需求分析</router-link></li><li><router-link to="#_4-1-2-定义实体类">4.1.2.定义实体类</router-link></li><li><router-link to="#_4-1-3-定义-controller">4.1.3.定义 controller</router-link></li><li><router-link to="#_4-1-4-实现搜索业务">4.1.4.实现搜索业务</router-link></li></ul></li><li><router-link to="#_4-2-酒店结果过滤">4.2.酒店结果过滤</router-link><ul><li><router-link to="#_4-2-1-需求分析">4.2.1.需求分析</router-link></li><li><router-link to="#_4-2-2-修改实体类">4.2.2.修改实体类</router-link></li><li><router-link to="#_4-2-3-修改搜索业务">4.2.3.修改搜索业务</router-link></li></ul></li><li><router-link to="#_4-3-我周边的酒店">4.3.我周边的酒店</router-link><ul><li><router-link to="#_4-3-1-需求分析">4.3.1.需求分析</router-link></li><li><router-link to="#_4-3-2-修改实体类">4.3.2.修改实体类</router-link></li><li><router-link to="#_4-3-3-距离排序-api">4.3.3.距离排序 API</router-link></li><li><router-link to="#_4-3-4-添加距离排序">4.3.4.添加距离排序</router-link></li><li><router-link to="#_4-3-5-排序距离显示">4.3.5.排序距离显示</router-link></li></ul></li><li><router-link to="#_4-4-酒店竞价排名">4.4.酒店竞价排名</router-link><ul><li><router-link to="#_4-4-1-需求分析">4.4.1.需求分析</router-link></li><li><router-link to="#_4-4-2-修改-hoteldoc-实体">4.4.2.修改 HotelDoc 实体</router-link></li><li><router-link to="#_4-4-3-添加广告标记">4.4.3.添加广告标记</router-link></li><li><router-link to="#_4-4-4-添加算分函数查询">4.4.4.添加算分函数查询</router-link></li></ul></li></ul></nav>
<p>在昨天的学习中，我们已经导入了大量数据到 elasticsearch 中，实现了 elasticsearch 的数据存储功能。但 elasticsearch 最擅长的还是搜索和数据分析。</p>
<p>所以今天，我们研究下 elasticsearch 的数据搜索功能。我们会分别使用<strong>DSL</strong>和<strong>RestClient</strong>实现搜索。</p>
<h1 id="_0-学习目标" tabindex="-1"><a class="header-anchor" href="#_0-学习目标" aria-hidden="true">#</a> 0.学习目标</h1>
<h1 id="_1-dsl-查询文档" tabindex="-1"><a class="header-anchor" href="#_1-dsl-查询文档" aria-hidden="true">#</a> 1.DSL 查询文档</h1>
<p>elasticsearch 的查询依然是基于 JSON 风格的 DSL 来实现的。</p>
<h2 id="_1-1-dsl-查询分类" tabindex="-1"><a class="header-anchor" href="#_1-1-dsl-查询分类" aria-hidden="true">#</a> 1.1.DSL 查询分类</h2>
<p>Elasticsearch 提供了基于 JSON 的 DSL（<a href="https://www.elastic.co/guide/en/elasticsearch/reference/current/query-dsl.html" target="_blank" rel="noopener noreferrer">Domain Specific Language<ExternalLinkIcon/></a>）来定义查询。常见的查询类型包括：</p>
<ul>
<li>
...
<p>查询的语法基本一致：</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>GET /indexName/_search
<span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>我们以查询所有为例，其中：</p>
<ul>
<li>查询类型为 match_all</li>
<li>没有查询条件</li>
</ul>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code><span class="token comment">// 查询所有</span>
...
<span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>其它查询无非就是<strong>查询类型</strong>、<strong>查询条件</strong>的变化。</p>
<h2 id="_1-2-全文检索查询" tabindex="-1"><a class="header-anchor" href="#_1-2-全文检索查询" aria-hidden="true">#</a> 1.2.全文检索查询</h2>
<h3 id="_1-2-1-使用场景" tabindex="-1"><a class="header-anchor" href="#_1-2-1-使用场景" aria-hidden="true">#</a> 1.2.1.使用场景</h3>
<p>全文检索查询的基本流程如下：</p>
<ul>
...
<p>例如京东：</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210721165326938.png" alt="image-20210721165326938"></p>
<p>因为是拿着词条去匹配，因此参与搜索的字段也必须是可分词的 text 类型的字段。</p>
<h3 id="_1-2-2-基本语法" tabindex="-1"><a class="header-anchor" href="#_1-2-2-基本语法" aria-hidden="true">#</a> 1.2.2.基本语法</h3>
<p>常见的全文检索查询包括：</p>
<ul>
...
<span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>mulit_match 语法如下：</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>GET /indexName/_search
<span class="token punctuation">{</span>
  <span class="token property">"query"</span><span class="token operator">:</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-2-3-示例" tabindex="-1"><a class="header-anchor" href="#_1-2-3-示例" aria-hidden="true">#</a> 1.2.3.示例</h3>
<p>match 查询示例：</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210721170455419.png" alt="image-20210721170455419"></p>
<p>multi_match 查询示例：</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210721170720691.png" alt="image-20210721170720691"></p>
...
<h3 id="_1-2-4-总结" tabindex="-1"><a class="header-anchor" href="#_1-2-4-总结" aria-hidden="true">#</a> 1.2.4.总结</h3>
<p>match 和 multi_match 的区别是什么？</p>
<ul>
<li>match：根据一个字段查询</li>
<li>multi_match：根据多个字段查询，参与查询字段越多，查询性能越差</li>
</ul>
<h2 id="_1-3-精准查询" tabindex="-1"><a class="header-anchor" href="#_1-3-精准查询" aria-hidden="true">#</a> 1.3.精准查询</h2>
<p>精确查询一般是查找 keyword、数值、日期、boolean 等类型字段。所以<strong>不会</strong>对搜索条件分词。常见的有：</p>
<ul>
<li>term：根据词条精确值查询</li>
<li>range：根据值的范围查询</li>
</ul>
<h3 id="_1-3-1-term-查询" tabindex="-1"><a class="header-anchor" href="#_1-3-1-term-查询" aria-hidden="true">#</a> 1.3.1.term 查询</h3>
<p>因为精确查询的字段搜是不分词的字段，因此查询的条件也必须是<strong>不分词</strong>的词条。查询时，用户输入的内容跟自动值完全匹配时才认为符合条件。如果用户输入的内容过多，反而搜索不到数据。</p>
<p>语法说明：</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code><span class="token comment">// term查询</span>
GET /indexName/_search
<span class="token punctuation">{</span>
  <span class="token property">"query"</span><span class="token operator">:</span> <span class="token punctuation">{</span>
...
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210721171655308.png" alt="image-20210721171655308"></p>
<p>但是，当我搜索的内容不是词条，而是多个词语形成的短语时，反而搜索不到：</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210721171838378.png" alt="image-20210721171838378"></p>
<h3 id="_1-3-2-range-查询" tabindex="-1"><a class="header-anchor" href="#_1-3-2-range-查询" aria-hidden="true">#</a> 1.3.2.range 查询</h3>
<p>范围查询，一般应用在对数值类型做范围过滤的时候。比如做价格范围过滤。</p>
<p>基本语法：</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code><span class="token comment">// range查询</span>
GET /indexName/_search
<span class="token punctuation">{</span>
  <span class="token property">"query"</span><span class="token operator">:</span> <span class="token punctuation">{</span>
...
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210721172307172.png" alt="image-20210721172307172"></p>
<h3 id="_1-3-3-总结" tabindex="-1"><a class="header-anchor" href="#_1-3-3-总结" aria-hidden="true">#</a> 1.3.3.总结</h3>
<p>精确查询常见的有哪些？</p>
<ul>
<li>term 查询：根据词条精确匹配，一般搜索 keyword 类型、数值类型、布尔类型、日期类型字段</li>
<li>range 查询：根据数值范围查询，可以是数值、日期的范围</li>
</ul>
<h2 id="_1-4-地理坐标查询" tabindex="-1"><a class="header-anchor" href="#_1-4-地理坐标查询" aria-hidden="true">#</a> 1.4.地理坐标查询</h2>
...
<p>附近的酒店：</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210721172645103.png" alt="image-20210721172645103"></p>
<p>附近的车：</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210721172654880.png" alt="image-20210721172654880"></p>
<h3 id="_1-4-1-矩形范围查询" tabindex="-1"><a class="header-anchor" href="#_1-4-1-矩形范围查询" aria-hidden="true">#</a> 1.4.1.矩形范围查询</h3>
<p>矩形范围查询，也就是 geo_bounding_box 查询，查询坐标落在某个矩形范围的所有文档：</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/DKV9HZbVS6.gif" alt="DKV9HZbVS6"></p>
<p>查询时，需要指定矩形的<strong>左上</strong>、<strong>右下</strong>两个点的坐标，然后画出一个矩形，落在该矩形内的都是符合条件的点。</p>
<p>语法如下：</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code><span class="token comment">// geo_bounding_box查询</span>
GET /indexName/_search
<span class="token punctuation">{</span>
  <span class="token property">"query"</span><span class="token operator">:</span> <span class="token punctuation">{</span>
...
<h3 id="_1-4-2-附近查询" tabindex="-1"><a class="header-anchor" href="#_1-4-2-附近查询" aria-hidden="true">#</a> 1.4.2.附近查询</h3>
<p>附近查询，也叫做距离查询（geo_distance）：查询到指定中心点小于某个距离值的所有文档。</p>
<p>换句话来说，在地图上找一个点作为圆心，以指定距离为半径，画一个圆，落在圆内的坐标都算符合条件：</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/vZrdKAh19C.gif" alt="vZrdKAh19C"></p>
<p>语法说明：</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code><span class="token comment">// geo_distance 查询</span>
GET /indexName/_search
<span class="token punctuation">{</span>
  <span class="token property">"query"</span><span class="token operator">:</span> <span class="token punctuation">{</span>
...
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210721175443234.png" alt="image-20210721175443234"></p>
<p>发现共有 47 家酒店。</p>
<p>然后把半径缩短到 3 公里：</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210721182031475.png" alt="image-20210721182031475"></p>
<p>可以发现，搜索到的酒店数量减少到了 5 家。</p>
<h2 id="_1-5-复合查询" tabindex="-1"><a class="header-anchor" href="#_1-5-复合查询" aria-hidden="true">#</a> 1.5.复合查询</h2>
...
<h3 id="_1-5-1-相关性算分" tabindex="-1"><a class="header-anchor" href="#_1-5-1-相关性算分" aria-hidden="true">#</a> 1.5.1.相关性算分</h3>
...
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code><span class="token punctuation">[</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">]</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在 elasticsearch 中，早期使用的打分算法是 TF-IDF 算法，公式如下：</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210721190152134.png" alt="image-20210721190152134"></p>
<p>在后来的 5.1 版本升级中，elasticsearch 将算法改进为 BM25 算法，公式如下：</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210721190416214.png" alt="image-20210721190416214"></p>
<p>TF-IDF 算法有一各缺陷，就是词条频率越高，文档得分也会越高，单个词条对文档影响较大。而 BM25 则会让单个词条的算分有一个上限，曲线更加平滑：</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210721190907320.png" alt="image-20210721190907320"></p>
<p>小结：elasticsearch 会根据词条和文档的相关度做打分，算法由两种：</p>
<ul>
<li>TF-IDF 算法</li>
<li>BM25 算法，elasticsearch5.1 版本后采用的算法</li>
</ul>
<h3 id="_1-5-2-算分函数查询" tabindex="-1"><a class="header-anchor" href="#_1-5-2-算分函数查询" aria-hidden="true">#</a> 1.5.2.算分函数查询</h3>
<p>根据相关度打分是比较合理的需求，但<strong>合理的不一定是产品经理需要</strong>的。</p>
<p>以百度为例，你搜索的结果中，并不是相关度越高排名越靠前，而是谁掏的钱多排名就越靠前。如图：</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210721191144560.png" alt="image-20210721191144560"></p>
<p>要想认为控制相关性算分，就需要利用 elasticsearch 中的 function score 查询了。</p>
<h4 id="_1-语法说明" tabindex="-1"><a class="header-anchor" href="#_1-语法说明" aria-hidden="true">#</a> 1）语法说明</h4>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210721191544750.png" alt="image-20210721191544750"></p>
<p>function score 查询中包含四部分内容：</p>
<ul>
<li><strong>原始查询</strong>条件：query 部分，基于这个条件搜索文档，并且基于 BM25 算法给文档打分，<strong>原始算分</strong>（query score)</li>
<li><strong>过滤条件</strong>：filter 部分，符合该条件的文档才会重新算分</li>
<li><strong>算分函数</strong>：符合 filter 条件的文档要根据这个函数做运算，得到的<strong>函数算分</strong>（function score），有四种函数
<ul>
...
<h4 id="_2-示例" tabindex="-1"><a class="header-anchor" href="#_2-示例" aria-hidden="true">#</a> 2）示例</h4>
...
<p>因此最终的 DSL 语句如下：</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>GET /hotel/_search
<span class="token punctuation">{</span>
  <span class="token property">"query"</span><span class="token operator">:</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>测试，在未添加算分函数时，如家得分如下：</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210721193152520.png" alt="image-20210721193152520"></p>
<p>添加了算分函数后，如家得分就提升了：</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210721193458182.png" alt="image-20210721193458182"></p>
...
<h3 id="_1-5-3-布尔查询" tabindex="-1"><a class="header-anchor" href="#_1-5-3-布尔查询" aria-hidden="true">#</a> 1.5.3.布尔查询</h3>
...
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210721193822848.png" alt="image-20210721193822848"></p>
...
<h4 id="_1-语法示例" tabindex="-1"><a class="header-anchor" href="#_1-语法示例" aria-hidden="true">#</a> 1）语法示例：</h4>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>GET /hotel/_search
<span class="token punctuation">{</span>
  <span class="token property">"query"</span><span class="token operator">:</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_2-示例-1" tabindex="-1"><a class="header-anchor" href="#_2-示例-1" aria-hidden="true">#</a> 2）示例</h4>
...
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210721194744183.png" alt="image-20210721194744183"></p>
<h4 id="_3-小结-1" tabindex="-1"><a class="header-anchor" href="#_3-小结-1" aria-hidden="true">#</a> 3）小结</h4>
<p>bool 查询有几种逻辑关系？</p>
<ul>
...
<h1 id="_2-搜索结果处理" tabindex="-1"><a class="header-anchor" href="#_2-搜索结果处理" aria-hidden="true">#</a> 2.搜索结果处理</h1>
<p>搜索的结果可以按照用户指定的方式去处理或展示。</p>
<h2 id="_2-1-排序" tabindex="-1"><a class="header-anchor" href="#_2-1-排序" aria-hidden="true">#</a> 2.1.排序</h2>
<p>elasticsearch 默认是根据相关度算分（_score）来排序，但是也支持自定义方式对搜索<a href="https://www.elastic.co/guide/en/elasticsearch/reference/current/sort-search-results.html" target="_blank" rel="noopener noreferrer">结果排序<ExternalLinkIcon/></a>。可以排序字段类型有：keyword 类型、数值类型、地理坐标类型、日期类型等。</p>
<h3 id="_2-1-1-普通字段排序" tabindex="-1"><a class="header-anchor" href="#_2-1-1-普通字段排序" aria-hidden="true">#</a> 2.1.1.普通字段排序</h3>
...
<span class="token punctuation">{</span>
  ...
  <span class="token punctuation">]</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>排序条件是一个数组，也就是可以写多个排序条件。按照声明的顺序，当第一个条件相等时，再按照第二个条件排序，以此类推</p>
<p><strong>示例</strong>：</p>
<p>需求描述：酒店数据按照用户评价（score)降序排序，评价相同的按照价格(price)升序排序</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210721195728306.png" alt="image-20210721195728306"></p>
<h3 id="_2-1-2-地理坐标排序" tabindex="-1"><a class="header-anchor" href="#_2-1-2-地理坐标排序" aria-hidden="true">#</a> 2.1.2.地理坐标排序</h3>
<p>地理坐标排序略有不同。</p>
...
<span class="token punctuation">{</span>
  ...
  <span class="token punctuation">]</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这个查询的含义是：</p>
<ul>
<li>指定一个坐标，作为目标点</li>
<li>计算每一个文档中，指定字段（必须是 geo_point 类型）的坐标 到目标点的距离是多少</li>
<li>根据距离排序</li>
</ul>
<p><strong>示例：</strong></p>
...
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210721200214690.png" alt="image-20210721200214690"></p>
<h2 id="_2-2-分页" tabindex="-1"><a class="header-anchor" href="#_2-2-分页" aria-hidden="true">#</a> 2.2.分页</h2>
<p>elasticsearch 默认情况下只返回 top10 的数据。而如果要查询更多数据就需要修改分页参数了。elasticsearch 中通过修改 from、size 参数来控制要返回的分页结果：</p>
<ul>
<li>from：从第几个文档开始</li>
<li>size：总共查询几个文档</li>
</ul>
<p>类似于 mysql 中的<code v-pre>limit ?, ?</code></p>
<h3 id="_2-2-1-基本的分页" tabindex="-1"><a class="header-anchor" href="#_2-2-1-基本的分页" aria-hidden="true">#</a> 2.2.1.基本的分页</h3>
<p>分页的基本语法如下：</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>GET /hotel/_search
<span class="token punctuation">{</span>
  <span class="token property">"query"</span><span class="token operator">:</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">]</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-2-2-深度分页问题" tabindex="-1"><a class="header-anchor" href="#_2-2-2-深度分页问题" aria-hidden="true">#</a> 2.2.2.深度分页问题</h3>
...
<span class="token punctuation">{</span>
  ...
  <span class="token punctuation">]</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这里是查询 990 开始的数据，也就是 第 990~第 1000 条 数据。</p>
<p>不过，elasticsearch 内部分页时，必须先查询 0~1000 条，然后截取其中的 990 ~ 1000 的这 10 条：</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210721200643029.png" alt="image-20210721200643029"></p>
<p>查询 TOP1000，如果 es 是单点模式，这并无太大影响。</p>
<p>但是 elasticsearch 将来一定是集群，例如我集群有 5 个节点，我要查询 TOP1000 的数据，并不是每个节点查询 200 条就可以了。</p>
<p>因为节点 A 的 TOP200，在另一个节点可能排到 10000 名以外了。</p>
<p>因此要想获取整个集群的 TOP1000，必须先查询出每个节点的 TOP1000，汇总结果后，重新排名，重新截取 TOP1000。</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210721201003229.png" alt="image-20210721201003229"></p>
<p>那如果我要查询 9900~10000 的数据呢？是不是要先查询 TOP10000 呢？那每个节点都要查询 10000 条？汇总到内存中？</p>
<p>当查询分页深度较大时，汇总数据过多，对内存和 CPU 会产生非常大的压力，因此 elasticsearch 会禁止 from+ size 超过 10000 的请求。</p>
<p>百度限制分页 76 页</p>
<p>京东限制分页 100 页</p>
<p>针对深度分页，ES 提供了两种解决方案，<a href="https://www.elastic.co/guide/en/elasticsearch/reference/current/paginate-search-results.html" target="_blank" rel="noopener noreferrer">官方文档<ExternalLinkIcon/></a>：</p>
<ul>
<li>search after：分页时需要排序，原理是从上一次的排序值开始，查询下一页数据。官方推荐使用的方式。</li>
<li>scroll：原理将排序后的文档 id 形成快照，保存在内存。官方已经不推荐使用。</li>
</ul>
<h3 id="_2-2-3-小结" tabindex="-1"><a class="header-anchor" href="#_2-2-3-小结" aria-hidden="true">#</a> 2.2.3.小结</h3>
<p>分页查询的常见实现方案以及优缺点：</p>
<ul>
<li>
<p><code v-pre>from + size</code>：</p>
<ul>
<li>优点：支持随机翻页</li>
...
<li>
<p><code v-pre>after search</code>：</p>
<ul>
...
<h2 id="_2-3-高亮" tabindex="-1"><a class="header-anchor" href="#_2-3-高亮" aria-hidden="true">#</a> 2.3.高亮</h2>
<h3 id="_2-3-1-高亮原理" tabindex="-1"><a class="header-anchor" href="#_2-3-1-高亮原理" aria-hidden="true">#</a> 2.3.1.高亮原理</h3>
<p>什么是高亮显示呢？</p>
<p>我们在百度，京东搜索时，关键字会变成红色，比较醒目，这叫高亮显示：</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210721202705030.png" alt="image-20210721202705030"></p>
<p>高亮显示的实现分为两步：</p>
<ul>
<li>1）给文档中的所有关键字都添加一个标签，例如<code v-pre>&lt;em&gt;</code>标签</li>
<li>2）页面给<code v-pre>&lt;em&gt;</code>标签编写 CSS 样式</li>
</ul>
<h3 id="_2-3-2-实现高亮" tabindex="-1"><a class="header-anchor" href="#_2-3-2-实现高亮" aria-hidden="true">#</a> 2.3.2.实现高亮</h3>
...
<p><strong>示例</strong>：</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210721203349633.png" alt="image-20210721203349633"></p>
<h2 id="_2-4-总结" tabindex="-1"><a class="header-anchor" href="#_2-4-总结" aria-hidden="true">#</a> 2.4.总结</h2>
...
<p>示例：</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210721203657850.png" alt="image-20210721203657850"></p>
<h1 id="_3-restclient-查询文档" tabindex="-1"><a class="header-anchor" href="#_3-restclient-查询文档" aria-hidden="true">#</a> 3.RestClient 查询文档</h1>
<p>文档的查询同样适用昨天学习的 RestHighLevelClient 对象，基本步骤包括：</p>
<ul>
<li>1）准备 Request 对象</li>
<li>2）准备请求参数</li>
<li>3）发起请求</li>
<li>4）解析响应</li>
</ul>
<h2 id="_3-1-快速入门" tabindex="-1"><a class="header-anchor" href="#_3-1-快速入门" aria-hidden="true">#</a> 3.1.快速入门</h2>
<p>我们以 match_all 查询为例</p>
<h3 id="_3-1-1-发起查询请求" tabindex="-1"><a class="header-anchor" href="#_3-1-1-发起查询请求" aria-hidden="true">#</a> 3.1.1.发起查询请求</h3>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210721203950559.png" alt="image-20210721203950559"></p>
<p>代码解读：</p>
<ul>
<li>
<p>第一步，创建<code v-pre>SearchRequest</code>对象，指定索引库名</p>
</li>
<li>
<p>第二步，利用<code v-pre>request.source()</code>构建 DSL，DSL 中可以包含查询、分页、排序、高亮等</p>
<ul>
<li><code v-pre>query()</code>：代表查询条件，利用<code v-pre>QueryBuilders.matchAllQuery()</code>构建一个 match_all 查询的 DSL</li>
</ul>
</li>
<li>
<p>第三步，利用 client.search()发送请求，得到响应</p>
</li>
</ul>
<p>这里关键的 API 有两个，一个是<code v-pre>request.source()</code>，其中包含了查询、排序、分页、高亮等所有功能：</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210721215640790.png" alt="image-20210721215640790"></p>
<p>另一个是<code v-pre>QueryBuilders</code>，其中包含 match、term、function_score、bool 等各种查询：</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210721215729236.png" alt="image-20210721215729236"></p>
<h3 id="_3-1-2-解析响应" tabindex="-1"><a class="header-anchor" href="#_3-1-2-解析响应" aria-hidden="true">#</a> 3.1.2.解析响应</h3>
<p>响应结果的解析：</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210721214221057.png" alt="image-20210721214221057"></p>
<p>elasticsearch 返回的结果是一个 JSON 字符串，结构包含：</p>
<ul>
<li><code v-pre>hits</code>：命中的结果
<ul>
<li><code v-pre>total</code>：总条数，其中的 value 是具体的总条数值</li>
<li><code v-pre>max_score</code>：所有结果中得分最高的文档的相关性算分</li>
<li><code v-pre>hits</code>：搜索结果的文档数组，其中的每个文档都是一个 json 对象
<ul>
<li><code v-pre>_source</code>：文档中的原始数据，也是 json 对象</li>
</ul>
</li>
</ul>
</li>
...
<ul>
<li><code v-pre>SearchHits</code>：通过 response.getHits()获取，就是 JSON 中的最外层的 hits，代表命中的结果
<ul>
<li><code v-pre>SearchHits#getTotalHits().value</code>：获取总条数信息</li>
<li><code v-pre>SearchHits#getHits()</code>：获取 SearchHit 数组，也就是文档数组
<ul>
<li><code v-pre>SearchHit#getSourceAsString()</code>：获取文档结果中的_source，也就是原始的 json 文档数据</li>
</ul>
</li>
</ul>
</li>
</ul>
<h3 id="_3-1-3-完整代码" tabindex="-1"><a class="header-anchor" href="#_3-1-3-完整代码" aria-hidden="true">#</a> 3.1.3.完整代码</h3>
<p>完整代码如下：</p>
...
<span class="token keyword">private</span> <span class="token keyword">void</span> <span class="token function">handleResponse</span><span class="token punctuation">(</span><span class="token class-name">SearchResponse</span> response<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-1-4-小结" tabindex="-1"><a class="header-anchor" href="#_3-1-4-小结" aria-hidden="true">#</a> 3.1.4.小结</h3>
<p>查询的基本步骤是：</p>
<ol>
<li>
<p>创建 SearchRequest 对象</p>
</li>
<li>
<p>准备 Request.source()，也就是 DSL。</p>
<p>① QueryBuilders 来构建查询条件</p>
<p>② 传入 Request.source() 的 query() 方法</p>
</li>
<li>
<p>发送请求，得到结果</p>
</li>
<li>
<p>解析结果（参考 JSON 结果，从外到内，逐层解析）</p>
</li>
</ol>
<h2 id="_3-2-match-查询" tabindex="-1"><a class="header-anchor" href="#_3-2-match-查询" aria-hidden="true">#</a> 3.2.match 查询</h2>
<p>全文检索的 match 和 multi_match 查询与 match_all 的 API 基本一致。差别是查询条件，也就是 query 的部分。</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210721215923060.png" alt="image-20210721215923060"></p>
<p>因此，Java 代码上的差异主要是 request.source().query()中的参数了。同样是利用 QueryBuilders 提供的方法：</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210721215843099.png" alt="image-20210721215843099"></p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3-3-精确查询" tabindex="-1"><a class="header-anchor" href="#_3-3-精确查询" aria-hidden="true">#</a> 3.3.精确查询</h2>
<p>精确查询主要是两者：</p>
<ul>
<li>term：词条精确匹配</li>
<li>range：范围查询</li>
...
<p>查询条件构造的 API 如下：</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210721220305140.png" alt="image-20210721220305140"></p>
<h2 id="_3-4-布尔查询" tabindex="-1"><a class="header-anchor" href="#_3-4-布尔查询" aria-hidden="true">#</a> 3.4.布尔查询</h2>
<p>布尔查询是用 must、must_not、filter 等方式组合其它查询，代码示例如下：</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210721220927286.png" alt="image-20210721220927286"></p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3-5-排序、分页" tabindex="-1"><a class="header-anchor" href="#_3-5-排序、分页" aria-hidden="true">#</a> 3.5.排序、分页</h2>
<p>搜索结果的排序和分页是与 query 同级的参数，因此同样是使用 request.source()来设置。</p>
<p>对应的 API 如下：</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210721221121266.png" alt="image-20210721221121266"></p>
<p>完整代码示例：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3-6-高亮" tabindex="-1"><a class="header-anchor" href="#_3-6-高亮" aria-hidden="true">#</a> 3.6.高亮</h2>
<p>高亮的代码与之前代码差异较大，有两点：</p>
<ul>
<li>查询的 DSL：其中除了查询条件，还需要添加高亮条件，同样是与 query 同级。</li>
<li>结果解析：结果除了要解析_source 文档数据，还要解析高亮结果</li>
</ul>
<h3 id="_3-6-1-高亮请求构建" tabindex="-1"><a class="header-anchor" href="#_3-6-1-高亮请求构建" aria-hidden="true">#</a> 3.6.1.高亮请求构建</h3>
<p>高亮请求的构建 API 如下：</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210721221744883.png" alt="image-20210721221744883"></p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-6-2-高亮结果解析" tabindex="-1"><a class="header-anchor" href="#_3-6-2-高亮结果解析" aria-hidden="true">#</a> 3.6.2.高亮结果解析</h3>
<p>高亮的结果与查询的文档结果默认是分离的，并不在一起。</p>
<p>因此解析高亮的代码需要额外处理：</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210721222057212.png" alt="image-20210721222057212"></p>
<p>代码解读：</p>
<ul>
<li>第一步：从结果中获取 source。hit.getSourceAsString()，这部分是非高亮结果，json 字符串。还需要反序列为 HotelDoc 对象</li>
<li>第二步：获取高亮结果。hit.getHighlightFields()，返回值是一个 Map，key 是高亮字段名称，值是 HighlightField 对象，代表高亮值</li>
<li>第三步：从 map 中根据高亮字段名称，获取高亮字段值对象 HighlightField</li>
<li>第四步：从 HighlightField 中获取 Fragments，并且转为字符串。这部分就是真正的高亮字符串了</li>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">private</span> <span class="token keyword">void</span> <span class="token function">handleResponse</span><span class="token punctuation">(</span><span class="token class-name">SearchResponse</span> response<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="_4-黑马旅游案例" tabindex="-1"><a class="header-anchor" href="#_4-黑马旅游案例" aria-hidden="true">#</a> 4.黑马旅游案例</h1>
...
<p>启动我们提供的 hotel-demo 项目，其默认端口是 8089，访问 http://localhost:8090，就能看到项目页面了：</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210721223159598.png" alt="image-20210721223159598"></p>
<h2 id="_4-1-酒店搜索和分页" tabindex="-1"><a class="header-anchor" href="#_4-1-酒店搜索和分页" aria-hidden="true">#</a> 4.1.酒店搜索和分页</h2>
<p>案例需求：实现黑马旅游的酒店搜索功能，完成关键字搜索和分页</p>
<h3 id="_4-1-1-需求分析" tabindex="-1"><a class="header-anchor" href="#_4-1-1-需求分析" aria-hidden="true">#</a> 4.1.1.需求分析</h3>
<p>在项目的首页，有一个大大的搜索框，还有分页按钮：</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210721223859419.png" alt="image-20210721223859419"></p>
<p>点击搜索按钮，可以看到浏览器控制台发出了请求：</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210721224033789.png" alt="image-20210721224033789"></p>
<p>请求参数如下：</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210721224112708.png" alt="image-20210721224112708"></p>
<p>由此可以知道，我们这个请求的信息如下：</p>
<ul>
<li>请求方式：POST</li>
<li>请求路径：/hotel/list</li>
<li>请求参数：JSON 对象，包含 4 个字段：
<ul>
<li>key：搜索关键字</li>
<li>page：页码</li>
<li>size：每页大小</li>
...
<li>返回值：分页查询，需要返回分页结果 PageResult，包含两个属性：
<ul>
<li><code v-pre>total</code>：总条数</li>
<li><code v-pre>List&lt;HotelDoc&gt;</code>：当前页的数据</li>
</ul>
</li>
</ul>
<p>因此，我们实现业务的流程如下：</p>
...
<h3 id="_4-1-2-定义实体类" tabindex="-1"><a class="header-anchor" href="#_4-1-2-定义实体类" aria-hidden="true">#</a> 4.1.2.定义实体类</h3>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>因此，我们在<code v-pre>cn.itcast.hotel.pojo</code>包下定义一个实体类：</p>
...
<p>分页查询，需要返回分页结果 PageResult，包含两个属性：</p>
<ul>
<li><code v-pre>total</code>：总条数</li>
<li><code v-pre>List&lt;HotelDoc&gt;</code>：当前页的数据</li>
</ul>
<p>因此，我们在<code v-pre>cn.itcast.hotel.pojo</code>中定义返回结果：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">cn<span class="token punctuation">.</span>itcast<span class="token punctuation">.</span>hotel<span class="token punctuation">.</span>pojo</span><span class="token punctuation">;</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">PageResult</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-1-3-定义-controller" tabindex="-1"><a class="header-anchor" href="#_4-1-3-定义-controller" aria-hidden="true">#</a> 4.1.3.定义 controller</h3>
...
<ul>
<li><code v-pre>Long total</code>：总条数</li>
<li><code v-pre>List&lt;HotelDoc&gt; hotels</code>：酒店数据</li>
</ul>
</li>
</ul>
<p>因此，我们在<code v-pre>cn.itcast.hotel.web</code>中定义 HotelController：</p>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">HotelController</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-1-4-实现搜索业务" tabindex="-1"><a class="header-anchor" href="#_4-1-4-实现搜索业务" aria-hidden="true">#</a> 4.1.4.实现搜索业务</h3>
<p>我们在 controller 调用了 IHotelService，并没有实现该方法，因此下面我们就在 IHotelService 中定义方法，并且去实现业务逻辑。</p>
<p>1）在<code v-pre>cn.itcast.hotel.service</code>中的<code v-pre>IHotelService</code>接口中定义一个方法：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2）实现搜索业务，肯定离不开 RestHighLevelClient，我们需要把它注册到 Spring 中作为一个 Bean。在<code v-pre>cn.itcast.hotel</code>中的<code v-pre>HotelDemoApplication</code>中声明这个 Bean：</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>3）在<code v-pre>cn.itcast.hotel.service.impl</code>中的<code v-pre>HotelService</code>中实现 search 方法：</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_4-2-酒店结果过滤" tabindex="-1"><a class="header-anchor" href="#_4-2-酒店结果过滤" aria-hidden="true">#</a> 4.2.酒店结果过滤</h2>
<p>需求：添加品牌、城市、星级、价格等过滤功能</p>
<h3 id="_4-2-1-需求分析" tabindex="-1"><a class="header-anchor" href="#_4-2-1-需求分析" aria-hidden="true">#</a> 4.2.1.需求分析</h3>
<p>在页面搜索框下面，会有一些过滤项：</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210722091940726.png" alt="image-20210722091940726"></p>
<p>传递的参数如图：</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210722092051994.png" alt="image-20210722092051994"></p>
<p>包含的过滤条件有：</p>
<ul>
<li>brand：品牌值</li>
<li>city：城市</li>
...
<h3 id="_4-2-2-修改实体类" tabindex="-1"><a class="header-anchor" href="#_4-2-2-修改实体类" aria-hidden="true">#</a> 4.2.2.修改实体类</h3>
<p>修改在<code v-pre>cn.itcast.hotel.pojo</code>包下的实体类 RequestParams：</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-2-3-修改搜索业务" tabindex="-1"><a class="header-anchor" href="#_4-2-3-修改搜索业务" aria-hidden="true">#</a> 4.2.3.修改搜索业务</h3>
<p>在 HotelService 的 search 方法中，只有一个地方需要修改：requet.source().query( ... )其中的查询条件。</p>
...
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210722092935453.png" alt="image-20210722092935453"></p>
<p>buildBasicQuery 的代码如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">private</span> <span class="token keyword">void</span> <span class="token function">buildBasicQuery</span><span class="token punctuation">(</span><span class="token class-name">RequestParams</span> params<span class="token punctuation">,</span> <span class="token class-name">SearchRequest</span> request<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    request<span class="token punctuation">.</span><span class="token function">source</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">.</span><span class="token function">query</span><span class="token punctuation">(</span>boolQuery<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_4-3-我周边的酒店" tabindex="-1"><a class="header-anchor" href="#_4-3-我周边的酒店" aria-hidden="true">#</a> 4.3.我周边的酒店</h2>
<p>需求：我附近的酒店</p>
...
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210722093414542.png" alt="image-20210722093414542"></p>
<p>并且，在前端会发起查询请求，将你的坐标发送到服务端：</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210722093642382.png" alt="image-20210722093642382"></p>
...
<h3 id="_4-3-2-修改实体类" tabindex="-1"><a class="header-anchor" href="#_4-3-2-修改实体类" aria-hidden="true">#</a> 4.3.2.修改实体类</h3>
<p>修改在<code v-pre>cn.itcast.hotel.pojo</code>包下的实体类 RequestParams：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">cn<span class="token punctuation">.</span>itcast<span class="token punctuation">.</span>hotel<span class="token punctuation">.</span>pojo</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-3-3-距离排序-api" tabindex="-1"><a class="header-anchor" href="#_4-3-3-距离排序-api" aria-hidden="true">#</a> 4.3.3.距离排序 API</h3>
...
<span class="token punctuation">{</span>
  ...
  <span class="token punctuation">]</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>对应的 java 代码示例：</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210722095227059.png" alt="image-20210722095227059"></p>
<h3 id="_4-3-4-添加距离排序" tabindex="-1"><a class="header-anchor" href="#_4-3-4-添加距离排序" aria-hidden="true">#</a> 4.3.4.添加距离排序</h3>
<p>在<code v-pre>cn.itcast.hotel.service.impl</code>的<code v-pre>HotelService</code>的<code v-pre>search</code>方法中，添加一个排序功能：</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210722095902314.png" alt="image-20210722095902314"></p>
<p>完整代码：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Override</span>
<span class="token keyword">public</span> <span class="token class-name">PageResult</span> <span class="token function">search</span><span class="token punctuation">(</span><span class="token class-name">RequestParams</span> params<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token keyword">try</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-3-5-排序距离显示" tabindex="-1"><a class="header-anchor" href="#_4-3-5-排序距离显示" aria-hidden="true">#</a> 4.3.5.排序距离显示</h3>
<p>重启服务后，测试我的酒店功能：</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210722100040674.png" alt="image-20210722100040674"></p>
<p>发现确实可以实现对我附近酒店的排序，不过并没有看到酒店到底距离我多远，这该怎么办？</p>
<p>排序完成后，页面还要获取我附近每个酒店的具体<strong>距离</strong>值，这个值在响应结果中是独立的：</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210722095648542.png" alt="image-20210722095648542"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2）修改 HotelService 中的 handleResponse 方法</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210722100613966.png" alt="image-20210722100613966"></p>
<p>重启后测试，发现页面能成功显示距离了：</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210722100838604.png" alt="image-20210722100838604"></p>
<h2 id="_4-4-酒店竞价排名" tabindex="-1"><a class="header-anchor" href="#_4-4-酒店竞价排名" aria-hidden="true">#</a> 4.4.酒店竞价排名</h2>
<p>需求：让指定的酒店在搜索结果中排名置顶</p>
<h3 id="_4-4-1-需求分析" tabindex="-1"><a class="header-anchor" href="#_4-4-1-需求分析" aria-hidden="true">#</a> 4.4.1.需求分析</h3>
<p>要让指定酒店在搜索结果中排名置顶，效果如图：</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210722100947292.png" alt="image-20210722100947292"></p>
...
<ol>
<li>
<p>给 HotelDoc 类添加 isAD 字段，Boolean 类型</p>
</li>
<li>
<p>挑选几个你喜欢的酒店，给它的文档数据添加 isAD 字段，值为 true</p>
</li>
<li>
<p>修改 search 方法，添加 function score 功能，给 isAD 值为 true 的酒店增加权重</p>
</li>
</ol>
<h3 id="_4-4-2-修改-hoteldoc-实体" tabindex="-1"><a class="header-anchor" href="#_4-4-2-修改-hoteldoc-实体" aria-hidden="true">#</a> 4.4.2.修改 HotelDoc 实体</h3>
<p>给<code v-pre>cn.itcast.hotel.pojo</code>包下的 HotelDoc 类添加 isAD 字段：</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210722101908062.png" alt="image-20210722101908062"></p>
<h3 id="_4-4-3-添加广告标记" tabindex="-1"><a class="header-anchor" href="#_4-4-3-添加广告标记" aria-hidden="true">#</a> 4.4.3.添加广告标记</h3>
<p>接下来，我们挑几个酒店，添加 isAD 字段，设置为 true：</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>POST /hotel/_update/<span class="token number">1902197537</span>
<span class="token punctuation">{</span>
...
<span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-4-4-添加算分函数查询" tabindex="-1"><a class="header-anchor" href="#_4-4-4-添加算分函数查询" aria-hidden="true">#</a> 4.4.4.添加算分函数查询</h3>
<p>接下来我们就要修改查询条件了。之前是用的 boolean 查询，现在要改成 function_socre 查询。</p>
<p>function_score 查询结构如下：</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210721191544750.png" alt="image-20210721191544750"></p>
<p>对应的 JavaAPI 如下：</p>
<p><img src="@source/notes/microservices/01/day06-Elasticsearch02/assets/image-20210722102850818.png" alt="image-20210722102850818"></p>
<p>我们可以将之前写的 boolean 查询作为<strong>原始查询</strong>条件放到 query 中，接下来就是添加<strong>过滤条件</strong>、<strong>算分函数</strong>、<strong>加权模式</strong>了。所以原来的代码依然可以沿用。</p>
<p>修改<code v-pre>cn.itcast.hotel.service.impl</code>包下的<code v-pre>HotelService</code>类中的<code v-pre>buildBasicQuery</code>方法，添加算分函数查询：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">private</span> <span class="token keyword">void</span> <span class="token function">buildBasicQuery</span><span class="token punctuation">(</span><span class="token class-name">RequestParams</span> params<span class="token punctuation">,</span> <span class="token class-name">SearchRequest</span> request<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token comment">// 1.构建BooleanQuery</span>
    <span class="token class-name">BoolQueryBuilder</span> boolQuery <span class="token operator">=</span> <span class="token class-name">QueryBuilders</span><span class="token punctuation">.</span><span class="token function">boolQuery</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
