<template><div><h1 id="springcloud-实用篇-02-🍑" tabindex="-1"><a class="header-anchor" href="#springcloud-实用篇-02-🍑" aria-hidden="true">#</a> SpringCloud 实用篇 02 🍑</h1>
<nav class="table-of-contents"><ul><li><router-link to="#_1-1-统一配置管理">1.1.统一配置管理</router-link><ul><li><router-link to="#_1-1-1-在-nacos-中添加配置文件">1.1.1.在 nacos 中添加配置文件</router-link></li><li><router-link to="#_1-1-2-从微服务拉取配置">1.1.2.从微服务拉取配置</router-link></li></ul></li><li><router-link to="#_1-2-配置热更新">1.2.配置热更新</router-link><ul><li><router-link to="#_1-2-1-方式一">1.2.1.方式一</router-link></li><li><router-link to="#_1-2-2-方式二">1.2.2.方式二</router-link></li></ul></li><li><router-link to="#_1-3-配置共享">1.3.配置共享</router-link><ul><li><router-link to="#_1-添加一个环境共享配置">1）添加一个环境共享配置</router-link></li><li><router-link to="#_2-在-user-service-中读取共享配置">2）在 user-service 中读取共享配置</router-link></li><li><router-link to="#_3-运行两个-userapplication-使用不同的-profile">3）运行两个 UserApplication，使用不同的 profile</router-link></li><li><router-link to="#_4-配置共享的优先级">4）配置共享的优先级</router-link></li></ul></li><li><router-link to="#_1-4-搭建-nacos-集群">1.4.搭建 Nacos 集群</router-link></li><li><router-link to="#_2-1-feign-替代-resttemplate">2.1.Feign 替代 RestTemplate</router-link><ul><li><router-link to="#_1-引入依赖">1）引入依赖</router-link></li><li><router-link to="#_2-添加注解">2）添加注解</router-link></li><li><router-link to="#_3-编写-feign-的客户端">3）编写 Feign 的客户端</router-link></li><li><router-link to="#_4-测试">4）测试</router-link></li><li><router-link to="#_5-总结">5）总结</router-link></li></ul></li><li><router-link to="#_2-2-自定义配置">2.2.自定义配置</router-link><ul><li><router-link to="#_2-2-1-配置文件方式">2.2.1.配置文件方式</router-link></li><li><router-link to="#_2-2-2-java-代码方式">2.2.2.Java 代码方式</router-link></li></ul></li><li><router-link to="#_2-3-feign-使用优化">2.3.Feign 使用优化</router-link></li><li><router-link to="#_2-4-最佳实践">2.4.最佳实践</router-link><ul><li><router-link to="#_2-4-1-继承方式">2.4.1.继承方式</router-link></li><li><router-link to="#_2-4-2-抽取方式">2.4.2.抽取方式</router-link></li><li><router-link to="#_2-4-3-实现基于抽取的最佳实践">2.4.3.实现基于抽取的最佳实践</router-link></li></ul></li><li><router-link to="#_3-1-为什么需要网关">3.1.为什么需要网关</router-link></li><li><router-link to="#_3-2-gateway-快速入门">3.2.gateway 快速入门</router-link><ul><li><router-link to="#_1-创建-gateway-服务-引入依赖">1）创建 gateway 服务，引入依赖</router-link></li><li><router-link to="#_2-编写启动类">2）编写启动类</router-link></li><li><router-link to="#_3-编写基础配置和路由规则">3）编写基础配置和路由规则</router-link></li><li><router-link to="#_4-重启测试">4）重启测试</router-link></li><li><router-link to="#_5-网关路由的流程图">5）网关路由的流程图</router-link></li></ul></li><li><router-link to="#_3-3-断言工厂">3.3.断言工厂</router-link></li><li><router-link to="#_3-4-过滤器工厂">3.4.过滤器工厂</router-link><ul><li><router-link to="#_3-4-1-路由过滤器的种类">3.4.1.路由过滤器的种类</router-link></li><li><router-link to="#_3-4-2-请求头过滤器">3.4.2.请求头过滤器</router-link></li><li><router-link to="#_3-4-3-默认过滤器">3.4.3.默认过滤器</router-link></li><li><router-link to="#_3-4-4-总结">3.4.4.总结</router-link></li></ul></li><li><router-link to="#_3-5-全局过滤器">3.5.全局过滤器</router-link><ul><li><router-link to="#_3-5-1-全局过滤器作用">3.5.1.全局过滤器作用</router-link></li><li><router-link to="#_3-5-2-自定义全局过滤器">3.5.2.自定义全局过滤器</router-link></li><li><router-link to="#_3-5-3-过滤器执行顺序">3.5.3.过滤器执行顺序</router-link></li></ul></li><li><router-link to="#_3-6-跨域问题">3.6.跨域问题</router-link><ul><li><router-link to="#_3-6-1-什么是跨域问题">3.6.1.什么是跨域问题</router-link></li><li><router-link to="#_3-6-2-模拟跨域问题">3.6.2.模拟跨域问题</router-link></li><li><router-link to="#_3-6-3-解决跨域问题">3.6.3.解决跨域问题</router-link></li></ul></li></ul></nav>
<h1 id="_0-学习目标" tabindex="-1"><a class="header-anchor" href="#_0-学习目标" aria-hidden="true">#</a> 0.学习目标</h1>
<h1 id="_1-nacos-配置管理" tabindex="-1"><a class="header-anchor" href="#_1-nacos-配置管理" aria-hidden="true">#</a> 1.Nacos 配置管理</h1>
...
<p><img src="@source/notes/microservices/01/day02-SpringCloud02/assets/image-20210714164426792.png" alt="image-20210714164426792"></p>
<p>Nacos 一方面可以将配置集中管理，另一方可以在配置变更时，及时通知微服务，实现配置的热更新。</p>
<h3 id="_1-1-1-在-nacos-中添加配置文件" tabindex="-1"><a class="header-anchor" href="#_1-1-1-在-nacos-中添加配置文件" aria-hidden="true">#</a> 1.1.1.在 nacos 中添加配置文件</h3>
<p>如何在 nacos 中管理配置呢？</p>
<p><img src="@source/notes/microservices/01/day02-SpringCloud02/assets/image-20210714164742924.png" alt="image-20210714164742924"></p>
<p>然后在弹出的表单中，填写配置信息：</p>
<p><img src="@source/notes/microservices/01/day02-SpringCloud02/assets/image-20210714164856664.png" alt="image-20210714164856664"></p>
<blockquote>
...
<p><img src="@source/notes/microservices/01/day02-SpringCloud02/assets/L0iFYNF.png" alt="img"></p>
<p>1）引入 nacos-config 依赖</p>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>dependency</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2）添加 bootstrap.yaml</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这里会根据 spring.cloud.nacos.server-addr 获取 nacos 地址，再根据</p>
<p><code v-pre>${spring.application.name}-${spring.profiles.active}.${spring.cloud.nacos.config.file-extension}</code>作为文件 id，来读取配置。</p>
<p>本例中，就是去读取<code v-pre>userservice-dev.yaml</code>：</p>
<p><img src="@source/notes/microservices/01/day02-SpringCloud02/assets/image-20210714170845901.png" alt="image-20210714170845901"></p>
<p>3）读取 nacos 配置</p>
<p>在 user-service 中的 UserController 中添加业务逻辑，读取 pattern.dateformat 配置：</p>
<p><img src="@source/notes/microservices/01/day02-SpringCloud02/assets/image-20210714170337448.png" alt="image-20210714170337448"></p>
<p>完整代码：</p>
...
<p><img src="@source/notes/microservices/01/day02-SpringCloud02/assets/image-20210714170449612.png" alt="image-20210714170449612"></p>
...
<p>在@Value 注入的变量所在类上添加注解@RefreshScope：</p>
<p><img src="@source/notes/microservices/01/day02-SpringCloud02/assets/image-20210714171036335.png" alt="image-20210714171036335"></p>
...
<p><img src="@source/notes/microservices/01/day02-SpringCloud02/assets/image-20210714171316124.png" alt="image-20210714171316124"></p>
<p>完整代码：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">cn<span class="token punctuation">.</span>itcast<span class="token punctuation">.</span>user<span class="token punctuation">.</span>web</span><span class="token punctuation">;</span>
...
<p><img src="@source/notes/microservices/01/day02-SpringCloud02/assets/image-20210714173233650.png" alt="image-20210714173233650"></p>
<h3 id="_2-在-user-service-中读取共享配置" tabindex="-1"><a class="header-anchor" href="#_2-在-user-service-中读取共享配置" aria-hidden="true">#</a> 2）在 user-service 中读取共享配置</h3>
<p>在 user-service 服务中，修改 PatternProperties 类，读取新添加的属性：</p>
<p><img src="@source/notes/microservices/01/day02-SpringCloud02/assets/image-20210714173324231.png" alt="image-20210714173324231"></p>
<p>在 user-service 服务中，修改 UserController，添加一个方法：</p>
<p><img src="@source/notes/microservices/01/day02-SpringCloud02/assets/image-20210714173721309.png" alt="image-20210714173721309"></p>
<h3 id="_3-运行两个-userapplication-使用不同的-profile" tabindex="-1"><a class="header-anchor" href="#_3-运行两个-userapplication-使用不同的-profile" aria-hidden="true">#</a> 3）运行两个 UserApplication，使用不同的 profile</h3>
<p>修改 UserApplication2 这个启动项，改变其 profile 值：</p>
<p><img src="@source/notes/microservices/01/day02-SpringCloud02/assets/image-20210714173538538.png" alt="image-20210714173538538"></p>
<p><img src="@source/notes/microservices/01/day02-SpringCloud02/assets/image-20210714173519963.png" alt="image-20210714173519963"></p>
...
<p>访问 http://localhost:8081/user/prop，结果：</p>
<p><img src="@source/notes/microservices/01/day02-SpringCloud02/assets/image-20210714174313344.png" alt="image-20210714174313344"></p>
<p>访问 http://localhost:8082/user/prop，结果：</p>
<p><img src="@source/notes/microservices/01/day02-SpringCloud02/assets/image-20210714174424818.png" alt="image-20210714174424818"></p>
...
<p><img src="@source/notes/microservices/01/day02-SpringCloud02/assets/image-20210714174623557.png" alt="image-20210714174623557"></p>
<h2 id="_1-4-搭建-nacos-集群" tabindex="-1"><a class="header-anchor" href="#_1-4-搭建-nacos-集群" aria-hidden="true">#</a> 1.4.搭建 Nacos 集群</h2>
<p>Nacos 生产环境下一定要部署为集群状态，部署方式参考课前资料中的文档：</p>
<p><img src="@source/notes/microservices/01/day02-SpringCloud02/assets/image-20210714174728042.png" alt="image-20210714174728042"></p>
<h1 id="_2-feign-远程调用" tabindex="-1"><a class="header-anchor" href="#_2-feign-远程调用" aria-hidden="true">#</a> 2.Feign 远程调用</h1>
<p>先来看我们以前利用 RestTemplate 发起远程调用的代码：</p>
<p><img src="@source/notes/microservices/01/day02-SpringCloud02/assets/image-20210714174814204.png" alt="image-20210714174814204"></p>
<p>存在下面的问题：</p>
<p>•代码可读性差，编程体验不统一</p>
<p>•参数复杂 URL 难以维护</p>
<p>Feign 是一个声明式的 http 客户端，官方地址：https://github.com/OpenFeign/feign</p>
<p>其作用就是帮助我们优雅的实现 http 请求的发送，解决上面提到的问题。</p>
<p><img src="@source/notes/microservices/01/day02-SpringCloud02/assets/image-20210714174918088.png" alt="image-20210714174918088"></p>
<h2 id="_2-1-feign-替代-resttemplate" tabindex="-1"><a class="header-anchor" href="#_2-1-feign-替代-resttemplate" aria-hidden="true">#</a> 2.1.Feign 替代 RestTemplate</h2>
<p>Fegin 的使用步骤如下：</p>
...
<p>在 order-service 的启动类添加注解开启 Feign 的功能：</p>
<p><img src="@source/notes/microservices/01/day02-SpringCloud02/assets/image-20210714175102524.png" alt="image-20210714175102524"></p>
<h3 id="_3-编写-feign-的客户端" tabindex="-1"><a class="header-anchor" href="#_3-编写-feign-的客户端" aria-hidden="true">#</a> 3）编写 Feign 的客户端</h3>
...
<p>修改 order-service 中的 OrderService 类中的 queryOrderById 方法，使用 Feign 客户端代替 RestTemplate：</p>
<p><img src="@source/notes/microservices/01/day02-SpringCloud02/assets/image-20210714175415087.png" alt="image-20210714175415087"></p>
<p>是不是看起来优雅多了。</p>
<h3 id="_5-总结" tabindex="-1"><a class="header-anchor" href="#_5-总结" aria-hidden="true">#</a> 5）总结</h3>
<p>使用 Feign 的步骤：</p>
<p>① 引入依赖</p>
<p>② 添加@EnableFeignClients 注解</p>
<p>③ 编写 FeignClient 接口</p>
<p>④ 使用 FeignClient 中定义的方法代替 RestTemplate</p>
...
<h3 id="_2-2-2-java-代码方式" tabindex="-1"><a class="header-anchor" href="#_2-2-2-java-代码方式" aria-hidden="true">#</a> 2.2.2.Java 代码方式</h3>
<p>也可以基于 Java 代码来修改日志级别，先声明一个类，然后声明一个 Logger.Level 的对象：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">DefaultFeignConfiguration</span>  <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果要<strong>全局生效</strong>，将其放到启动类的@EnableFeignClients 这个注解中：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>如果是<strong>局部生效</strong>，则把它放到对应的@FeignClient 这个注解中：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="_2-3-feign-使用优化" tabindex="-1"><a class="header-anchor" href="#_2-3-feign-使用优化" aria-hidden="true">#</a> 2.3.Feign 使用优化</h2>
<p>Feign 底层发起 http 请求，依赖于其它的框架。其底层客户端实现包括：</p>
<p>•URLConnection：默认实现，不支持连接池</p>
<p>•Apache HttpClient ：支持连接池</p>
<p>•OKHttp：支持连接池</p>
<p>因此提高 Feign 的性能主要手段就是使用<strong>连接池</strong>代替默认的 URLConnection。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>接下来，在 FeignClientFactoryBean 中的 loadBalance 方法中打断点：</p>
<p><img src="@source/notes/microservices/01/day02-SpringCloud02/assets/image-20210714185925910.png" alt="image-20210714185925910"></p>
<p>Debug 方式启动 order-service 服务，可以看到这里的 client，底层就是 Apache HttpClient：</p>
<p><img src="@source/notes/microservices/01/day02-SpringCloud02/assets/image-20210714190041542.png" alt="image-20210714190041542"></p>
<p>总结，Feign 的优化：</p>
<p>1.日志级别尽量用 basic</p>
<p>2.使用 HttpClient 或 OKHttp 代替 URLConnection</p>
<p>① 引入 feign-httpClient 依赖</p>
<p>② 配置文件开启 httpClient 功能，设置连接池参数</p>
...
<p>自习观察可以发现，Feign 的客户端与服务提供者的 controller 代码非常相似：</p>
<p>feign 客户端：</p>
<p><img src="@source/notes/microservices/01/day02-SpringCloud02/assets/image-20210714190542730.png" alt="image-20210714190542730"></p>
<p>UserController：</p>
<p><img src="@source/notes/microservices/01/day02-SpringCloud02/assets/image-20210714190528450.png" alt="image-20210714190528450"></p>
...
<p><img src="@source/notes/microservices/01/day02-SpringCloud02/assets/image-20210714190640857.png" alt="image-20210714190640857"></p>
<p>优点：</p>
<ul>
<li>简单</li>
<li>实现了代码共享</li>
...
<li>
<p>参数列表中的注解映射并不会继承，因此 Controller 中必须再次声明方法、参数列表、注解</p>
</li>
</ul>
...
<p><img src="@source/notes/microservices/01/day02-SpringCloud02/assets/image-20210714214041796.png" alt="image-20210714214041796"></p>
...
<p><img src="@source/notes/microservices/01/day02-SpringCloud02/assets/image-20210714204557771.png" alt="image-20210714204557771"></p>
<p>项目结构：</p>
<p><img src="@source/notes/microservices/01/day02-SpringCloud02/assets/image-20210714204656214.png" alt="image-20210714204656214"></p>
<p>在 feign-api 中然后引入 feign 的 starter 依赖</p>
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>dependency</span><span class="token punctuation">></span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>groupId</span><span class="token punctuation">></span></span>org.springframework.cloud<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>groupId</span><span class="token punctuation">></span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>artifactId</span><span class="token punctuation">></span></span>spring-cloud-starter-openfeign<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>artifactId</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>dependency</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>然后，order-service 中编写的 UserClient、User、DefaultFeignConfiguration 都复制到 feign-api 项目中</p>
<p><img src="@source/notes/microservices/01/day02-SpringCloud02/assets/image-20210714205221970.png" alt="image-20210714205221970"></p>
<h4 id="_2-在-order-service-中使用-feign-api" tabindex="-1"><a class="header-anchor" href="#_2-在-order-service-中使用-feign-api" aria-hidden="true">#</a> 2）在 order-service 中使用 feign-api</h4>
<p>首先，删除 order-service 中的 UserClient、User、DefaultFeignConfiguration 等类或接口。</p>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>dependency</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>修改 order-service 中的所有与上述三个组件有关的导包部分，改成导入 feign-api 中的包</p>
<h4 id="_3-重启测试" tabindex="-1"><a class="header-anchor" href="#_3-重启测试" aria-hidden="true">#</a> 3）重启测试</h4>
<p>重启后，发现服务报错了：</p>
<p><img src="@source/notes/microservices/01/day02-SpringCloud02/assets/image-20210714205623048.png" alt="image-20210714205623048"></p>
<p>这是因为 UserClient 现在在 cn.itcast.feign.clients 包下，</p>
<p>而 order-service 的@EnableFeignClients 注解是在 cn.itcast.order 包下，不在同一个包，无法扫描到 UserClient。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h1 id="_3-gateway-服务网关" tabindex="-1"><a class="header-anchor" href="#_3-gateway-服务网关" aria-hidden="true">#</a> 3.Gateway 服务网关</h1>
...
<p>架构图：</p>
<p><img src="@source/notes/microservices/01/day02-SpringCloud02/assets/image-20210714210131152.png" alt="image-20210714210131152"></p>
...
<h2 id="_3-2-gateway-快速入门" tabindex="-1"><a class="header-anchor" href="#_3-2-gateway-快速入门" aria-hidden="true">#</a> 3.2.gateway 快速入门</h2>
...
<h3 id="_1-创建-gateway-服务-引入依赖" tabindex="-1"><a class="header-anchor" href="#_1-创建-gateway-服务-引入依赖" aria-hidden="true">#</a> 1）创建 gateway 服务，引入依赖</h3>
<p>创建服务：</p>
<p><img src="@source/notes/microservices/01/day02-SpringCloud02/assets/image-20210714210919458.png" alt="image-20210714210919458"></p>
<p>引入依赖：</p>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">cn<span class="token punctuation">.</span>itcast<span class="token punctuation">.</span>gateway</span><span class="token punctuation">;</span>
...
<p>本例中，我们将 <code v-pre>/user/**</code>开头的请求，代理到<code v-pre>lb://userservice</code>，lb 是负载均衡，根据服务名拉取服务列表，实现负载均衡。</p>
<h3 id="_4-重启测试" tabindex="-1"><a class="header-anchor" href="#_4-重启测试" aria-hidden="true">#</a> 4）重启测试</h3>
<p>重启网关，访问 http://localhost:10010/user/1 时，符合<code v-pre>/user/**</code>规则，请求转发到 uri：http://userservice/user/1，得到了结果：</p>
<p><img src="@source/notes/microservices/01/day02-SpringCloud02/assets/image-20210714211908341.png" alt="image-20210714211908341"></p>
<h3 id="_5-网关路由的流程图" tabindex="-1"><a class="header-anchor" href="#_5-网关路由的流程图" aria-hidden="true">#</a> 5）网关路由的流程图</h3>
<p>整个访问的流程如下：</p>
<p><img src="@source/notes/microservices/01/day02-SpringCloud02/assets/image-20210714211742956.png" alt="image-20210714211742956"></p>
<p>总结：</p>
<p>网关搭建步骤：</p>
<ol>
<li>
...
<p>处理的，像这样的断言工厂在 SpringCloudGateway 还有十几个:</p>
<table>
<thead>
<tr>
...
<p>大多数情况下我们只需要掌握 Path 这种路由工厂就可以了。</p>
...
<p><img src="@source/notes/microservices/01/day02-SpringCloud02/assets/image-20210714212312871.png" alt="image-20210714212312871"></p>
...
<p>下面我们以 AddRequestHeader 为例来讲解。</p>
<blockquote>
<p><strong>需求</strong>：给所有进入 userservice 的请求添加一个请求头：Truth=itcast is freaking awesome!</p>
</blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>当前过滤器写在 userservice 路由下，因此仅仅对访问 userservice 的请求有效。</p>
...
<p>全局过滤器的作用也是处理一切进入网关的请求和微服务响应，与 GatewayFilter 的作用一样。区别在于 GatewayFilter 通过配置定义，处理逻辑是固定的；而 GlobalFilter 的逻辑需要自己写代码实现。</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在 filter 中编写自定义逻辑，可以实现下列功能：</p>
<ul>
<li>登录状态判断</li>
<li>权限校验</li>
<li>请求限流等</li>
...
<p><img src="@source/notes/microservices/01/day02-SpringCloud02/assets/image-20210714214228409.png" alt="image-20210714214228409"></p>
<p>排序的规则是什么呢？</p>
<ul>
...
<p>详细内容，可以查看源码：</p>
<p><code v-pre>org.springframework.cloud.gateway.route.RouteDefinitionRouteLocator#getFilters()</code>方法是先加载 defaultFilters，然后再加载某个 route 的 filters，然后合并。</p>
<p><code v-pre>org.springframework.cloud.gateway.handler.FilteringWebHandler#handle()</code>方法会加载全局过滤器，与前面的过滤器合并后根据 order 排序，组织过滤器链</p>
...
<p>跨域问题：<strong>浏览器禁止</strong>请求的发起者与服务端发生跨域<strong>ajax 请求</strong>，请求被浏览器拦截的问题</p>
...
<p>找到课前资料的页面文件：</p>
<p><img src="@source/notes/microservices/01/day02-SpringCloud02/assets/image-20210714215713563.png" alt="image-20210714215713563"></p>
<p>放入 tomcat 或者 nginx 这样的 web 服务器中，启动并访问。</p>
<p>可以在浏览器控制台看到下面的错误：</p>
<p><img src="@source/notes/microservices/01/day02-SpringCloud02/assets/image-20210714215832675.png" alt="image-20210714215832675"></p>
<p>从 localhost:8090 访问 localhost:10010，端口不同，显然是跨域的请求。</p>
