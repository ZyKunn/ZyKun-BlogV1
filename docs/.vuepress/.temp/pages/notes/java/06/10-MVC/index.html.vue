<template><div><h1 id="_10-mvc" tabindex="-1"><a class="header-anchor" href="#_10-mvc" aria-hidden="true">#</a> 10 - MVC 🚀</h1>
<nav class="table-of-contents"><ul><li><router-link to="#从-model1-到-model2-mvc">从 Model1 到 Model2(MVC)</router-link><ul><li><router-link to="#model1-模式">Model1 模式</router-link></li><li><router-link to="#model2-模式-mvc">Model2 模式（MVC）</router-link></li><li><router-link to="#三层架构和-mvc-区别">三层架构和 MVC 区别</router-link></li></ul></li><li><router-link to="#baseservlet">BaseServlet</router-link></li><li><router-link to="#分页技术">分页技术</router-link><ul><li><router-link to="#通用分页工具类">通用分页工具类</router-link></li></ul></li><li><router-link to="#基于-mvc-的-web-开发案例">基于 MVC 的 web 开发案例</router-link></li></ul></nav>
<h2 id="从-model1-到-model2-mvc" tabindex="-1"><a class="header-anchor" href="#从-model1-到-model2-mvc" aria-hidden="true">#</a> 从 Model1 到 Model2(MVC)</h2>
<p>软件架构编年史</p>
<p>Servlet---&gt;JSP</p>
<h3 id="model1-模式" tabindex="-1"><a class="header-anchor" href="#model1-模式" aria-hidden="true">#</a> Model1 模式</h3>
<p>model1 是早期 javaweb 软件开发中最为流行的一种技术，整个项目的开发只需要：JSP+JavaBean 即可完成</p>
<p><img src="@source/notes/java/06/10-MVC/assets/1612057263869.png" alt="1612057263869"></p>
<p><strong>Model1 模式的优缺点:</strong></p>
<ul>
<li>优点：
<ul>
<li>开发效率很高</li>
...
<h3 id="model2-模式-mvc" tabindex="-1"><a class="header-anchor" href="#model2-模式-mvc" aria-hidden="true">#</a> Model2 模式（MVC）</h3>
<p>通过对 model1 模式的了解，会发现随着互联网的发展，model1 模式已经不适用于当前的环境，因此在 model1 的基础上，软件架构继续发展出现了 Model2(MVC)模式，Model2 模式的架构如下:</p>
<p><img src="@source/notes/java/06/10-MVC/assets/1612058175710.png" alt="1612058175710"></p>
<p>Model2 模式的优缺点</p>
<ul>
<li>优点
<ul>
...
<p><img src="@source/notes/java/06/10-MVC/assets/1612058368559.png" alt="1612058368559"></p>
<h3 id="三层架构和-mvc-区别" tabindex="-1"><a class="header-anchor" href="#三层架构和-mvc-区别" aria-hidden="true">#</a> 三层架构和 MVC 区别</h3>
<p><img src="@source/notes/java/06/10-MVC/assets/1612061127620.png" alt="1612061127620"></p>
<p><img src="@source/notes/java/06/10-MVC/assets/1612060874141.png" alt="1612060874141"></p>
<p>三层架构:</p>
<ul>
<li>表现层（UI）</li>
<li>业务逻辑层（BL）</li>
...
<p>三层架构是一种软件架构技术，MVC 是一种设计模式；三层架构中的表现层即 MVC</p>
<blockquote>
<p>MVC 框架目前市面上有很多：</p>
<ol>
<li>struts1</li>
...
<p>分层开发的最终目的是：</p>
<p>降低耦合度（<strong>高内聚低耦合</strong>）</p>
<h2 id="baseservlet" tabindex="-1"><a class="header-anchor" href="#baseservlet" aria-hidden="true">#</a> BaseServlet</h2>
<p><img src="@source/notes/java/06/10-MVC/assets/1612058810737.png" alt="1612058810737"></p>
<p>实现代码：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">BaseServlet</span> <span class="token keyword">extends</span> <span class="token class-name">HttpServlet</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="分页技术" tabindex="-1"><a class="header-anchor" href="#分页技术" aria-hidden="true">#</a> 分页技术</h2>
<h3 id="通用分页工具类" tabindex="-1"><a class="header-anchor" href="#通用分页工具类" aria-hidden="true">#</a> 通用分页工具类</h3>
<ol>
<li>
<p>编写分页模型类(PageModel)</p>
...
<li>
<p>控制层的请求处理</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@WebServlet</span><span class="token punctuation">(</span><span class="token string">"/emp"</span><span class="token punctuation">)</span>
...
<h2 id="基于-mvc-的-web-开发案例" tabindex="-1"><a class="header-anchor" href="#基于-mvc-的-web-开发案例" aria-hidden="true">#</a> 基于 MVC 的 web 开发案例</h2>
</div></template>
