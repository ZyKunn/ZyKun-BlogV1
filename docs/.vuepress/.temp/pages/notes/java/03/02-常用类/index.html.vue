<template><div><h1 id="_02-常用类" tabindex="-1"><a class="header-anchor" href="#_02-常用类" aria-hidden="true">#</a> 02 - 常用类 🏄</h1>
<nav class="table-of-contents"><ul><li><router-link to="#objects-类">Objects 类</router-link></li><li><router-link to="#random-类">Random 类</router-link></li><li><router-link to="#file-类">File 类</router-link><ul><li><router-link to="#常见属性">常见属性</router-link></li><li><router-link to="#构造器">构造器</router-link></li><li><router-link to="#常用方法">常用方法</router-link></li><li><router-link to="#文件过滤">文件过滤</router-link></li><li><router-link to="#文件递归遍历">文件递归遍历</router-link></li></ul></li></ul></nav>
<h2 id="objects-类" tabindex="-1"><a class="header-anchor" href="#objects-类" aria-hidden="true">#</a> Objects 类</h2>
<p>Object 类是所有 java 类的顶层父类（祖宗类），但是 Objects 是从 Java7 开始新增的一个对于 java 对象进行空指针安全操作的工具类</p>
<ul>
<li>Objects 类是一个工具类</li>
<li>Objects 对外不提供构造器，因此无法创建对象</li>
<li>Objects 类中的所有方法都是 static</li>
<li>提供的是对于对象的空指针安全操作的方法</li>
</ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="random-类" tabindex="-1"><a class="header-anchor" href="#random-类" aria-hidden="true">#</a> Random 类</h2>
<p>​ Math 类中提供了一个<code v-pre>random()</code>的方法,用于随机一个从 0.0~1.0 之间的浮点数，当实际需求有个性化的要求时，只能通过计算获取其他类型的随机数，实际操作相对比较麻烦；因此，Java 中还提供了另一个专门用于生成各种需求的随机数类型,比如，随机整数，随机浮点数，随机布尔值。</p>
...
<ul>
<li>nextBoolean()：随机一个布尔值</li>
<li>nextDouble()：随机一个 0.0~1.0 之间的 double 值</li>
<li>nextInt()：随机一个 int 范围内的整数值</li>
<li><strong>nextInt(int bounds)：随机一个从 0~bounds-1 位的整数值</strong></li>
</ul>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">RandomDemo</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="file-类" tabindex="-1"><a class="header-anchor" href="#file-类" aria-hidden="true">#</a> File 类</h2>
<p>​ File 类是来自于<code v-pre>java.io</code>包中的一个用于处理本机操作系统中的文件，文件可以是<strong>目录</strong>也可以是一个<strong>标准文件</strong>；File 类是用于在 Java 中实现跟本机文件系统进行关联的操作类。其中包含一些常见的文件操作：创建文件/目录，查看文件的状态，删除文件等。</p>
<h3 id="常见属性" tabindex="-1"><a class="header-anchor" href="#常见属性" aria-hidden="true">#</a> 常见属性</h3>
<table>
<thead>
<tr>
<th>常量</th>
...
<tr>
<td>pathSeparator</td>
<td>获取与本机系统相关的路径分隔符（windows 是&quot;;&quot;符号,Linux 是”:“符号）</td>
</tr>
<tr>
<td>separator</td>
<td>获取与本机系统相关的目录分隔符（windows 是”\“，Linux 是”/“）</td>
</tr>
</tbody>
</table>
...
<thead>
<tr>
<th><code v-pre>File(File parent, String child)</code> 使用父目录所表示的 File 对象，结合子文件名构建新的 File 对象</th>
</tr>
</thead>
<tbody>
<tr>
<td><code v-pre>File(String pathname)</code> 根据提供的文件路径构建一个 File 对象</td>
</tr>
<tr>
<td><code v-pre>File(String parent,  String child)</code> 从父路径名字符串和子路径名字符串创建新的 <code v-pre>File</code>实例。</td>
</tr>
<tr>
<td><code v-pre>File(URI uri)</code> 通过将给定的 <code v-pre>file:</code> URI 转换为抽象路径名来创建新的 <code v-pre>File</code>实例。</td>
</tr>
</tbody>
</table>
<h3 id="常用方法" tabindex="-1"><a class="header-anchor" href="#常用方法" aria-hidden="true">#</a> 常用方法</h3>
<ul>
<li>createNewFile() 创建新文件（标准文件）</li>
<li>exists() 判断 File 对象是否存在</li>
<li>delete() 删除 File 对象所表示的文件或者目录(空目录)</li>
<li>deleteOnExit() 当 JVM 结束时删除</li>
<li>getName() 获取 File 对象所表示的文件名称</li>
<li>getParent() 获取 File 所指的文件或者目录的父路径</li>
<li>isFile() 判断当前 File 所指的是否是标准文件</li>
<li>isDirectory() 判断当前 File 所指的是否是目录</li>
<li>isHidden() 判断当前 File 对象是否是隐藏目录</li>
<li>lastModified() 获取最后修改时间</li>
<li>length() 获取 File 所表示文件大小(目录为 4096)</li>
<li>list() 获取 File 所表示目录下所有子文件的名称数组</li>
<li>listFiles() 获取 File 对象所表示目录下的所有子 File 数组</li>
<li>listFiles(FileFilter filter) 通过文件过滤器将 File 所表示目录中符合条件的 File 对象过滤出来</li>
<li>listRoots() 获取当前电脑可用的磁盘根</li>
<li>mkdir() 创建当前 File 所表示的目录(一级)</li>
<li>mkdirs() 创建当前 File 所表示的目录(多级)</li>
<li>renameTo(File file) 重命名文件</li>
</ul>
<p><strong>测试一：</strong></p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">FileDemo1</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>测试二：</strong></p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">FileDemo2</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="文件过滤" tabindex="-1"><a class="header-anchor" href="#文件过滤" aria-hidden="true">#</a> 文件过滤</h3>
<p>File 类中提供了几个用于列出指定目录下所有子文件的方法：</p>
<ul>
<li>list()</li>
<li>listFiles()</li>
</ul>
<p>以上两个方法不会对文件进行任何的限制和过滤，直接全部遍历，但是以上两个方法还提供了对应的重载方法</p>
<ul>
<li>list(FilenameFilter filter)</li>
<li>listFiles(FileFilter filter)</li>
<li>listFiles(FilenameFilter filter)</li>
</ul>
<h4 id="过滤方式一" tabindex="-1"><a class="header-anchor" href="#过滤方式一" aria-hidden="true">#</a> 过滤方式一</h4>
<p>以<code v-pre>listFiles(FileFilter filter)</code>为例，使用方法如下：</p>
...
<p><img src="@source/notes/java/03/02-常用类/assets/1605698553122.png" alt="1605698553122"></p>
<p>以上程序的实现，使用了匿名内部类，回调机制</p>
<h4 id="过滤方式二" tabindex="-1"><a class="header-anchor" href="#过滤方式二" aria-hidden="true">#</a> 过滤方式二：</h4>
<p>创建文件过滤器：</p>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">FileDemo5</span> <span class="token punctuation">{</span>
...
<p>在对系统文件加遍历时往往会遇到一种情况：需要将一个目录下的所有子文件全部获取，但是该目录下可能还存在子目录，以及多个子目录嵌套的情况；而具体的嵌套层次是未知的，因此无法使用传统的循环语句进行遍历，此时，最好的方式可以通过递归实现遍历：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">FileDemo6</span> <span class="token punctuation">{</span>
