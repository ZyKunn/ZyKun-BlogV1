<template><div><h1 id="_04-常用类-日期类-正则表达式" tabindex="-1"><a class="header-anchor" href="#_04-常用类-日期类-正则表达式" aria-hidden="true">#</a> 04 - 常用类(日期类&amp;正则表达式) 🍅</h1>
<nav class="table-of-contents"><ul><li><router-link to="#日期处理类">日期处理类</router-link><ul><li><router-link to="#date-类">Date 类</router-link></li><li><router-link to="#日期格式化-dateformat-simpledateformat">日期格式化（DateFormat &amp; SimpleDateFormat）</router-link></li><li><router-link to="#calendar">Calendar</router-link></li></ul></li><li><router-link to="#正则表达式">正则表达式</router-link><ul><li><router-link to="#匹配元字符">匹配元字符</router-link></li><li><router-link to="#匹配长度">匹配长度</router-link></li><li><router-link to="#分区">分区</router-link></li><li><router-link to="#分组">分组</router-link></li><li><router-link to="#pattern-matcher">Pattern&amp;Matcher</router-link></li><li><router-link to="#正则表达式在线测试">正则表达式在线测试</router-link></li></ul></li><li><router-link to="#作业">作业</router-link></li></ul></nav>
<h2 id="日期处理类" tabindex="-1"><a class="header-anchor" href="#日期处理类" aria-hidden="true">#</a> 日期处理类</h2>
<p>在程序开发中日期的处理十分常见，比如：订单的创建时间，用户注册时间，某项具体操作的触发时间等；因此 java 中也提供了丰富用于日期时间处理的工具类：</p>
<ul>
<li><strong>java.util.Date</strong>(jdk1.0)</li>
<li><strong>java.util.Calendar</strong>(jdk1.1)</li>
<li>java.time.LocalDate(jdk8)</li>
<li>java.time.LocalTime(jdk8)</li>
<li>java.time.LocalDateTime(jdk8)</li>
</ul>
<h3 id="date-类" tabindex="-1"><a class="header-anchor" href="#date-类" aria-hidden="true">#</a> Date 类</h3>
<p><code v-pre>java.util.Date</code>是一个传统的 java 用于处理日期时间的类，由于版本更新，内部有很多构造器包括方法均已标记为过时，取而代之的是 java.util.Calendar 类；</p>
<h4 id="常用构造器" tabindex="-1"><a class="header-anchor" href="#常用构造器" aria-hidden="true">#</a> 常用构造器</h4>
<ul>
<li>Date()：获取当前系统时间所表示的日期对象</li>
<li>Date(long time)：根据提供的时间毫秒数，构建一个日期对象（从 1970 年 1 月 1 日 00:00:00 开始）</li>
</ul>
...
<span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span>d<span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="常用方法" tabindex="-1"><a class="header-anchor" href="#常用方法" aria-hidden="true">#</a> 常用方法</h4>
<ul>
<li>after(Date d)</li>
<li>before(Date d)</li>
<li>compareTo(Date d)</li>
<li>getTime()</li>
</ul>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//判断当前日期对象是否是参数日期对象之后的日期</span>
...
<p>DateFormat 类来自<code v-pre>java.text</code>包下的用于进行日期时间格式化处理的类，是一个抽象类，内部提供了一系列用于获取格式化对象的静态方法：</p>
<ul>
<li>getDateInstance()</li>
<li>getTimeInstance()</li>
<li>getDateTimeInstance()</li>
<li>getInstance()</li>
</ul>
<p>用法如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token class-name">Date</span> d <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">Date</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="simpledateformat" tabindex="-1"><a class="header-anchor" href="#simpledateformat" aria-hidden="true">#</a> SimpleDateFormat</h4>
<p>DateFormat 中提供的静态方法可以用户获取各种丰富的格式化对象，但是针对一些需求 DateFormat 并不能完全满足，比如需要如下格式日期：</p>
<ul>
<li>20201120</li>
<li>2020 年 11 月 20 日 09 时 48 分 50 秒</li>
<li>10:11:35</li>
</ul>
<p>通过观察 DateFormat 中 getInstance()源码得知，内部使用了一个子类<code v-pre>SimpleDateFormat</code>实现，SimpleDateFormat 可以通过定制化的匹配模式来匹配不同的日期时间输出格式：</p>
<p><img src="@source/notes/java/03/04-常用类（日期类&amp;正则表达式）/assets/1605839468142.png" alt="1605839468142"></p>
<p>实例参考：</p>
<p><img src="@source/notes/java/03/04-常用类（日期类&amp;正则表达式）/assets/1605839490665.png" alt="1605839490665"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="calendar" tabindex="-1"><a class="header-anchor" href="#calendar" aria-hidden="true">#</a> Calendar</h3>
<p>从 JDK1.1 开始<code v-pre>java.util.Date</code>中的很多方法和构造器标记为过时，同时 jdk 新增了对应的替代方案：<code v-pre>java.util.Calendar</code>，是一个抽象类，有一个直接子类:<code v-pre>java.util.GregorianCalendar</code>对其继承，并且实现其中的抽象方法，常见的 Calendar 实例获取方式为直接使用内部提供的静态方法<code v-pre>getInstance()</code></p>
<p>具体使用如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//以当前系统时间为基础获取日历实例  +8</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="常见字段" tabindex="-1"><a class="header-anchor" href="#常见字段" aria-hidden="true">#</a> 常见字段</h4>
<ul>
<li>YEAR</li>
<li>MONTH</li>
<li>DAY_OF_MONTH</li>
...
<h4 id="常见方法" tabindex="-1"><a class="header-anchor" href="#常见方法" aria-hidden="true">#</a> 常见方法</h4>
<ul>
<li>get(int field)</li>
<li>set(int field,int value)</li>
<li>getActualMaximum(int field)</li>
</ul>
<h4 id="具体用法" tabindex="-1"><a class="header-anchor" href="#具体用法" aria-hidden="true">#</a> 具体用法</h4>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//以当前系统时间为基础获取日历实例  +8</span>
<span class="token class-name">Calendar</span> c <span class="token operator">=</span> <span class="token class-name">Calendar</span><span class="token punctuation">.</span><span class="token function">getInstance</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span>c<span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<p>正则表达式（ Regular expression）是一组由字母和符号组成的特殊文本, 它可以用来从文本中找出满足你想要的格式的句子。正则表达式最早源自于 perl 语言（脚本语言）；正则表达式的功能十分强大，可以用于进行文本的匹配，检索，替换；常见于一些网络爬虫。</p>
<p>java 中对于正则表达式的处理主要由一下三个类实现：</p>
<ul>
<li><strong>java.lang.String</strong></li>
<li><strong>java.util.regex.Pattern</strong></li>
<li><strong>java.util.regex.Macher</strong></li>
</ul>
<p>简单案例：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token class-name">String</span> a <span class="token operator">=</span> <span class="token string">"13567845635"</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="匹配元字符" tabindex="-1"><a class="header-anchor" href="#匹配元字符" aria-hidden="true">#</a> 匹配元字符</h3>
<table>
<thead>
<tr>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//.用于匹配出回车换行之外的其他任意单个字符（数字，字母，符号）</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="匹配长度" tabindex="-1"><a class="header-anchor" href="#匹配长度" aria-hidden="true">#</a> 匹配长度</h3>
<table>
<thead>
<tr>
...
<td style="text-align:center">重复 n 到 m 次</td>
</tr>
</tbody>
</table>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//匹配输入长度为4的数字要求必须以1开头</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="分区" tabindex="-1"><a class="header-anchor" href="#分区" aria-hidden="true">#</a> 分区</h3>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 匹配至少一个小写字符串</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="分组" tabindex="-1"><a class="header-anchor" href="#分组" aria-hidden="true">#</a> 分组</h3>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 匹配指定运营商号的手机号</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="pattern-matcher" tabindex="-1"><a class="header-anchor" href="#pattern-matcher" aria-hidden="true">#</a> Pattern&amp;Matcher</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="正则表达式在线测试" tabindex="-1"><a class="header-anchor" href="#正则表达式在线测试" aria-hidden="true">#</a> 正则表达式在线测试</h3>
<ul>
...
<ol>
<li>
<p>要求用户输入年份月份，显示当月的日历布局，并且周末日期使用【】包裹，当前日期前使用“*”标记，效果如下：</p>
<p><img src="@source/notes/java/03/04-常用类（日期类&amp;正则表达式）/assets/1605845028810.png" alt="1605845028810"></p>
</li>
<li>
<p>从一个提供的网页地址中搜索并提取所有的超链接地址（http://||https://）</p>
</li>
<li>
<p>统计从第一天开始到目前为止，Eclipse 工作空间总所有代码总行数，另外统计有多少空行，多少注释行,以及多少有效代码行。</p>
</li>
</ol>
</div></template>
