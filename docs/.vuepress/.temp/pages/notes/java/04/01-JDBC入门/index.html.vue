<template><div><h1 id="_01-jdbc-入门" tabindex="-1"><a class="header-anchor" href="#_01-jdbc-入门" aria-hidden="true">#</a> 01 - JDBC 入门 🛫</h1>
<nav class="table-of-contents"><ul><li><router-link to="#jdbc-概述">JDBC 概述</router-link></li><li><router-link to="#入门案例">入门案例</router-link></li><li><router-link to="#jdbc-常见类与接口">JDBC 常见类与接口</router-link><ul><li><router-link to="#drivermanager">DriverManager</router-link></li><li><router-link to="#connection">Connection</router-link></li><li><router-link to="#statement-与-preparedstatement">Statement 与 PreparedStatement</router-link></li><li><router-link to="#resultset">ResultSet</router-link></li></ul></li><li><router-link to="#crud-操作">CRUD 操作</router-link></li><li><router-link to="#练习">练习</router-link></li></ul></nav>
<h2 id="jdbc-概述" tabindex="-1"><a class="header-anchor" href="#jdbc-概述" aria-hidden="true">#</a> JDBC 概述</h2>
<p>JDBC 全称:Java DataBase Connectivity;是由 SUN 公司提供的一套通用的 Java 连接数据的标准（接口），这套接口用于屏蔽数据库之间的差异（方言），使得 Java 程序员可以专注于处理数据而不需要考虑数据库之间的差异；</p>
<p><img src="@source/notes/java/04/01-JDBC入门/assets/1607477170410.png" alt="1607477170410"></p>
<p>JDBC 这套标准所有的类和接口都位于<code v-pre>java.sql</code>包中。</p>
<h2 id="入门案例" tabindex="-1"><a class="header-anchor" href="#入门案例" aria-hidden="true">#</a> 入门案例</h2>
<p>第一个 JDBC 程序:</p>
<p><strong>实现添加一条固定的数据到表格中</strong></p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 1.加载数据库驱动</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="jdbc-常见类与接口" tabindex="-1"><a class="header-anchor" href="#jdbc-常见类与接口" aria-hidden="true">#</a> JDBC 常见类与接口</h2>
<h3 id="drivermanager" tabindex="-1"><a class="header-anchor" href="#drivermanager" aria-hidden="true">#</a> DriverManager</h3>
<p>DriverManager 是 java.sql 包中提供的一个用于进行数据库驱动管理的工具类，对于驱动的注册，以及连接的获取都可以通过 DriverManager 来完成，另外从 jdbc4 开始，不再需要显示的使用<code v-pre>Class.forName(&quot;com.mysql.jdbc.Driver&quot;)</code>加载驱动；因为 DriverManager 会自动寻找驱动包里面的以下文件:</p>
<p><img src="@source/notes/java/04/01-JDBC入门/assets/1607485243871.png" alt="1607485243871"></p>
<p>DriverManager 提供的常见方法：</p>
<ul>
<li>
<p><strong>getConnection(String url,String user,String password)</strong></p>
</li>
<li>
...
<h3 id="connection" tabindex="-1"><a class="header-anchor" href="#connection" aria-hidden="true">#</a> Connection</h3>
<p>Connection 是 JDBC 中的核心接口位于<code v-pre>java.sql</code>包，用于实现应用程序和数据库管理系统（DBMS）进行通信一个通道，通过该接口可以向数据库发送可以执行 sql 脚本，以及将执行之后的结果返回到程序中。connection 即数据库与应用程序之间的一个会话(session)</p>
<p>常用方法：</p>
<ul>
<li>createStatement() :获取一个用于执行 sql 语句的执行对象，主要用于执行静态的 sql（存在 SQL 注入风险）</li>
<li>prepareStatement(String sql) :获取一个预处理 sql 语句的执行对象，预先对 sql 语句编译，一般用于执行动态 sql（解决 SQL 注入风险）</li>
<li>prepareCall(String sql)：获取一个用于预处理 sql 存储过程的执行对象，主要用于执行存储过程（procedure）</li>
<li>setAutoCommit(boolean b)：设置事物是否自动提交</li>
<li>commit()：提交事务</li>
<li>rollback()：事物回滚</li>
<li>getMetaData(): 获取数据库的元数据对象（DatabaseMetaData），包含了数据库的详细信息</li>
</ul>
<h3 id="statement-与-preparedstatement" tabindex="-1"><a class="header-anchor" href="#statement-与-preparedstatement" aria-hidden="true">#</a> Statement 与 PreparedStatement</h3>
<h4 id="statement" tabindex="-1"><a class="header-anchor" href="#statement" aria-hidden="true">#</a> Statement</h4>
<p>Statement 是来自<code v-pre>java.sql</code>包中用于执行 sql 语句的处理接口对象，该接口声明了一些用于执行 sql 语句的相关方法，常见如下：</p>
<ul>
<li>execute(String sql)：用于执行任何的 sql 语句</li>
<li>executeQuery(String sql)：主要用于执行 sql 查询(Select)操作</li>
<li>executeUpdate(String sql)：主要用于执行 sql 更新(insert,update,delete)操作以及 DDL 操作</li>
<li>addBatch(String sql)：用于将 sql 语句添加到当前 Statement 对象的命令列表中用于批量执行 sql</li>
<li>executeBatch()：用于将一批（多条 sql）sql 命令同时执行</li>
<li>getResultSet()：获取执行当前 SQL 语句之后的结果集对象（ResultSet）</li>
<li>getGeneratedKeys()：获取自动生成的键所在结果集</li>
</ul>
<p>具体使用如下:</p>
...
<p>通过对以上代码的观察发现，如果需要实现动态的数据操作，则需要对 sql 语句进行字符串拼接，使得 sql 语句编写起来比较麻烦，并且使用过程中存在 SQL 注入的风险：</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>若调用该方法时按如下格式提供方法参数值：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//select * from user where username='asdfasdf' and password='' or '1'='1'</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>分析得知，无论账号如何提供，子需要密码按照第二个参数的写法，即可绕过登录过程直接输出如下结果:</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>登录成功
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>因为使用 Statement 不仅会存在字符串拼接的复杂问题，还会导致 SQL 注入的风险；因此 JDBC 中针对该问题从 Statement 接口还扩展了一个子接口<code v-pre>java.sql.PraparedStatement</code>用于解决以上问题:</p>
<h4 id="preparedstatement" tabindex="-1"><a class="header-anchor" href="#preparedstatement" aria-hidden="true">#</a> PreparedStatement</h4>
<p>PreparedStatement 是从 Statement 接口继承而来，使用该接口可以有效的避免 sql 注入以及字符串拼接的问题:</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">JDBCDemo3</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="resultset" tabindex="-1"><a class="header-anchor" href="#resultset" aria-hidden="true">#</a> ResultSet</h3>
<p>结果集对象，用于表示对于查询语句执行之后的结果，内部的数据可能是一条也可以是多条</p>
<p>ResultSet 常见方法：</p>
<ul>
<li>boolean next() ： 判断是否有下一个结果行</li>
<li>getXXX(int index)：根据列索引获取列值</li>
<li>getXXX(String columnLabel)：根据列标签（默认列名）获取值</li>
<li>ResultSetMetaData getMetaData()：返回结果集的元数据</li>
</ul>
<p><img src="@source/notes/java/04/01-JDBC入门/assets/1652535020110.png" alt="1652535020110"></p>
<p>ResultSet 的基本使用：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token class-name">String</span> sql <span class="token operator">=</span> <span class="token string">"select * from user"</span><span class="token punctuation">;</span>
...
<ol>
<li>
<p>要求实现 JDBC 基本封装，将以下几行重复代码封装起来，提供简单的方式进行调用</p>
...
<li>
<p>完成一个简单的用户管理系统，其中用户的信息包含以下：</p>
<ul>
<li>用户 id/用户名/密码/性别/生日/手机号/账户状态</li>
</ul>
<p>要求实现以下功能：</p>
<ol>
<li>用户登录</li>
...
<li>查询所有用户</li>
<li>修改指定 id 的用户密码</li>
<li>修改指定 id 用户的登录状态</li>
<li>根据 id 删除指定用户</li>
</ol>
<p>说明：以上所有功能的实现都必须先经过登陆之后才可完成，另外登录功能需要验证用户的账户状态(0:账户不可用、1:账户可用)，登录失败时提示友好的信息（账号不正确、密码错误、账户不可用）</p>
</li>
</ol>
</div></template>
