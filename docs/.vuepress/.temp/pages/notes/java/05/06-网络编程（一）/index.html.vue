<template><div><h1 id="_06-网络编程-一" tabindex="-1"><a class="header-anchor" href="#_06-网络编程-一" aria-hidden="true">#</a> 06 - 网络编程（一） 🤺</h1>
<nav class="table-of-contents"><ul><li><router-link to="#软件结构">软件结构</router-link><ul><li><router-link to="#cs-结构">CS 结构</router-link></li><li><router-link to="#bs-结构">BS 结构</router-link></li></ul></li><li><router-link to="#计算机网络">计算机网络</router-link><ul><li><router-link to="#概述">概述</router-link></li><li><router-link to="#网络分类">网络分类</router-link></li><li><router-link to="#网络协议">网络协议</router-link></li></ul></li><li><router-link to="#ip-与端口-port">IP 与端口(port)</router-link><ul><li><router-link to="#ip">IP</router-link></li><li><router-link to="#端口">端口</router-link></li></ul></li><li><router-link to="#inetaddress-类-ip-地址的-java-对象表示形式">InetAddress 类(ip 地址的 Java 对象表示形式)</router-link><ul><li><router-link to="#常见方法">常见方法</router-link></li><li><router-link to="#localhost-与-127-0-0-1">localhost 与 127.0.0.1</router-link></li></ul></li><li><router-link to="#inetsocketaddress-inetaddress-port-组合">InetSocketAddress（InetAddress+port 组合）</router-link><ul><li><router-link to="#常见构造器">常见构造器</router-link></li><li><router-link to="#常见方法-1">常见方法</router-link></li></ul></li><li><router-link to="#socket-之-tcp-通信">Socket 之 TCP 通信</router-link><ul><li><router-link to="#socket-概述">Socket 概述</router-link></li><li><router-link to="#serversocket-服务端套接字">ServerSocket(服务端套接字)</router-link></li><li><router-link to="#socket">Socket</router-link></li></ul></li><li><router-link to="#综合案例-文件传输服务">综合案例:文件传输服务</router-link><ul><li><router-link to="#服务端">服务端</router-link></li><li><router-link to="#客户端">客户端</router-link></li></ul></li><li><router-link to="#思考">思考</router-link></li></ul></nav>
<h2 id="软件结构" tabindex="-1"><a class="header-anchor" href="#软件结构" aria-hidden="true">#</a> 软件结构</h2>
<p>在互联网的软件结构中主要分为两种结构模式:</p>
<ol>
<li>CS 结构:Client/Server</li>
<li>BS 结构:Browser/Server</li>
</ol>
<h3 id="cs-结构" tabindex="-1"><a class="header-anchor" href="#cs-结构" aria-hidden="true">#</a> CS 结构</h3>
<p>CS:客户端/服务器模式，在这种结构下，我们需要先在终端（PC/手机/平板）下载相关的客户端程序，连接到服务端使用软件相关的功能，这种结构如下：</p>
<p><img src="@source/notes/java/05/06-网络编程（一）/assets/1610776198031.png" alt="1610776198031"></p>
<ul>
<li>优点:用户体验好，对网络要求相对较低</li>
<li>缺点:对硬件要求高,软件升级需要推送到服务端,所有客户都需要重新安装</li>
</ul>
<h3 id="bs-结构" tabindex="-1"><a class="header-anchor" href="#bs-结构" aria-hidden="true">#</a> BS 结构</h3>
<p>BS:浏览器/服务器模式，在这种结构下，任何软件的使用不需要下载客户端程序，只需终端支持浏览器即可（all in one）,所有的程序都可以直接通过浏览器打开，实现真正的即用即走思想。BS 结构如下:</p>
<p><img src="@source/notes/java/05/06-网络编程（一）/assets/1610776555495.png" alt="1610776555495"></p>
<ul>
<li>优点:对硬件要求较低</li>
<li>缺点:对网络的要求较高</li>
</ul>
<p>对于以上两种软件结构来说，无论哪一种都有各自的优劣势，但是两种结构都有一个共同的要求：必需保持<strong>网络连接</strong>，才能使用相关功能</p>
...
<p>计算机网络：通过相关的网络介质连接位于不同地理区域的计算机设备，将这些能够联网的设备连接成一个规模庞大的网络系统，实现设备之间的数据交换，从而达到一种能力：<strong>数据共享</strong>，计算机网络存在的意义:</p>
<ul>
<li>使用远程资源</li>
<li>共享信息、程序和数据</li>
<li>分布式处理</li>
</ul>
<h3 id="网络分类" tabindex="-1"><a class="header-anchor" href="#网络分类" aria-hidden="true">#</a> 网络分类</h3>
<ul>
<li>局域网</li>
<li>城域网（都市网）</li>
<li><strong>广域网</strong></li>
</ul>
<h3 id="网络协议" tabindex="-1"><a class="header-anchor" href="#网络协议" aria-hidden="true">#</a> 网络协议</h3>
<p>计算机设备之间的连接需要两种必要资源：</p>
<ul>
<li>硬件设备（网卡，交换机，路由器，连接介质:光纤，双绞线，同轴电缆）</li>
<li>软件设备（网络协议）</li>
</ul>
<h4 id="协议" tabindex="-1"><a class="header-anchor" href="#协议" aria-hidden="true">#</a> 协议</h4>
<p>通信双方之间约定好的一些通信规则，类似一个组织内部通信暗语；计算中网络连接的底层协议主要分为：TCP/IP 协议与 UDP 协议</p>
<h5 id="tcp-ip-打电话" tabindex="-1"><a class="header-anchor" href="#tcp-ip-打电话" aria-hidden="true">#</a> TCP/IP(打电话)</h5>
<p>​ 传输控制协议，是一个安全可靠的互联网协议，需要通信的主机之间需要先建立正确的链接，才能够进行通信，并且改协议能够保证数据传输稳定性(必须的保证信息发送到一台主机，由该主机确认之后才能发送下一条信息)，另外该协议也能保证数据传输的有序性(先发送的信息一定先到达)。一般基于 C/S 架构，存在服务器客户端模式。</p>
<p>应用领域:远程登陆</p>
<p><img src="@source/notes/java/05/06-网络编程（一）/assets/1610777639798.png" alt="1610777639798"></p>
<h5 id="udp-发快递" tabindex="-1"><a class="header-anchor" href="#udp-发快递" aria-hidden="true">#</a> UDP(发快递)</h5>
<p>User Diagram Protocol（用户数据报协议），是一个不安全的网络协议，不需要双方之间建立联系，也不保证信息传输的有序性(有可能后发消息先到)，传输效率比 TCP/IP 更高.没有专门服务器和客户端，只有发送端和接收端.</p>
<p>应用领域: 广播，视频会议</p>
<p><img src="@source/notes/java/05/06-网络编程（一）/assets/1610777921607.png" alt="1610777921607"></p>
<h5 id="tcp-ip-与-udp-协议应用层协议对比" tabindex="-1"><a class="header-anchor" href="#tcp-ip-与-udp-协议应用层协议对比" aria-hidden="true">#</a> TCP/IP 与 UDP 协议应用层协议对比</h5>
<p><img src="@source/notes/java/05/06-网络编程（一）/assets/1610777990166.png" alt="1610777990166"></p>
<h2 id="ip-与端口-port" tabindex="-1"><a class="header-anchor" href="#ip-与端口-port" aria-hidden="true">#</a> IP 与端口(port)</h2>
<h3 id="ip" tabindex="-1"><a class="header-anchor" href="#ip" aria-hidden="true">#</a> IP</h3>
<p>IP:Internet Protocol 互联网协议，表示当前主机在网络中的位置(同一个网络系统中是独一无二的)；简单的认为:ip 即主机在网络中的位置</p>
<p>IP 地址目前主要分为两类:</p>
<ul>
<li>IPV4：32 位，4 个字节组成，取值范围位：0~255；目前全球可用的 ipv4 地址也就 40 多亿</li>
<li>IPV6：128 位，126 个字节组成，可取的地址“无穷无尽”</li>
</ul>
<p>其中 IPV4 主要分为 5 类，目前民用主要位于 C 类地址:</p>
<p><img src="@source/notes/java/05/06-网络编程（一）/assets/1610778605557.png" alt="1610778605557"></p>
<blockquote>
<p>ip 地址就类似家庭住址(精确到街道)</p>
</blockquote>
<h3 id="端口" tabindex="-1"><a class="header-anchor" href="#端口" aria-hidden="true">#</a> 端口</h3>
<p>计算机设备能够联网的应用种类很多，但是如果需要精确的找到某一个的应用程序，则该应用程序就需要存在一个对外的独一无二的通信端点，这个端点称之为:端口号；</p>
<p>端口号的可选择范围: 0~65535 之间</p>
<p>端口也分为三类：</p>
<ul>
<li>公端认口:0~1023 之间，理论上不应该为你的应用程序分配这些端口，因为这些端口密集绑定了一些固定的服务</li>
<li><strong>注册端口:1024~49151 之间，一般建议将应用程序的端口在这个范围内选择；位于这个区域的端口松散的绑定了部分服务</strong></li>
<li>动态端口/私有端口：从 49152 到 65535。理论上不应为服务分配这些端口</li>
</ul>
<p>常用 TCP 端口占用情况:</p>
<p><img src="@source/notes/java/05/06-网络编程（一）/assets/1610779132059.png" alt="1610779132059"></p>
<blockquote>
<p>端口就类似家庭住址的所在门牌号</p>
</blockquote>
<h2 id="inetaddress-类-ip-地址的-java-对象表示形式" tabindex="-1"><a class="header-anchor" href="#inetaddress-类-ip-地址的-java-对象表示形式" aria-hidden="true">#</a> InetAddress 类(ip 地址的 Java 对象表示形式)</h2>
<p><code v-pre>java.net.InetAddress</code>类是来自<code v-pre>java.net</code>包中，用于表示一个 ip 地址的 Java 类，内部包含目标主机的<strong>主机名和 ip 地址</strong></p>
<h3 id="常见方法" tabindex="-1"><a class="header-anchor" href="#常见方法" aria-hidden="true">#</a> 常见方法</h3>
<ul>
<li>getByName(String host)：根据提供的 IP 地址或者主机名称获取当前主机所表示的 IP 地址对象</li>
<li>getAllByName(String host)：获取所有符合主机名称的主机 ip 对象</li>
<li>getLocalHost()：获取本地主机 ip 对象</li>
</ul>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//根据提供的主机名获取主机所在的ip地址对象</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="localhost-与-127-0-0-1" tabindex="-1"><a class="header-anchor" href="#localhost-与-127-0-0-1" aria-hidden="true">#</a> localhost 与 127.0.0.1</h3>
<ul>
<li>localhost 是本地主机的<strong>域名</strong>表示形式</li>
<li>127.0.0.1 是本地主机的<strong>ip</strong>表示形式</li>
</ul>
<h2 id="inetsocketaddress-inetaddress-port-组合" tabindex="-1"><a class="header-anchor" href="#inetsocketaddress-inetaddress-port-组合" aria-hidden="true">#</a> InetSocketAddress（InetAddress+port 组合）</h2>
<p>InetSocketAddress 类是从 SocketAddress（抽象类）继承而来，内部表示为 ip 地址对象与端口的结合，称之为 ip 套接字(主机对外通信的桥梁)</p>
<h3 id="常见构造器" tabindex="-1"><a class="header-anchor" href="#常见构造器" aria-hidden="true">#</a> 常见构造器</h3>
<ul>
<li>InetSocketAddress(String host,int port)</li>
<li>InetSocketAddress(InetAddress ip,int port)</li>
</ul>
<h3 id="常见方法-1" tabindex="-1"><a class="header-anchor" href="#常见方法-1" aria-hidden="true">#</a> 常见方法</h3>
<ul>
...
<h3 id="socket-概述" tabindex="-1"><a class="header-anchor" href="#socket-概述" aria-hidden="true">#</a> Socket 概述</h3>
<p>socket 又称为<strong>套接字</strong>，用于实现两台主机之间通信的端点（桥梁），基于 TCP 通信协议的套接字类主要由以下两个类构成:</p>
<ul>
<li>ServerSocket</li>
<li>Socket</li>
</ul>
<p>基于 Socket 的 TCP 通信主要由两个方法分别获取基于 Socket 的输入流和输出流，然后通过 input/output 的原理实现主机之间的信息交换：</p>
<p><img src="@source/notes/java/05/06-网络编程（一）/assets/1610789115848.png" alt="1610789115848"></p>
<h3 id="serversocket-服务端套接字" tabindex="-1"><a class="header-anchor" href="#serversocket-服务端套接字" aria-hidden="true">#</a> ServerSocket(服务端套接字)</h3>
<p>ServerSocket 提供的是服务端套接字功能，通过该类可以创建任何的网络服务程序。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">MyServer</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="socket" tabindex="-1"><a class="header-anchor" href="#socket" aria-hidden="true">#</a> Socket</h3>
<p>Socket 提供的是客户端套接字功能，该类可以连接指定地址指定端口的服务</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">MyClient</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="综合案例-文件传输服务" tabindex="-1"><a class="header-anchor" href="#综合案例-文件传输服务" aria-hidden="true">#</a> 综合案例:文件传输服务</h2>
<p>案例结合 IO 流、多线程、网络编程三个 java 高级知识点实现，原理图如下：</p>
<p><img src="@source/notes/java/05/06-网络编程（一）/assets/1610789245845.png" alt="1610789245845"></p>
<p>以上原理解释：</p>
<ol>
<li>服务端读取本地文件到内存中</li>
<li>通过 socket 的输出流将字节数据输出</li>
<li>客户端获取 socket 输入流</li>
<li>将流中的字节数据通过客户端文件的输出流输出，完成下载</li>
</ol>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">FileDownloadClient</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="思考" tabindex="-1"><a class="header-anchor" href="#思考" aria-hidden="true">#</a> 思考</h2>
<ol>
<li><strong>如何将上述文件传输的代码进行优化（减少重复代码）</strong></li>
<li>如何实现一个目录的共享(对象序列化)
<ol>
<li>服务端启动</li>
<li>客户端连接服务端</li>
<li>客户端看到可下载的文件列表（序号-&gt;文件名）</li>
<li>客户端发送文件序号到服务端</li>
<li>服务端接收到需要找到对应文件</li>
<li>服务端将目标文件传输到客户端</li>
<li>客户端下载文件存储到本地</li>
</ol>
</li>
<li>实现一个多线程的聊天室</li>
