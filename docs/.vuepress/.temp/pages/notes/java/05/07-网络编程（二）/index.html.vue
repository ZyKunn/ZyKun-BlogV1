<template><div><h1 id="_07-网络编程-二" tabindex="-1"><a class="header-anchor" href="#_07-网络编程-二" aria-hidden="true">#</a> 07 - 网络编程（二） 🏄</h1>
<nav class="table-of-contents"><ul><li><router-link to="#基于-tcp-的-socket-通信案例讲解">基于 TCP 的 Socket 通信案例讲解</router-link><ul><li><router-link to="#文件服务器实现">文件服务器实现</router-link></li><li><router-link to="#聊天室实现">聊天室实现</router-link></li></ul></li><li><router-link to="#基于-udp-协议的-socket-通信">基于 UDP 协议的 Socket 通信</router-link><ul><li><router-link to="#概述">概述</router-link></li><li><router-link to="#datagramsocket-udp-网络通道">DatagramSocket（UDP 网络通道）</router-link></li><li><router-link to="#datagrampacket-数据报包">DatagramPacket（数据报包）</router-link></li><li><router-link to="#udp-通信实例">UDP 通信实例</router-link></li><li><router-link to="#udp-通信之与飞秋通信实例">UDP 通信之与飞秋通信实例</router-link></li><li><router-link to="#udp-数据广播之-multicastsocket">UDP 数据广播之 MulticastSocket</router-link></li><li><router-link to="#"></router-link></li></ul></li><li><router-link to="#作业">作业</router-link></li></ul></nav>
<h2 id="基于-tcp-的-socket-通信案例讲解" tabindex="-1"><a class="header-anchor" href="#基于-tcp-的-socket-通信案例讲解" aria-hidden="true">#</a> 基于 TCP 的 Socket 通信案例讲解</h2>
<h3 id="文件服务器实现" tabindex="-1"><a class="header-anchor" href="#文件服务器实现" aria-hidden="true">#</a> 文件服务器实现</h3>
<p><img src="@source/notes/java/05/07-网络编程（二）/assets/1610872258160.png" alt="1610872258160"></p>
<h3 id="聊天室实现" tabindex="-1"><a class="header-anchor" href="#聊天室实现" aria-hidden="true">#</a> 聊天室实现</h3>
<p><img src="@source/notes/java/05/07-网络编程（二）/assets/1610872274378.png" alt="1610872274378"></p>
<p><img src="@source/notes/java/05/07-网络编程（二）/assets/1610872293282.png" alt="1610872293282"></p>
<h2 id="基于-udp-协议的-socket-通信" tabindex="-1"><a class="header-anchor" href="#基于-udp-协议的-socket-通信" aria-hidden="true">#</a> 基于 UDP 协议的 Socket 通信</h2>
<h3 id="概述" tabindex="-1"><a class="header-anchor" href="#概述" aria-hidden="true">#</a> 概述</h3>
<p>​ UDP(User Datagram Protocol)用户数据报协议，在这种协议之下，通信的双方之间不需要建立稳定可靠的连接，UDP 协议下没有服务端和客户端的概念，只存在发送方和接收方（发送方也可能是接收方：例如飞秋）；数据的传输模式是以<strong>报文的形式发送（TCP 基于输入输出流）</strong>；类似于快递包裹的投递，UDP 协议不保证数据发送的安全性，可能会出现数据报包丢失(丢包)，导致数据传输的卡顿，但是数据报包的偶尔丢失对于用户来说无关紧要；数据报包的到达也不一定是有序的，可能会出现后发先到；UDP 协议的使用场景十分常见：</p>
<p>例如:</p>
<ul>
<li>视频会议</li>
<li>屏幕广播</li>
...
<blockquote>
<p>TCP：打电话（必须先接通，才能通话）</p>
<p>UDP：发快递（无需建立稳定连接）</p>
</blockquote>
<h3 id="datagramsocket-udp-网络通道" tabindex="-1"><a class="header-anchor" href="#datagramsocket-udp-网络通道" aria-hidden="true">#</a> DatagramSocket（UDP 网络通道）</h3>
<p>DatagramSocket 用于构建一个无连接的网络通道，通过该对象可以实现消息的发送(send)和消息的接收(receive)。</p>
...
<p>常见方法：</p>
<ul>
<li>send(DatagramPacket dp)：发送数据报包</li>
<li>receive(DatagramPacket dp)：接收数据存储到数据报包中</li>
</ul>
<h3 id="datagrampacket-数据报包" tabindex="-1"><a class="header-anchor" href="#datagrampacket-数据报包" aria-hidden="true">#</a> DatagramPacket（数据报包）</h3>
<p>DatagramPacket 用于表示数据报包，内部通过字节数组作为缓冲区存储或者接收数据.</p>
<p><strong>常见构造器：</strong></p>
<ul>
<li>DatagramPacket(byte[] buff,int len)</li>
<li>DatagramPacket(byte[] buff,int offset ,int len,InetAddress addr,int port)</li>
</ul>
<p><strong>常见方法：</strong></p>
<ul>
<li>getLength():获取数据报包裹中实际的字节长度</li>
</ul>
<h3 id="udp-通信实例" tabindex="-1"><a class="header-anchor" href="#udp-通信实例" aria-hidden="true">#</a> UDP 通信实例</h3>
<h4 id="发送方" tabindex="-1"><a class="header-anchor" href="#发送方" aria-hidden="true">#</a> 发送方</h4>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Sender</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="接收方" tabindex="-1"><a class="header-anchor" href="#接收方" aria-hidden="true">#</a> 接收方</h4>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Receiver</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="udp-通信之与飞秋通信实例" tabindex="-1"><a class="header-anchor" href="#udp-通信之与飞秋通信实例" aria-hidden="true">#</a> UDP 通信之与飞秋通信实例</h3>
<p>飞秋的消息发送实现也是基于 UDP 协议的，如果我们熟悉飞秋消息的组织方式，即可通过编写 Java 程序向飞秋发送消息：</p>
<p>飞秋的消息发送协议如下:</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>版本号:消息识别号:发送人昵称:发送人主机地址:命令字:消息内容
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><blockquote>
<p>其中：</p>
<p>版本号固定为<code v-pre>1</code></p>
<p>消息识别号:保持唯一即可（一般使用系统时间）</p>
<p>发送昵称可以任意编写</p>
<p>发送主机地址可伪装，即任意编写</p>
<p>命令字：32 固定表示为消息发送</p>
<p>消息内容：实际需要发送到目标地址的消息内容</p>
<p>例如:</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>1:100:刘德华:liudehua:32:hello飞秋
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></blockquote>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">FeiQUtils</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="udp-数据广播之-multicastsocket" tabindex="-1"><a class="header-anchor" href="#udp-数据广播之-multicastsocket" aria-hidden="true">#</a> UDP 数据广播之 MulticastSocket</h3>
<p>在传统的互联网架构之下，一台主机需要将消息发送的多台不同的主机时 中间是经过了交换机(路由器)，如果需要进行消息的群发，此时在 TCP 协议之下，发送方需要将消息制作 N 份拷贝发给交换机，然后交换机再将这些消息分发给局域网中其他主机，这样一来，大大增加网络负担。</p>
<p><img src="@source/notes/java/05/07-网络编程（二）/assets/1610868786927.png" alt="1610868786927"></p>
<p>因此，在 UDP 协议中，提供了组播功能（数据广播），使用 UDP 数据广播，只需要将消息发送一次到交换机，交换机会将消息制作 N 份拷贝，发送到位于该广播组内的所有其他主机。类似如下结构:</p>
<p><img src="@source/notes/java/05/07-网络编程（二）/assets/1610868996313.png" alt="1610868996313"></p>
<p>使用 UDP 数据广播时，需要提供一个数据广播地址，该地址为 IP 地址的 D 类地址,可选范围为:<code v-pre>224.0.0.0</code>~<code v-pre>239.255.255.255</code>之间，并且广播消息的发送方和接收方需要加入该广播地址：</p>
<h4 id="发送广播" tabindex="-1"><a class="header-anchor" href="#发送广播" aria-hidden="true">#</a> 发送广播</h4>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">BoradcastSender</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="接收广播" tabindex="-1"><a class="header-anchor" href="#接收广播" aria-hidden="true">#</a> 接收广播</h4>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">BordercastReceiver</span> <span class="token punctuation">{</span>
...
<ol>
<li>
<p>基于 UDP 协议实现一个聊天室</p>
</li>
<li>
<p>基于 TCP/IP 协议完成一个远程登陆功能</p>
<p><img src="@source/notes/java/05/07-网络编程（二）/assets/1610871562834.png" alt="1610871562834"></p>
</li>
</ol>
</div></template>
