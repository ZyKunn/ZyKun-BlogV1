<template><div><h1 id="_09-反射-框架的设计灵魂" tabindex="-1"><a class="header-anchor" href="#_09-反射-框架的设计灵魂" aria-hidden="true">#</a> 09 - 反射：框架的设计灵魂 ⭐</h1>
<nav class="table-of-contents"><ul><li><router-link to="#class-对象功能">Class 对象功能</router-link></li></ul></nav>
<ul>
<li>
...
<p>（多数用于配置文件，将类名定义在配置文件中。读取文件，加载类）</p>
</li>
<li>
...
<li>
<p>对象.getClass(): getClass 方法在 Object 类中定义的</p>
<p>（多用于对象的获取字节码的方式）</p>
</li>
</ol>
</li>
</ul>
<p><img src="@source/notes/java/05/09-反射/assets/1618563471583.png" alt="1618563471583"></p>
<p><img src="@source/notes/java/05/09-反射/assets/1618565068053.png" alt="1618565068053"></p>
<p><img src="@source/notes/java/05/09-反射/assets/1618565088510.png" alt="1618565088510"></p>
<p>结论： 通过同一个字节码文件（.Class）在一次程序运行过程中，只会被加载一次，无论通过那一种方式获取的 class 对象都是同一个</p>
<h2 id="class-对象功能" tabindex="-1"><a class="header-anchor" href="#class-对象功能" aria-hidden="true">#</a> Class 对象功能</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/notes/java/05/09-反射/assets/1618569358836.png" alt="1618569358836"></p>
<p><img src="@source/notes/java/05/09-反射/assets/1618569410323.png" alt="1618569410323"></p>
</li>
<li>
<p>获取构造方法们 construction [ ]</p>
...
<li>
<p>获取类名</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token class-name">String</span>	<span class="token function">getName</span><span class="token punctuation">(</span><span class="token punctuation">)</span> 	<span class="token comment">//获取类名</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li>
</ol>
<h4 id="field-成员变量" tabindex="-1"><a class="header-anchor" href="#field-成员变量" aria-hidden="true">#</a> Field：成员变量</h4>
<p>操作：</p>
<ol>
<li>
<p>设置值</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token class-name">Object</span>	<span class="token function">get</span><span class="token punctuation">(</span><span class="token class-name">Object</span> obj<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li>
<li>
<p>获取值</p>
...
<h4 id="construction-构造方法" tabindex="-1"><a class="header-anchor" href="#construction-构造方法" aria-hidden="true">#</a> Construction:构造方法</h4>
<p>创建对象</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><code v-pre>如果使用空参数构造方法创建对象，控制可以简化：class对象的newInstance</code></p>
<h4 id="method-方法" tabindex="-1"><a class="header-anchor" href="#method-方法" aria-hidden="true">#</a> Method：方法</h4>
<p>执行方法：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>获取方法名称</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token class-name">String</span> <span class="token function">getName</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
