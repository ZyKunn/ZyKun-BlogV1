<template><div><h1 id="_03-线程-一" tabindex="-1"><a class="header-anchor" href="#_03-线程-一" aria-hidden="true">#</a> 03 - 线程（一） 👾</h1>
<nav class="table-of-contents"><ul><li><router-link to="#线程概述">线程概述</router-link><ul><li><router-link to="#并发与并行">并发与并行</router-link></li><li><router-link to="#进程与线程">进程与线程</router-link></li><li><router-link to="#线程概述-1">线程概述</router-link></li></ul></li><li><router-link to="#线程创建与启动">线程创建与启动</router-link><ul><li><router-link to="#线程创建">线程创建</router-link></li><li><router-link to="#启动线程">启动线程</router-link></li><li><router-link to="#线程池">线程池</router-link></li><li><router-link to="#线程综合案例-文件监控">线程综合案例：文件监控</router-link></li><li><router-link to="#使用匿名内部类创建并启动线程">使用匿名内部类创建并启动线程</router-link></li></ul></li><li><router-link to="#thread-类">Thread 类</router-link><ul><li><router-link to="#构造器">构造器</router-link></li><li><router-link to="#常见方法">常见方法</router-link></li><li><router-link to="#线程优先级">线程优先级</router-link></li><li><router-link to="#守护线程">守护线程</router-link></li><li><router-link to="#join-线程-插队">join 线程(插队)</router-link></li></ul></li><li><router-link to="#线程中断">线程中断</router-link><ul><li><router-link to="#标记中断">标记中断</router-link></li></ul></li><li><router-link to="#多线程编程-gui-详情代码请查看代码文件夹">多线程编程(GUI)详情代码请查看代码文件夹</router-link></li></ul></nav>
<h2 id="线程概述" tabindex="-1"><a class="header-anchor" href="#线程概述" aria-hidden="true">#</a> 线程概述</h2>
<p>​ 在之前所接触任何 java 程序的执行流程，都是先从 mian 方法开始，从上往下依次执行，其中任何一个步骤出现异常或者错误，都会导致程序结束（JVM 退出）；在这种情况下，程序的稳定性无法得到保障，因此，在程序中需要有一种并行或者并发的机制，使得程序能够同时执行多个任务。</p>
<h3 id="并发与并行" tabindex="-1"><a class="header-anchor" href="#并发与并行" aria-hidden="true">#</a> 并发与并行</h3>
<ul>
<li>并发：在一个<strong>时间段</strong>之内同时执行多个任务，但是同一时间点只有一个任务运行（单核 CPU 时代）</li>
<li>并行：在同一个<strong>时间点</strong>同时执行多个任务（要求的系统 CPU 具备多核能力）</li>
</ul>
<p><img src="@source/notes/java/05/03-线程（一）/assets/1610500109744.png" alt="1610500109744"></p>
<blockquote>
<p>并行和并发通俗解释：</p>
<ol>
<li>你在吃饭，电话来了，你先吃完饭，然后接电话（不并行，也不并发）</li>
<li>你在吃饭，电话来了，你先暂停吃饭，然后接电话，接完之后继续吃饭(并发)</li>
<li>你在吃饭，电话来了，你拿起电话一边接电话一边吃饭(并行)</li>
</ol>
</blockquote>
<h3 id="进程与线程" tabindex="-1"><a class="header-anchor" href="#进程与线程" aria-hidden="true">#</a> 进程与线程</h3>
<p>​ 目前的操作系统是一个支持多任务的系统（可以&quot;同时&quot;运行多个应用程序），计算机中的每一个任务称之为进程,进程即一个应用程序（windows 系统中一个 exe 文件），但是一个应用程序内部可能又存在多个子任务，比如正在运行的 360 卫士，可以同时执行垃圾清理，开机启动优化，后台检查更新等任务，正在运行的程序称之为一个进程，每一个子任务称之为线程。</p>
<ul>
<li>进程：一个应用程序称之为进程（食堂打饭）</li>
<li>线程：进程中的一条执行路径（每一个打饭的窗口）</li>
</ul>
<p><img src="@source/notes/java/05/03-线程（一）/assets/1610516258800.png" alt="1610516258800"></p>
<blockquote>
<p>每一个进程的运行都需要有系统分配独立的运行空间(内存)</p>
</blockquote>
<h3 id="线程概述-1" tabindex="-1"><a class="header-anchor" href="#线程概述-1" aria-hidden="true">#</a> 线程概述</h3>
<p>线程是进程中的一条执行路径(一个进程可以包含多个线程)，每个进程中至少有一条线程，在一个进程中的多个线程是共享该进程的内存空间的，线程一般分为通用的五种状态（线程生命周期）：</p>
<ul>
<li>新建状态（New）</li>
<li>就绪状态（Runnable）</li>
<li>运行状态（Running）</li>
...
<p><img src="@source/notes/java/05/03-线程（一）/assets/1610516709209.png" alt="1610516709209"></p>
<blockquote>
<p>线程的主要作用在于提高 CPU 的利用率</p>
</blockquote>
<h2 id="线程创建与启动" tabindex="-1"><a class="header-anchor" href="#线程创建与启动" aria-hidden="true">#</a> 线程创建与启动</h2>
<h3 id="线程创建" tabindex="-1"><a class="header-anchor" href="#线程创建" aria-hidden="true">#</a> 线程创建</h3>
<p>java 中创建线程包含三种方式（四种）：</p>
<ul>
<li><strong>继承 Thread</strong></li>
<li><strong>实现 Runnable</strong></li>
<li><strong>实现 Callable 接口</strong></li>
<li>使用线程池*</li>
</ul>
<h4 id="继承-thread-类" tabindex="-1"><a class="header-anchor" href="#继承-thread-类" aria-hidden="true">#</a> 继承 Thread 类</h4>
<p>线程创建的第一种较为简单的方式是：</p>
<ul>
<li>创建一个普通 Java 类继承 Thread 类</li>
<li>重写 run 方法。</li>
</ul>
<p>案例代码:</p>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">MyThread01</span> <span class="token keyword">extends</span> <span class="token class-name">Thread</span><span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="实现-runnable-接口" tabindex="-1"><a class="header-anchor" href="#实现-runnable-接口" aria-hidden="true">#</a> 实现 Runnable 接口</h4>
<p>第二种创建线程的方式为实现 Runnable 接口：</p>
<ul>
<li>创建类实现 Runnable 接口</li>
<li>实现 run 方法</li>
</ul>
...
<p>Callable 接口是 JDK1.5 之后，新增<code v-pre>java.util.concurrent</code>包中新增的接口，用于执行一些并行计算，功能相对 Runnable 接口更为强大，创建方式为实现 Callable 接口：</p>
<ul>
<li>创建类实现 Callable 接口</li>
<li>实现 call 方法</li>
</ul>
...
<ul>
<li>优点：简单方便(只需要继承 Thread 类，即可创建当前类对象调用 start 启动线程)</li>
<li>缺点：影响扩展性(一旦继承 Thread 则无法再继承其他类，使用比较局限)</li>
</ul>
<ol start="2">
<li>实现 Runnable 接口</li>
</ol>
<ul>
<li>优点：不影响程序的扩展性（类还可以继承其他类或者实现其他接口）</li>
<li>缺点：使用相对继承 Thread 复杂(创建 Runnable 对象之后，最终依然需要 Thread 创建并且启动线程)</li>
</ul>
<ol start="3">
<li>实现 Callable 接口</li>
</ol>
<ul>
<li>优点：方法允许有任意类型的返回值，方法可以抛出异常，适合做一些分布式计算</li>
<li>缺点：使用比较复杂（需要依赖 FutureTask 类完成 Runnable 对象创建，然后还需要 Thread 创建并启动）</li>
</ul>
</blockquote>
<h3 id="启动线程" tabindex="-1"><a class="header-anchor" href="#启动线程" aria-hidden="true">#</a> 启动线程</h3>
<h4 id="继承-thread-类-1" tabindex="-1"><a class="header-anchor" href="#继承-thread-类-1" aria-hidden="true">#</a> 继承 Thread 类</h4>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//创建线程对象</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="实现-runnable-接口-1" tabindex="-1"><a class="header-anchor" href="#实现-runnable-接口-1" aria-hidden="true">#</a> 实现 Runnable 接口</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="实现-callable-接口-jdk1-5" tabindex="-1"><a class="header-anchor" href="#实现-callable-接口-jdk1-5" aria-hidden="true">#</a> 实现 Callable 接口（JDK1.5）</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="线程池" tabindex="-1"><a class="header-anchor" href="#线程池" aria-hidden="true">#</a> 线程池</h3>
<p>Java 中线程对象的创建需要一定的时间开销，如果频繁创建，销毁必然对内存以及程序的运行效率产生影响，因此，Java 中提供线程池解决方案，允许通过资源的池的概念对线程进行统一管理，尽可能节省不必要的内存以及时间的开销。Java 中的线程池包含四种类型：</p>
<ul>
<li>newCachedThreadPool() ：由程序决定需要创建任意个线程的线程池对象</li>
<li><strong>newFiexdThreadPool(int count)</strong>：创建一个固定核心线程数的线程池</li>
<li><strong>newScheduledThreadPool(int count)</strong>：创建一个核心线程数为指定数目的定时调度线程</li>
<li><strong>newSingleThreadExecutor()</strong>：创建单个线程执行器</li>
</ul>
<p>以上线程池对象的创建都需要 Executors 类完成，上述方法都是<code v-pre>java.util.concurrent.Executors</code>类中的静态方法</p>
<h3 id="线程综合案例-文件监控" tabindex="-1"><a class="header-anchor" href="#线程综合案例-文件监控" aria-hidden="true">#</a> 线程综合案例：文件监控</h3>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>子线程每1秒钟一次，判断指定的某个目录下的某个文件是否被修改，如果被修改，
就在Console上打印出“File changed…”, ，最后修改时间
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="使用匿名内部类创建并启动线程" tabindex="-1"><a class="header-anchor" href="#使用匿名内部类创建并启动线程" aria-hidden="true">#</a> 使用匿名内部类创建并启动线程</h3>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">new</span> <span class="token class-name">Thread</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
    <span class="token annotation punctuation">@Override</span>
    <span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">run</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
        <span class="token keyword">for</span> <span class="token punctuation">(</span><span class="token keyword">int</span> i <span class="token operator">=</span> <span class="token number">0</span><span class="token punctuation">;</span> i <span class="token operator">&lt;</span> <span class="token number">10</span><span class="token punctuation">;</span> i<span class="token operator">++</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
            <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token keyword">this</span><span class="token punctuation">.</span><span class="token function">getName</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token operator">+</span><span class="token string">"--"</span><span class="token operator">+</span>i<span class="token punctuation">)</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="thread-类" tabindex="-1"><a class="header-anchor" href="#thread-类" aria-hidden="true">#</a> Thread 类</h2>
<p><code v-pre>java.lang.Thread</code>类是由 JDK 提供的一个用于创建线程对象的核心类，从 Runnable 接口实现而来，提供 Java 的多线程执行能力.</p>
<h3 id="构造器" tabindex="-1"><a class="header-anchor" href="#构造器" aria-hidden="true">#</a> 构造器</h3>
<ul>
<li>Thread()：创建一个默认的 Thread 实例</li>
<li>Thread(String name)：根据提供的线程名称创建 Thread 实例</li>
<li>Thread(Runnable r)：根据提供的 Runnable 对象创建一个 Thread 实例</li>
<li>Thread(Runnable r,String name)：根据提供的 Runnable 对象以及线程名称创建一个 Thread 实例</li>
</ul>
<h3 id="常见方法" tabindex="-1"><a class="header-anchor" href="#常见方法" aria-hidden="true">#</a> 常见方法</h3>
<ul>
<li>static int activeCount()：获取活动线程数</li>
<li>static Thread currentThread()：返回当前正在执行的线程实例</li>
<li>long getId()：获取线程的 id（该 id 在当前线程结束后可以被重用）</li>
<li>String getName()：获取当前线程的名称</li>
</ul>
<p>使用案例:</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">ThreadDemo1</span> <span class="token keyword">extends</span> <span class="token class-name">Thread</span><span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="线程优先级" tabindex="-1"><a class="header-anchor" href="#线程优先级" aria-hidden="true">#</a> 线程优先级</h3>
<p>线程是具备优先级，优先级越高的线程获得的执行机会更多，反之越少；Java 中线程的优先级取值范围从 0~10 之间（默认为:5），java 中设置和获取线程的优先级通过以下两个方法实现:</p>
<ul>
<li>setPriority(int priority)</li>
<li>getPriority()</li>
</ul>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">ThreadDemo2</span> <span class="token keyword">extends</span> <span class="token class-name">Thread</span><span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="守护线程" tabindex="-1"><a class="header-anchor" href="#守护线程" aria-hidden="true">#</a> 守护线程</h3>
<p>​ 守护线程（daemon）也称之后台线程，是为其他主线程提供服务的后台线程，一旦主线程结束，则守护线程也会随之结束，典型的守护线程案例即：JVM 中的垃圾收集器，就是典型的守护线程，一旦程序执行结束，JVM 退出，则垃圾收集线程也会随之结束。</p>
...
<p>以上程序解读:</p>
<p>启动目标线程后，线程中的任务每隔 0.6 秒执行一次，当 i 的到达 5 目标线程计数，此时启动守护线程 ThreadDemo2 并未结束，等到 main 方法中 while 循环执行完成(即主线程执行完毕)，守护线程也随之结束。</p>
</blockquote>
<h3 id="join-线程-插队" tabindex="-1"><a class="header-anchor" href="#join-线程-插队" aria-hidden="true">#</a> join 线程(插队)</h3>
<p>Thread 类中提供的 join 方法允许将当前线程并入到其他线程(即当前线程暂停执行，先执行其他线程)，通过设置并入的时间，当并入时间到达之后，继续执行当前线程，join 方法包含以下两个:</p>
<ul>
<li>join()</li>
<li>join(long milis)</li>
</ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>join 的另一种使用使用方式为：当某个线程执行到一定的时间之后，执行目标线程的 join 方法，此时目标线程会获取所有的执行时间(插队)，当目标线程执行完毕之后才交出执行权，给其他线程执行，如下:</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="线程中断" tabindex="-1"><a class="header-anchor" href="#线程中断" aria-hidden="true">#</a> 线程中断</h2>
<p>大多数时候线程只有在任务执行完毕之后才会终止，但是在程序运行期间可能因为一些特殊的原因，需要提前结束某个线程；此时 java 的线程中提供了几种用于中断线程的方式：</p>
<ul>
<li>异常中断（以抛出运行时异常的方式结束）</li>
<li>直接调用 stop()方法（不推荐，已经过时；会导致对象锁的释放，造成并发修改结果异常）</li>
<li>调用 interrupt()方法 (不推荐)</li>
<li><strong>标记中断法（推荐）</strong></li>
</ul>
<h3 id="标记中断" tabindex="-1"><a class="header-anchor" href="#标记中断" aria-hidden="true">#</a> 标记中断</h3>
<p>原理是:在线程类中声明一个全局的变量用于表示为线程是否结束，然后再 run 方法中根据该状态决定是否执行线程任务，如果线程外部需要将当前线程中止，此时可通过对外提供访问该状态标记的方法，外部可以设置该线程的中断状态(True||False)，以实现线程的中断操作。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="多线程编程-gui-详情代码请查看代码文件夹" tabindex="-1"><a class="header-anchor" href="#多线程编程-gui-详情代码请查看代码文件夹" aria-hidden="true">#</a> 多线程编程(GUI)详情代码请查看代码文件夹</h2>
</div></template>
