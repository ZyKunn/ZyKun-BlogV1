<template><div><h1 id="_04-面向对象程序设计-多态" tabindex="-1"><a class="header-anchor" href="#_04-面向对象程序设计-多态" aria-hidden="true">#</a> 04 - 面向对象程序设计 - 多态 🍮</h1>
<nav class="table-of-contents"><ul><li><router-link to="#hashcode-equals">hashCode &amp; equals</router-link></li><li><router-link to="#多态入门">多态入门</router-link><ul><li><router-link to="#多态的好处">多态的好处</router-link></li></ul></li><li><router-link to="#封装类型">封装类型</router-link><ul><li><router-link to="#基本使用">基本使用</router-link></li><li><router-link to="#装箱拆箱">装箱拆箱</router-link></li></ul></li><li><router-link to="#string-类">String 类</router-link><ul><li><router-link to="#常见构造器">常见构造器</router-link></li><li><router-link to="#string-常用方法使用">String 常用方法使用:</router-link></li></ul></li><li><router-link to="#动态数组参数">动态数组参数</router-link></li><li><router-link to="#作业">作业</router-link></li></ul></nav>
<h2 id="hashcode-equals" tabindex="-1"><a class="header-anchor" href="#hashcode-equals" aria-hidden="true">#</a> hashCode &amp; equals</h2>
<p>​ hashCode 在 Java 中用于表示引用类型对象在堆内存的存储地址，如果是两个相同(比如对象的 equals 为 true)的对象，必须要保证两个对象的 hash 地址是一致的,如果对象的 equals 方法执行为 true 时，hashcode 却不一致，将会导致集合框架中（特别是 Set 集合）出现大量重复元素，从而违反 hash 表(散列表)的存储规则；因此，为了维护这一规则，<strong>必须要确保重写对象的 equals 时必须要同时重写 hashcode</strong>。</p>
...
<p>注意事项:</p>
<ul>
<li>在比较引用数据类型的时候永远使用 equals</li>
<li>重写 equals 方法时一定要同时重写 hashCode</li>
</ul>
</blockquote>
<h2 id="多态入门" tabindex="-1"><a class="header-anchor" href="#多态入门" aria-hidden="true">#</a> 多态入门</h2>
<p>多态是面向对象程序设计中最为重要的一种(没有之一)特性，java 中的多态主要包含两种呈现方式：</p>
<ul>
<li>行为的多态(方法多态：一种方法以多种不同的形态呈现)
<ul>
<li>方法的重写</li>
<li>方法的重载</li>
</ul>
...
<ul>
<li>父类的引用指向子类对象</li>
<li>子类引用指向父类对象(强制转换：前提是被转换的引用变量原本指向的就是目标对象)</li>
</ul>
</li>
</ul>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="多态的好处" tabindex="-1"><a class="header-anchor" href="#多态的好处" aria-hidden="true">#</a> 多态的好处</h3>
<p>多态性的优势体现在如下：</p>
<ul>
<li>提高程序的<strong>可扩展性</strong></li>
<li>提高代码的<strong>可复用性</strong></li>
<li>提高了程序的<strong>可维护性</strong></li>
</ul>
<h2 id="封装类型" tabindex="-1"><a class="header-anchor" href="#封装类型" aria-hidden="true">#</a> 封装类型</h2>
<p>​ 由于 java 中提供基本数据类型只能用于一些简单运算(算术，关系，布尔逻辑等)，但是无法像引用数据类型一样可以进行对象创建，方法或属性调用；因此对于一些特殊需求(比如：将字符串类型的数字转换整数，将十进制整数转成其他进制：2 进制，8 进制，16 进制)，基本数据类型显得功能不足；所以 JDK 提供了针对以上需求的基本类型封装类，用于进行相关类型的面向对象操作(方法调用)。</p>
<p>针对 java 中的 8 个基本类型数据，JDK 也提供了对应的 8 个封装类型：</p>
<table>
<thead>
<tr>
<th>基本类型</th>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="装箱拆箱" tabindex="-1"><a class="header-anchor" href="#装箱拆箱" aria-hidden="true">#</a> 装箱拆箱</h3>
<p>在 JDK1.5 之后，引入了装箱和拆箱机制，用于实现基本类型数据和对应的封装类型之间的自动转换。</p>
<ul>
<li>装箱(boxing)：将基本类型的数据值包装为对应的引用类型对象</li>
<li>拆箱(unboxing)：将封装类型中的基本数据值拆成为基本数据类型</li>
</ul>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//装箱（boxing）</span>
...
<p>装箱和拆箱机制的实现：</p>
<p>1.5 之后编译器对以下代码自动调用<code v-pre>Integer.valueOf()</code>完成装箱提供能</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token class-name">Integer</span> i <span class="token operator">=</span> <span class="token number">10</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>拆箱的实现使用的是如下方法</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token function">intValue</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></blockquote>
<h4 id="笔试题" tabindex="-1"><a class="header-anchor" href="#笔试题" aria-hidden="true">#</a> 笔试题</h4>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token class-name">Integer</span> i1 <span class="token operator">=</span> <span class="token number">10</span><span class="token punctuation">;</span>
...
<p>在对基本类型数据装箱时，valueOf 方法内部会检测传入的数据值是否在缓存范围之内(-128~127）,如果位于缓存区间，则直接返回缓存的对象（如果两个基本值是相同的，则缓存的对象地址为同一个）；如果基本值超出了缓存范围，则重新创建一个 Integer 对象：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//jdk5之后新增（装箱时由编译器自动调用）</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>注: <code v-pre>IntegerCache</code>是一个内部类，用于缓存位于<code v-pre>-128~127</code>之间的封装类型对象</p>
</blockquote>
<h2 id="string-类" tabindex="-1"><a class="header-anchor" href="#string-类" aria-hidden="true">#</a> String 类</h2>
<p>​ String 是来自 java.lang 包中的一个常见字符串处理类，用于表示一个定长字符串，String 的底层实现原理实际上就是一个字符序列(char 数组)；由于 String 是一个长度不可变的字符数组，因此对 String 进行修改实际就是在创建新的对象，在进行大量字符串拼接操作时内存和时间的开销会比较大，影响程序执行效率，因此 String 不适合做大量的字符串拼接操作。（如果有大量字符串拼接需求，建议使用:<strong>StringBuffer 或 StringBuilder</strong>）。</p>
...
<tbody>
<tr>
<td><strong>String(String s)</strong></td>
<td>根据提供的字符串直接量创建 String 对象</td>
</tr>
<tr>
<td>String(char[] c)</td>
<td>根据提供的字符数组创建 String 对象</td>
</tr>
<tr>
<td><strong>String(char[] c,int offset,int len)</strong></td>
<td>根据提供的字符数组，偏移量以及长度构建 String 对象</td>
</tr>
<tr>
<td>String(byte[] b)</td>
<td>根据提供的字节数组，转换为 String 对象</td>
</tr>
<tr>
<td><strong>String(byte[] b,int offset,int len)</strong></td>
<td>根据提供的字节数组，偏移量以及长度构建 String 对象</td>
</tr>
</tbody>
</table>
...
<span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span>s1<span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="string-常用方法使用" tabindex="-1"><a class="header-anchor" href="#string-常用方法使用" aria-hidden="true">#</a> String 常用方法使用:</h3>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//将ABCDEFGHIJKLMN字符串以16进制的方式显示到控制台中？</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="动态数组参数" tabindex="-1"><a class="header-anchor" href="#动态数组参数" aria-hidden="true">#</a> 动态数组参数</h2>
...
<ol>
<li>
<p>完成一个验证码生成器，要求能够随机生成 0-9，a-z，A-Z 之间长度为 4 位的验证码，并完成一个验证过程</p>
</li>
<li>
<p>String commons = &quot;听说凤姐去了米国，找到了心仪男票，三天两头在微博上抨击单身狗。。。。&quot;;
​ //屏蔽:凤姐，男票，单身狗 规则用*替换</p>
</li>
<li>
<p>//有如下请求路径</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>http://www.softeem.com/query/list.html
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>//请获取请求的资源名称,即<code v-pre>list.html</code></p>
</li>
</ol>
</div></template>
