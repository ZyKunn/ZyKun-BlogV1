<template><div><h1 id="_08-面向对象程序设计-内部类" tabindex="-1"><a class="header-anchor" href="#_08-面向对象程序设计-内部类" aria-hidden="true">#</a> 08 - 面向对象程序设计(内部类)🎂</h1>
<nav class="table-of-contents"><ul><li><router-link to="#内部类">内部类</router-link><ul><li><router-link to="#内部类的好处">内部类的好处</router-link></li><li><router-link to="#成员内部类">成员内部类</router-link></li><li><router-link to="#局部内部类">局部内部类</router-link></li><li><router-link to="#静态内部类">静态内部类</router-link></li><li><router-link to="#匿名内部类">匿名内部类</router-link></li><li><router-link to="#接口的匿名内部类使用">接口的匿名内部类使用</router-link></li></ul></li><li><router-link to="#timer-timertask">Timer&amp;TimerTask</router-link></li></ul></nav>
<h2 id="内部类" tabindex="-1"><a class="header-anchor" href="#内部类" aria-hidden="true">#</a> 内部类</h2>
<p>通常一个 java 文件中只能包含一个 public class，但是可以在一个 java 类的内部中嵌套其他的 java 类，这种类称之为内部类，也叫嵌套类，或者类属类，比如：</p>
...
<p>以上就是一个典型的内部类,生成的字节码文件如下:</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>People$Body.class
People.class
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div></blockquote>
<p>java 中的内部类包含以下几种定义方式：</p>
<ol>
<li>成员内部类</li>
<li>局部内部类</li>
<li>静态内部类</li>
...
<h3 id="内部类的好处" tabindex="-1"><a class="header-anchor" href="#内部类的好处" aria-hidden="true">#</a> 内部类的好处</h3>
<ul>
<li>提供了比方法更好的封装性</li>
<li>提高类多继承的可能性</li>
</ul>
<h3 id="成员内部类" tabindex="-1"><a class="header-anchor" href="#成员内部类" aria-hidden="true">#</a> 成员内部类</h3>
<p>成员内部类即在类结构中直接定义的与属性，方法，构造器同一级别的类。</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>成员内部类的使用场景：在 JDK 中有很多类使用到了成员内部类，例如: ArrayList：</p>
<p><img src="@source/notes/java/02/09-面向对象程序设计(内部类)/assets/1605232071468.png" alt="1605232071468"></p>
<blockquote>
<p>成员内部类注意事项:</p>
<p>成员内部类类似成员方法，允许被任意的访问修饰符修饰（<em>default</em>,public,private,protected）</p>
</blockquote>
<h3 id="局部内部类" tabindex="-1"><a class="header-anchor" href="#局部内部类" aria-hidden="true">#</a> 局部内部类</h3>
<p>所谓局部内部类即在一个类的方法或者其他成员的(构造器，游离块)语句块中定义，不太常见：</p>
...
<p>局部内部类注意事项:</p>
<ol>
<li>不能使用任何的访问修饰符(除了 default 外)修饰，原理参考局部变量的定义</li>
<li>局部内部类中不能对方法中的局部变量进行修改，如果局部内部类中需要使用为外部方法的局部变量时，该变量必须定义为 final（<strong>java8 无需显式定义 final，编译器默认添加</strong>）</li>
<li>使用 final 修饰局部变量的作用在于延长局部变量的生命周期，避免因为方法的结束而被清理（可能局部内部类在使用该变量）</li>
</ol>
</blockquote>
<h3 id="静态内部类" tabindex="-1"><a class="header-anchor" href="#静态内部类" aria-hidden="true">#</a> 静态内部类</h3>
<p>静态内部类即使用 static 修饰的成员内部类；静态内部类与外部类的对象无关，一般用于数据缓存，比如 Integer 中的静态内部类：<code v-pre>IntegerCache</code></p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>自定义静态内部类:</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">StaticClass</span> <span class="token punctuation">{</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//创建静态内部类的对象</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="匿名内部类" tabindex="-1"><a class="header-anchor" href="#匿名内部类" aria-hidden="true">#</a> 匿名内部类</h3>
<p>匿名内部类即没有名字的内部类，通常用于事件监听机制，回调机制中</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">abstract</span> <span class="token keyword">class</span> <span class="token class-name">Animal</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>匿名内部类实例:</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/notes/java/02/09-面向对象程序设计(内部类)/assets/1605237740759.png" alt="1605237740759"></p>
<h3 id="接口的匿名内部类使用" tabindex="-1"><a class="header-anchor" href="#接口的匿名内部类使用" aria-hidden="true">#</a> 接口的匿名内部类使用</h3>
<p>接口的声明:</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">interface</span> <span class="token class-name">Flyable</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>接口匿名内部类使用:</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="timer-timertask" tabindex="-1"><a class="header-anchor" href="#timer-timertask" aria-hidden="true">#</a> Timer&amp;TimerTask</h2>
<p>Timer 类是 JDK 中，java.util 包中提供的用于执行定时任务的定时器类；Timer 通常与 TimerTask 结合使用，以达到定时任务执行的功能，比如定时消息推送，闹钟应用的实现等。</p>
<p>TimerTask 是一个抽象类，内部的 run 方法是一个抽象方法，因此通过对 TimerTask 扩展可以创建自定义的定时任务，只需要实现 run 方法即可：</p>
<p><strong>定时任务类:</strong></p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>测试类：</strong></p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">TestTimer</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>另外如果定时任务只在某个固定的位置使用，可以无需创建具体类进行继承；此时可以考虑使用<strong>匿名内部类</strong>实现：</p>
...
<p>以上代码表示等待 3 秒执行任务，之后每隔 0.5 秒执行一次</p>
</blockquote>
</div></template>
