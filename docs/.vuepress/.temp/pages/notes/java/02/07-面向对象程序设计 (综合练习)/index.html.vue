<template><div><h1 id="_06-面向对象程序设计-综合练习" tabindex="-1"><a class="header-anchor" href="#_06-面向对象程序设计-综合练习" aria-hidden="true">#</a> 06 - 面向对象程序设计(综合练习)🍭</h1>
<nav class="table-of-contents"><ul><li><router-link to="#练习讲解">练习讲解</router-link></li><li><router-link to="#math-类-array-类">Math 类&amp;Array 类</router-link><ul><li><router-link to="#math-类">Math 类</router-link></li><li><router-link to="#arrays-类">Arrays 类</router-link></li></ul></li><li><router-link to="#设计模式之-单例模式-singleton">设计模式之-单例模式（Singleton）</router-link><ul><li><router-link to="#单例模式概述">单例模式概述</router-link></li><li><router-link to="#懒汉式">懒汉式</router-link></li><li><router-link to="#饿汉式">饿汉式</router-link></li><li><router-link to="#应用场景">应用场景</router-link></li></ul></li><li><router-link to="#final-关键字">final 关键字</router-link></li><li><router-link to="#常量使用">常量使用</router-link></li><li><router-link to="#扩展-gui-编程">扩展：GUI 编程</router-link><ul><li><router-link to="#swing">Swing</router-link></li></ul></li></ul></nav>
<h2 id="练习讲解" tabindex="-1"><a class="header-anchor" href="#练习讲解" aria-hidden="true">#</a> 练习讲解</h2>
<ol>
<li>
<p>分析以下需求，并用代码实现：</p>
<p>​ (1)从键盘循环录入录入一个字符串,输入&quot;end&quot;表示结束</p>
<p>​ (2)将字符串中大写字母变成小写字母，小写字母变成大写字母，其它字符用&quot;*&quot;代替,并统计字母的个数</p>
<p>​ 举例:</p>
<p>​ 键盘录入：Hello12345World</p>
<p>​ 输出结果：hELLO*****wORLD</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">ConvertChars</span> <span class="token punctuation">{</span>
...
<li>
<p>完成一个企业人事管理系统，该系统中包含两个实体类:员工(Emp)，部门(Dept)，两个类中分别包含以下属性:</p>
<p>员工(工号，姓名，性别，职位，年龄，月薪，部门）</p>
<p>部门(编号，部门名，部门介绍，分机号)</p>
<p>要求实现以下功能:</p>
<p>完成部门的创建，添加 3 个部门</p>
<p>向各个部门中添加若干员工</p>
<p>查询所有的员工信息和所在的部门信息</p>
<p>根据员工工号显示员工信息</p>
<p>修改指定工号员工的薪资</p>
<p>根据部门号查询出门中的所有员工</p>
</li>
</ol>
<p><strong>员工类</strong></p>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Dept</span> <span class="token punctuation">{</span>
    ...
    <span class="token comment">//toString</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>员工管理类</strong></p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">EmpManagement</span> <span class="token punctuation">{</span>
...
<h3 id="math-类" tabindex="-1"><a class="header-anchor" href="#math-类" aria-hidden="true">#</a> Math 类</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="arrays-类" tabindex="-1"><a class="header-anchor" href="#arrays-类" aria-hidden="true">#</a> Arrays 类</h3>
...
<p>​ 设计模式即在软件开发历史中,经过不断迭代和演变形成的一套针对于某些特定问题，所提供的的专门的解决方案;在 java 中常见的设计模式包含 23 种，比如：</p>
<ul>
<li>单例模式</li>
<li>模板方法</li>
<li>简单工厂</li>
...
<h3 id="单例模式概述" tabindex="-1"><a class="header-anchor" href="#单例模式概述" aria-hidden="true">#</a> 单例模式概述</h3>
<p>单例模式也称之为单态模式，单子模式等；<strong>指的是在程序运行的过程中始终只存在一个对象(实例)</strong>。单例模式的表现形式又分为两种：</p>
<ol>
<li>懒汉式（需要的时候才创建：以时间换空间的概念）</li>
<li>饿汉式（类加载即创建：以空间换时间的概念）</li>
</ol>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="饿汉式" tabindex="-1"><a class="header-anchor" href="#饿汉式" aria-hidden="true">#</a> 饿汉式</h3>
<p>饿汉式即类加载时就创建实例对象</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token doc-comment comment">/**
 * 	单例模式-饿汉式(类加载即创建对象)
 * <span class="token keyword">@author</span> mrchai
...
<p>​ 单例模式的使用场景十分广泛，比如：数据库连接池，字符串常量池，线程池等资源池，比如日历类，Runtime 类等常见与系统环境交互相关的类。</p>
<h4 id="runtime-类" tabindex="-1"><a class="header-anchor" href="#runtime-类" aria-hidden="true">#</a> Runtime 类</h4>
<p>Runtime 类是 java 中提供的与本机系统交互的类，该类的实现使用了单例模式(饿汉式)；</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>通过 Runtime 类可以获取系统运行环境信息，以及操作系统命令和系统中的应用程序:</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">TestRuntime</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="final-关键字" tabindex="-1"><a class="header-anchor" href="#final-关键字" aria-hidden="true">#</a> final 关键字</h2>
<p>final 表示最终的，final 是一个关键字，可以用于修饰类，属性和方法，被 final 修饰的元素有以下特征:</p>
<ul>
<li>final 修饰的类无法被继承（断子绝孙类）</li>
<li>final 修饰属性一旦赋值则无法修改（常量）</li>
<li>final 修饰的方法无法被重写</li>
</ul>
<p>final 在修饰类时一般表示该类就已经是最终的实现了，不能再进行扩展；final 在修饰属性时一般会结合 static 共同使用，用于声明常量（constant）</p>
<h2 id="常量使用" tabindex="-1"><a class="header-anchor" href="#常量使用" aria-hidden="true">#</a> 常量使用</h2>
<p>java 中的常量分为两种：</p>
<ol>
<li>直接量</li>
<li><strong>自定义常量</strong></li>
</ol>
<p>自定义常量一般使用 final 和 static 结合使用，通常用于对某些固定不变的值进行声明，</p>
<p>语法：</p>
<p>[&lt;访问修饰符&gt;] static final 数据类型 类型名称 = 值;</p>
<p>例如:</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>关于常量的命名规范:</p>
<ol>
<li><strong>名称全部使用大写的英文单词</strong></li>
<li><strong>如果由多个单词组合而成，每个单词之间使用下划线隔开</strong></li>
</ol>
<h2 id="扩展-gui-编程" tabindex="-1"><a class="header-anchor" href="#扩展-gui-编程" aria-hidden="true">#</a> 扩展：GUI 编程</h2>
<p>GUI（Graphic User Interface）：图形用户接口，Java 中提供的图形界面编程技术，内部主要有两个部分构成：</p>
<ul>
<li>java.awt.*</li>
<li><strong>javax.swing.*</strong></li>
<li>javaFx</li>
</ul>
<h3 id="swing" tabindex="-1"><a class="header-anchor" href="#swing" aria-hidden="true">#</a> Swing</h3>
<ul>
<li>JFrame 窗体：界面的骨架</li>
<li>JPanel 面板：容器，内部可以摆放各种控件</li>
<li>布局(layout)：设置窗口中控件的摆放方式</li>
<li>控件：按钮，文本，输入框，文本域，下拉列表，单选按钮，表格，列表组件等 w</li>
</ul>
</div></template>
