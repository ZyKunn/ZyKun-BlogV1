<template><div><h1 id="_03-面向对象程序设计-继承" tabindex="-1"><a class="header-anchor" href="#_03-面向对象程序设计-继承" aria-hidden="true">#</a> 03 - 面向对象程序设计-继承 🍩</h1>
<nav class="table-of-contents"><ul><li><router-link to="#类之间关系-软件工程与统一建模语言-uml">类之间关系(软件工程与统一建模语言 UML)</router-link><ul><li><router-link to="#横向关系">横向关系</router-link></li><li><router-link to="#纵向关系">纵向关系</router-link></li></ul></li><li><router-link to="#继承-extends">继承（extends）</router-link><ul><li><router-link to="#继承优点">继承优点</router-link></li><li><router-link to="#继承注意事项">继承注意事项</router-link></li></ul></li><li><router-link to="#super-关键字">super 关键字</router-link></li><li><router-link to="#练习">练习</router-link></li></ul></nav>
<h2 id="类之间关系-软件工程与统一建模语言-uml" tabindex="-1"><a class="header-anchor" href="#类之间关系-软件工程与统一建模语言-uml" aria-hidden="true">#</a> 类之间关系(软件工程与统一建模语言 UML)</h2>
<p>面向对象设计语言中，类和类之间是存在一定关系的，从关系角度考虑，分为两种：</p>
<ul>
<li>横向关系（平级）</li>
<li>纵向关系（上下级）</li>
</ul>
<h3 id="横向关系" tabindex="-1"><a class="header-anchor" href="#横向关系" aria-hidden="true">#</a> 横向关系</h3>
<p>横向关系一般表示为多个类之间是同一级别，横向关系又分为以下几类</p>
<ol>
<li>
<p><strong>依赖关系</strong></p>
<p>依赖关系表示为一个类的方法中需要另一个类型对象作为参数</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Cat</span><span class="token punctuation">{</span>
...
<p>关联，聚合，组合三种关系在代码的表现形式上是相同，只是存在语义上的区别，主要区别为类和类之间的紧密程度；代码层面的表现方式是在一个类中将另一个类型对象作为属性定义。</p>
...
<span class="token punctuation">}</span>
    ...
    <span class="token comment">//setter/getter ...</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>典型的关联关系实例:</strong></p>
<ul>
<li>学生选课系统类设计</li>
</ul>
<p><img src="@source/notes/java/02/03-面向对象程序设计-继承/assets/1604558621975.png" alt="1604558621975"></p>
</li>
</ol>
<h3 id="纵向关系" tabindex="-1"><a class="header-anchor" href="#纵向关系" aria-hidden="true">#</a> 纵向关系</h3>
<p>纵向关系是一种上下级的关系，表现方式在 java 中通常以以下两种形式呈现：</p>
<ol>
<li><strong>继承（extends）</strong></li>
<li>实现（implements）</li>
</ol>
<h2 id="继承-extends" tabindex="-1"><a class="header-anchor" href="#继承-extends" aria-hidden="true">#</a> 继承（extends）</h2>
<p>​ 继承是面向对象程序设计中另一个重要的特征，继承即由一个类从另一个通过 extends 关键字继承，被继承的类称之为父类(也叫超类)，继承的类称之为子类（扩展类）；继承可以使得类的<strong>扩展性提高</strong>，<strong>减少重复代码</strong>的编写。</p>
<p>语法：</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>[&lt;修饰符>] class 子类 extends 父类 {
...
<p><strong>父类 Father：</strong></p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Father</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>子类 Son:</strong></p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Son</span> <span class="token keyword">extends</span> <span class="token class-name">Father</span><span class="token punctuation">{</span>
	...
	<span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="继承优点" tabindex="-1"><a class="header-anchor" href="#继承优点" aria-hidden="true">#</a> 继承优点</h3>
<ol>
<li>子类可以直接通过对象调用父类中的非私有元素</li>
<li>子类还可以在父类的基础上扩展新的功能</li>
</ol>
<h3 id="继承注意事项" tabindex="-1"><a class="header-anchor" href="#继承注意事项" aria-hidden="true">#</a> 继承注意事项</h3>
<ul>
<li>子类只能继承父类的属性和方法，不能继承构造器</li>
<li>子类对象构造之前会先执行父类的构造器（<code v-pre>如果存在多重继承，则从最顶层父类构造器开始执行</code>）</li>
<li>一个父类可以存在多个子类，但是一个子类只能存在一个父类</li>
<li>Java 不允许多继承，但是支持多重继承</li>
<li>被 protected 修饰的元素可以在子类中被访问（即便父类和子类不在同一个包）</li>
</ul>
<h2 id="super-关键字" tabindex="-1"><a class="header-anchor" href="#super-关键字" aria-hidden="true">#</a> super 关键字</h2>
<p>super 关键字用于在子类中调用父类的元素:</p>
<ul>
<li>构造器</li>
<li>属性</li>
<li>方法</li>
