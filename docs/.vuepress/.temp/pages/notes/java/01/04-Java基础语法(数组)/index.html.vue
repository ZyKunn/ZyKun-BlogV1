<template><div><h1 id="_04-java-基础语法-数组" tabindex="-1"><a class="header-anchor" href="#_04-java-基础语法-数组" aria-hidden="true">#</a> 04 - Java 基础语法(数组) 🍤</h1>
<nav class="table-of-contents"><ul><li><router-link to="#数组入门">数组入门</router-link><ul><li><router-link to="#概述">概述</router-link></li><li><router-link to="#数组的声明和初始化">数组的声明和初始化</router-link></li><li><router-link to="#操作数组">操作数组</router-link></li><li><router-link to="#多维数组-二维数组">多维数组(二维数组)</router-link></li></ul></li></ul></nav>
<h2 id="数组入门" tabindex="-1"><a class="header-anchor" href="#数组入门" aria-hidden="true">#</a> 数组入门</h2>
<h3 id="概述" tabindex="-1"><a class="header-anchor" href="#概述" aria-hidden="true">#</a> 概述</h3>
<p>​ 数组即一组用于存储相同数据类型的<strong>数据结构</strong>；数组是一种典型的线性结构(连续)。比如将一些商品数据呈现到页面中，此时可以将所有商品存储到数组中进行传递。<strong>数组是一种引用数据类型</strong>。数组中的每一个值都称之为元素</p>
<h3 id="数组的声明和初始化" tabindex="-1"><a class="header-anchor" href="#数组的声明和初始化" aria-hidden="true">#</a> 数组的声明和初始化</h3>
<h4 id="数组声明" tabindex="-1"><a class="header-anchor" href="#数组声明" aria-hidden="true">#</a> 数组声明</h4>
<p>java 中对数组的声明语法如下:</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>数据类型[] 数组名;
数据类型 数组名[];
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//推荐</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="数组初始化" tabindex="-1"><a class="header-anchor" href="#数组初始化" aria-hidden="true">#</a> 数组初始化</h4>
<p>数组的初始化（为变量赋初始值）包含两种方式：</p>
<ol>
<li>静态初始化</li>
<li>动态初始化</li>
</ol>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//静态初始化</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>动态初始化</strong></p>
<p>动态初始化即，在声明数组时只指定数组的容量，不为数组中指定位置赋值</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//声明一个长度(容量)为5的数组</span>
<span class="token keyword">int</span><span class="token punctuation">[</span><span class="token punctuation">]</span> arr <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token keyword">int</span><span class="token punctuation">[</span><span class="token number">5</span><span class="token punctuation">]</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="操作数组" tabindex="-1"><a class="header-anchor" href="#操作数组" aria-hidden="true">#</a> 操作数组</h3>
<p>​ 数组中每一个元素都有一个独一无二的索引(下标)，通过语法<code v-pre>数组名[索引]</code>可以获取数组中指定位置的元素；<strong>数组的索引从 0 开始</strong>；比如一个数组中有 10 个元素则索引从 0~9；<strong>任何一个数组都包含一个 length 属性用于获取数组中元素的个数</strong>;</p>
...
<p>注意事项:</p>
<p>在对数组操作时如果下标(索引)使用不当，则会导致一个异常出现:</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token class-name"><span class="token namespace">java<span class="token punctuation">.</span>lang<span class="token punctuation">.</span></span>ArrayIndexOutOfBoundsException</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><strong>数组索引越界</strong></p>
</blockquote>
<h4 id="jdk1-5-增强-for-循环-foreach" tabindex="-1"><a class="header-anchor" href="#jdk1-5-增强-for-循环-foreach" aria-hidden="true">#</a> JDK1.5 增强 for 循环-forEach</h4>
<p><img src="@source/notes/java/01/04-Java基础语法(数组)/assets/1604039987710.png" alt="1604039987710"></p>
<p>语法:</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>for(数据类型 变量名:数组名){
    //循环体
}
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote>
<p>以上循环中的数据类型表示的是数组中每个元素对应的数据类型</p>
</blockquote>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="多维数组-二维数组" tabindex="-1"><a class="header-anchor" href="#多维数组-二维数组" aria-hidden="true">#</a> 多维数组(二维数组)</h3>
<p>​ <strong>多维数组即数组中的数组</strong>。在实际的应用中多维数组的使用也很常见（比如二维数组），电影院座位布局，教室座位布局，游戏开发中游戏元素的坐标。</p>
<h4 id="声明语法" tabindex="-1"><a class="header-anchor" href="#声明语法" aria-hidden="true">#</a> 声明语法</h4>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>数据类型[][] 数组名
数据类型 数组名[][]
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 二维数组</span>
