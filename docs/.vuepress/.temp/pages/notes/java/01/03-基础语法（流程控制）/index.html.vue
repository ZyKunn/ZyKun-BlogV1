<template><div><h1 id="_03-基础语法-流程控制" tabindex="-1"><a class="header-anchor" href="#_03-基础语法-流程控制" aria-hidden="true">#</a> 03 - 基础语法（流程控制）🤖</h1>
<nav class="table-of-contents"><ul><li><router-link to="#分支语句">分支语句</router-link><ul><li><router-link to="#if-语句">if 语句</router-link></li><li><router-link to="#switch-语句">switch 语句</router-link></li><li><router-link to="#枚举类型入门">枚举类型入门</router-link></li></ul></li><li><router-link to="#循环语句">循环语句</router-link><ul><li><router-link to="#for-循环">for 循环</router-link></li><li><router-link to="#while-循环">while 循环</router-link></li><li><router-link to="#嵌套循环">嵌套循环</router-link></li><li><router-link to="#循环中断">循环中断</router-link></li></ul></li><li><router-link to="#练习">练习</router-link></li></ul></nav>
<p>​ 到目前为止，所有 Java 程序的执行从 main 方法开始，从上向下顺序执行，是一种典型的顺序结构；但是由于后续业务需求的变化，程序的执行不一定顺序执行，比如有多个分支，根据不同条件分支执行；有一些重复的动作需要反复执行，因此除了顺序结构，Java 中还提供了另外两种执行结构：</p>
<ol>
<li>分支结构</li>
<li>循环结构</li>
</ol>
<h2 id="分支语句" tabindex="-1"><a class="header-anchor" href="#分支语句" aria-hidden="true">#</a> 分支语句</h2>
<p>Java 中的分支语句分为两种常见结构：</p>
<ul>
<li>if...else...</li>
<li>switch</li>
</ul>
<h3 id="if-语句" tabindex="-1"><a class="header-anchor" href="#if-语句" aria-hidden="true">#</a> if 语句</h3>
<p>基本语法结构</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>if(布尔条件表达) {
    //条件成立时执行
}else {
    //条件不成立时执行
}
...
<p>程序员买西瓜：</p>
<p>一天程序员老婆对程序员说:你去买个西瓜，路上如果看到买包子的就买两个回来！</p>
</blockquote>
<h4 id="if-结构分类" tabindex="-1"><a class="header-anchor" href="#if-结构分类" aria-hidden="true">#</a> if 结构分类</h4>
<p>if 的结构分为三种：</p>
<p><img src="@source/notes/java/01/03-基础语法（流程控制）/assets/1603939256670.png" alt="1603939256670"></p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//根据输入的一个年份，如果该年份是闰年，则输出”闰年“ 否则不做任何操作</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/notes/java/01/03-基础语法（流程控制）/assets/1603941942003.png" alt="1603941942003"></p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">int</span> i <span class="token operator">=</span> <span class="token number">1234</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/notes/java/01/03-基础语法（流程控制）/assets/1603941916157.png" alt="1603941916157"></p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 输入一个商品（康帅傅牛肉面）的单价，以及购买数量，根据购买数量的不同</span>
...
<p>对于 if...else...语句如果执行体中只有一行语句需要执行，则可以省略“{}”</p>
<p>if...else...分支语句主要对于布尔逻辑结果判断，以及区间值的判断；</p>
</blockquote>
<h3 id="switch-语句" tabindex="-1"><a class="header-anchor" href="#switch-语句" aria-hidden="true">#</a> switch 语句</h3>
<p>对于一些固定数据值的判断，Java 中提供的 switch 更加实用</p>
<p><img src="@source/notes/java/01/03-基础语法（流程控制）/assets/1603951989200.png" alt="1603951989200"></p>
<h4 id="语法" tabindex="-1"><a class="header-anchor" href="#语法" aria-hidden="true">#</a> 语法</h4>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">switch</span><span class="token punctuation">(</span>变量<span class="token punctuation">)</span><span class="token punctuation">{</span>
...
<span class="token keyword">switch</span><span class="token punctuation">(</span>i<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token keyword">default</span><span class="token operator">:</span>
        ...
        <span class="token keyword">break</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>switch 支持的数据类型包含以下：</strong></p>
<ol>
<li><strong>byte short int</strong></li>
<li><strong>char</strong></li>
<li><strong>String （JDK1.7+）</strong></li>
<li><strong>enum（枚举，JDK1.5+）</strong></li>
</ol>
<blockquote>
<p>if 和 switch 区别：</p>
<p>if 主要对布尔结果判断，多数时候用于区间值的分支判断</p>
<p>switch 一般用于对于确定值的判断</p>
</blockquote>
<h3 id="枚举类型入门" tabindex="-1"><a class="header-anchor" href="#枚举类型入门" aria-hidden="true">#</a> 枚举类型入门</h3>
<p>枚举即将有限的固定值列举出来，比如：性别只有：男，女；季节只有春夏秋冬等；</p>
<p>语法：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//声明枚举类型 Season</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>使用:</p>
...
<p>在以上对于条件分支的案例中，发现，有些程序在执行过程中如果不满足条件需要重复执行，而分支语句没法做到反复执行的能力，因此，Java 中提供对于循环操作相关的解决方案；</p>
<p>循环可以用于反复执行某一个代码片段，必须循环打印输出，对某些结果集的遍历操作；Java 中的循环方分为以下几类:</p>
<ol>
...
<p><strong>for 循环流程图</strong></p>
<p><img src="@source/notes/java/01/03-基础语法（流程控制）/assets/1603952475933.png" alt="1603952475933"></p>
<p><strong>语法：</strong></p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>for(初始变量;条件判断;更改变量) {
    //循环体
}
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="while-循环" tabindex="-1"><a class="header-anchor" href="#while-循环" aria-hidden="true">#</a> while 循环</h3>
<p>java 中 while 循环包含两种呈现方式：</p>
<ol>
<li>while</li>
<li>do...while</li>
</ol>
<h4 id="while-语法" tabindex="-1"><a class="header-anchor" href="#while-语法" aria-hidden="true">#</a> while 语法</h4>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">while</span><span class="token punctuation">(</span>条件判断<span class="token punctuation">)</span><span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="do-while-语法" tabindex="-1"><a class="header-anchor" href="#do-while-语法" aria-hidden="true">#</a> do...while 语法</h4>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>do{
    //循环体
}while(条件判断)
...
<p>while 循环执行 0 次或多次</p>
<p>do...while 执行 1 次或多次</p>
<p>for 循环一般用于对循环次数确定的需求</p>
<p>while 循环一般用于对循环次数不确定的需求</p>
</blockquote>
<h3 id="嵌套循环" tabindex="-1"><a class="header-anchor" href="#嵌套循环" aria-hidden="true">#</a> 嵌套循环</h3>
<p>嵌套循环，即在循环语句中包含另一个循环：</p>
<p><img src="@source/notes/java/01/03-基础语法（流程控制）/assets/1603957893771.png" alt="1603957893771"></p>
<p>嵌套循环的执行流程：从外向内，内层执行完毕再返回外层执行。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//行</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>1*1=1
1*2=2 2*2=4
1*3=3 2*3=6 3*3=9
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="循环中断" tabindex="-1"><a class="header-anchor" href="#循环中断" aria-hidden="true">#</a> 循环中断</h3>
<p>通常情况下，循环语句只有在满足循环结束条件时才会结束，对于某些特殊需要，比如数到 7 的倍数跳过等需求；java 中也提供用于跳出循环的关键字：</p>
<ul>
<li>
<p><strong>continue</strong></p>
<p>continue 用于跳出循环结构中的某一次循环，后续次数的循环不受影响</p>
...
<p>break 在 case 语句中用于结束 case；在循环中用于结束一层循环，如果有多层循环嵌套，也只会结束其中一层循环（<strong>循环标签除外</strong>）</p>
...
<p>return 用于结束方法，并可以根据方法的定义返回类型，为方法返回结果；在循环中也会结束整个方法</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">for</span> <span class="token punctuation">(</span><span class="token keyword">int</span> n <span class="token operator">=</span> <span class="token number">0</span><span class="token punctuation">;</span> n <span class="token operator">&lt;</span> <span class="token number">10</span><span class="token punctuation">;</span> n<span class="token operator">++</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token keyword">for</span><span class="token punctuation">(</span><span class="token keyword">int</span> i <span class="token operator">=</span> <span class="token number">1</span><span class="token punctuation">;</span> i <span class="token operator">&lt;</span> <span class="token number">1000</span><span class="token punctuation">;</span> i<span class="token operator">++</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
        <span class="token keyword">if</span><span class="token punctuation">(</span>i <span class="token operator">%</span> <span class="token number">7</span> <span class="token operator">==</span> <span class="token number">0</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<ol>
<li>
<p>设计一个 ATM 机的程序，当对方正确的输入卡号(int)和密码(int)时，显示 come in，错误时要求重新输入（3 次机会），如果第三次还输入错误，则提示 today is more，please next！（控制台）</p>
</li>
<li>
<p>模拟地下城与勇士(DNF)的装备强化过程：</p>
<p>提示 1:</p>
</li>
</ol>
<ul>
<li>DNF 装备强化在+1 ～+3 不会失败；</li>
<li>+4 ～+7，失败后物品原有强化等级降低 1 级；</li>
<li>+8 ～+10，失败后掉 3 级；</li>
<li>10 上 11 或以上就爆了。</li>
</ul>
<p>提示 2：</p>
<ul>
<li>DNF 装备强化 1 ～ 3 级，成功率 100%</li>
<li>DNF 装备强化 3 ～ 4 级，成功率 95%</li>
<li>DNF 装备强化 4 ～ 5 级，成功率 90%</li>
<li>DNF 装备强化 5 ～ 6 级，成功率 80%</li>
<li>DNF 装备强化 6 ～ 7 级，成功率 75%</li>
<li>DNF 装备强化 7 ～ 8 级，成功率 62.1%</li>
<li>DNF 装备强化 8 ～ 9 级，成功率 53.7%</li>
<li>DNF 装备强化 9 ～ 10 级，成功率 41.4%</li>
<li>DNF 装备强化 10~11 级，成功率 33.9%</li>
<li>DNF 装备强化 11 ～ 12 级，成功率 28%</li>
<li>DNF 装备强化 12 ～ 13 级，成功率 20.7%</li>
<li>DNF 装备强化 13 ～ 14 级，成功率 17.3%</li>
<li>DNF 装备强化 14 ～ 15 级，成功率 13.6%</li>
<li>DNF 装备强化 15 ～ 16 级，成功率 10.1%</li>
</ul>
<p>实现流程:</p>
<p>要求输入装备的原始等级，输入 1 执行强化，根据原始等级以及强化的成功率，显示装备的强化结果</p>
<p>Math.random()</p>
</div></template>
