<template><div><h1 id="_02-java-基础语法" tabindex="-1"><a class="header-anchor" href="#_02-java-基础语法" aria-hidden="true">#</a> 02 - Java 基础语法 😎</h1>
<nav class="table-of-contents"><ul><li><router-link to="#数据类型">数据类型</router-link><ul><li><router-link to="#基本数据类型">基本数据类型</router-link></li><li><router-link to="#数据类型转换">数据类型转换</router-link></li><li><router-link to="#引用数据类型">引用数据类型</router-link></li></ul></li><li><router-link to="#运算符">运算符</router-link><ul><li><router-link to="#算术运算">算术运算</router-link></li><li><router-link to="#关系运算符">关系运算符</router-link></li><li><router-link to="#布尔逻辑运算">布尔逻辑运算</router-link></li><li><router-link to="#位运算">位运算</router-link></li><li><router-link to="#三目运算">三目运算</router-link></li><li><router-link to="#其他运算符">其他运算符</router-link></li><li><router-link to="#运算符的优先级">运算符的优先级</router-link></li></ul></li><li><router-link to="#标准输入和随机数">标准输入和随机数</router-link><ul><li><router-link to="#scanner-基本使用">Scanner 基本使用</router-link></li><li><router-link to="#math-类与随机数使用">Math 类与随机数使用</router-link></li></ul></li></ul></nav>
<h2 id="数据类型" tabindex="-1"><a class="header-anchor" href="#数据类型" aria-hidden="true">#</a> 数据类型</h2>
<p>​ 在 java 开发中，大多数时间都是在对数据进行操作，比如:登录，注册，搜索商品，下订单，转账等。既然是数据，就有类型之分；不同的数据类型也不同。</p>
<p>java 是一门强类型(弱类型：JavaScript、python)语言，任何的变量在声明之前都必须显式的指定其数据类型，并且，在使用过程中数据类型不能够改变。Java 中的数据类型分为两个大类：第一类称之为<strong>基本数据类型</strong>；第二类称之<strong>引用数据类型</strong>（面向对象）。</p>
<h3 id="基本数据类型" tabindex="-1"><a class="header-anchor" href="#基本数据类型" aria-hidden="true">#</a> 基本数据类型</h3>
<p>基本类型数据也称之为简单类型，通常用于描述一个基本值，比如说：一个整数，一个字符，一个小数，一个 true、false 值等；java 中的基本类型数据分为以下四类八种：</p>
<ul>
<li>
...
<li>
<p>布尔类型（boolean）</p>
<p><img src="@source/notes/java/01/02-Java基础语法/assets/1603848370680.png" alt="1603848370680"></p>
</li>
</ul>
<h4 id="整数类型" tabindex="-1"><a class="header-anchor" href="#整数类型" aria-hidden="true">#</a> 整数类型</h4>
<p>整数类型一般用于表示一个整数（包含正负数），整数类型主要包含 4 个：</p>
<ul>
<li><strong>byte</strong>（文件操作时常用）</li>
<li><strong>short</strong></li>
<li><strong>int</strong>（推荐）</li>
<li><strong>long</strong>（时间毫秒数，文件字节数）</li>
</ul>
<p><img src="@source/notes/java/01/02-Java基础语法/assets/1603848442755.png" alt="1603848442755"></p>
...
<ol>
<li>java 中默认的整数类型是 int</li>
<li>任何整数类型的运算结果都会转换为 int 类型</li>
<li>声明 long 类型变量时，数据值必须在末尾跟上“L”</li>
</ol>
<blockquote>
<p>计算机基础知识:</p>
<p>1 字节(byte) = 8 位(bits) 计算机底层能够识别的只能是 0 和 1</p>
...
<h4 id="浮点类型" tabindex="-1"><a class="header-anchor" href="#浮点类型" aria-hidden="true">#</a> 浮点类型</h4>
<p>java 中对于小数类型的表示称之为浮点类型，浮点类型包含两种：</p>
<ol>
<li>
<p>float</p>
</li>
<li>
<p>double</p>
<p><img src="@source/notes/java/01/02-Java基础语法/assets/1603850416345.png" alt="1603850416345"></p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">float</span> f <span class="token operator">=</span> <span class="token number">3.1415926F</span><span class="token punctuation">;</span>
...
<p>注意事项；</p>
<ol>
<li>java 中默认的浮点数类型为 double</li>
<li>表示一个 float 类型的数据必须在数值末尾追加“f”或“F”</li>
<li>浮点类型一般用于对精度要求不高的运算中 0</li>
</ol>
<blockquote>
<p>浮点类型的概念源之于科学计数法，比如表示一个大数值(<strong>10045.6</strong>)可以按如下方式表示:</p>
<p>1.00456 * 10^4</p>
<p>10.0456 * 10^3</p>
<p>0.100456 * 10^5</p>
</blockquote>
<h4 id="字符类型" tabindex="-1"><a class="header-anchor" href="#字符类型" aria-hidden="true">#</a> 字符类型</h4>
<p>Java 中对于单个字符提供了一个 char 类型表述，区别于 String 类型（String 用于表示一个字符串）</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>通过以上观察得知 String 类型用于表示一个字符串，值必须包含在双引号之间；而 char 类型用于表示一个字符，并且字符包含在单引号之间。char 类型除了可以表示单个英文字符外，还能表示中文字符，特殊符号等：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">char</span> c1 <span class="token operator">=</span> <span class="token char">'中'</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>关于转义符号“\”，java 中对于特殊的符号可以使用“\”转义：</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>\b  \t  \n  \f  \r  \"  \'  \\
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/java/01/02-Java基础语法/assets/1603855437442.png" alt="1603855437442"></p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//char类型占据存储空间是两个字节</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/notes/java/01/02-Java基础语法/assets/1603872786660.png" alt="1603872786660"></p>
<blockquote>
<p>String 不是基本类型数据，是 JDK 中提供一个引用类型数据</p>
<p>char 类型一般用于字符转码(编码转换)；String 的内部实现原理基于 char 类型(String 本质上就是一个 char 数组)</p>
</blockquote>
<h4 id="布尔类型" tabindex="-1"><a class="header-anchor" href="#布尔类型" aria-hidden="true">#</a> 布尔类型</h4>
<p>​ 布尔类型通常用于表示 true 或者 false 值，<strong>只占一个二进制位</strong>；因此布尔的取值只能是 0 和 1(这是 c 语言的用法)；但是 Java 中只允许用 true 和 false 表示 boolean 的值。布尔类型一般用于一些逻辑判断中，比如条件分支，循环的判断。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//True  False</span>
...
<p>​ 在实际的项目经常会涉及到许多不同的基本类型数据的交替使用，因此，不同的基本数据类型之间会涉及到一些转换需求；java 中基本类型数据的转换遵循以下原则：</p>
<ul>
<li>小转大，直接转</li>
<li>大转小，需强转</li>
</ul>
<p><img src="@source/notes/java/01/02-Java基础语法/assets/1603856445953.png" alt="1603856445953"></p>
<p>实现语法:</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//初始化</span>
...
<p>思考题:</p>
<p>观察代码：short s = 10; s = s + 10；请问 s=?</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">short</span> s <span class="token operator">=</span> <span class="token number">10</span><span class="token punctuation">;</span>
...
<p>​ 之前所有的基本类型数据都是用于表示一个简单的值，比如:一个整数，一个字符，一个小数，一个 true、false 值；如果需要表示一个人，一只狗或者一条订单信息；对于以上复杂的数据来说，单纯使用一个基本类型的数据无法全面表示；</p>
<p>​ 所以，对于以上的需求无法通过一个基本类型数据来表示，因此，java 中针对一些复杂的数据还提供了一种特殊的数据类型-----<strong>引用数据类型</strong></p>
<p>​ 引用类型的呈现方式通常以一个类的形式存在，这里就涉及到了 java 中面向对象程序设计。java 中的引用类型包含以下三类:</p>
<ol>
<li><strong>类的引用</strong></li>
<li><strong>数组的引用</strong></li>
<li><strong>接口的引用</strong></li>
</ol>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//类</span>
...
<p>Java 中提供了大量的用于操作数据的运算符号，这些运算符号分为以下几类:</p>
<ul>
<li>算术运算符</li>
<li>关系运算</li>
<li>布尔逻辑运算</li>
<li>位运算符</li>
<li>三目运算</li>
<li>其他(扩展赋值，字符串拼接，赋值，造型)</li>
</ul>
<h3 id="算术运算" tabindex="-1"><a class="header-anchor" href="#算术运算" aria-hidden="true">#</a> 算术运算</h3>
<p>算术运算符主要用于对基本类型的数据（整数，小数）进行类似加减乘除等算术运算；二元运算符</p>
<table>
<thead>
<tr>
<th>符号</th>
...
<tr>
<td>%</td>
<td>对两个运算数进行取余数，获取两个数相除之后除不尽结果，比如 10 % 3 = 1 余数为 1</td>
</tr>
<tr>
<td>++/--</td>
<td>自增自减，对变量进行自增自减操作；符号可以出现在运算数的左右两侧</td>
</tr>
</tbody>
</table>
...
<p>算术运算注意事项:</p>
<ol>
<li>任何整数类型进行算术运算都会将结果转换为 int 类型</li>
<li>任何数值类型跟浮点进行算术运算都会转换为 double 类型</li>
</ol>
</blockquote>
<h3 id="关系运算符" tabindex="-1"><a class="header-anchor" href="#关系运算符" aria-hidden="true">#</a> 关系运算符</h3>
<p>关系运算一般用于对于基本类型数据的大小比较，等于比较，另外也可以对两个引用类型对象的地址进行比较，java 中的关系运算包含以下符号:</p>
<table>
<thead>
<tr>
<th>符号</th>
...
<p>关系运算注意事项:</p>
<ol>
<li>关系运算符运算之后的结果是布尔类型</li>
<li>==和!=可以用于对引用类型对象的地址比较</li>
</ol>
</blockquote>
<h3 id="布尔逻辑运算" tabindex="-1"><a class="header-anchor" href="#布尔逻辑运算" aria-hidden="true">#</a> 布尔逻辑运算</h3>
<p>java 后期主要应用于一些商业化的服务端业务逻辑操作，因此会包含很多有关业务逻辑判断等，运算符也因此包含了布尔逻辑运算等符号，如：与，或，非</p>
<table>
<thead>
<tr>
<th>符号</th>
...
<tr>
<td>^</td>
<td>亦或(如果两个都一样则为 false 如果两个不一样 则为 true)</td>
</tr>
</tbody>
</table>
<p><img src="@source/notes/java/01/02-Java基础语法/assets/1603868526551.png" alt="1603868526551"></p>
...
<p>注意事项:</p>
<ol>
<li>布尔逻辑运算的操作数都是 boolean 类型变量</li>
</ol>
<p><strong>&amp;和&amp;&amp;区别？</strong></p>
<p>&amp;:逻辑与，在进行运算时不论运算符左侧的表达式结果是否为 true，右侧的表达式始终会执行；</p>
<p>&amp;&amp;:短路与，在进行运算时一旦运算符左侧的表达式结果为 false，则右侧表达式不再执行</p>
</blockquote>
<h3 id="位运算" tabindex="-1"><a class="header-anchor" href="#位运算" aria-hidden="true">#</a> 位运算</h3>
<p>计算机底层最终只能够识别 0 和 1，不论多么复杂的表达式，到计算机底层都会进行二进制加法运算，java 中对于位运算包含以下运算符号:</p>
<table>
<thead>
<tr>
<th>符号</th>
...
<p><strong>引入:如何以最快的速度将 8 变为 2</strong></p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">int</span> i <span class="token operator">=</span> <span class="token number">8</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="三目运算" tabindex="-1"><a class="header-anchor" href="#三目运算" aria-hidden="true">#</a> 三目运算</h3>
<p>三目运算符也称之三元运算，运算符具备逻辑判断的功能，语法：</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>布尔类型表达式 ? 结果1 : 结果2
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>基本案例:</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token class-name">Scanner</span> sc <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">Scanner</span><span class="token punctuation">(</span><span class="token class-name">System</span><span class="token punctuation">.</span>in<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token keyword">int</span> a <span class="token operator">=</span> sc<span class="token punctuation">.</span><span class="token function">nextInt</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token keyword">int</span> b <span class="token operator">=</span> sc<span class="token punctuation">.</span><span class="token function">nextInt</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>复杂的三目运算使用:</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//输入一个分数(0~100)，根据该分数所在的区间显示分数对应的等级（ABCDE）</span>
...
<span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span>c<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="其他运算符" tabindex="-1"><a class="header-anchor" href="#其他运算符" aria-hidden="true">#</a> 其他运算符</h3>
<ul>
<li>扩展赋值运算（+= -= *= /=）</li>
<li>字符串拼接运算（+）</li>
<li>造型运算（(type)）</li>
</ul>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">byte</span> a <span class="token operator">=</span> <span class="token number">10</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="运算符的优先级" tabindex="-1"><a class="header-anchor" href="#运算符的优先级" aria-hidden="true">#</a> 运算符的优先级</h3>
<p>不同的运算符计算顺序也不同，比如数学中：先乘除出后加减；Java 中的运算符优先级如下:</p>
<p><img src="@source/notes/java/01/02-Java基础语法/assets/1603873058630.png" alt="1603873058630"></p>
<p><img src="@source/notes/java/01/02-Java基础语法/assets/1603873074586.png" alt="1603873074586"></p>
<p>实际开发中一切以可读性为主，所以对于运算的优先级问题可以通过（）解决。不需要记忆符号的优先级。</p>
<h2 id="标准输入和随机数" tabindex="-1"><a class="header-anchor" href="#标准输入和随机数" aria-hidden="true">#</a> 标准输入和随机数</h2>
<h3 id="scanner-基本使用" tabindex="-1"><a class="header-anchor" href="#scanner-基本使用" aria-hidden="true">#</a> Scanner 基本使用</h3>
<p>Scanner 是 JDK 中内置的一个类，可以用于对系统输入内容扫描，读取控制台输入的数据，具体使用方式如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span><span class="token punctuation">{</span>
...
<p>注意：</p>
<p>在使用 Scanner 类时需要将 Scanner 所在的包导入到当前类中，在类定义之前添加以下代码:</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">import</span> <span class="token import"><span class="token namespace">java<span class="token punctuation">.</span>util<span class="token punctuation">.</span></span><span class="token class-name">Scanner</span></span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></blockquote>
<h3 id="math-类与随机数使用" tabindex="-1"><a class="header-anchor" href="#math-类与随机数使用" aria-hidden="true">#</a> Math 类与随机数使用</h3>
<p>​ java 中提供了一个 Math 类，是一个工具类，内部主要包含的是一些工具方法，比如，求两数的最大值，最小值，绝对值，四舍五入，随机数；这些所有的方法都可以直接通过类名称调用。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//随机获取从0.0~1.0(不包含)之间浮点数</span>
