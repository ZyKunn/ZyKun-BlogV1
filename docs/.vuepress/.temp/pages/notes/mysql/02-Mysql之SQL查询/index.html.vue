<template><div><h1 id="_02-mysql-之-sql-查询" tabindex="-1"><a class="header-anchor" href="#_02-mysql-之-sql-查询" aria-hidden="true">#</a> 02 - Mysql 之 SQL 查询 🤓</h1>
<nav class="table-of-contents"><ul><li><router-link to="#mysql-图形界面工具使用">Mysql 图形界面工具使用</router-link></li><li><router-link to="#运算符">运算符</router-link><ul><li><router-link to="#算术运算">算术运算</router-link></li><li><router-link to="#关系运算">关系运算</router-link></li><li><router-link to="#逻辑运算">逻辑运算</router-link></li></ul></li><li><router-link to="#sql-查询">SQL 查询</router-link><ul><li><router-link to="#基础查询">基础查询</router-link></li><li><router-link to="#条件查询">条件查询</router-link></li><li><router-link to="#多表联合查询">多表联合查询</router-link></li></ul></li><li><router-link to="#维护数据完整性之约束">维护数据完整性之约束</router-link><ul><li><router-link to="#约束-constraint">约束（Constraint）</router-link></li><li><router-link to="#触发器">触发器：</router-link></li></ul></li></ul></nav>
<h2 id="mysql-图形界面工具使用" tabindex="-1"><a class="header-anchor" href="#mysql-图形界面工具使用" aria-hidden="true">#</a> Mysql 图形界面工具使用</h2>
<p>mysql 的第三方图形界面工具非常多，比如:</p>
<ul>
<li><strong>Sqlyog</strong></li>
<li><strong>Navicat for Mysql</strong></li>
<li><strong>Navicat Premium</strong></li>
<li>Mysql Front</li>
<li>PhpMyAdmin</li>
</ul>
...
<h3 id="关系运算" tabindex="-1"><a class="header-anchor" href="#关系运算" aria-hidden="true">#</a> 关系运算</h3>
<table>
<thead>
<tr>
<th>运算符</th>
...
<td>=</td>
<td>a=b</td>
<td>如果两操作数相等则为 true</td>
</tr>
<tr>
<td>!=,&lt;&gt;</td>
<td>a != b,a&lt;&gt;b</td>
<td>如果两操作数不相等则为 true</td>
</tr>
<tr>
<td>&gt;</td>
<td>a &gt; b</td>
<td>如果 a 大于 b,为 true</td>
</tr>
<tr>
<td>&gt;=</td>
<td>a &gt;= b</td>
<td>如果 a 大于等于 b,为 true</td>
</tr>
<tr>
<td>&lt;</td>
<td>a &lt; b</td>
<td>如果 a 小于 b,为 true</td>
</tr>
<tr>
<td>&lt;=</td>
<td>a &lt;= b</td>
<td>如果 a 小于等于 b,为 true</td>
</tr>
<tr>
<td>in</td>
<td>a in(b1,b2,b3...)</td>
<td>判断 a 是否是 b1,b2,b3...中的一个</td>
</tr>
<tr>
<td>between...and</td>
<td>a between b1 and b2</td>
<td>判断 a 是否在 b1,b2 之间</td>
</tr>
<tr>
<td>like</td>
<td>a like b</td>
<td>如果 a 与 b 匹配，则为 true</td>
</tr>
<tr>
<td>not like</td>
<td>a not like b</td>
<td>如果 a 与 b 不匹配，则为 true</td>
</tr>
<tr>
<td>is null</td>
<td>a is null</td>
<td>如果操作数为 null，则为 true</td>
</tr>
<tr>
<td>is not null</td>
<td>a is not null</td>
<td>如果操作数不为 null，则为 true</td>
</tr>
</tbody>
</table>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>SELECT * FROM emp where NAME &lt;&gt; '张三'
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="逻辑运算" tabindex="-1"><a class="header-anchor" href="#逻辑运算" aria-hidden="true">#</a> 逻辑运算</h3>
<table>
<thead>
<tr>
<th>运算符</th>
...
<td>and,&amp;&amp;</td>
<td>a and b,a &amp;&amp; b</td>
<td>逻辑与，两操作数都为 true 则为 true</td>
</tr>
<tr>
<td>or，||</td>
<td>a or b,a||b</td>
<td>逻辑或，两操作数任意一个为 true，则为 true</td>
</tr>
<tr>
<td>not,!</td>
<td>not a,!a</td>
<td>逻辑非，如果操作数为 false，则结果为 true</td>
</tr>
</tbody>
</table>
<blockquote>
<p>运算数左右需为 boolean 结果</p>
</blockquote>
<h2 id="sql-查询" tabindex="-1"><a class="header-anchor" href="#sql-查询" aria-hidden="true">#</a> SQL 查询</h2>
<p>​ SQL 查询在数据库中是非常重要的组成，因为未来开发场景下，大多数的功能都集中在查询上，而且查询可以简单，也可以复杂，复杂到很多表之间的联合查询。</p>
<p>SQL 查询的语法：</p>
...
<span class="token keyword">limit</span>
	结果限制
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="基础查询" tabindex="-1"><a class="header-anchor" href="#基础查询" aria-hidden="true">#</a> 基础查询</h3>
<ol>
<li>
<p>查询所有列</p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token keyword">select</span> <span class="token operator">*</span> <span class="token keyword">from</span> emp<span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li>
<li>
<p>查询部分列信息（查询员工的姓名，职位，薪资）</p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token keyword">select</span> ename<span class="token punctuation">,</span>job<span class="token punctuation">,</span>sal <span class="token keyword">from</span> emp<span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li>
</ol>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token keyword">insert</span> <span class="token keyword">into</span> emp<span class="token punctuation">(</span>eno<span class="token punctuation">,</span>ename<span class="token punctuation">,</span>job<span class="token punctuation">,</span>age<span class="token punctuation">)</span> <span class="token keyword">values</span><span class="token punctuation">(</span><span class="token number">23</span><span class="token punctuation">,</span><span class="token string">'卡牌大师'</span><span class="token punctuation">,</span><span class="token string">'骨干员工'</span><span class="token punctuation">,</span><span class="token number">33</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="条件查询" tabindex="-1"><a class="header-anchor" href="#条件查询" aria-hidden="true">#</a> 条件查询</h3>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token comment">/* 条件查询 */</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="多表联合查询" tabindex="-1"><a class="header-anchor" href="#多表联合查询" aria-hidden="true">#</a> 多表联合查询</h3>
<h5 id="笛卡尔沉积" tabindex="-1"><a class="header-anchor" href="#笛卡尔沉积" aria-hidden="true">#</a> 笛卡尔沉积：</h5>
<ol>
<li>先确定数据要用到哪些表。</li>
<li>将多个表先通过笛卡尔积变成一个表。</li>
<li>然后去除不符合逻辑的数据（根据两个表的关系去掉）。</li>
<li>最后当做是一个虚拟表一样来加上条件即可。</li>
</ol>
<p>如果 A 表有 20 条记录，B 表有 30 条记录，则二者关联后的笛卡尔积工 20*30=600 条记实录。也就是说 A 表中的每条记录都会于 B 表的所有记录关联一次，三种关联方式实际上就是对“笛卡尔积”的处理方式不同。</p>
...
<li>
<p><strong>查询列</strong></p>
</li>
<li>
<p><strong>查询目标表</strong></p>
</li>
<li>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>多表查询:
等值连接
内连接
自连接
外连接(左外连接，右外连接)
...
<li>对于同一个查询需求可以使用多种手段实现，但是需要考虑效率</li>
<li>查询语句优化：</li>
<li>尽量避免子查询</li>
<li>避免使用“*”</li>
<li>对查询结果尽量使用 limit 显示</li>
<li>单条 sql 尽量少用或者不用 like</li>
<li>在 sql 语句中尽量使用等值作为条件</li>
<li>使用函数的时候，尽量使用系统函数，少使用自定义函数</li>
<li>对某些经常使用或者经常被查询的字段添加索引</li>
</ol>
</blockquote>
<h2 id="维护数据完整性之约束" tabindex="-1"><a class="header-anchor" href="#维护数据完整性之约束" aria-hidden="true">#</a> 维护数据完整性之约束</h2>
<p>在数据库中维护<strong>数据完整性</strong>的解决方案有两种：</p>
<ol>
<li>约束（constraint）</li>
<li>触发器（trigger）</li>
</ol>
<h3 id="约束-constraint" tabindex="-1"><a class="header-anchor" href="#约束-constraint" aria-hidden="true">#</a> 约束（Constraint）</h3>
<p>约束是通过对数据表中的字段使用以一些特殊用途的关键字进行限定，从而使得该列的数据不能随意填写，以此来保障数据的完整性；数据库中一共包含以下 5 种约束：</p>
<ol>
<li><strong>主键约束（primary key）</strong></li>
<li>外键约束（foreign key）</li>
<li>唯一约束（unique）</li>
<li>检查约束（check） <strong>Mysql 暂时不生效</strong></li>
<li>不为空约束（not null）</li>
</ol>
<h4 id="主键约束-primary-key" tabindex="-1"><a class="header-anchor" href="#主键约束-primary-key" aria-hidden="true">#</a> 主键约束（primary key）</h4>
<p>主键约束一般用于一张表中的标识列（该列数据唯一且不为空）；每一张表都应该存在一个主键，主键可以用于一个列，也可以应用于多个列</p>
<p>如果主键类型为 int 的时候：</p>
<p>建议主键设置成自增长，如果主键设置成自增长的时候，在添加数据时，可以不用给主键赋值</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>INSERT into emp (eno,ename) VALUES (null,'沙和尚2')
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>如果主键类型为字符串：</p>
<p>可以使用类似于 UUID 这样的一个 32 位或者 18 位的一个字符串：比如 eb077943-0b49-43ba-a7be-22c443e1b7b8</p>
<p>作为 varchar 类型的 id 的值</p>
<ol>
<li>注意事项：</li>
</ol>
<blockquote>
<ol>
<li>主键列一般用于标识列（不能重复，且不为空）</li>
<li>尽量避免使用联合主键（设置多个列同时为主键）</li>
<li>任何表都应该存在主键列</li>
</ol>
</blockquote>
<h4 id="外键约束-foreign-key" tabindex="-1"><a class="header-anchor" href="#外键约束-foreign-key" aria-hidden="true">#</a> 外键约束（foreign key）</h4>
<p>外键约束一般用于对一个表与另一个表进行关 联时的依据，通常会在表中使用 foreign key 建立外键；外键必然是另一张表的主键，而另一张就称之为主表，添加外键的表称之为从表。</p>
<h4 id="唯一约束-unique" tabindex="-1"><a class="header-anchor" href="#唯一约束-unique" aria-hidden="true">#</a> 唯一约束（unique）</h4>
<p>唯一约束用于设置表中指定列是唯一的（不可重复）；常见于用于表中的用户名列，分类表中类别名列等，使用方式：</p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code>username <span class="token keyword">varchar</span><span class="token punctuation">(</span><span class="token number">30</span><span class="token punctuation">)</span> <span class="token keyword">unique</span> <span class="token operator">not</span> <span class="token boolean">null</span><span class="token punctuation">,</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>如果报错值，后面偷偷跟了一个空格这样会导致数据重复</p>
<p>解决这种问题：</p>
<p>​ 先后台对这个数据去空格在数据库中查询一边，再做保存</p>
<h4 id="不为空约束-not-null" tabindex="-1"><a class="header-anchor" href="#不为空约束-not-null" aria-hidden="true">#</a> 不为空约束（not null）</h4>
<p>设置表中指定列必须给定值，不允许为 null</p>
<h4 id="检查约束-check" tabindex="-1"><a class="header-anchor" href="#检查约束-check" aria-hidden="true">#</a> 检查约束（check）</h4>
<p>检查约束在 mysql 中还未生效，如果需要对字段进行检查约束，可以考虑使用 enum 类型。</p>
...
<p>确定它是非常高效的：触发器是针对每一行的；对增删改非常频繁的表上切记不要使用触发器，因为它会非常消耗资源。</p>
<h4 id="练习" tabindex="-1"><a class="header-anchor" href="#练习" aria-hidden="true">#</a> 练习：</h4>
<p><em>1.列出同部门下所有员工的姓名及其直接上级的名字(根据 deptno 划分部门)</em></p>
<p>2.列出受雇日期早于直接上级的所有员工的编号、姓名、部门名称</p>
<p>3.列出部门名称和这些部门的员工信息</p>
<p>4.列出在销售部工作的员工的姓名，假定不知道销售部的部门编号</p>
<p>5.列出与庞统从事相同工作的所有员工及部门名称</p>
<p>6.列出最低薪金大于 15000 的各种工作以及从事此工作的员工人数</p>
</div></template>
