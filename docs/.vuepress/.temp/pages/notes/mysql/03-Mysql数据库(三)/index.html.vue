<template><div><h1 id="_03-mysql-数据库-三" tabindex="-1"><a class="header-anchor" href="#_03-mysql-数据库-三" aria-hidden="true">#</a> 03 - Mysql 数据库 (三) 💦</h1>
<nav class="table-of-contents"><ul><li><router-link to="#内置函数">内置函数</router-link><ul><li><router-link to="#聚合函数">聚合函数</router-link></li><li><router-link to="#字符函数">字符函数</router-link></li><li><router-link to="#数值函数">数值函数</router-link></li><li><router-link to="#日期函数">日期函数</router-link></li><li><router-link to="#加密函">加密函</router-link></li></ul></li><li><router-link to="#复制表与数据复制">复制表与数据复制</router-link></li><li><router-link to="#索引">索引</router-link><ul><li><router-link to="#索引分类">索引分类</router-link></li><li><router-link to="#索引创建语法">索引创建语法</router-link></li></ul></li><li><router-link to="#视图">视图</router-link><ul><li><router-link to="#创建语法">创建语法</router-link></li></ul></li><li><router-link to="#事务-transaction">事务（Transaction）</router-link><ul><li><router-link to="#概述">概述</router-link></li><li><router-link to="#事务特性">事务特性</router-link></li><li><router-link to="#mysql-事务的使用">Mysql 事务的使用</router-link></li><li><router-link to="#事务隔离级别">事务隔离级别</router-link></li></ul></li><li><router-link to="#数据库可编程性介绍">数据库可编程性介绍</router-link><ul><li><router-link to="#概述-1">概述</router-link></li><li><router-link to="#数据库可编程性分类">数据库可编程性分类</router-link></li><li><router-link to="#存储过程-procedure">存储过程（Procedure）</router-link></li></ul></li></ul></nav>
...
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token comment">--查询表中一共有多少员工</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="字符函数" tabindex="-1"><a class="header-anchor" href="#字符函数" aria-hidden="true">#</a> 字符函数</h3>
<table>
<thead>
<tr>
<th>函数名</th>
...
<tr>
<td>ltrim(s)/rtrim(s)</td>
<td>去除字符串左边空格/右边空格</td>
</tr>
<tr>
<td>substr(s,pos,len)</td>
<td>将字符串 s 从 pos 开始截取 len 长</td>
</tr>
<tr>
<td>lpad/rpad</td>
<td>左填充/右填充</td>
...
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token comment">-- 获取字符串使用的字符集</span>
...
<tr>
<td>format(n,len)</td>
<td>截取 len 位小数（四舍五入）</td>
</tr>
<tr>
<td>rand()</td>
<td>获取随机数(0-1)，取 0-1 之间随机的小数，无限接近于 0 且不会等于 0，无限接近于 1，且不会等于 1</td>
</tr>
</tbody>
</table>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="日期函数" tabindex="-1"><a class="header-anchor" href="#日期函数" aria-hidden="true">#</a> 日期函数</h3>
<table>
<thead>
<tr>
<th>函数名</th>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="加密函" tabindex="-1"><a class="header-anchor" href="#加密函" aria-hidden="true">#</a> 加密函</h3>
<table>
<thead>
<tr>
<th>函数名</th>
...
<tr>
<td>password(s)</td>
<td>使用 sha1 对字符串加密</td>
</tr>
</tbody>
</table>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token comment">-- 加密函数（非对称加密）</span>
...
这三种加密方式都是不可逆，不能反推破解
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="复制表与数据复制" tabindex="-1"><a class="header-anchor" href="#复制表与数据复制" aria-hidden="true">#</a> 复制表与数据复制</h2>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token comment">-- 复制表（同时复制数据） 对关键表的数据进行备份</span>
...
<p>​ 索引提供指向存储在表的指定列中的数据值的指针，然后根据您指定的排序顺序对这些指针排序。数据库使用索引以找到特定值，然后顺指针找到包含该值的行。这样可以使对应于表的 SQL 语句执行得更快，可快速访问数据库表中的特定信息。</p>
<p>​ <strong>索引类似字典的目录，可通过索引快速查询到目标数据。</strong></p>
<h3 id="索引分类" tabindex="-1"><a class="header-anchor" href="#索引分类" aria-hidden="true">#</a> 索引分类</h3>
<p>1、普通索引：MySQL 中基本索引类型，没有什么限制，允许在定义索引的列中插入重复值和空值，纯粹为了查询数据更快一点</p>
<p>2、唯一性索引：索引列中的值必须是唯一的，但是允许为空值</p>
<p>3、主键索引(聚簇索引)：即表中主键列</p>
<p>4、全文索引：全文索引，只有在 MyISAM 引擎上才能使用，只能在 CHAR,VARCHAR,TEXT 类型字段上使用全文索引。（mysql 数据库在 5.5 版本以前，使用的引擎是 MylSAM;在 5.5 以及以上的版本，mysql 的引擎使用的是 InnoDB）</p>
<p>5、组合索引：
在表中的多个字段组合上创建的索引，只有在查询条件中使用了这些字段的左边字段时，索引才会被使用，使用组合索引时遵循最左前缀集合。</p>
<h6 id="如果某个字段不是经常被作为查询条件进行使用时-那么该字段尽量就不要作为索引" tabindex="-1"><a class="header-anchor" href="#如果某个字段不是经常被作为查询条件进行使用时-那么该字段尽量就不要作为索引" aria-hidden="true">#</a> 如果某个字段不是经常被作为查询条件进行使用时，那么该字段尽量就不要作为索引</h6>
<p>因为添加字段索引，就是将该字段的索引添加在服务器内存当中，如果每张表的索引过多，会对整个服务器的运行产生巨大的影响</p>
<h3 id="索引创建语法" tabindex="-1"><a class="header-anchor" href="#索引创建语法" aria-hidden="true">#</a> 索引创建语法</h3>
<p><img src="@source/notes/mysql/03-Mysql数据库(三)/assets/1596078377803.png" alt="1596078377803"></p>
<h4 id="创建普通索引" tabindex="-1"><a class="header-anchor" href="#创建普通索引" aria-hidden="true">#</a> 创建普通索引</h4>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token keyword">create</span> <span class="token keyword">index</span> index_ename <span class="token keyword">on</span> tbemp<span class="token punctuation">(</span>ename<span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="创建唯一索引" tabindex="-1"><a class="header-anchor" href="#创建唯一索引" aria-hidden="true">#</a> 创建唯一索引</h4>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token keyword">create</span> <span class="token keyword">unique</span> <span class="token keyword">index</span> index_username <span class="token keyword">on</span> tbuser<span class="token punctuation">(</span>username<span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><blockquote>
<p><strong>唯一索引要求被添加索引的列值必须唯一</strong></p>
</blockquote>
<h4 id="创建组合索引" tabindex="-1"><a class="header-anchor" href="#创建组合索引" aria-hidden="true">#</a> 创建组合索引</h4>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token keyword">create</span> <span class="token keyword">index</span> index_emp <span class="token keyword">on</span> tbemp<span class="token punctuation">(</span>ename<span class="token punctuation">,</span>sal<span class="token punctuation">,</span>age<span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><blockquote>
<p><strong>组合索引的使用一般在进行多条件查询时提升查询效率</strong></p>
</blockquote>
<p><img src="@source/notes/mysql/03-Mysql数据库(三)/assets/1596079997391.png" alt="1596079997391"></p>
<blockquote>
<p>注意事项：</p>
<p>任何一张数据库表都应该有一个主键列，默认数据系统对主键列增加了聚簇索引，因此针对主键列的查询速度比较快。</p>
<p>Mysql 中的索引实现基于 B+树（二叉树） 最左匹配原则</p>
</blockquote>
<h2 id="视图" tabindex="-1"><a class="header-anchor" href="#视图" aria-hidden="true">#</a> 视图</h2>
<p>​ 视图实际上就是一张虚拟的表，视图是针对基表的一部分字段的缩影，一般用于对一些字段比较多的表，通过视图可以简化表结构；另外针对一些涉及到多表的查询操作时，建立视图可以简化查询语句；</p>
<h3 id="创建语法" tabindex="-1"><a class="header-anchor" href="#创建语法" aria-hidden="true">#</a> 创建语法</h3>
<p><img src="@source/notes/mysql/03-Mysql数据库(三)/assets/1596089489736.png" alt="1596089489736"></p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token comment">-- 创建视图</span>
...
<p>注意事项：</p>
<p>视图不占据存储空间，只是一种逻辑存在（非物理存储）；只有在使用视图时才通过视图的定义，加载对应的数据</p>
<p>对视图的操作会影响基表(物理表，实际开发中一般针对视图做查询，避免基于视图做修改</p>
<p><strong>索引提高查询速度，视图简化了查询的方式</strong></p>
</blockquote>
<h2 id="事务-transaction" tabindex="-1"><a class="header-anchor" href="#事务-transaction" aria-hidden="true">#</a> 事务（Transaction）</h2>
<h3 id="概述" tabindex="-1"><a class="header-anchor" href="#概述" aria-hidden="true">#</a> 概述</h3>
<p>​ 事务是实际开发中，比较常见业务逻辑操作中都会存在问题，比如转账的业务，需要将一个账户的钱转向到另一个账号，此时会涉及到两个修改操作：A 账户钱减少，B 账户钱增加；这两个操作要保证能同时成功或者同时失败，那么这一个业务需求(逻辑单元)就称之为一个事务。</p>
<p><img src="@source/notes/mysql/03-Mysql数据库(三)/assets/1596090904115.png" alt="1596090904115"></p>
<h3 id="事务特性" tabindex="-1"><a class="header-anchor" href="#事务特性" aria-hidden="true">#</a> 事务特性</h3>
<p>数据库事务包含四大特征(ACID)：</p>
<ol>
<li>原子性：对于事务中的多次更新操作要么同时成功，要么同时失败</li>
<li>一致性：保证事务操作完成之后，所有的结果一致</li>
<li>隔离性：事物之间各自独立存在相互不影响</li>
<li>持久性：事务完成之后，确保所有的数据长期持久的存在</li>
</ol>
<h3 id="mysql-事务的使用" tabindex="-1"><a class="header-anchor" href="#mysql-事务的使用" aria-hidden="true">#</a> Mysql 事务的使用</h3>
<p>mysql 中只有使用 InnoDB 引擎才支持事务；MyISAM 引擎不支持事务</p>
<p>​ show table status where name = 'emp' \G</p>
<p><img src="@source/notes/mysql/03-Mysql数据库(三)/assets/1596093789302.png" alt="1596093789302"></p>
<p>参考代码</p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token comment">-- 开启事务(事务一旦开，后续的所有更新操作都在这个事务中，直到提交后才会对物理表产生影响)</span>
...
<p>由于实际的业务操作可能会涉及到很多事务的并发操作，因此在事务并发时可能会遇到以下问题：</p>
<ol>
<li>
<p>**丢失更新：**撤消一个事务时，把其它事务已提交的更新的数据覆盖了。</p>
</li>
<li>
<p><strong>脏读</strong>：事务 A 读取了事务 B 更新的数据，而此时事务 B 并未提交，那么 A 读取到的数据是脏数据</p>
<p>脏数据</p>
</li>
<li>
<p>**不可重复读：**事务 A 多次读取同一数据，事务 B 在事务 A 多次读取的过程中，对数据作了更新
并提交，导致事务 A 多次读取同一数据时，结果 不一致。</p>
</li>
<li>
<p>**幻读：**系统管理员 A 将数据库中所有学生的成绩从具体分数改为 ABCDE 等级，但是系统管理员 B
就在这个时候插入了一条具体分数的记录，当系统管理员 A 改结束后发现还有一条记录没有
改过来，就好像发生了幻觉一样，这就叫幻读。</p>
</li>
</ol>
<p>对于以上可能出现的问题，数据库中引入事务隔离级别的解决方案：</p>
<p><img src="@source/notes/mysql/03-Mysql数据库(三)/assets/1596094489993.png" alt="1596094489993"></p>
<p>以上是解决事务并发问题的方案，其中隔离级别从低到高，对数据操作的效率影响从低到高；Mysql 中默认的隔离级别是：repeatable-read</p>
<p><img src="@source/notes/mysql/03-Mysql数据库(三)/assets/1596094769618.png" alt="1596094769618"></p>
<h2 id="数据库可编程性介绍" tabindex="-1"><a class="header-anchor" href="#数据库可编程性介绍" aria-hidden="true">#</a> 数据库可编程性介绍</h2>
<h3 id="概述-1" tabindex="-1"><a class="header-anchor" href="#概述-1" aria-hidden="true">#</a> 概述</h3>
<p>​ 在之前学习到所有有关数据库操作几乎都是一行命令解决问题，这些命令大多都是 sql 标准语法；但是不同的数据库管理系统对 sql 语句都添加了扩展支持，允许通过一些常见数据类型，运算符，分支语句，循环语句等实现一些类似常规编程语言的操作，这个概念称之为数据库的可编程性；对于不同的数据库产品对于可编程的命名也存在差异：</p>
<ol>
<li>MSSQLServer 的可编程性称之为 T-SQL</li>
<li>Oracle 中的可编程性称之为 PL/SQL</li>
</ol>
<h3 id="数据库可编程性分类" tabindex="-1"><a class="header-anchor" href="#数据库可编程性分类" aria-hidden="true">#</a> 数据库可编程性分类</h3>
<ul>
<li>存储过程(procedure)</li>
<li>触发器(trigger)</li>
</ul>
<h3 id="存储过程-procedure" tabindex="-1"><a class="header-anchor" href="#存储过程-procedure" aria-hidden="true">#</a> 存储过程（Procedure）</h3>
<p>​ 存储过程(Procedure),是数据库操作语言 SQL 的可编程性实现，传统的 SQL 语句通常是在数据库服务器中执行一条命令，命令在数据库引擎内部需要经过创建与分析的过程，因此在运行时间上开销较大；而存储过程是预编译的，在首次运行一个存储过程时，查询优化器对其进行分析、优化，并给出最终被存在系统表中的存储计划，这样，后期的使用只需通过命令调用即可，因此，在执行过程时便可节省此开销。</p>
<p><img src="@source/notes/mysql/03-Mysql数据库(三)/assets/1596104686639.png" alt="1596104686639"></p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token comment">--最基础简单存储过程</span>
...
<p>存储过程优劣势：</p>
<p><img src="@source/notes/mysql/03-Mysql数据库(三)/assets/1596104342361.png" alt="1596104342361"></p>
</blockquote>
<h4 id="练习" tabindex="-1"><a class="header-anchor" href="#练习" aria-hidden="true">#</a> 练习：</h4>
<p>​ 1：索引的使用</p>
<p>​ 对 emp 表中的 enam 字段添加索引</p>
<p>​ 对 emp 表中 ename,job,age 三个字段添加组合索引</p>
<p>​ 修改索引，将上条组合索引修改为 ename 和 job 的组合</p>
<p>2：视图的使用</p>
<p>​ 新建员工表的视图</p>
<p>​ 新建部门表的视图</p>
<p>​ 新建获取 T8 薪资等，所有研发部员工的个人信息和部门名称</p>
<p>3: 事务的使用</p>
<p>​ 修改 emp 表为不自动提交事务，新建事务对员工的薪资调整的完整事务</p>
<p>​ 分别对员工薪资做两次调整，并且对这两次操作分别设置保存点；</p>
<p>​ 最后回滚到第一个保存点</p>
<p>​ 并提交事务，完成对第一次薪资的修改</p>
<p>4：存储过程的实现</p>
<p>​ 新建存储过程，当修改员工的薪资低于当前员工岗位等级（比如 T5,T6）最低薪资时，让员工的薪资默认为最低薪资,并最终显示员工修改后的所有信息</p>
</div></template>
